...
const ts = new na(), Fo = async (u) => {
  const s = `${N.ssl ? "https" : "http"}://${ts.botHost}`;
  return await fetch(`${s}${N.projectPath}chat`, {
    headers: {
  ...
  const s = `${N.ssl ? "https" : "http"}://${N.botHost}`;
...
class sa {
  ...
  init(s) {
    ...
    const r = `wss://endpoint-prod-chatgpt.mibot.cl:8080${N.projectPath}messages/${s}/ws`;
...
class tn extends Y {
  constructor() {
    super(), this.isMicShowing = !1, this.attachedFiles = [], this.isSendingMessage = !1, this.messagesHistory = [
      { response: N.welcomeMessage, from: "api", type: "text" }
    ];
  }
  ...
  async onSubmit(s) {
    ...
    if (this.attachedFiles.length && (this.addMessageAndUpdateScroll(
      ...
      oa({
        content: `${h.message}
${h.url}`,
        conversation_id: N.messageHistoryId,
        channel_id: N.chathubChannelId,
        sender: "user"
      }).finally(() => {
    ...
    h.url.length ? h.url.forEach((l) => {
      Fo({
        ...
        var c, _;
        f != null && f.unique_id && (N.messageHistoryId = f.unique_id, ti.init(N.messageHistoryId), ti.onIncomingMessage(
          ...
          ...f,
          from: "api"
        }), f.thought && N.showThoughts && this.showBotThought(f.thought), f.redirect && (this.chattingWith = "human_agent");
      }).catch((f) => console.log(f)).finally(() => {
        this.removeLoadingMessages(), this.updateScrollbar(), this.isSendingMessage = !1;
      });
    }) : Fo(h).then((l) => {
      var f, c;
      l != null && l.unique_id && (N.messageHistoryId = l.unique_id, ti.init(N.messageHistoryId), ti.onIncomingMessage(
        ...
        ...l,
        from: "api"
      }), l.redirect && (this.chattingWith = "human_agent"), l.thought && this.showBotThought(l.thought);
...
class on extends Y {
  ...
  get interactiveTemplate() {
    ...
    })}`), r.length && ((h = N.callbacks) != null && h.address) && N.callbacks.address(r), s;
  }
  get botAvatar() {
...
(function(u, s) {
  (function(r, h) {
    ...
    at.prototype = {
      ...
      extend: function(t) {
        ...
        if (t instanceof H)
          ...
          return t ? this.extend(I(t) || Q(t)) : this;
      ...
      // Returns `true` if the rectangle contains the given point.
      contains: function(t) {
        typeof t[0] == "number" || t instanceof H || "lat" in t ? t = I(t) : t = Q(t);
        var e = this._southWest, i = this._northEast, n, o;
    ...
    function $n(t, e) {
      ...
      var E = I([0, 0]), O = Q(t), nt = O.getNorthWest().distanceTo(O.getSouthWest()) * O.getNorthEast().distanceTo(O.getNorthWest());
      nt < 1700 && (E = Bi(t));
      var J = t.length, mt = [];
      for (i = 0; i < J; i++) {
        var ht = I(t[i]);
        mt.push(e.project(I([ht.lat - E.lat, ht.lng - E.lng])));
      }
      ...
      return I([ae.lat + E.lat, ae.lng + E.lng]);
    }
    function Bi(t) {
    ...
    function so(t, e) {
      ...
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      pt(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var y = I([0, 0]), E = Q(t), O = E.getNorthWest().distanceTo(E.getSouthWest()) * E.getNorthEast().distanceTo(E.getNorthWest());
      O < 1700 && (y = Bi(t));
      var nt = t.length, J = [];
      for (i = 0; i < nt; i++) {
        var mt = I(t[i]);
        J.push(e.project(I([mt.lat - y.lat, mt.lng - y.lng])));
      }
      ...
      return I([ht.lat + y.lat, ht.lng + y.lng]);
    }
    var tr = {
      __proto__: null,
      simplify: to,
    ...
    var zt = vt.extend({
      ...
      initialize: function(t, e) {
        P(this, e), this._latlng = I(t), this._radius = this.options.radius;
      },
      // @method setLatLng(latLng: LatLng): this
    ...
    var Di = Ve.extend({
      initialize: function(t, e, i) {
        if (typeof e == "number" && (e = l({}, i, { radius: e })), P(this, e), this._latlng = I(t), isNaN(this.options.radius))
    ...
    function Hi(t, e) {
      return t = I(t), t.alt !== void 0 ? [S(t.lng, e), S(t.lat, e), S(t.alt, e)] : [S(t.lng, e), S(t.lat, e)];
    }
    function Qe(t, e, i, n) {
    ...
    var xt = vt.extend({
      ...
      initialize: function(t, e) {
        t && (t instanceof H || tt(t)) ? (this._latlng = I(t), P(this, e)) : (P(this, t), this._source = e), this.options.content && (this._content = this.options.content);
      },
    ...
    Le.create = We, Le.pointsToPath = xn, Lt.geometryToLayer = qe, Lt.coordsToLatLng = Zi, Lt.coordsToLatLngs = Ye, Lt.latLngToCoords = Hi, Lt.latLngsToCoords = Qe, Lt.getFeature = se, Lt.asFeature = Ge, z.mergeOptions({
    ...
    z.addInitHook("addHandler", "boxZoom", bo), z.mergeOptions({
    ...
    z.addInitHook("addHandler", "doubleClickZoom", xo), z.mergeOptions({
    ...
    z.addInitHook("addHandler", "dragging", wo), z.mergeOptions({
      // @option keyboard: Boolean = true
    ...
    z.addInitHook("addHandler", "keyboard", Ao), z.mergeOptions({
    ...
    z.addInitHook("addHandler", "scrollWheelZoom", Eo);
    var Ar = 600;
    z.mergeOptions({
    ...
    z.addInitHook("addHandler", "tapHold", Co), z.mergeOptions({
      // @section Touch interaction options
    ...
    z.addInitHook("addHandler", "touchZoom", Po), z.BoxZoom = bo, z.DoubleClickZoom = xo, z.Drag = wo, z.Keyboard = Ao, z.ScrollWheelZoom = Eo, z.TapHold = Co, z.TouchZoom = Po, r.Bounds = F, r.Browser = w, r.CRS = Et, r.Canvas = go, r.Circle = Di, r.CircleMarker = Ve, r.Class = X, r.Control = gt, r.DivIcon = fo, r.DivOverlay = xt, r.DomEvent = Us, r.DomUtil = Zs, r.Draggable = It, r.Evented = fe, r.FeatureGroup = Ct, r.GeoJSON = Lt, r.GridLayer = Ce, r.Handler = bt, r.Icon = ne, r.ImageOverlay = Ke, r.LatLng = H, r.LatLngBounds = at, r.Layer = vt, r.LayerGroup = ie, r.LineUtil = tr, r.Map = z, r.Marker = je, r.Mixin = Gs, r.Path = zt, r.Point = k, r.PolyUtil = Ks, r.Polygon = oe, r.Polyline = Pt, r.Popup = Xe, r.PosAnimation = Gn, r.Projection = er, r.Rectangle = yo, r.Renderer = Tt, r.SVG = Le, r.SVGOverlay = co, r.TileLayer = re, r.Tooltip = Je, r.Transformation = ui, r.Util = At, r.VideoOverlay = uo, r.bind = c, r.bounds = rt, r.canvas = vo, r.circle = lr, r.circleMarker = hr, r.control = we, r.divIcon = _r, r.extend = l, r.featureGroup = sr, r.geoJSON = lo, r.geoJson = dr, r.gridLayer = yr, r.icon = rr, r.imageOverlay = fr, r.latLng = I, r.latLngBounds = Q, r.layerGroup = or, r.map = Fs, r.marker = ar, r.point = T, r.polygon = cr, r.polyline = ur, r.popup = gr, r.rectangle = wr, r.setOptions = P, r.stamp = g, r.svg = _o, r.svgOverlay = mr, r.tileLayer = po, r.tooltip = vr, r.transformation = pe, r.version = h, r.videoOverlay = pr;
    var Er = window.L;
...
class ln extends Y {
  ...
  get mapActionButton() {
    ...
    return B`<onbotgo-raisedbutton
      @click=${((r = (s = N.callbacks) == null ? void 0 : s.addressButton) == null ? void 0 : r.action) && ((h) => N.callbacks.addressButton.action(this.cardInfo, h))}
      >${N.callbacks.addressButton.text}</onbotgo-raisedbutton
    >`;
  }
  get backgroundMap() {
    return B`<onbotgo-box class="background-map-container"
      ...
      ${N.callbacks.addressButton && this.mapActionButton}
    </onbotgo-box>`;
  }
  async modalMap() {
    ...
    this.isSearching = !0, r.search({
      ...
      lt.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
        ...
        typeof ((c = (f = N.callbacks) == null ? void 0 : f.addressButton) == null ? void 0 : c.action)
      ) || ((g = (_ = N.callbacks) == null ? void 0 : _.addressButton) == null ? void 0 : g.action) instanceof Promise) && (this.template = B` <link
              rel="stylesheet"
...
class Fa {
  constructor({
    ...
    if (N.chatflowID = s, N.chathubChannelId = r, f && (N.projectPath = f), l && (N.welcomeMessage = l), c && (N.ssl = c), l && (N.welcomeMessage = l), g && (N.googleApikey = g), b && (N.callbacks = b), g && (N.googleApikey = g), [!1, !0].includes(A) && (N.showThoughts = A), !h)
      return;
  ...
  init() {
    ...
    if (ot.active) {
      const r = document.createElement("onbotgo-whatsappbubble");
      ot.position.includes("t") && (r.style.top = "min(2%, 2dvh)"), ot.position.includes("l") && (r.style.left = "min(2%, 2dvh)"), ot.position.includes("r") && (r.style.right = "min(2%, 2dvh)"), ot.position.includes("b") && (r.style.bottom = "min(2%, 2dvh)"), r.onclick = () => {
        window.open(
