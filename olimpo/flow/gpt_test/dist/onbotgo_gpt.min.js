...
var Kt = (n, t, e) => t in n ? zt(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e;
var f = (n, t, e) => (Kt(n, typeof t != "symbol" ? t + "" : t, e), e);
class Gt {
  constructor() {
    f(this, "typography", {
...
const Zt = {}, _t = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Zt
}, Symbol.toStringTag, { value: "Module" })), Ht = /* @__PURE__ */ Wt(_t);
...
function N(n, t, e) {
  for (var r in t)
    It(t, r) && (t[r] != null && typeof t[r] == "object" && (r === "storage" || r === "prefixes") && !e ? n[r] = N(
      /*toObj[key] ||*/
      {},
      t[r]
    ) : n[r] = t[r]);
...
`).replace(/^\s+|\s+$/gm, "")), X.lastIndex = 0, J.lastIndex = 0, z.lastIndex = 0;
  var e = t.prefixes, r = [
    ...
    return u && g ? u + "|" + K(g) : g ? K(g) : u;
  }, ""), o = new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?" + // comments, strings
  K(t.tags[1]) + ")", "g"), i = new RegExp("([^]*?)" + K(t.tags[0]) + "(-|_)?\\s*(" + r + ")?\\s*", "g"), s = 0, l = !1;
  function c(u, g) {
    var p = { f: [] }, m = 0, y = "c";
    g === "h" || g === "b" || g === "c" ? y = "n" : g === "r" && (p.raw = !0, g = "i");
    function A(Q) {
      var vt = n.slice(s, Q), H = vt.trim();
      if (y === "f")
        H === "safe" ? p.raw = !0 : t.async && F.test(H) ? (H = H.replace(F, ""), p.f.push([H, "", !0])) : p.f.push([H, ""]);
      else if (y === "fp")
        p.f[p.f.length - 1][1] += H;
      else if (y === "err") {
        if (H) {
          var Jt = vt.search(/\S/);
          D("invalid syntax", n, s + Jt);
        }
      } else
        p[y] = H;
      s = Q + 1;
    ...
    o.lastIndex = s;
    for (var C; (C = o.exec(n)) !== null; ) {
      var S = C[1], E = C[2], x = C[3], B = C[4], v = C[5], M = C.index;
      if (S)
        S === "(" ? (m === 0 && (y === "n" ? (A(M), y = "p") : y === "f" && (A(M), y = "fp")), m++) : S === ")" ? (m--, m === 0 && y !== "c" && (A(M), y = "err")) : m === 0 && S === "|" ? (A(M), y = "f") : S === "=>" && (A(M), s += 1, y = "res");
      else if (E) {
        if (E === "/*") {
          var I = n.indexOf("*/", o.lastIndex);
          I === -1 && D("unclosed comment", n, C.index), o.lastIndex = I + 2;
        } else if (E === "'") {
          J.lastIndex = C.index;
          var k = J.exec(n);
          k ? o.lastIndex = J.lastIndex : D("unclosed string", n, C.index);
        } else if (E === '"') {
          z.lastIndex = C.index;
          var V = z.exec(n);
          V ? o.lastIndex = z.lastIndex : D("unclosed string", n, C.index);
        } else if (E === "`") {
          X.lastIndex = C.index;
          var L = X.exec(n);
          L ? o.lastIndex = X.lastIndex : D("unclosed string", n, C.index);
        }
      } else if (x)
        return A(M), s = M + C[0].length, i.lastIndex = s, l = v, B && g === "h" && (g = "s"), p.t = g, p;
    }
    return D("unclosed tag", n, u), p;
  }
  function d(u, g) {
    u.b = [], u.d = [];
    var p = !1, m = [];
    ...
    for (var A; (A = i.exec(n)) !== null; ) {
      var C = A[1], S = A[2], E = A[3] || "", x;
      for (var B in e)
        if (e[B] === E) {
          x = B;
          break;
        }
      y(C, S), s = A.index + A[0].length, x || D("unrecognized tag type: " + E, n, s);
      var v = c(A.index, x), M = v.t;
      if (M === "h") {
        var I = v.n || "";
        t.async && F.test(I) && (v.a = !0, v.n = I.replace(F, "")), v = d(v), m.push(v);
      } else if (M === "c") {
        if (u.n === v.n)
          return p ? (p.d = m, u.b.push(p)) : u.d = m, u;
        D("Helper start and end don't match", n, A.index + A[0].length);
      } else if (M === "b") {
        p ? (p.d = m, u.b.push(p)) : u.d = m;
        var k = v.n || "";
        t.async && F.test(k) && (v.a = !0, v.n = k.replace(F, "")), p = v, m = [];
      } else if (M === "s") {
        var V = v.n || "";
        t.async && F.test(V) && (v.a = !0, v.n = V.replace(F, "")), m.push(v);
      } else
        m.push(v);
    }
    if (g)
      y(n.slice(s, n.length), !1), u.d = m;
    else
      throw R('unclosed helper "' + u.n + '"');
    return u;
  }
  var a = d({ f: [] }, !0);
  if (t.plugins)
...
function Rt(n, t) {
  var e = ee(n, t), r = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + U(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function kt(n, t, e, r, o, i) {
  var s = "{exec:" + (o ? "async " : "") + Dt(e, t, n) + ",params:[" + r + "]";
  return i && (s += ",name:'" + i + "'"), o && (s += ",async:true"), s += "}", s;
}
function re(n, t) {
  for (var e = "[", r = 0; r < n.length; r++) {
    var o = n[r];
    e += kt(t, o.res || "", o.d, o.p || "", o.a, o.n), r < n.length && (e += ",");
  }
  return e += "]", e;
}
function Dt(n, t, e) {
  return "function(" + t + "){var tR='';" + U(n, e) + "return tR}";
}
function U(n, t) {
  ...
  for (e; e < r; e++) {
    ...
    if (typeof i == "string") {
      ...
      var l = i.t, c = i.c || "", d = i.f, a = i.n || "", h = i.p || "", b = i.res || "", u = i.b, g = !!i.a;
      if (l === "i") {
        ...
        if (t.storage.nativeHelpers.get(a))
          ...
          var m = (g ? "await " : "") + "c.l('H','" + a + "')(" + kt(t, b, i.d, h, g);
          u ? m += "," + re(u, t) : m += ",[]", m += ",c)", o += "tR+=" + et(m, d) + ";";
        }
      else
...
function O(n, t, e, r) {
  if (t && t.length > 0)
    throw R((r ? "Native" : "") + "Helper '" + n + "' doesn't accept blocks");
  if (e && e.length > 0)
    throw R((r ? "Native" : "") + "Helper '" + n + "' doesn't accept filters");
}
function Ft(n, t, e, r, o) {
  e(n[t], t).then(function(i) {
    r += i, t === n.length - 1 ? o(r) : Ft(n, t + 1, e, r, o);
  });
}
function jt(n, t, e, r, o, i) {
  r(t[e], n[t[e]]).then(function(s) {
    o += s, e === t.length - 1 ? i(o) : jt(n, t, e + 1, r, o, i);
  });
}
var ne = {
  "&": "&amp;",
...
var se = new Z({}), ut = new Z({
  ...
  foreach: function(n, t) {
    var e = n.params[0];
    if (O("foreach", t, !1), n.async)
      return new Promise(function(i) {
        jt(e, Object.keys(e), 0, n.exec, "", i);
      });
    var r = "";
    for (var o in e)
      It(e, o) && (r += n.exec(o, e[o]));
    return r;
  },
  include: function(n, t, e) {
    ...
    if (!r)
      throw R('Could not fetch template "' + n.params[0] + '"');
  ...
  useScope: function(n, t) {
    return O("useScope", t, !1), n.exec(n.params[0]);
  }
}), ae = new Z({
  if: function(n, t) {
    O("if", !1, n.f, !0);
    var e = "if(" + n.p + "){" + U(n.d, t) + "}";
    if (n.b)
  ...
  try: function(n, t) {
    if (O("try", !1, n.f, !0), !n.b || n.b.length !== 1 || n.b[0].n !== "catch")
      throw R("native helper 'try' only accepts 1 block, 'catch'");
    var e = "try{" + U(n.d, t) + "}", r = n.b[0];
    return e += "catch" + (r.res ? "(" + r.res + ")" : "") + "{" + U(r.d, t) + "}", e;
  },
  block: function(n, t) {
    O("block", n.b, n.f, !0);
    var e = "if(!" + t.varName + "[" + n.p + "]){tR+=(" + Dt(n.d, "", t) + ")()}else{tR+=" + t.varName + "[" + n.p + "]}";
    return e;
  }
}), le = new Z({ e: ie }), st = {
  varName: "it",
...
function _(n, t) {
  var e = {};
  return N(e, st), t && N(e, t), n && N(e, n), e.l.bind(e), e;
}
function pt(n, t) {
...
function de(n, t) {
  ...
  if (i && i.length)
    ...
    throw R('Could not find the include file "' + n + '"');
  return e;
}
function Ut(n) {
  return at.readFileSync(n).toString().replace(ce, "");
}
function he(n, t) {
  var e = _(t), r = Ut(n);
  try {
...
function Ot(n, t) {
  var e = _({ filename: de(n, t) }, t);
  return ge(e);
}
function ue(n, t, e) {
  if (t && t.length > 0)
    throw R("Helper 'includeFile' doesn't accept blocks");
  return Ot(n.params[0], e)(n.params[1], e);
}
function pe(n, t, e) {
  var r = n.params[1] || {};
  r.content = n.exec();
  ...
  return Ot(n.params[0], e)(r, e);
}
function ot(n, t) {
  var e;
  return t.cache && t.name && t.storage.templates.get(t.name) ? t.storage.templates.get(t.name) : (typeof n == "function" ? e = n : e = pt(n, t), t.cache && t.name && t.storage.templates.define(t.name, e), e);
}
function fe(n, t, e, r) {
  var o = _(e || {});
  if (o.async) {
...
}), Ae = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
function ve(n, t) {
  return typeof n[0] == "number" && (n = [n]), Ee(n), {
    duration: t,
    length: n[0].length,
...
var Pt = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function o(i) {
    return i instanceof e ? i : new e(function(s) {
      s(i);
    });
...
function xe(n, t, e) {
  ...
  return Pt(this, void 0, void 0, function* () {
    const i = yield fetch(n, e);
    {
      ...
      let c = 0;
      const d = (a, h) => Pt(this, void 0, void 0, function* () {
        if (a)
          return;
        c += (h == null ? void 0 : h.length) || 0;
        const b = Math.round(c / l * 100);
        return t(b), s == null ? void 0 : s.read().then(({ done: u, value: g }) => d(u, g));
      });
...
function Se(n, t, e, r, o = 5) {
  ...
  const s = (l) => {
    ...
    const h = (g) => {
      ...
      const p = g.clientX, m = g.clientY;
      if (a || Math.abs(p - c) >= o || Math.abs(m - d) >= o) {
        const { left: y, top: A } = n.getBoundingClientRect();
        a || (a = !0, e == null || e(c - y, d - A)), t(p - c, m - d, p - y, m - A), c = p, d = m;
      }
    }, b = (g) => {
    ...
    document.addEventListener("pointermove", h), document.addEventListener("pointerup", u), document.addEventListener("pointerleave", u), document.addEventListener("click", b, !0), i = () => {
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, r, o) {
    const i = t[0], s = t[1] || t[0], l = i.length, { width: c, height: d } = r.canvas, a = d / 2, h = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * h : 1, u = e.barGap ? e.barGap * h : e.barWidth ? b / 2 : 0, g = e.barRadius || 0, p = c / (b + u) / l, m = g && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let y = 0, A = 0, C = 0;
    for (let S = 0; S <= l; S++) {
      const E = Math.round(S * p);
      if (E > y) {
        const v = Math.round(A * a * o), M = Math.round(C * a * o), I = v + M || 1;
        let k = a - v;
        e.barAlign === "top" ? k = 0 : e.barAlign === "bottom" && (k = d - I), r[m](y * (b + u), k, b, I, g), y = E, A = 0, C = 0;
      }
      const x = Math.abs(i[S] || 0), B = Math.abs(s[S] || 0);
      x > A && (A = x), B > C && (C = B);
    }
    r.fill(), r.closePath();
  }
  renderLineWaveform(t, e, r, o) {
    const i = (s) => {
      const l = t[s] || t[0], c = l.length, { height: d } = r.canvas, a = d / 2, h = r.canvas.width / c;
      r.moveTo(0, a);
      let b = 0, u = 0;
      for (let g = 0; g <= c; g++) {
        const p = Math.round(g * h);
        if (p > b) {
          const y = Math.round(u * a * o) || 1, A = a + y * (s === 0 ? -1 : 1);
          r.lineTo(b, A), b = p, u = 0;
        }
  ...
  renderSingleCanvas(t, e, r, o, i, s, l, c) {
    ...
    a.width = Math.round(r * (s - i) / h), a.height = o * d, a.style.width = `${Math.floor(a.width / d)}px`, a.style.height = `${o}px`, a.style.left = `${Math.floor(i * r / d / h)}px`, l.appendChild(a);
    const b = a.getContext("2d");
    this.renderWaveform(t.map((p) => p.slice(i, s)), e, b);
    const u = a.cloneNode();
    c.appendChild(u);
  ...
  renderChannel(t, e, r) {
    ...
    let b = Math.min($.MAX_CANVAS_WIDTH, d);
    if (e.barWidth || e.barGap) {
      const E = e.barWidth || 0.5, x = e.barGap || E / 2, B = E + x;
      b % B !== 0 && (b = Math.floor(b / B) * B);
    }
    const u = Math.floor(Math.abs(l) * h), g = Math.floor(u + b * h), p = g - u, m = (E, x) => {
      this.renderSingleCanvas(t, e, r, i, Math.max(0, E), Math.min(x, a), o, s);
    }, y = this.createDelay(), A = this.createDelay(), C = (E, x) => {
      m(E, x), E > 0 && y(() => {
        C(E - p, x - p);
      });
    }, S = (E, x) => {
  ...
  scrollIntoView(t, e = !1) {
    ...
    if (s > o + c || s < o)
      if (this.options.autoCenter && !this.isDragging) {
        const d = l / 20;
        s - (o + l) >= d && s < o + r ? this.scrollContainer.scrollLeft += d : this.scrollContainer.scrollLeft = s - l;
      } else
        this.isDragging ? this.scrollContainer.scrollLeft = s < o ? s - 10 : s - r + 10 : this.scrollContainer.scrollLeft = s;
    {
      const { scrollLeft: d } = this.scrollContainer, a = d / i, h = (d + r) / i;
...
var G = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function o(i) {
    return i instanceof e ? i : new e(function(s) {
      s(i);
    });
...
class tt extends Re {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, Me, t), this.timer = new Pe();
  ...
  loadAudio(t, e, r, o) {
    return G(this, void 0, void 0, function* () {
      ...
      if (this.setSrc(t, e), r)
        ...
        })) || (yield Promise.resolve(0)), this.decodedData = St.createBuffer(r, o);
      else if (e) {
        const i = yield e.arrayBuffer();
        this.decodedData = yield St.decode(i, this.options.sampleRate);
      }
...
class bt extends T {
  constructor(e, r = !1) {
    ...
    if (this.message = e, this.setStyles({
      ...
      alignItems: "center"
    }), this.innerHTML = this.renderHTML(Ae, {
      type: e.type,
      fileType: e.fileType,
      file: e.file,
      message: e.message,
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
      ...
      const o = this.querySelector(".onbotgo-message");
      this.insertBefore(
        this.getAvatarMessage("apiMessage", r),
        o
  ...
  getAvatarMessage(e = "api", r = !1) {
    const o = new q();
    let i;
    return e === "apiMessage" && !r ? i = Te : e === "userMessage" ? i = He : r && (i = Le), o.innerHTML = `<img src=${i} width="25" height="25" />`, o.setStyles({
      padding: "5px",
      marginRight: "10px",
...
const P = new ke(), Mt = async (n) => await fetch(`${P.gpt_url}/chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(n)
}).then((t) => t.json()), De = async (n) => await fetch(`${P.gpt_url}/messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
...
class At extends T {
  constructor() {
    ...
    f(this, "input");
    this.innerHTML = this.renderHTML(Fe, { sendIcon: qt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(q.tag), this.input.style.fontFamily = w.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
yt.tag = "onbotgo-customscrollbar";
...
const Ne = async (n) => await fetch(`${P.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(n)
}).then((t) => t.json()), Y = "onbotgo-chatcontainer";
class Ct extends T {
  constructor() {
    super();
  ...
  initMessagesWebsocket(e) {
    ...
    this.messagesWebsocket = new WebSocket(r), this.messagesWebsocket.onmessage = (o) => {
  ...
  onSubmit(e) {
    ...
    const o = {
      ...
      url: (this.attachedFiles || []).map(({ url: s }) => s),
      unique_id: P.messageHistoryId
    };
    this.attachedFiles.length && (this.addMessages(
      this.attachedFiles.map((s) => ({
        type: "userMessage",
        file: s,
        fileType: s.type.includes("image") ? "image" : s.type
      }))
    ), this.attachedFiles = [], this.renderAttachTemplate(), this.messagesContainer.querySelectorAll("img").forEach((s) => {
      s.onload = () => this.updateScrollbar();
    ...
    const i = this.getChild("input[type=text]");
    if (i.disabled = !0, this.getChild("#onbotgo-chatinput").style.backgroundColor = "rgba(239,239,239,.6)", this.chattingWith === "human_agent") {
      De({
        content: `${o.message}
${o.url}`,
        ...
        var s;
        (s = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || s.forEach((l) => l.remove());
      });
      return;
    }
    o.url.length ? o.url.forEach((s) => {
      Mt({
        ...o,
        message: `envio comprobante de pago, esta es la url "${s}"`,
        url: void 0
      }).then((l) => {
        var c, d;
        l != null && l.unique_id && (P.messageHistoryId = l.unique_id, this.initMessagesWebsocket(P.messageHistoryId)), (d = (c = l == null ? void 0 : l.data) == null ? void 0 : c.process) != null && d.length && l.data.process.forEach((a) => {
          this.addMessages([
            {
              type: a.role,
              name: a.name,
        ...
        ]), l.redirect && (this.chattingWith = "human_agent");
      }).catch((l) => console.log(l)).finally(() => {
        var l;
        (l = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || l.forEach((c) => c.remove()), this.updateScrollbar(), i.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white";
      });
    }) : Mt(o).then((s) => {
      var l, c;
      s != null && s.unique_id && (P.messageHistoryId = s.unique_id, this.initMessagesWebsocket(P.messageHistoryId)), (c = (l = s == null ? void 0 : s.data) == null ? void 0 : l.process) != null && c.length && s.data.process.forEach((d) => {
        this.addMessages([
          {
            type: d.role,
            name: d.name,
      ...
      var s;
      (s = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || s.forEach((l) => l.remove()), i.disabled = !1, i.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", this.updateScrollbar();
    });
  }
  toggle() {
  ...
  renderMessages(e, r = !1) {
    e.forEach(
      (o) => !["dataMessage"].includes(o.type) && this.messagesContainer.appendChild(new bt(o, r))
    );
  }
  addMessages(e, { updateScrollbar: r } = { updateScrollbar: !1 }, o = !1) {
    this.messagesHistory = this.messagesHistory.concat(e), this.renderMessages(e, o), r && this.updateScrollbar();
  }
  updateScrollbar() {
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(Oe, {
...
class gt extends T {
  constructor() {
    ...
    const e = new ft(w.customIcon), r = new Ct();
...
function Xe({ element: n, styles: t }) {
  const e = t.reduce(
    (i, s) => ({
      ...i,
      ...s
    ...
    {}
  ), r = document.createElement("style"), o = Ke(e);
...
class Nt extends T {
  constructor() {
    ...
    let r = "black";
    t === "primary" && (r = w.colors.primary), t === "danger" && (r = "red"), e && (this.querySelector("svg").style.width = `calc(${e} - 16px)`, this.querySelector("svg").style.height = `calc(${e} - 16px)`, this.setStyles({ width: e, height: e })), this.setStyles({ color: r });
    const o = new q();
    o.setStyles({
      backgroundColor: r,
      opacity: 0.2,
...
class Qt extends T {
  constructor() {
    ...
    const t = this.getAttribute("color"), e = this.getAttribute("size");
    let r = "black";
    t === "primary" && (r = w.colors.primary), e && this.setStyles({ width: e, height: e }), this.setStyles({
...
Qt.tag = Ze;
const _e = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, $e = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
const rr = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class Et extends er {
  constructor(t) {
    var e;
  ...
  startRecording() {
    return Lt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || rr.find((o) => MediaRecorder.isTypeSupported(o)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
class Xt extends T {
  ...
  render() {
    this.innerHTML = this.renderHTML(_e, {
  ...
  initMic() {
    this.wavesurfer = tt.create({
      ...
      barHeight: 1,
      fillParent: !0
    }), this.recorder = this.wavesurfer.registerPlugin(Et.create());
  }
  startRecording() {
...
class ir {
  constructor({
    ...
    if (P.chatflowID = t, P.chathubChannelId = e, o && (P.welcomeMessage = o), !r)
      return;
    const { typography: i, colors: s, icon: l } = r;
    i && Object.keys(i).forEach(
      (c) => w.typography[c] = i[c]
