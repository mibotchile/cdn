...
`).replace(/^\s+|\s+$/gm, "")), Y.lastIndex = 0, Q.lastIndex = 0, V.lastIndex = 0;
  ...
  function c(p, g) {
    ...
    for (var v; (v = o.exec(n)) !== null; ) {
      var w = v[1], I = v[2], x = v[3], M = v[4], A = v[5], R = v.index;
      if (w)
        w === "(" ? (m === 0 && (C === "n" ? (y(R), C = "p") : C === "f" && (y(R), C = "fp")), m++) : w === ")" ? (m--, m === 0 && C !== "c" && (y(R), C = "err")) : m === 0 && w === "|" ? (y(R), C = "f") : w === "=>" && (y(R), s += 1, C = "res");
      else if (I) {
        if (I === "/*") {
        ...
        return y(R), s = R + v[0].length, i.lastIndex = s, l = A, M && g === "h" && (g = "s"), u.t = g, u;
    }
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, r, o) {
    ...
    for (let w = 0; w <= l; w++) {
      ...
      if (I > C) {
        const A = Math.round(y * a * o), R = Math.round(v * a * o), P = A + R || 1;
        let W = a - A;
...
const k = new Le(), kt = async (n) => await fetch(`${k.gpt_url}/chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(n)
}).then((t) => t.json()), Te = async (n) => await fetch(`${k.gpt_url}/messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  ...
  onSubmit(e) {
    ...
    if (this.attachedFiles.length && (this.addMessages(
      ...
      Te({
        content: `${o.message}
${o.url}`,
        conversation_id: k.messageHistoryId,
        channel_id: k.chathubChannelId,
        sender: "user"
      });
      return;
    }
    o.url.length ? o.url.forEach((i) => {
      kt({
        ...
        var l, c;
        s != null && s.unique_id && (k.messageHistoryId = s.unique_id, this.initMessagesWebsocket(k.messageHistoryId)), (c = (l = s == null ? void 0 : s.data) == null ? void 0 : l.process) != null && c.length && s.data.process.forEach((h) => {
          this.addMessages([
            {
              type: h.role,
              name: h.name,
      ...
      var s, l;
      i != null && i.unique_id && (k.messageHistoryId = i.unique_id, this.initMessagesWebsocket(k.messageHistoryId)), (l = (s = i == null ? void 0 : i.data) == null ? void 0 : s.process) != null && l.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
...
class er {
  constructor({ chatflow: t, chathubChannelId: e, theme: r, welcomeMessage: o }) {
    if (k.chatflowID = t, k.chathubChannelId = e, o && (k.welcomeMessage = o), !r)
      return;
