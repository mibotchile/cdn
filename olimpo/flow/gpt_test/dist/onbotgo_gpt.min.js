...
`).replace(/^\s+|\s+$/gm, "")), X.lastIndex = 0, z.lastIndex = 0, J.lastIndex = 0;
  ...
  function c(p, u) {
    ...
    for (var y; (y = s.exec(r)) !== null; ) {
      ...
      if (T === "h") {
        var H = x.n || "";
        t.async && F.test(H) && (x.a = !0, x.n = H.replace(F, "")), x = c(x), f.push(x);
      } else if (T === "c") {
        if (p.n === x.n)
        ...
        var I = x.n || "";
        t.async && F.test(I) && (x.a = !0, x.n = I.replace(F, "")), g = x, f = [];
      } else if (T === "s") {
        var V = x.n || "";
        t.async && F.test(V) && (x.a = !0, x.n = V.replace(F, "")), f.push(x);
      } else
        f.push(x);
    }
    if (u)
...
function Rt(r, t) {
  var e = ie(r, t), n = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + O(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function Dt(r, t, e) {
  return "function(" + t + "){var tR='';" + O(r, e) + "return tR}";
}
function O(r, t) {
    ...
    if (typeof s == "string") {
      ...
      if (a === "i") {
        ...
        if (t.storage.nativeHelpers.get(l))
          ...
          var f = (u ? "await " : "") + "c.l('H','" + l + "')(" + It(t, b, s.d, h, u);
          p ? f += "," + se(p, t) : f += ",[]", f += ",c)", o += "tR+=" + et(f, c) + ";";
        }
      else
        a === "s" ? o += "tR+=" + et((u ? "await " : "") + "c.l('H','" + l + "')({params:[" + h + "]},[],c)", c) + ";" : a === "e" && (o += d + `
`);
    }
  }
  return o;
...
function jt(r, t, e, n, o, s) {
  n(t[e], r[t[e]]).then(function(i) {
    o += i, e === t.length - 1 ? s(o) : jt(r, t, e + 1, n, o, s);
  });
}
var ae = {
  "&": "&amp;",
...
var de = new Z({}), pt = new Z({
  ...
  if: function(r, t) {
    U("if", !1, r.f, !0);
    var e = "if(" + r.p + "){" + O(r.d, t) + "}";
    if (r.b)
      for (var n = 0; n < r.b.length; n++) {
        var o = r.b[n];
        o.n === "else" ? e += "else{" + O(o.d, t) + "}" : o.n === "elif" && (e += "else if(" + o.p + "){" + O(o.d, t) + "}");
      }
    return e;
  },
  try: function(r, t) {
    ...
    var e = "try{" + O(r.d, t) + "}", n = r.b[0];
    return e += "catch" + (n.res ? "(" + n.res + ")" : "") + "{" + O(n.d, t) + "}", e;
  },
  block: function(r, t) {
    U("block", r.b, r.f, !0);
...
function Pe(r, t, e) {
  ...
  return Pt(this, void 0, void 0, function* () {
    const s = yield fetch(r, e);
    {
      ...
      let d = 0;
      const c = (l, h) => Pt(this, void 0, void 0, function* () {
        if (l)
          return;
...
function Le(r, t, e, n, o = 5) {
  ...
  const i = (a) => {
    ...
    const h = (u) => {
      ...
      if (l || Math.abs(g - d) >= o || Math.abs(f - c) >= o) {
        const { left: A, top: y } = r.getBoundingClientRect();
        l || (l = !0, e == null || e(d - A, c - y)), t(g - d, f - c, g - A, f - y), d = g, c = f;
      }
    }, b = (u) => {
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, n, o) {
    const s = t[0], i = t[1] || t[0], a = s.length, { width: d, height: c } = n.canvas, l = c / 2, h = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * h : 1, p = e.barGap ? e.barGap * h : e.barWidth ? b / 2 : 0, u = e.barRadius || 0, g = d / (b + p) / a, f = u && "roundRect" in n ? "roundRect" : "rect";
    n.beginPath();
    let A = 0, y = 0, C = 0;
    for (let P = 0; P <= a; P++) {
      const v = Math.round(P * g);
      if (v > A) {
        const x = Math.round(y * l * o), T = Math.round(C * l * o), H = x + T || 1;
        let I = l - x;
  ...
  renderLineWaveform(t, e, n, o) {
    const s = (i) => {
      ...
      for (let u = 0; u <= d; u++) {
        ...
        if (g > b) {
          const A = Math.round(p * l * o) || 1, y = l + A * (i === 0 ? -1 : 1);
          n.lineTo(b, y), b = g, p = 0;
        }
        const f = Math.abs(a[u] || 0);
        f > p && (p = f);
      }
      n.lineTo(b, l);
    };
...
const w = new je(), Tt = async (r) => await fetch(`${w.gpt_url}${w.projectPath}chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), Oe = async (r) => await fetch(`${w.gpt_url}${w.projectPath}messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
...
class Ct extends L {
  ...
  initMessagesWebsocket(e) {
    ...
    this.messagesWebsocket = new WebSocket(n), console.log(this.messagesWebsocket), this.messagesWebsocket.onmessage = (o) => {
      ...
      if (console.log("ON MESSAGE ", s), s.event === "incoming_message") {
        const i = s.data;
        this.addMessages(
          [{ message: i.content, type: "apiMessage" }],
          { updateScrollbar: !0 },
          !0
        );
      }
  ...
  onSubmit(e) {
    ...
    ]), e && this.addMessages([{ message: e, type: "userMessage" }]), this.renderMessages([{ type: "LoadingMessage" }]), this.updateScrollbar(), this.isRecordSelected = !1, this.attachedRecord = null, this.chatInput.getChild("input").value = "", this.getChild("#onbotgo-chatinput").style.display = "grid", this.getChild("#onbotgo-attachFileTemplateContainer").style.display = "grid", this.getChild("#onbotgo-micrecord").style.display = "none", this.updateScrollbar();
...
${o.url}`,
        ...
        var i;
        (i = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || i.forEach((a) => a.remove());
      });
      return;
    }
    o.url.length ? o.url.forEach((i) => {
      Tt({
        ...
        ]), a.thought && this.showBotThought(a.thought), a.redirect && (this.chattingWith = "human_agent");
      }).catch((a) => console.log(a)).finally(() => {
        var a;
        (a = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || a.forEach((d) => d.remove()), this.updateScrollbar(), s.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white";
      });
    }) : Tt(o).then((i) => {
      var a, d;
      ...
      var i;
      (i = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || i.forEach((a) => a.remove()), s.disabled = !1, s.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", this.updateScrollbar();
    });
  }
  toggle() {
...
class un {
  constructor({
    ...
    if (w.chatflowID = t, w.projectPath = n, w.chathubChannelId = e, s && (w.welcomeMessage = s), !o)
      return;
    const { typography: i, colors: a, icon: d } = o;
    i && Object.keys(i).forEach(
      (c) => R.typography[c] = i[c]
