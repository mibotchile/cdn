...
var Qt = (n, t, e) => t in n ? Yt(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e;
var m = (n, t, e) => (Qt(n, typeof t != "symbol" ? t + "" : t, e), e);
class Vt {
  constructor() {
    m(this, "typography", {
...
const Jt = {}, Zt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Jt
}, Symbol.toStringTag, { value: "Module" })), Ft = /* @__PURE__ */ Xt(Zt);
var xt = new Function("return this")().Promise, st = !1;
try {
...
function O(n, t, e) {
  for (var r in t)
    Tt(t, r) && (t[r] != null && typeof t[r] == "object" && (r === "storage" || r === "prefixes") && !e ? n[r] = O(
      /*toObj[key] ||*/
      {},
      t[r]
    ) : n[r] = t[r]);
...
`).replace(/^\s+|\s+$/gm, "")), Y.lastIndex = 0, Q.lastIndex = 0, V.lastIndex = 0;
  ...
  function h(p, g) {
    ...
    function y(G) {
      ...
      if (C === "f")
        F === "safe" ? u.raw = !0 : t.async && D.test(F) ? (F = F.replace(D, ""), u.f.push([F, "", !0])) : u.f.push([F, ""]);
      else if (C === "fp")
        u.f[u.f.length - 1][1] += F;
      else if (C === "err") {
        if (F) {
          var Gt = At.search(/\S/);
          z("invalid syntax", n, s + Gt);
        }
      } else
        u[C] = F;
      s = G + 1;
    ...
    for (var v; (v = i.exec(n)) !== null; ) {
      var S = v[1], I = v[2], x = v[3], M = v[4], A = v[5], R = v.index;
      if (S)
        S === "(" ? (f === 0 && (C === "n" ? (y(R), C = "p") : C === "f" && (y(R), C = "fp")), f++) : S === ")" ? (f--, f === 0 && C !== "c" && (y(R), C = "err")) : f === 0 && S === "|" ? (y(R), C = "f") : S === "=>" && (y(R), s += 1, C = "res");
      else if (I) {
        if (I === "/*") {
          var P = n.indexOf("*/", i.lastIndex);
          P === -1 && z("unclosed comment", n, v.index), i.lastIndex = P + 2;
        } else if (I === "'") {
          Q.lastIndex = v.index;
          var H = Q.exec(n);
          H ? i.lastIndex = Q.lastIndex : z("unclosed string", n, v.index);
        } else if (I === '"') {
          V.lastIndex = v.index;
          var j = V.exec(n);
          ...
          Y.lastIndex = v.index;
          var L = Y.exec(n);
          L ? i.lastIndex = Y.lastIndex : z("unclosed string", n, v.index);
        }
      } else if (x)
        return y(R), s = R + v[0].length, o.lastIndex = s, l = A, M && g === "h" && (g = "s"), u.t = g, u;
    }
  ...
  function c(p, g) {
    ...
    for (var y; (y = o.exec(n)) !== null; ) {
      var v = y[1], S = y[2], I = y[3] || "", x;
      for (var M in e)
        if (e[M] === I) {
          x = M;
          break;
        }
      C(v, S), s = y.index + y[0].length, x || z("unrecognized tag type: " + I, n, s);
      var A = h(y.index, x), R = A.t;
      if (R === "h") {
        var P = A.n || "";
        t.async && D.test(P) && (A.a = !0, A.n = P.replace(D, "")), A = c(A), f.push(A);
      } else if (R === "c") {
        if (p.n === A.n)
          return u ? (u.d = f, p.b.push(u)) : p.d = f, p;
        z("Helper start and end don't match", n, y.index + y[0].length);
      } else if (R === "b") {
        u ? (u.d = f, p.b.push(u)) : p.d = f;
        var H = A.n || "";
        t.async && D.test(H) && (A.a = !0, A.n = H.replace(D, "")), u = A, f = [];
      } else if (R === "s") {
        var j = A.n || "";
        t.async && D.test(j) && (A.a = !0, A.n = j.replace(D, "")), f.push(A);
      } else
        f.push(A);
    }
    if (g)
...
function St(n, t) {
  var e = $t(n, t), r = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + B(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function te(n, t) {
  for (var e = "[", r = 0; r < n.length; r++) {
    var i = n[r];
    e += Pt(t, i.res || "", i.d, i.p || "", i.a, i.n), r < n.length && (e += ",");
  }
  return e += "]", e;
}
function Ht(n, t, e) {
...
function B(n, t) {
  ...
  for (e; e < r; e++) {
    ...
    if (typeof o == "string") {
      ...
      var l = o.t, h = o.c || "", c = o.f, a = o.n || "", d = o.p || "", b = o.res || "", p = o.b, g = !!o.a;
      if (l === "i") {
        ...
        if (t.storage.nativeHelpers.get(a))
          ...
          var f = (g ? "await " : "") + "c.l('H','" + a + "')(" + Pt(t, b, o.d, d, g);
          p ? f += "," + te(p, t) : f += ",[]", f += ",c)", i += "tR+=" + rt(f, c) + ";";
        }
      else
        l === "s" ? i += "tR+=" + rt((g ? "await " : "") + "c.l('H','" + a + "')({params:[" + d + "]},[],c)", c) + ";" : l === "e" && (i += h + `
`);
    }
  }
  return i;
...
function zt(n, t, e, r, i) {
  e(n[t], t).then(function(o) {
    r += o, t === n.length - 1 ? i(r) : zt(n, t + 1, e, r, i);
  });
}
function Dt(n, t, e, r, i, o) {
  r(t[e], n[t[e]]).then(function(s) {
    i += s, e === t.length - 1 ? o(i) : Dt(n, t, e + 1, r, i, o);
  });
}
var ee = {
  "&": "&amp;",
...
var ie = new _({}), pt = new _({
  ...
  foreach: function(n, t) {
    ...
    if (N("foreach", t, !1), n.async)
      return new Promise(function(o) {
        Dt(e, Object.keys(e), 0, n.exec, "", o);
      });
    var r = "";
    for (var i in e)
      Tt(e, i) && (r += n.exec(i, e[i]));
    return r;
  },
...
function $(n, t) {
  var e = {};
  return O(e, at), t && O(e, t), n && O(e, n), e.l.bind(e), e;
}
function ut(n, t) {
  var e = $(t || {}), r = Function;
  if (e.async)
...
function le(n, t) {
  ...
  if (o && o.length)
    e = it(n.replace(/^\/*/, ""), t.root || "/", !0);
  else if (t.filename && (r = it(n, t.filename), lt.existsSync(r) && (e = r)), e || Array.isArray(i) && i.some(function(s) {
    return r = it(n, s, !0), lt.existsSync(r);
  }) && (e = r), !e)
...
function Bt(n, t) {
  var e = $({ filename: le(n, t) }, t);
  return he(e);
}
function de(n, t, e) {
  if (t && t.length > 0)
    throw w("Helper 'includeFile' doesn't accept blocks");
  return Bt(n.params[0], e)(n.params[1], e);
}
function ge(n, t, e) {
  var r = n.params[1] || {};
  r.content = n.exec();
...
pt.define("includeFile", de);
pt.define("extendsFile", ge);
  ...
  return Et(this, void 0, void 0, function* () {
    const o = yield fetch(n, e);
    {
      ...
      const c = (a, d) => Et(this, void 0, void 0, function* () {
        ...
        const b = Math.round(h / l * 100);
        return t(b), s == null ? void 0 : s.read().then(({ done: p, value: g }) => c(p, g));
      });
  ...
  const s = (l) => {
    ...
    const d = (g) => {
      ...
      if (a || Math.abs(u - h) >= i || Math.abs(f - c) >= i) {
        ...
        a || (a = !0, e == null || e(h - C, c - y)), t(u - h, f - c, u - C, f - y), h = u, c = f;
      }
    }, b = (g) => {
    ...
    document.addEventListener("pointermove", d), document.addEventListener("pointerup", p), document.addEventListener("pointerleave", p), document.addEventListener("click", b, !0), o = () => {
...
class tt extends mt {
  ...
  renderBarWaveform(t, e, r, i) {
    const o = t[0], s = t[1] || t[0], l = o.length, { width: h, height: c } = r.canvas, a = c / 2, d = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * d : 1, p = e.barGap ? e.barGap * d : e.barWidth ? b / 2 : 0, g = e.barRadius || 0, u = h / (b + p) / l, f = g && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let C = 0, y = 0, v = 0;
    for (let S = 0; S <= l; S++) {
      const I = Math.round(S * u);
      if (I > C) {
        const A = Math.round(y * a * i), R = Math.round(v * a * i), P = A + R || 1;
        let H = a - A;
        e.barAlign === "top" ? H = 0 : e.barAlign === "bottom" && (H = c - P), r[f](C * (b + p), H, b, P, g), C = I, y = 0, v = 0;
      }
      const x = Math.abs(o[S] || 0), M = Math.abs(s[S] || 0);
      x > y && (y = x), M > v && (v = M);
    }
    r.fill(), r.closePath();
  }
  renderLineWaveform(t, e, r, i) {
    const o = (s) => {
      ...
      for (let g = 0; g <= h; g++) {
        ...
        if (u > b) {
          const C = Math.round(p * a * i) || 1, y = a + C * (s === 0 ? -1 : 1);
  ...
  renderSingleCanvas(t, e, r, i, o, s, l, h) {
    ...
    this.renderWaveform(t.map((u) => u.slice(o, s)), e, b);
    const p = a.cloneNode();
    h.appendChild(p);
  ...
  renderChannel(t, e, r) {
    ...
    let b = Math.min(tt.MAX_CANVAS_WIDTH, c);
    if (e.barWidth || e.barGap) {
      const I = e.barWidth || 0.5, x = e.barGap || I / 2, M = I + x;
      b % M !== 0 && (b = Math.floor(b / M) * M);
    }
    const p = Math.floor(Math.abs(l) * d), g = Math.floor(p + b * d), u = g - p, f = (I, x) => {
...
class et extends xe {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, Re, t), this.timer = new Se();
    const i = t.media ? void 0 : this.getMediaElement();
    this.renderer = new tt(this.options, i), this.initPlayerEvents(), this.initRendererEvents(), this.initTimerEvents(), this.initPlugins();
  ...
  loadAudio(t, e, r, i) {
    return J(this, void 0, void 0, function* () {
      if (this.emit("load", t), this.isPlaying() && this.pause(), this.decodedData = null, !e && !r) {
        ...
        e = yield Ae.fetchBlob(t, o, this.options.fetchParams);
      }
...
</svg>`, Ee = '<?xml version="1.0" ?><svg fill="currentColor" style="color:currentColor;enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M224,435.8V76.1c0-6.7-5.4-12.1-12.2-12.1h-71.6c-6.8,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6   C218.6,448,224,442.6,224,435.8z"/><path d="M371.8,64h-71.6c-6.7,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6c6.7,0,12.2-5.4,12.2-12.2V76.1   C384,69.4,378.6,64,371.8,64z"/></g></svg>', W = "onbotgo-chatmessage";
class bt extends k {
  constructor(e) {
    super();
    m(this, "wavesurfer");
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
  ...
  handlePlayPause() {
    this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
      ...
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = Ee;
...
const K = new ke(), Le = async (n) => await fetch(`${K.gpt_url}/chat`, {
  headers: {
...
class yt extends k {
  constructor() {
    ...
    m(this, "input");
    this.innerHTML = this.renderHTML(Fe, { sendIcon: Nt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(U.tag), this.input.style.fontFamily = E.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
const Pe = `<onbotgo-box style="padding: 20px; max-width: 100%" id="onbotgo-chatheader">\r
  <img\r
    src=""\r
...
</svg>`, kt = '<svg  style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M28,14H18V4c0-1.104-0.896-2-2-2s-2,0.896-2,2v10H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h10v10c0,1.104,0.896,2,2,2  s2-0.896,2-2V18h10c1.104,0,2-0.896,2-2S29.104,14,28,14z"/></svg>';
class T {
}
m(T, "messageHistoryId", {
...
class vt extends k {
  ...
  onSubmit(e) {
    ...
    structuredClone(this.messagesHistory).splice(0, 1), console.log(
      T.messageHistoryId,
      T.messageHistoryId.get()
    );
    const i = {
      message: e,
      unique_id: T.messageHistoryId.get() ?? ""
    };
    ...
    ]), e && this.addMessages([{ message: e, type: "userMessage" }]), T.messagesHistory.add([
      {
        message: e,
        type: "userMessage"
      }
    ]), this.renderMessages([{ type: "LoadingMessage" }]), this.updateScrollbar(), this.isRecordSelected = !1, this.attachedRecord = null, this.chatInput.getChild("input").value = "", this.getChild("#onbotgo-chatinput").style.display = "grid", this.getChild("#onbotgo-attachFileTemplateContainer").style.display = "grid", this.getChild("#onbotgo-micrecord").style.display = "none", this.updateScrollbar(), Le(i).then((o) => {
      var s, l;
      console.log(o), o != null && o.unique_id && T.messageHistoryId.set(o.unique_id), (l = (s = o == null ? void 0 : o.data) == null ? void 0 : s.process) != null && l.length && o.data.process.forEach((h) => {
        this.addMessages([
          {
            type: h.role,
            name: h.name,
...
function Ne({ element: n, styles: t }) {
  const e = t.reduce(
    (o, s) => ({
      ...o,
      ...s
    ...
    {}
  ), r = document.createElement("style"), i = Ue(e);
...
Ut.tag = Ye;
const Qe = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, Ve = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
const Ze = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class It extends Je {
  constructor(t) {
    var e;
  ...
  startRecording() {
    return Lt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || Ze.find((i) => MediaRecorder.isTypeSupported(i)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
class jt extends k {
  ...
  render() {
    this.innerHTML = this.renderHTML(Qe, {
...
class $e {
  constructor({ chatflow: t, theme: e, welcomeMessage: r }) {
    if (K.chatflowID = t, console.log(r), r && (K.welcomeMessage = r), !e)
      return;
