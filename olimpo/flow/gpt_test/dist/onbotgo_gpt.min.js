...
var Vt = (n, t, e) => t in n ? Qt(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e;
var m = (n, t, e) => (Vt(n, typeof t != "symbol" ? t + "" : t, e), e);
class Xt {
  constructor() {
    m(this, "typography", {
...
const Zt = {}, Kt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Zt
}, Symbol.toStringTag, { value: "Module" })), Tt = /* @__PURE__ */ Jt(Kt);
var xt = new Function("return this")().Promise, ot = !1;
try {
  ot = new Function("return (async function(){}).constructor")();
} catch (n) {
...
function O(n, t, e) {
  for (var r in t)
    Pt(t, r) && (t[r] != null && typeof t[r] == "object" && (r === "storage" || r === "prefixes") && !e ? n[r] = O(
      /*toObj[key] ||*/
      {},
      t[r]
    ) : n[r] = t[r]);
...
function _t(n, t, e, r) {
  var i, o;
  return typeof t.autoTrim == "string" ? i = o = t.autoTrim : Array.isArray(t.autoTrim) && (i = t.autoTrim[1], o = t.autoTrim[0]), (e || e === !1) && (i = e), (r || r === !1) && (o = r), i === "slurp" && o === "slurp" ? n.trim() : (i === "_" || i === "slurp" ? String.prototype.trimLeft ? n = n.trimLeft() : n = n.replace(/^[\s\uFEFF\xA0]+/, "") : (i === "-" || i === "nl") && (n = n.replace(/^(?:\n|\r|\r\n)/, "")), o === "_" || o === "slurp" ? String.prototype.trimRight ? n = n.trimRight() : n = n.replace(/[\s\uFEFF\xA0]+$/, "") : (o === "-" || o === "nl") && (n = n.replace(/(?:\n|\r|\r\n)$/, "")), n);
}
var K = (
  /** @class */
  function() {
...
function w(n) {
  var t = new Error(n);
  return $t(t, w.prototype), t;
}
w.prototype = Object.create(Error.prototype, {
  name: { value: "Squirrelly Error", enumerable: !1 }
});
function z(n, t, e) {
  var r = t.slice(0, e).split(/\n/), i = r.length, o = r[i - 1].length + 1;
  throw n += " at line " + i + " col " + o + `:

  ` + t.split(/\n/)[i - 1] + `
  ` + Array(o).join(" ") + "^", w(n);
}
var H = /^async +/, Y = /`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g, Q = /'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g, V = /"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g, wt = /[.*+\-?^${}()|[\]\\]/g;
function X(n) {
  return wt.test(n) ? n.replace(wt, "\\$&") : n;
}
function te(n, t) {
  t.rmWhitespace && (n = n.replace(/[\r\n]+/g, `
`).replace(/^\s+|\s+$/gm, "")), Y.lastIndex = 0, Q.lastIndex = 0, V.lastIndex = 0;
  var e = t.prefixes, r = [
    e.h,
    e.b,
    e.i,
    ...
    return p && g ? p + "|" + X(g) : g ? X(g) : p;
  }, ""), i = new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?" + // comments, strings
  X(t.tags[1]) + ")", "g"), o = new RegExp("([^]*?)" + X(t.tags[0]) + "(-|_)?\\s*(" + r + ")?\\s*", "g"), s = 0, l = !1;
  function h(p, g) {
    var u = { f: [] }, f = 0, C = "c";
    g === "h" || g === "b" || g === "c" ? C = "n" : g === "r" && (u.raw = !0, g = "i");
    function b(G) {
      var At = n.slice(s, G), F = At.trim();
      if (C === "f")
        F === "safe" ? u.raw = !0 : t.async && H.test(F) ? (F = F.replace(H, ""), u.f.push([F, "", !0])) : u.f.push([F, ""]);
      else if (C === "fp")
        u.f[u.f.length - 1][1] += F;
      else if (C === "err") {
        if (F) {
          var Yt = At.search(/\S/);
          z("invalid syntax", n, s + Yt);
        }
      } else
        u[C] = F;
      s = G + 1;
    ...
    i.lastIndex = s;
    for (var v; (v = i.exec(n)) !== null; ) {
      var S = v[1], I = v[2], x = v[3], k = v[4], A = v[5], R = v.index;
      if (S)
        S === "(" ? (f === 0 && (C === "n" ? (b(R), C = "p") : C === "f" && (b(R), C = "fp")), f++) : S === ")" ? (f--, f === 0 && C !== "c" && (b(R), C = "err")) : f === 0 && S === "|" ? (b(R), C = "f") : S === "=>" && (b(R), s += 1, C = "res");
      else if (I) {
        if (I === "/*") {
          var T = n.indexOf("*/", i.lastIndex);
          T === -1 && z("unclosed comment", n, v.index), i.lastIndex = T + 2;
        } else if (I === "'") {
          Q.lastIndex = v.index;
          var P = Q.exec(n);
          P ? i.lastIndex = Q.lastIndex : z("unclosed string", n, v.index);
        } else if (I === '"') {
          V.lastIndex = v.index;
          var j = V.exec(n);
          j ? i.lastIndex = V.lastIndex : z("unclosed string", n, v.index);
        } else if (I === "`") {
          Y.lastIndex = v.index;
          var M = Y.exec(n);
          M ? i.lastIndex = Y.lastIndex : z("unclosed string", n, v.index);
        }
      } else if (x)
        return b(R), s = R + v[0].length, o.lastIndex = s, l = A, k && g === "h" && (g = "s"), u.t = g, u;
    }
    return z("unclosed tag", n, p), u;
  }
  function c(p, g) {
    p.b = [], p.d = [];
    var u = !1, f = [];
    ...
    for (var b; (b = o.exec(n)) !== null; ) {
      var v = b[1], S = b[2], I = b[3] || "", x;
      for (var k in e)
        if (e[k] === I) {
          x = k;
          break;
        }
      C(v, S), s = b.index + b[0].length, x || z("unrecognized tag type: " + I, n, s);
      var A = h(b.index, x), R = A.t;
      if (R === "h") {
        var T = A.n || "";
        t.async && H.test(T) && (A.a = !0, A.n = T.replace(H, "")), A = c(A), f.push(A);
      } else if (R === "c") {
        if (p.n === A.n)
          return u ? (u.d = f, p.b.push(u)) : p.d = f, p;
        z("Helper start and end don't match", n, b.index + b[0].length);
      } else if (R === "b") {
        u ? (u.d = f, p.b.push(u)) : p.d = f;
        var P = A.n || "";
        t.async && H.test(P) && (A.a = !0, A.n = P.replace(H, "")), u = A, f = [];
      } else if (R === "s") {
        var j = A.n || "";
        t.async && H.test(j) && (A.a = !0, A.n = j.replace(H, "")), f.push(A);
      } else
        f.push(A);
    }
    if (g)
      C(n.slice(s, n.length), !1), p.d = f;
    else
      throw w('unclosed helper "' + p.n + '"');
    return p;
  }
  var a = c({ f: [] }, !0);
  if (t.plugins)
...
function St(n, t) {
  var e = te(n, t), r = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + B(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
    for (var i = 0; i < t.plugins.length; i++) {
      var o = t.plugins[i];
      o.processFnString && (r = o.processFnString(r, t));
    }
  return r;
}
function et(n, t) {
  for (var e = 0; e < t.length; e++) {
    var r = t[e][0], i = t[e][1], o = t[e][2];
    n = (o ? "await " : "") + "c.l('F','" + r + "')(" + n, i && (n += "," + i), n += ")";
  }
  return n;
}
function zt(n, t, e, r, i, o) {
  var s = "{exec:" + (i ? "async " : "") + Ht(e, t, n) + ",params:[" + r + "]";
  return o && (s += ",name:'" + o + "'"), i && (s += ",async:true"), s += "}", s;
}
function ee(n, t) {
  for (var e = "[", r = 0; r < n.length; r++) {
    var i = n[r];
    e += zt(t, i.res || "", i.d, i.p || "", i.a, i.n), r < n.length && (e += ",");
  }
  return e += "]", e;
}
function Ht(n, t, e) {
  return "function(" + t + "){var tR='';" + B(n, e) + "return tR}";
}
function B(n, t) {
  var e = 0, r = n.length, i = "";
  for (e; e < r; e++) {
    var o = n[e];
    if (typeof o == "string") {
      var s = o;
      ...
      var l = o.t, h = o.c || "", c = o.f, a = o.n || "", d = o.p || "", y = o.res || "", p = o.b, g = !!o.a;
      if (l === "i") {
        t.defaultFilter && (h = "c.l('F','" + t.defaultFilter + "')(" + h + ")");
        var u = et(h, c);
        !o.raw && t.autoEscape && (u = "c.l('F','e')(" + u + ")"), i += "tR+=" + u + ";";
      } else if (l === "h")
        if (t.storage.nativeHelpers.get(a))
          i += t.storage.nativeHelpers.get(a)(o, t);
        else {
          var f = (g ? "await " : "") + "c.l('H','" + a + "')(" + zt(t, y, o.d, d, g);
          p ? f += "," + ee(p, t) : f += ",[]", f += ",c)", i += "tR+=" + et(f, c) + ";";
        }
      else
        l === "s" ? i += "tR+=" + et((g ? "await " : "") + "c.l('H','" + a + "')({params:[" + d + "]},[],c)", c) + ";" : l === "e" && (i += h + `
`);
    }
  }
  return i;
...
function N(n, t, e, r) {
  if (t && t.length > 0)
    throw w((r ? "Native" : "") + "Helper '" + n + "' doesn't accept blocks");
  if (e && e.length > 0)
    throw w((r ? "Native" : "") + "Helper '" + n + "' doesn't accept filters");
}
function Dt(n, t, e, r, i) {
  e(n[t], t).then(function(o) {
    r += o, t === n.length - 1 ? i(r) : Dt(n, t + 1, e, r, i);
  });
}
function Wt(n, t, e, r, i, o) {
  r(t[e], n[t[e]]).then(function(s) {
    i += s, e === t.length - 1 ? o(i) : Wt(n, t, e + 1, r, i, o);
  });
}
var re = {
  "&": "&amp;",
...
function ie(n) {
  var t = String(n);
  return /[&<>"']/.test(t) ? t.replace(/[&<>"']/g, ne) : t;
}
var oe = new K({}), pt = new K({
  each: function(n, t) {
    var e = "", r = n.params[0];
    if (N("each", t, !1), n.async)
  ...
  foreach: function(n, t) {
    var e = n.params[0];
    if (N("foreach", t, !1), n.async)
      return new Promise(function(o) {
        Wt(e, Object.keys(e), 0, n.exec, "", o);
      });
    var r = "";
    for (var i in e)
      Pt(e, i) && (r += n.exec(i, e[i]));
    return r;
  },
  include: function(n, t, e) {
    ...
    if (!r)
      throw w('Could not fetch template "' + n.params[0] + '"');
  ...
  useScope: function(n, t) {
    return N("useScope", t, !1), n.exec(n.params[0]);
  }
}), se = new K({
  if: function(n, t) {
    N("if", !1, n.f, !0);
    var e = "if(" + n.p + "){" + B(n.d, t) + "}";
    if (n.b)
      for (var r = 0; r < n.b.length; r++) {
        var i = n.b[r];
        i.n === "else" ? e += "else{" + B(i.d, t) + "}" : i.n === "elif" && (e += "else if(" + i.p + "){" + B(i.d, t) + "}");
      }
    return e;
  },
  try: function(n, t) {
    if (N("try", !1, n.f, !0), !n.b || n.b.length !== 1 || n.b[0].n !== "catch")
      throw w("native helper 'try' only accepts 1 block, 'catch'");
    var e = "try{" + B(n.d, t) + "}", r = n.b[0];
    return e += "catch" + (r.res ? "(" + r.res + ")" : "") + "{" + B(r.d, t) + "}", e;
  },
  block: function(n, t) {
    N("block", n.b, n.f, !0);
    var e = "if(!" + t.varName + "[" + n.p + "]){tR+=(" + Ht(n.d, "", t) + ")()}else{tR+=" + t.varName + "[" + n.p + "]}";
    return e;
  }
}), ae = new K({ e: ie }), st = {
  varName: "it",
  ...
  l: function(n, t) {
    if (n === "H") {
      ...
      if (e)
        return e;
      throw w("Can't find helper '" + t + "'");
    } else if (n === "F") {
      var r = this.storage.filters.get(t);
      if (r)
        return r;
      throw w("Can't find filter '" + t + "'");
    }
  },
  async: !1,
  storage: {
...
function _(n, t) {
  var e = {};
  return O(e, st), t && O(e, t), n && O(e, n), e.l.bind(e), e;
}
function ut(n, t) {
  var e = _(t || {}), r = Function;
  if (e.async)
    if (ot)
      r = ot;
    else
      throw w("This environment doesn't support async/await");
  try {
    return new r(
      e.varName,
      "c",
    ...
    throw i instanceof SyntaxError ? w(`Bad template syntax
...
function ce(n, t) {
  var e, r, i = t.views, o = /^[A-Za-z]+:\\|^\//.exec(n);
  if (o && o.length)
    e = nt(n.replace(/^\/*/, ""), t.root || "/", !0);
  else if (t.filename && (r = nt(n, t.filename), at.existsSync(r) && (e = r)), e || Array.isArray(i) && i.some(function(s) {
    return r = nt(n, s, !0), at.existsSync(r);
  }) && (e = r), !e)
    throw w('Could not find the include file "' + n + '"');
  return e;
}
function Bt(n) {
  return at.readFileSync(n).toString().replace(le, "");
}
function he(n, t) {
  var e = _(t), r = Bt(n);
  try {
    var i = ut(r, e);
    return e.storage.templates.define(e.filename, i), i;
  } catch {
    throw w("Loading file: " + n + " failed");
  }
}
function de(n) {
  var t = n.filename;
...
function Nt(n, t) {
  var e = _({ filename: ce(n, t) }, t);
  return de(e);
}
function ge(n, t, e) {
  if (t && t.length > 0)
    throw w("Helper 'includeFile' doesn't accept blocks");
  return Nt(n.params[0], e)(n.params[1], e);
}
function pe(n, t, e) {
  var r = n.params[1] || {};
  r.content = n.exec();
  ...
  return Nt(n.params[0], e)(r, e);
}
function it(n, t) {
  var e;
  return t.cache && t.name && t.storage.templates.get(t.name) ? t.storage.templates.get(t.name) : (typeof n == "function" ? e = n : e = ut(n, t), t.cache && t.name && t.storage.templates.define(t.name, e), e);
}
function ue(n, t, e, r) {
  var i = _(e || {});
  if (i.async) {
    ...
    if (r)
      ...
      throw w("Please provide a callback function, this env doesn't support Promises");
    }
  } else
    return it(n, i)(t, i);
}
pt.define("includeFile", ge);
pt.define("extendsFile", pe);
...
class ft extends L {
  constructor(t) {
    super(), this.innerHTML = t, this.innerHTML = this.isIconValid(t) ? t : E.defaultIcon;
  }
  isIconValid(t) {
    var r, i, o, s;
    if (!t)
      return !1;
    const e = new U();
    if (e.innerHTML = t, !["svg", "i", "img"].includes((i = (r = e.children[0]) == null ? void 0 : r.tagName) == null ? void 0 : i.toLowerCase()))
      return console.error(`node is not valid.
 allowed nodes: "svg", "i", "img"`), !1;
    for (let l = 0; l < e.childNodes.length; l++) {
      const h = (s = (o = e.childNodes[l]) == null ? void 0 : o.tagName) == null ? void 0 : s.toLowerCase();
...
}), ye = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
{{ /if}} {{/if}}\r
`;
var be = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function i(o) {
  ...
  return new (e || (e = Promise))(function(o, s) {
    ...
    function c(a) {
      a.done ? o(a.value) : i(a.value).then(l, h);
    }
...
function Ie(n, t) {
  return typeof n[0] == "number" && (n = [n]), ve(n), {
    duration: t,
    length: n[0].length,
...
var Et = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function i(o) {
    return o instanceof e ? o : new e(function(s) {
      s(o);
    });
...
function Ae(n, t, e) {
  ...
  return Et(this, void 0, void 0, function* () {
    ...
    {
      const s = (r = o.clone().body) === null || r === void 0 ? void 0 : r.getReader(), l = Number((i = o.headers) === null || i === void 0 ? void 0 : i.get("Content-Length"));
      let h = 0;
      const c = (a, d) => Et(this, void 0, void 0, function* () {
        if (a)
          return;
        h += (d == null ? void 0 : d.length) || 0;
        const y = Math.round(h / l * 100);
        return t(y), s == null ? void 0 : s.read().then(({ done: p, value: g }) => c(p, g));
      });
...
class mt {
  ...
  once(t, e) {
    const r = this.on(t, e), i = this.on(t, () => {
      r(), i();
    });
    return r;
  }
...
function Se(n, t, e, r, i = 5) {
  ...
  const s = (l) => {
    ...
    const d = (g) => {
      ...
      const u = g.clientX, f = g.clientY;
      if (a || Math.abs(u - h) >= i || Math.abs(f - c) >= i) {
        const { left: C, top: b } = n.getBoundingClientRect();
        a || (a = !0, e == null || e(h - C, c - b)), t(u - h, f - c, u - C, f - b), h = u, c = f;
      }
    }, y = (g) => {
    ...
    document.addEventListener("pointermove", d), document.addEventListener("pointerup", p), document.addEventListener("pointerleave", p), document.addEventListener("click", y, !0), o = () => {
      document.removeEventListener("pointermove", d), document.removeEventListener("pointerup", p), document.removeEventListener("pointerleave", p), setTimeout(() => {
        document.removeEventListener("click", y, !0);
      }, 10);
    };
  };
  return n.addEventListener("pointerdown", s), () => {
    o(), n.removeEventListener("pointerdown", s);
  };
}
class $ extends mt {
  constructor(t, e) {
    ...
    r.appendChild(i), this.container = i, this.scrollContainer = o.querySelector(".scroll"), this.wrapper = o.querySelector(".wrapper"), this.canvasWrapper = o.querySelector(".canvases"), this.progressWrapper = o.querySelector(".progress"), this.cursor = o.querySelector(".cursor"), e && o.appendChild(e), this.initEvents();
  }
  initEvents() {
    this.wrapper.addEventListener("click", (e) => {
      const r = this.wrapper.getBoundingClientRect(), o = (e.clientX - r.left) / r.width;
      this.emit("click", o);
    }), this.options.dragToSeek && this.initDrag(), this.scrollContainer.addEventListener("scroll", () => {
      const { scrollLeft: e, scrollWidth: r, clientWidth: i } = this.scrollContainer, o = e / r, s = (e + i) / r;
      this.emit("scroll", o, s);
    });
  ...
  convertColorValues(t) {
    ...
    if (t.length < 2)
      return t[0] || "";
    const e = document.createElement("canvas"), i = e.getContext("2d").createLinearGradient(0, 0, 0, e.height), o = 1 / (t.length - 1);
    return t.forEach((s, l) => {
      const h = l * o;
      i.addColorStop(h, s);
    }), i;
  }
  renderBarWaveform(t, e, r, i) {
    const o = t[0], s = t[1] || t[0], l = o.length, { width: h, height: c } = r.canvas, a = c / 2, d = window.devicePixelRatio || 1, y = e.barWidth ? e.barWidth * d : 1, p = e.barGap ? e.barGap * d : e.barWidth ? y / 2 : 0, g = e.barRadius || 0, u = h / (y + p) / l, f = g && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let C = 0, b = 0, v = 0;
    for (let S = 0; S <= l; S++) {
      const I = Math.round(S * u);
      if (I > C) {
        const A = Math.round(b * a * i), R = Math.round(v * a * i), T = A + R || 1;
        let P = a - A;
        e.barAlign === "top" ? P = 0 : e.barAlign === "bottom" && (P = c - T), r[f](C * (y + p), P, y, T, g), C = I, b = 0, v = 0;
      }
      const x = Math.abs(o[S] || 0), k = Math.abs(s[S] || 0);
      x > b && (b = x), k > v && (v = k);
    }
    r.fill(), r.closePath();
  }
  renderLineWaveform(t, e, r, i) {
    const o = (s) => {
      const l = t[s] || t[0], h = l.length, { height: c } = r.canvas, a = c / 2, d = r.canvas.width / h;
      r.moveTo(0, a);
      let y = 0, p = 0;
      for (let g = 0; g <= h; g++) {
        const u = Math.round(g * d);
        if (u > y) {
          const C = Math.round(p * a * i) || 1, b = a + C * (s === 0 ? -1 : 1);
          r.lineTo(y, b), y = u, p = 0;
        }
  ...
  renderWaveform(t, e, r) {
    ...
    let i = e.barHeight || 1;
    if (e.normalize) {
      const o = Array.from(t[0]).reduce((s, l) => Math.max(s, Math.abs(l)), 0);
      i = o ? 1 / o : 1;
    }
    if (e.barWidth || e.barGap || e.barAlign) {
      this.renderBarWaveform(t, e, r, i);
      return;
    }
    this.renderLineWaveform(t, e, r, i);
  }
  renderSingleCanvas(t, e, r, i, o, s, l, h) {
    const c = window.devicePixelRatio || 1, a = document.createElement("canvas"), d = t[0].length;
    a.width = Math.round(r * (s - o) / d), a.height = i * c, a.style.width = `${Math.floor(a.width / c)}px`, a.style.height = `${i}px`, a.style.left = `${Math.floor(o * r / c / d)}px`, l.appendChild(a);
    const y = a.getContext("2d");
    this.renderWaveform(t.map((u) => u.slice(o, s)), e, y);
    const p = a.cloneNode();
    h.appendChild(p);
  ...
  renderChannel(t, e, r) {
    const i = document.createElement("div"), o = this.getHeight();
    i.style.height = `${o}px`, this.canvasWrapper.style.minHeight = `${o}px`, this.canvasWrapper.appendChild(i);
    const s = i.cloneNode();
    this.progressWrapper.appendChild(s);
    const { scrollLeft: l, scrollWidth: h, clientWidth: c } = this.scrollContainer, a = t[0].length, d = a / h;
    let y = Math.min($.MAX_CANVAS_WIDTH, c);
    if (e.barWidth || e.barGap) {
      const I = e.barWidth || 0.5, x = e.barGap || I / 2, k = I + x;
      y % k !== 0 && (y = Math.floor(y / k) * k);
    }
    const p = Math.floor(Math.abs(l) * d), g = Math.floor(p + y * d), u = g - p, f = (I, x) => {
      this.renderSingleCanvas(t, e, r, o, Math.max(0, I), Math.min(x, a), i, s);
    }, C = this.createDelay(), b = this.createDelay(), v = (I, x) => {
      f(I, x), I > 0 && C(() => {
        v(I - u, x - u);
      });
    }, S = (I, x) => {
  ...
  render(t) {
    ...
    const e = window.devicePixelRatio || 1, r = this.scrollContainer.clientWidth, i = Math.ceil(t.duration * (this.options.minPxPerSec || 0));
    this.isScrolling = i > r;
    const o = this.options.fillParent && !this.isScrolling, s = (o ? r : i) * e;
    if (this.wrapper.style.width = o ? "100%" : `${i}px`, this.scrollContainer.style.overflowX = this.isScrolling ? "auto" : "hidden", this.scrollContainer.classList.toggle("noScrollbar", !!this.options.hideScrollbar), this.cursor.style.backgroundColor = `${this.options.cursorColor || this.options.progressColor}`, this.cursor.style.width = `${this.options.cursorWidth}px`, this.options.splitChannels)
  ...
  scrollIntoView(t, e = !1) {
    const { clientWidth: r, scrollLeft: i, scrollWidth: o } = this.scrollContainer, s = o * t, l = r / 2, h = e && this.options.autoCenter && !this.isDragging ? l : r;
    if (s > i + h || s < i)
      if (this.options.autoCenter && !this.isDragging) {
        const c = l / 20;
        s - (i + l) >= c && s < i + r ? this.scrollContainer.scrollLeft += c : this.scrollContainer.scrollLeft = s - l;
      } else
        this.isDragging ? this.scrollContainer.scrollLeft = s < i ? s - 10 : s - r + 10 : this.scrollContainer.scrollLeft = s;
    {
      const { scrollLeft: c } = this.scrollContainer, a = c / o, d = (c + r) / o;
...
var J = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function i(o) {
    return o instanceof e ? o : new e(function(s) {
      s(o);
    });
...
class tt extends we {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, Ee, t), this.timer = new Re();
    const i = t.media ? void 0 : this.getMediaElement();
    this.renderer = new $(this.options, i), this.initPlayerEvents(), this.initRendererEvents(), this.initTimerEvents(), this.initPlugins();
    const o = this.options.url || ((e = this.options.media) === null || e === void 0 ? void 0 : e.currentSrc) || ((r = this.options.media) === null || r === void 0 ? void 0 : r.src);
    o && this.load(o, this.options.peaks, this.options.duration);
  }
  initTimerEvents() {
  ...
  loadAudio(t, e, r, i) {
    return J(this, void 0, void 0, function* () {
      if (this.emit("load", t), this.isPlaying() && this.pause(), this.decodedData = null, !e && !r) {
        const o = (s) => this.emit("loading", s);
        e = yield xe.fetchBlob(t, o, this.options.fetchParams);
      }
      if (this.setSrc(t, e), r)
        i = (yield Promise.resolve(i || this.getDuration())) || (yield new Promise((o) => {
          this.onceMediaEvent("loadedmetadata", () => o(this.getDuration()));
        })) || (yield Promise.resolve(0)), this.decodedData = Rt.createBuffer(r, i);
      else if (e) {
        const o = yield e.arrayBuffer();
        this.decodedData = yield Rt.decode(o, this.options.sampleRate);
      }
  ...
  exportPeaks({ channels: t = 1, maxLength: e = 8e3, precision: r = 1e4 } = {}) {
    ...
    const i = Math.min(t, this.decodedData.numberOfChannels), o = [];
    for (let s = 0; s < i; s++) {
      const l = this.decodedData.getChannelData(s), h = Math.min(l.length, e), c = l.length / h, a = [];
      for (let d = 0; d < h; d++) {
        const y = Math.round(d * c), p = l[y];
        a.push(Math.round(p * r) / r);
      }
      o.push(a);
    }
    return o;
...
</svg>`, ke = '<?xml version="1.0" ?><svg fill="currentColor" style="color:currentColor;enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M224,435.8V76.1c0-6.7-5.4-12.1-12.2-12.1h-71.6c-6.8,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6   C218.6,448,224,442.6,224,435.8z"/><path d="M371.8,64h-71.6c-6.7,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6c6.7,0,12.2-5.4,12.2-12.2V76.1   C384,69.4,378.6,64,371.8,64z"/></g></svg>', W = "onbotgo-chatmessage";
class yt extends L {
  constructor(e) {
    super();
    m(this, "wavesurfer");
    ...
    }), this.innerHTML = this.renderHTML(ye, {
      type: e.type,
      fileType: e.fileType,
      file: e.file,
      message: e.message,
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
      let r;
      typeof e.file == "string" ? r = e.file : r = URL.createObjectURL(e.file), this.wavesurfer = tt.create({
        barHeight: 12,
        height: 24,
        barWidth: 1,
      ...
      r.src = i, r.style.objectFit = "cover", r.style.minHeight = "100px", r.style.minWidth = "100px", r.style.maxHeight = "80%", r.style.maxWidth = "80%", this.querySelector(".onbotgo-message").appendChild(r);
    } else
  ...
  handlePlayPause() {
    this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
      ...
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = ke;
...
class Me {
  constructor() {
    ...
    m(this, "storage_url", "https://helpers.mibot.cl:444");
    m(this, "messageHistoryId", "");
    m(this, "chatflowID", "");
    m(this, "welcomeMessage", "¡Hola! ¿En qué puedo ayudarte hoy?");
  }
}
const D = new Me(), kt = async (n) => await fetch(`${D.gpt_url}/chat`, {
  headers: {
...
class bt extends L {
  constructor() {
    ...
    m(this, "input");
    this.innerHTML = this.renderHTML(Fe, { sendIcon: qt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(U.tag), this.input.style.fontFamily = E.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
class Ct extends HTMLElement {
  ...
  connectedCallback() {
    ...
    new IntersectionObserver((i) => {
      i.forEach((o) => {
        o.isIntersecting && (this.setTargetElCSS(), this.setScrollThumbHeight());
      });
  ...
  moveScrollThumb() {
    const e = this.shadowRoot.querySelector(
      ...
      ".custom-scrollbar__track"
    ).offsetHeight, i = this.targetEl.scrollTop / this.targetEl.scrollHeight * r;
    e.style.top = `${i}px`;
  }
  setTargetElCSS() {
  ...
  setScrollThumbHeight() {
    const e = this.shadowRoot.querySelector(
      ...
      ".custom-scrollbar__thumb"
    ), i = e.offsetHeight, o = this.targetEl.offsetHeight, s = this.targetEl.scrollHeight, l = o / s * i;
    r.style.height = `${l}px`;
    let h = !1, c;
    r.addEventListener("mousedown", (a) => {
      ...
      if (!h)
        return;
      const d = a.clientY - c;
      c = a.clientY, this.targetEl.scrollTop += d * (s / i);
    });
  }
...
`, De = ` <svg\r
  ...
  >\r
    ...
    >\r
      ...
      ></path>\r
    </svg>`, ht = `<svg viewBox="-3 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    \r
    <defs>\r
\r
</defs>\r
...
class vt extends L {
  ...
  onSubmit(e) {
    ...
    const i = {
      ...
      url: (this.attachedFiles || []).map(({ url: o }) => o),
      unique_id: D.messageHistoryId
    };
    this.attachedFiles.length && (this.addMessages(
      this.attachedFiles.map((o) => ({
        type: "userMessage",
        file: o,
        fileType: o.type.includes("image") ? "image" : o.type
      }))
    ), this.attachedFiles = [], this.renderAttachTemplate(), this.messagesContainer.querySelectorAll("img").forEach((o) => {
      o.onload = () => this.updateScrollbar();
    ...
    ]), e && this.addMessages([{ message: e, type: "userMessage" }]), this.renderMessages([{ type: "LoadingMessage" }]), this.updateScrollbar(), this.isRecordSelected = !1, this.attachedRecord = null, this.chatInput.getChild("input").value = "", this.getChild("#onbotgo-chatinput").style.display = "grid", this.getChild("#onbotgo-attachFileTemplateContainer").style.display = "grid", this.getChild("#onbotgo-micrecord").style.display = "none", this.updateScrollbar(), i.url.length ? i.url.forEach((o) => {
      kt({
        ...i,
        message: `envio comprobante de pago, esta es la url "${o}"`,
        url: void 0
      }).then((s) => {
        var l, h;
        s != null && s.unique_id && (D.messageHistoryId = s.unique_id), (h = (l = s == null ? void 0 : s.data) == null ? void 0 : l.process) != null && h.length && s.data.process.forEach((c) => {
          this.addMessages([
            {
              type: c.role,
              name: c.name,
      ...
      var s, l;
      o != null && o.unique_id && (D.messageHistoryId = o.unique_id), (l = (s = o == null ? void 0 : o.data) == null ? void 0 : s.process) != null && l.length && o.data.process.forEach((h) => {
        this.addMessages([
          {
            type: h.role,
            name: h.name,
        ...
        { message: o.response, type: "apiMessage" }
      ]);
    }).catch((o) => console.log(o)).finally(() => {
      var o;
      (o = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || o.forEach((s) => s.remove()), this.updateScrollbar();
    });
  }
  toggle() {
  ...
  async attachFile(e) {
    ...
    try {
      ...
      const i = await Be(r);
      this.attachedFiles.find(({ name: o }) => o === r[0].name).url = i.data[0].url;
    } catch {
    }
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(ze, {
  ...
  render() {
    ...
    this.messagesContainer = this.querySelector("#onbotgo-messageContainer"), this.chatInput = this.querySelector(bt.tag), this.scrollBar = this.querySelector(Ct.tag), this.header = this.querySelector("#onbotgo-chatheader"), this.header.style.display = "flex", this.header.style.width = "100%", this.header.style.justifyContent = "center", this.header.style.backgroundColor = E.colors.primary;
    const i = this.header.getChild("img");
    i.src = We, i.style.objectFit = "cover", this.getChild("#onbotgo-btnrecordSend").style.display = "none", this.querySelector("#onbotgo-btnrecord").onclick = () => {
    ...
    }, this.chatInput.onSubmit(this.onSubmit.bind(this)), this.renderMessages(this.messagesHistory), this.isRecordSelected ? (r.style.display = "none", this.chatInput.style.display = "none", e.style.display = "flex") : (r.style.display = "grid", this.btnattachNewFile.style.display = "grid", this.chatInput.style.display = "grid", e.style.display = "none"), this.querySelectorAll(".onbotgo-attachedFile").forEach((o, s) => {
      o.querySelector("i").onclick = (l) => {
        this.attachedFiles.splice(s, 1), this.renderAttachTemplate(), this.attachedFiles.length && (this.querySelector(".onbotgo-dropdown-content").style.display = "flex"), l.stopPropagation();
      };
    });
  }
}
const Ne = (n) => ({
  ...
  [`${q} .onbotgo-messageContainer`]: {
    display: "flex !important"
  },
  [`${q} .onbotgo-chat-footer`]: {
...
class gt extends L {
  constructor() {
    ...
    const e = new ft(E.customIcon), r = new vt();
...
function qe({ element: n, styles: t }) {
  const e = t.reduce(
    (o, s) => ({
      ...o,
      ...s
    ...
    {}
  ), r = document.createElement("style"), i = je(e);
  r.innerHTML = i, n.prepend(r);
}
function Oe(n, t = {}) {
  const e = Object.keys(t), r = Object.values(t);
  let i = `${n}{`;
  return e.forEach((o, s) => i += `${o}:${r[s]};`), i + "}";
}
function Ue(n, t = {}) {
  const e = Object.keys(t), r = Object.values(t);
  let i = `${n}{`;
...
class Ot extends L {
  constructor() {
    ...
    let r = "black";
    t === "primary" && (r = E.colors.primary), t === "danger" && (r = "red"), e && (this.querySelector("svg").style.width = `calc(${e} - 16px)`, this.querySelector("svg").style.height = `calc(${e} - 16px)`, this.setStyles({ width: e, height: e })), this.setStyles({ color: r });
    const i = new U();
    i.setStyles({
      backgroundColor: r,
      opacity: 0.2,
...
class jt extends L {
  constructor() {
    ...
    const t = this.getAttribute("color"), e = this.getAttribute("size");
    let r = "black";
    t === "primary" && (r = E.colors.primary), e && this.setStyles({ width: e, height: e }), this.setStyles({
...
<!-- END STOP-->\r
`, Xe = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
function Ft(n, t, e, r) {
  return new (e || (e = Promise))(function(i, o) {
    ...
    function h(c) {
      var a;
      c.done ? i(c.value) : (a = c.value, a instanceof e ? a : new e(function(d) {
        d(a);
      })).then(s, l);
    }
...
class It extends Ze {
  ...
  renderMicStream(t) {
    const e = new AudioContext(), r = e.createMediaStreamSource(t), i = e.createAnalyser();
    r.connect(i);
    const o = i.frequencyBinCount, s = new Float32Array(o), l = o / e.sampleRate;
    let h;
    const c = () => {
      i.getFloatTimeDomainData(s), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = !1, this.wavesurfer.load("", [s], l)), h = requestAnimationFrame(c);
    };
    return c(), () => {
  ...
  startRecording() {
    return Ft(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || Ke.find((i) => MediaRecorder.isTypeSupported(i)), audioBitsPerSecond: this.options.audioBitsPerSecond });
      this.mediaRecorder = e, this.stopRecording();
      const r = [];
      e.ondataavailable = (i) => {
        i.data.size > 0 && r.push(i.data);
      }, e.onstop = () => {
        var i;
        const o = new Blob(r, { type: e.mimeType });
        this.emit("record-end", o), this.options.renderRecordedAudio !== !1 && ((i = this.wavesurfer) === null || i === void 0 || i.load(URL.createObjectURL(o)));
...
class Gt extends L {
  constructor() {
    ...
    this.render(), this.hideMic(), this.initMic(), this.getChild("#onbootgo-delete-record").onclick = () => {
      ...
      let i = new CustomEvent("onbotgo-stop-record", { detail: r });
      document.querySelector("onbotgo-chatcontainer").dispatchEvent(i);
    });
  }
  render() {
  ...
  initMic() {
    this.wavesurfer = tt.create({
      ...
      barHeight: 1,
      fillParent: !0
    }), this.recorder = this.wavesurfer.registerPlugin(It.create());
  }
  startRecording() {
  ...
  displayMic() {
    ...
    this.getChild("#onbotgo-btn-stop").style.display = "grid", [e].forEach((o) => {
      o.style.display = "inline-block";
    });
    const r = this.getChild("#onbotgo-empty-waveform");
    [this.getChild("#onbotgo-btn-play"), r].forEach((o) => {
  ...
  hideMic() {
    ...
    const i = this.getChild("#onbotgo-empty-waveform");
    this.getChild("#onbotgo-btn-play").style.display = "grid", [i].forEach((o) => {
      o.style.display = "inline-block";
    });
  }
}
...
class tr {
  constructor({ chatflow: t, theme: e, welcomeMessage: r }) {
    if (D.chatflowID = t, r && (D.welcomeMessage = r), !e)
      return;
    const { typography: i, colors: o, icon: s } = e;
    i && Object.keys(i).forEach(
      (l) => E.typography[l] = i[l]
