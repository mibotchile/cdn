...
`).replace(/^\s+|\s+$/gm, "")), Y.lastIndex = 0, Q.lastIndex = 0, V.lastIndex = 0;
  ...
  function c(p, g) {
    ...
    for (var y; (y = i.exec(n)) !== null; ) {
      ...
      if (R === "h") {
        var P = A.n || "";
        t.async && z.test(P) && (A.a = !0, A.n = P.replace(z, "")), A = c(A), m.push(A);
      } else if (R === "c") {
        if (p.n === A.n)
...
function B(n, t) {
  ...
  for (e; e < r; e++) {
    ...
    if (typeof i == "string") {
      ...
      var l = i.t, h = i.c || "", c = i.f, a = i.n || "", d = i.p || "", b = i.res || "", p = i.b, g = !!i.a;
      if (l === "i") {
        ...
        if (t.storage.nativeHelpers.get(a))
          ...
          p ? m += "," + ee(p, t) : m += ",[]", m += ",c)", o += "tR+=" + et(m, c) + ";";
        }
      else
        l === "s" ? o += "tR+=" + et((g ? "await " : "") + "c.l('H','" + a + "')({params:[" + d + "]},[],c)", c) + ";" : l === "e" && (o += h + `
`);
    }
  }
  return o;
...
function Ae(n, t, e) {
  ...
  return Rt(this, void 0, void 0, function* () {
    const i = yield fetch(n, e);
    {
      ...
      let h = 0;
      const c = (a, d) => Rt(this, void 0, void 0, function* () {
        if (a)
          return;
...
function we(n, t, e, r, o = 5) {
  ...
  const s = (l) => {
    ...
    const d = (g) => {
      ...
      if (a || Math.abs(u - h) >= o || Math.abs(m - c) >= o) {
        const { left: C, top: y } = n.getBoundingClientRect();
        a || (a = !0, e == null || e(h - C, c - y)), t(u - h, m - c, u - C, m - y), h = u, c = m;
      }
    }, b = (g) => {
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, r, o) {
    const i = t[0], s = t[1] || t[0], l = i.length, { width: h, height: c } = r.canvas, a = c / 2, d = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * d : 1, p = e.barGap ? e.barGap * d : e.barWidth ? b / 2 : 0, g = e.barRadius || 0, u = h / (b + p) / l, m = g && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let C = 0, y = 0, v = 0;
    for (let w = 0; w <= l; w++) {
      ...
      if (I > C) {
        ...
        let W = a - A;
        e.barAlign === "top" ? W = 0 : e.barAlign === "bottom" && (W = c - P), r[m](C * (b + p), W, b, P, g), C = I, y = 0, v = 0;
      }
  ...
  renderChannel(t, e, r) {
    ...
    let b = Math.min($.MAX_CANVAS_WIDTH, c);
...
class vt extends L {
  ...
  initMessagesWebsocket(e) {
    ...
    this.messagesWebsocket = new WebSocket(r).OPEN, console.log(this.messagesWebsocket), this.messagesWebsocket.onmessage = (o) => {
...
${o.url}`,
    ...
    o.url.length ? o.url.forEach((i) => {
      kt({
        ...
        var l, h;
        s != null && s.unique_id && (k.messageHistoryId = s.unique_id, this.initMessagesWebsocket(k.messageHistoryId)), (h = (l = s == null ? void 0 : s.data) == null ? void 0 : l.process) != null && h.length && s.data.process.forEach((c) => {
          this.addMessages([
            {
              type: c.role,
              name: c.name,
      ...
      var s, l;
      i != null && i.unique_id && (k.messageHistoryId = i.unique_id, this.initMessagesWebsocket(k.messageHistoryId)), (l = (s = i == null ? void 0 : i.data) == null ? void 0 : s.process) != null && l.length && i.data.process.forEach((h) => {
        this.addMessages([
          {
            type: h.role,
            name: h.name,
...
class er {
  constructor({ chatflow: t, theme: e, welcomeMessage: r }) {
    if (k.chatflowID = t, r && (k.welcomeMessage = r), !e)
      return;
    const { typography: o, colors: i, icon: s } = e;
    o && Object.keys(o).forEach(
      (l) => E.typography[l] = o[l]
