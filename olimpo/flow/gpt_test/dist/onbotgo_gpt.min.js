...
`).replace(/^\s+|\s+$/gm, "")), X.lastIndex = 0, z.lastIndex = 0, J.lastIndex = 0;
  ...
  function d(p, u) {
    ...
    for (var C; (C = o.exec(r)) !== null; ) {
      var S = C[1], v = C[2], E = C[3], M = C[4], x = C[5], T = C.index;
      if (S)
        S === "(" ? (f === 0 && (A === "n" ? (y(T), A = "p") : A === "f" && (y(T), A = "fp")), f++) : S === ")" ? (f--, f === 0 && A !== "c" && (y(T), A = "err")) : f === 0 && S === "|" ? (y(T), A = "f") : S === "=>" && (y(T), i += 1, A = "res");
      else if (v) {
        if (v === "/*") {
  ...
  function c(p, u) {
    ...
    for (var y; (y = s.exec(r)) !== null; ) {
      var C = y[1], S = y[2], v = y[3] || "", E;
      for (var M in e)
        if (e[M] === v) {
          E = M;
          break;
        }
      A(C, S), i = y.index + y[0].length, E || D("unrecognized tag type: " + v, r, i);
...
function U(r, t, e, n) {
  if (t && t.length > 0)
    throw R((n ? "Native" : "") + "Helper '" + r + "' doesn't accept blocks");
  if (e && e.length > 0)
    throw R((n ? "Native" : "") + "Helper '" + r + "' doesn't accept filters");
}
...
var de = new Z({}), pt = new Z({
  ...
  include: function(r, t, e) {
    ...
    if (!n)
      throw R('Could not fetch template "' + r.params[0] + '"');
  ...
  try: function(r, t) {
    if (U("try", !1, r.f, !0), !r.b || r.b.length !== 1 || r.b[0].n !== "catch")
      throw R("native helper 'try' only accepts 1 block, 'catch'");
  ...
  l: function(r, t) {
    if (r === "H") {
      ...
      if (e)
        return e;
      throw R("Can't find helper '" + t + "'");
    } else if (r === "F") {
      var n = this.storage.filters.get(t);
      if (n)
        return n;
      throw R("Can't find filter '" + t + "'");
    }
  },
  async: !1,
  storage: {
...
function gt(r, t) {
  ...
  if (e.async)
    if (it)
      ...
      throw R("This environment doesn't support async/await");
  try {
    return new n(
      e.varName,
      "c",
    ...
    throw o instanceof SyntaxError ? R(`Bad template syntax
...
function ge(r, t) {
  ...
  if (s && s.length)
    ...
    throw R('Could not find the include file "' + r + '"');
  return e;
}
function jt(r) {
...
function be(r, t, e) {
  if (t && t.length > 0)
    throw R("Helper 'includeFile' doesn't accept blocks");
...
function Ae(r, t, e, n) {
  ...
  if (o.async) {
    ...
    if (n)
      ...
      throw R("Please provide a callback function, this env doesn't support Promises");
    }
  } else
    return ot(r, o)(t, o);
}
...
class N extends L {
  constructor() {
    super(), this.setStyles({
      fontFamily: w.typography.primary
    });
  }
}
N.tag = Ce;
...
class ft extends L {
  constructor(t) {
    super(), this.innerHTML = t, this.innerHTML = this.isIconValid(t) ? t : w.defaultIcon;
  }
  isIconValid(t) {
    var n, o, s, i;
    if (!t)
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, n, o) {
    ...
    for (let S = 0; S <= a; S++) {
      ...
      const E = Math.abs(s[S] || 0), M = Math.abs(i[S] || 0);
      E > y && (y = E), M > C && (C = M);
    }
    n.fill(), n.closePath();
  }
...
const P = new Oe(), Tt = async (r) => await fetch(`${P.gpt_url}/chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), je = async (r) => await fetch(`${P.gpt_url}/messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
...
class yt extends L {
  constructor() {
    ...
    m(this, "input");
    this.innerHTML = this.renderHTML(Ue, { sendIcon: qt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(N.tag), this.input.style.fontFamily = w.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
const Xe = async (r) => await fetch(`${P.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  ...
  onSubmit(e) {
    ...
    if (s.disabled = !0, this.getChild("#onbotgo-chatinput").style.backgroundColor = "rgba(239,239,239,.6)", this.chattingWith === "human_agent") {
      je({
        content: `${o.message}
${o.url}`,
        conversation_id: P.messageHistoryId,
        channel_id: P.chathubChannelId,
        sender: "user"
      }).finally(() => {
        var i;
    ...
    o.url.length ? o.url.forEach((i) => {
      Tt({
        ...
        var d, c;
        a != null && a.unique_id && (P.messageHistoryId = a.unique_id, this.initMessagesWebsocket(P.messageHistoryId)), (c = (d = a == null ? void 0 : a.data) == null ? void 0 : d.process) != null && c.length && a.data.process.forEach((l) => {
          this.addMessages([
            {
              type: l.role,
              name: l.name,
      ...
      var a, d;
      i != null && i.unique_id && (P.messageHistoryId = i.unique_id, this.initMessagesWebsocket(P.messageHistoryId)), (d = (a = i == null ? void 0 : i.data) == null ? void 0 : a.process) != null && d.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
  ...
  async attachFile(e) {
    ...
    try {
      ...
      .onbotgo-lds-ring div {
        ...
        width: 19px;
        height: 19px;
        border: 2px solid ${w.colors.primary};
        border-radius: 50%;
        animation: onbotgo-lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;
        border-color: ${w.colors.primary} transparent transparent transparent;
      }
...
class ut extends L {
  constructor() {
    ...
    const e = new ft(w.customIcon), n = new Ct();
...
class Qt extends L {
  constructor() {
    ...
    let n = "black";
    t === "primary" && (n = w.colors.primary), t === "danger" && (n = "red"), e && (this.querySelector("svg").style.width = `calc(${e} - 16px)`, this.querySelector("svg").style.height = `calc(${e} - 16px)`, this.setStyles({ width: e, height: e })), this.setStyles({ color: n });
    const o = new N();
    o.setStyles({
      backgroundColor: n,
      opacity: 0.2,
...
class zt extends L {
  constructor() {
    ...
    const t = this.getAttribute("color"), e = this.getAttribute("size");
    let n = "black";
    t === "primary" && (n = w.colors.primary), e && this.setStyles({ width: e, height: e }), this.setStyles({
...
class un {
  constructor({
    ...
    if (P.chatflowID = t, P.chathubChannelId = e, o && (P.welcomeMessage = o), !n)
      return;
    const { typography: s, colors: i, icon: a } = n;
    s && Object.keys(s).forEach(
      (d) => w.typography[d] = s[d]
