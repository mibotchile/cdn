...
function Xt(a, r) {
  ...
  for (o; o < h; o++) {
    ...
    if (typeof d == "string") {
      ...
      var m = d.t, p = d.c || "", _ = d.f, y = d.n || "", w = d.p || "", P = d.res || "", E = d.b, C = !!d.a;
      if (m === "i") {
        r.defaultFilter && (p = "c.l('F','" + r.defaultFilter + "')(" + p + ")");
        var x = ji(p, _);
        ...
        m === "s" ? l += "tR+=" + ji((C ? "await " : "") + "c.l('H','" + y + "')({params:[" + w + "]},[],c)", _) + ";" : m === "e" && (l += p + `
`);
    }
  }
  return l;
...
class un extends yt {
 ...
 allowed nodes: "svg", "i", "img"`), !1;
    for (let m = 0; m < o.childNodes.length; m++) {
      const p = (u = (d = o.childNodes[m]) == null ? void 0 : d.tagName) == null ? void 0 : u.toLowerCase();
      if (["script"].includes(p))
        return console.error(`Element "<${p}>" is not valid.`), !1;
    }
    return !0;
  }
}
...
{{ /if}} {{/if}} {{@if(it.type === "address" && it.render_map === 'backgroud')\r
}}\r
<onbotgo-box class="from-chatbot onbotgo-message">\r
  <onbotgo-box class="bg-semi-transp"></onbotgo-box>\r
</onbotgo-box>\r
...
var aa = globalThis && globalThis.__awaiter || function(a, r, o, h) {
  ...
  return new (o || (o = Promise))(function(d, u) {
    ...
    function _(y) {
      y.done ? d(y.value) : l(y.value).then(m, p);
    }
  ...
  return Oo(this, void 0, void 0, function* () {
    const d = yield fetch(a, o);
    {
      ...
      const _ = (y, w) => Oo(this, void 0, void 0, function* () {
        if (y)
          return;
        p += (w == null ? void 0 : w.length) || 0;
        const P = Math.round(p / m * 100);
...
function pa(a, r, o, h, l = 5) {
  ...
  const u = (m) => {
    ...
    let p = m.clientX, _ = m.clientY, y = !1;
    const w = (C) => {
      C.preventDefault(), C.stopPropagation();
      const x = C.clientX, R = C.clientY;
      if (y || Math.abs(x - p) >= l || Math.abs(R - _) >= l) {
        const { left: Z, top: S } = a.getBoundingClientRect();
        y || (y = !0, o == null || o(p - Z, _ - S)), r(x - p, R - _, x - Z, R - S), p = x, _ = R;
      }
    }, P = (C) => {
...
class si extends dn {
  ...
  renderBarWaveform(r, o, h, l) {
    const d = r[0], u = r[1] || r[0], m = d.length, { width: p, height: _ } = h.canvas, y = _ / 2, w = window.devicePixelRatio || 1, P = o.barWidth ? o.barWidth * w : 1, E = o.barGap ? o.barGap * w : o.barWidth ? P / 2 : 0, C = o.barRadius || 0, x = p / (P + E) / m, R = C && "roundRect" in h ? "roundRect" : "rect";
    h.beginPath();
    let Z = 0, S = 0, B = 0;
    for (let G = 0; G <= m; G++) {
  ...
  renderLineWaveform(r, o, h, l) {
    const d = (u) => {
      const m = r[u] || r[0], p = m.length, { height: _ } = h.canvas, y = _ / 2, w = h.canvas.width / p;
      h.moveTo(0, y);
      let P = 0, E = 0;
      for (let C = 0; C <= p; C++) {
  ...
  renderSingleCanvas(r, o, h, l, d, u, m, p) {
  ...
  renderChannel(r, o, h) {
    ...
    const { scrollLeft: m, scrollWidth: p, clientWidth: _ } = this.scrollContainer, y = r[0].length, w = y / p;
  ...
  render(r) {
    ...
    if (this.wrapper.style.width = d ? "100%" : `${l}px`, this.scrollContainer.style.overflowX = this.isScrolling ? "auto" : "hidden", this.scrollContainer.classList.toggle("noScrollbar", !!this.options.hideScrollbar), this.cursor.style.backgroundColor = `${this.options.cursorColor || this.options.progressColor}`, this.cursor.style.width = `${this.options.cursorWidth}px`, this.options.splitChannels)
      for (let m = 0; m < r.numberOfChannels; m++) {
        const p = Object.assign(Object.assign({}, this.options), this.options.splitChannels[m]);
        this.renderChannel([r.getChannelData(m)], p, u);
      }
    else {
  ...
  scrollIntoView(r, o = !1) {
    const { clientWidth: h, scrollLeft: l, scrollWidth: d } = this.scrollContainer, u = d * r, m = h / 2, p = o && this.options.autoCenter && !this.isDragging ? m : h;
    if (u > l + p || u < l)
...
class ai extends fa {
  ...
  exportPeaks({ channels: r = 1, maxLength: o = 8e3, precision: h = 1e4 } = {}) {
    ...
    for (let u = 0; u < l; u++) {
      const m = this.decodedData.getChannelData(u), p = Math.min(m.length, o), _ = m.length / p, y = [];
      for (let w = 0; w < p; w++) {
  ...
  (function(o, h) {
    ...
    var $ = {
      ...
      _off: function(t, e, i) {
        ...
        if (this._events && (n = this._events[t], !!n)) {
          ...
          if (f !== !1) {
            var g = n[f];
            this._firingCount && (g.fn = w, this._events[t] = n = n.slice()), n.splice(f, 1);
          }
        }
      },
        ...
        if (this._events) {
          ...
          if (s) {
            ...
            for (var c = 0, f = s.length; c < f; c++) {
              var g = s[c], v = g.fn;
              g.once && this.off(t, v, g.ctx), v.call(g.ctx || this, n);
            }
            this._firingCount--;
          }
        }
    ...
    var Rt = {
      ...
      wrapLatLngBounds: function(t) {
        ...
        if (n === 0 && s === 0)
          return t;
        var c = t.getSouthWest(), f = t.getNorthEast(), g = new W(c.lat - n, c.lng - s), v = new W(f.lat - n, f.lng - s);
        return new mt(g, v);
      }
    }, Dt = l({}, Rt, {
      wrapLng: [-180, 180],
      ...
      distance: function(t, e) {
        var i = Math.PI / 180, n = t.lat * i, s = e.lat * i, c = Math.sin((e.lat - t.lat) * i / 2), f = Math.sin((e.lng - t.lng) * i / 2), g = c * c + Math.cos(n) * Math.cos(s) * f * f, v = 2 * Math.atan2(Math.sqrt(g), Math.sqrt(1 - g));
        return this.R * v;
      }
    }), bn = 6378137, li = {
      R: bn,
    ...
    function xn(t, e) {
      ...
      for (n = 0, c = t.length; n < c; n++) {
        for (g = t[n], s = 0, f = g.length; s < f; s++)
          v = g[s], i += (s ? "L" : "M") + v.x + " " + v.y;
        i += e ? T.svg ? "z" : "x" : "";
      }
      return i || "M0 0";
    }
    ...
    function Ti(t, e, i, n) {
      ...
      !T.touchNative && T.pointer && e.indexOf("touch") === 0 ? c = Pr(t, e, c) : T.touch && e === "dblclick" ? c = Ir(t, c) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Li[e] || e, c, T.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (c = function(g) {
        g = g || window.event, Ri(t, g) && f(g);
    ...
    var Hr = {
      ...
      setZoomAround: function(t, e, i) {
        var n = this.getZoomScale(e), s = this.getSize().divideBy(2), c = t instanceof O ? t : this.latLngToContainerPoint(t), f = c.subtract(s).multiplyBy(1 - 1 / n), g = this.containerPointToLatLng(s.add(f));
      ...
      _getBoundsCenterZoom: function(t, e) {
        ...
        var c = n.subtract(i).divideBy(2), f = this.project(t.getSouthWest(), s), g = this.project(t.getNorthEast(), s), v = this.unproject(f.add(g).divideBy(2).add(c), s);
        return {
          center: v,
          zoom: s
        };
      ...
      flyTo: function(t, e, i) {
        ...
        var g = Math.max(c.x, c.y), v = g * this.getZoomScale(f, e), b = s.distanceTo(n) || 1, A = 1.42, M = A * A;
        function H(ht) {
          var We = ht ? -1 : 1, Ls = ht ? v : g, Ts = v * v - g * g + We * M * M * b * b, Ss = 2 * Ls * M * b, Ui = Ts / Ss, Mo = Math.sqrt(Ui * Ui + 1) - Ui, Ms = Mo < 1e-9 ? -18 : Math.log(Mo);
          return Ms;
        }
        function ft(ht) {
        ...
        var gt = H(0);
        function ce(ht) {
          return g * (ct(gt) / ct(gt + A * ht));
        }
        function Cs(ht) {
          return g * (ct(gt) * wt(gt + A * ht) - ft(gt)) / M;
        }
        function As(ht) {
          return 1 - Math.pow(1 - ht, 1.5);
        }
        var Es = Date.now(), To = (H(1) - gt) / A, Ps = i.duration ? 1e3 * i.duration : 1e3 * To * 0.8;
        function So() {
      ...
      panInside: function(t, e) {
        e = e || {};
        var i = I(e.paddingTopLeft || e.padding || [0, 0]), n = I(e.paddingBottomRight || e.padding || [0, 0]), s = this.project(this.getCenter()), c = this.project(t), f = this.getPixelBounds(), g = pt([f.min.add(i), f.max.subtract(n)]), v = g.getSize();
        if (!g.contains(c)) {
          this._enforcingBounds = !0;
          var b = c.subtract(g.getCenter()), A = g.extend(c).getSize().subtract(v);
      ...
      _handleGeolocationResponse: function(t) {
        if (this._container._leaflet_id) {
          ...
          for (var v in t.coords)
            typeof t.coords[v] == "number" && (g[v] = t.coords[v]);
      ...
      getBoundsZoom: function(t, e, i) {
        t = st(t), i = I(i || [0, 0]);
        var n = this.getZoom() || 0, s = this.getMinZoom(), c = this.getMaxZoom(), f = t.getNorthWest(), g = t.getSouthEast(), v = this.getSize().subtract(i), b = pt(this.project(g, n), this.project(f, n)).getSize(), A = T.any3d ? this.options.zoomSnap : 1, M = v.x / b.x, H = v.y / b.y, ft = e ? Math.max(M, H) : Math.min(M, H);
      ...
      _initContainer: function(t) {
        ...
        z(e, "scroll", this._onScroll, this), this._containerId = p(e);
      },
      ...
      _findEventTargets: function(t, e) {
        for (var i = [], n, s = e === "mouseout" || e === "mouseover", c = t.target || t.srcElement, f = !1; c; ) {
          if (n = this._targets[p(c)], n && (e === "click" || e === "preclick") && this._draggableMoved(n)) {
            f = !0;
            break;
          }
      ...
      _fireDOMEvent: function(t, e, i) {
        ...
        if (s.length) {
          ...
          if (t.type !== "keypress" && t.type !== "keydown" && t.type !== "keyup") {
            var b = g.getLatLng && (!g._radius || g._radius <= 10);
            v.containerPoint = b ? this.latLngToContainerPoint(g.getLatLng()) : this.mouseEventToContainerPoint(t), v.layerPoint = this.containerPointToLayerPoint(v.containerPoint), v.latlng = b ? g.getLatLng() : this.layerPointToLatLng(v.layerPoint);
          }
      ...
      _getBoundsOffset: function(t, e, i) {
        ...
        ), s = n.min.subtract(t.min), c = n.max.subtract(t.max), f = this._rebound(s.x, -c.x), g = this._rebound(s.y, -c.y);
        return new O(f, g);
      },
    ...
    var Qn = xt.extend({
      ...
      _addItem: function(t) {
        ...
        t.overlay ? (n = document.createElement("input"), n.type = "checkbox", n.className = "leaflet-control-layers-selector", n.defaultChecked = i) : n = this._createRadioElement("leaflet-base-layers_" + p(this), i), this._layerControlInputs.push(n), n.layerId = p(t.layer), z(n, "click", this._onInputClick, this);
    ...
    function $n(t, e, i) {
      var n, s = [1, 4, 2, 8], c, f, g, v, b, A, M, H;
      for (c = 0, A = t.length; c < A; c++)
        t[c]._code = Wt(t[c], e);
      for (g = 0; g < 4; g++) {
        for (M = s[g], n = [], c = 0, A = t.length, f = A - 1; c < A; f = c++)
          v = t[c], b = t[f], v._code & M ? b._code & M || (H = ze(b, v, M, e, i), H._code = Wt(H, e), n.push(H)) : (b._code & M && (H = ze(b, v, M, e, i), H._code = Wt(H, e), n.push(H)), n.push(v));
        t = n;
      }
      return t;
    }
    function to(t, e) {
      var i, n, s, c, f, g, v, b, A;
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      bt(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var M = U([0, 0]), H = st(t), ft = H.getNorthWest().distanceTo(H.getSouthWest()) * H.getNorthEast().distanceTo(H.getNorthWest());
      ft < 1700 && (M = Ii(t));
      var ct = t.length, wt = [];
      for (i = 0; i < ct; i++) {
        var gt = U(t[i]);
      ...
      for (g = v = b = 0, i = 0, n = ct - 1; i < ct; n = i++)
        s = wt[i], c = wt[n], f = s.y * c.x - c.y * s.x, v += (s.x + c.x) * f, b += (s.y + c.y) * f, g += f * 3;
      g === 0 ? A = wt[0] : A = [v / g, b / g];
    ...
    function Oi(t, e, i, n, s) {
      var c = 0, f, g, v;
      for (g = n + 1; g <= s - 1; g++)
        v = we(t[g], t[n], t[s], !0), v > c && (f = g, c = v);
    ...
    function oo(t, e, i, n, s) {
      var c = n ? no : Wt(t, i), f = Wt(e, i), g, v, b;
      for (no = f; ; ) {
        if (!(c | f))
          return [t, e];
        if (c & f)
          return !1;
        g = c || f, v = ze(t, e, g, i, s), b = Wt(v, i), g === c ? (t = v, c = b) : (e = v, f = b);
      }
    }
    function ze(t, e, i, n, s) {
      var c = e.x - t.x, f = e.y - t.y, g = n.min, v = n.max, b, A;
      return i & 8 ? (b = t.x + c * (v.y - t.y) / f, A = v.y) : i & 4 ? (b = t.x + c * (g.y - t.y) / f, A = g.y) : i & 2 ? (b = v.x, A = t.y + f * (v.x - t.x) / c) : i & 1 && (b = g.x, A = t.y + f * (g.x - t.x) / c), new O(b, A, s);
    }
    function Wt(t, e) {
      var i = 0;
    ...
    function we(t, e, i, n) {
      var s = e.x, c = e.y, f = i.x - s, g = i.y - c, v = f * f + g * g, b;
      return v > 0 && (b = ((t.x - s) * f + (t.y - c) * g) / v, b > 1 ? (s = i.x, c = i.y) : b > 0 && (s += f * b, c += g * b)), f = t.x - s, g = t.y - c, n ? f * f + g * g : new O(s, c);
    }
    function bt(t) {
    ...
    function so(t, e) {
      ...
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      bt(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var A = U([0, 0]), M = st(t), H = M.getNorthWest().distanceTo(M.getSouthWest()) * M.getNorthEast().distanceTo(M.getNorthWest());
      H < 1700 && (A = Ii(t));
      var ft = t.length, ct = [];
      for (i = 0; i < ft; i++) {
        var wt = U(t[i]);
      ...
      if (n === 0)
        ...
        for (i = 0, c = 0; i < ft - 1; i++)
          if (f = ct[i], g = ct[i + 1], s = f.distanceTo(g), c += s, c > n) {
            v = (c - n) / s, b = [
              g.x - v * (g.x - f.x),
              g.y - v * (g.y - f.y)
            ];
    ...
    var Jr = {
      ...
      project: function(t) {
        var e = Math.PI / 180, i = this.R, n = t.lat * e, s = this.R_MINOR / i, c = Math.sqrt(1 - s * s), f = c * Math.sin(n), g = Math.tan(Math.PI / 4 - n / 2) / Math.pow((1 - f) / (1 + f), c / 2);
        return n = -i * Math.log(Math.max(g, 1e-10)), new O(t.lng * e * i, n);
      },
      unproject: function(t) {
        for (var e = 180 / Math.PI, i = this.R, n = this.R_MINOR / i, s = Math.sqrt(1 - n * n), c = Math.exp(-t.y / i), f = Math.PI / 2 - 2 * Math.atan(c), g = 0, v = 0.1, b; g < 15 && Math.abs(v) > 1e-7; g++)
    ...
    var xe = se.extend({
      ...
      _adjustPan: function(t) {
        var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, s = this._marker.options.autoPanPadding, c = qt(e._icon), f = i.getPixelBounds(), g = i.getPixelOrigin(), v = pt(
          f.min._subtract(g).add(s),
          f.max._subtract(g).subtract(s)
        );
        if (!v.contains(c)) {
          var b = I(
    ...
    var Ni = Ne.extend({
      ...
      _project: function() {
        ...
        if (n.distance === Dt.distance) {
          var s = Math.PI / 180, c = this._mRadius / Dt.R / s, f = i.project([e + c, t]), g = i.project([e - c, t]), v = f.add(g).divideBy(2), b = i.unproject(v).lat, A = Math.acos((Math.cos(c * s) - Math.sin(e * s) * Math.sin(b * s)) / (Math.cos(e * s) * Math.cos(b * s))) / s;
    ...
    var Bt = Ht.extend({
      ...
      closestLayerPoint: function(t) {
        for (var e = 1 / 0, i = null, n = we, s, c, f = 0, g = this._parts.length; f < g; f++)
      ...
      _clipPoints: function() {
        ...
        if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
          ...
          var e = this._parts, i, n, s, c, f, g, v;
          for (i = 0, s = 0, c = this._rings.length; i < c; i++)
            for (v = this._rings[i], n = 0, f = v.length; n < f - 1; n++)
              g = oo(v[n], v[n + 1], t, n, !0), g && (e[s] = e[s] || [], e[s].push(g[0]), (g[1] !== v[n + 1] || n === f - 2) && (e[s].push(g[1]), s++));
        }
      },
      ...
      _containsPoint: function(t, e) {
        var i, n, s, c, f, g, v = this._clickTolerance();
        if (!this._pxBounds || !this._pxBounds.contains(t))
          return !1;
        for (i = 0, c = this._parts.length; i < c; i++)
          for (g = this._parts[i], n = 0, f = g.length, s = f - 1; n < f; s = n++)
            if (!(!e && n === 0) && io(t, g[s], g[n]) <= v)
              return !0;
        return !1;
      }
    });
    ...
    var ae = Bt.extend({
      ...
      // Needed by the `Canvas` renderer for interactivity
      _containsPoint: function(t) {
        var e = !1, i, n, s, c, f, g, v, b;
        if (!this._pxBounds || !this._pxBounds.contains(t))
          return !1;
        for (c = 0, v = this._parts.length; c < v; c++)
          for (i = this._parts[c], f = 0, b = i.length, g = b - 1; f < b; g = f++)
            n = i[f], s = i[g], n.y > t.y != s.y > t.y && t.x < (s.x - n.x) * (t.y - n.y) / (s.y - n.y) + n.x && (e = !e);
    ...
    function He(t, e) {
      var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, s = [], c = e && e.pointToLayer, f = e && e.coordsToLatLng || Hi, g, v, b, A;
      if (!n && !i)
        return null;
      switch (i.type) {
        case "Point":
          return g = f(n), lo(c, t, g, e);
        case "MultiPoint":
          for (b = 0, A = n.length; b < A; b++)
            g = f(n[b]), s.push(lo(c, t, g, e));
          return new kt(s);
        case "LineString":
    ...
    var qe = Tt.extend({
      ...
      _adjustPan: function() {
        if (this.options.autoPan) {
          ...
          var c = t.layerPointToContainerPoint(s), f = I(this.options.autoPanPadding), g = I(this.options.autoPanPaddingTopLeft || f), v = I(this.options.autoPanPaddingBottomRight || f), b = t.getSize(), A = 0, M = 0;
          c.x + n + v.x > b.x && (A = c.x + n - b.x + v.x), c.x - A - g.x < 0 && (A = c.x - g.x), c.y + i + v.y > b.y && (M = c.y + i - b.y + v.y), c.y - M - g.y < 0 && (M = c.y - g.y), (A || M) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([A, M]));
        }
      },
      _getAnchor: function() {
    ...
    var Ve = Tt.extend({
      ...
      _initLayout: function() {
        ...
        this._contentNode = this._container = q("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + p(this));
      },
      _updateLayout: function() {
      },
      _adjustPan: function() {
      ...
      _setPosition: function(t) {
        var e, i, n = this._map, s = this._container, c = n.latLngToContainerPoint(n.getCenter()), f = n.layerPointToContainerPoint(t), g = this.options.direction, v = s.offsetWidth, b = s.offsetHeight, A = I(this.options.offset), M = this._getAnchor();
        g === "top" ? (e = v / 2, i = b) : g === "bottom" ? (e = v / 2, i = 0) : g === "center" ? (e = v / 2, i = b / 2) : g === "right" ? (e = 0, i = b / 2) : g === "left" ? (e = v, i = b / 2) : f.x < c.x ? (g = "right", e = 0, i = b / 2) : (g = "left", e = v + (A.x + M.x) * 2, i = b / 2), t = t.subtract(I(e, i, !0)).add(A).add(M), nt(s, "leaflet-tooltip-right"), nt(s, "leaflet-tooltip-left"), nt(s, "leaflet-tooltip-top"), nt(s, "leaflet-tooltip-bottom"), D(s, "leaflet-tooltip-" + g), at(s, t);
      },
      _updatePosition: function() {
    ...
    var Ce = Ct.extend({
      ...
      _retainParent: function(t, e, i, n) {
        var s = Math.floor(t / 2), c = Math.floor(e / 2), f = i - 1, g = new O(+s, +c);
        g.z = +f;
        var v = this._tileCoordsToKey(g), b = this._tiles[v];
      ...
      _retainChildren: function(t, e, i, n) {
        for (var s = 2 * t; s < 2 * t + 2; s++)
          for (var c = 2 * e; c < 2 * e + 2; c++) {
            var f = new O(s, c);
            f.z = i + 1;
            var g = this._tileCoordsToKey(f), v = this._tiles[g];
            if (v && v.active) {
              v.retain = !0;
              continue;
            } else
      ...
      _update: function(t) {
        ...
        if (e) {
          ...
          if (t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0) {
            var n = this._getTiledPixelBounds(t), s = this._pxBoundsToTileRange(n), c = s.getCenter(), f = [], g = this.options.keepBuffer, v = new tt(
              s.getBottomLeft().subtract([g, -g]),
              s.getTopRight().add([g, -g])
            );
    ...
    var go = le.extend({
      ...
      getTileUrl: function(t) {
        var e = this._tileCoordsToNwSe(t), i = this._crs, n = pt(i.project(e[0]), i.project(e[1])), s = n.min, c = n.max, f = (this._wmsVersion >= 1.3 && this._crs === ao ? [s.y, s.x, c.y, c.x] : [s.x, s.y, c.x, c.y]).join(","), g = le.prototype.getTileUrl.call(this, t);
        return g + R(this.wmsParams, g, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + f;
      },
    ...
    var Ot = Ct.extend({
      ...
      initialize: function(t) {
        x(this, t), p(this), this._layers = this._layers || {};
      },
      onAdd: function() {
      ...
      _updatePoly: function(t, e) {
        if (this._drawing) {
          var i, n, s, c, f = t._parts, g = f.length, v = this._ctx;
          if (g) {
            for (v.beginPath(), i = 0; i < g; i++) {
    ...
    var Ae = function() {
      ...
      _initPath: function(t) {
        ...
        D(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = Ae("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[p(t)] = t;
      },
      _addPath: function(t) {
        var e = t._container;
      ...
      _removePath: function(t) {
        var e = t._container;
        et(e), t.removeInteractiveTarget(e), delete this._layers[p(t)];
      },
      _updateStyle: function(t) {
      ...
      _removePath: function(t) {
        et(t._path), t.removeInteractiveTarget(t._path), delete this._layers[p(t)];
      },
      _updatePath: function(t) {
    ...
    var Co = Lt.extend({
      ...
      _onDragEnd: function(t) {
        ...
        if (e.fire("dragend", t), n)
          ...
          var s = this._lastPos.subtract(this._positions[0]), c = (this._lastTime - this._times[0]) / 1e3, f = i.easeLinearity, g = s.multiplyBy(f / c), v = g.distanceTo([0, 0]), b = Math.min(i.inertiaMaxSpeed, v), A = g.multiplyBy(b / v), M = b / (i.inertiaDeceleration * f), H = A.multiplyBy(-M / 2).round();
          !H.x && !H.y ? e.fire("moveend") : (H = e._limitOffset(H, e.options.maxBounds), Q(function() {
            e.panBy(H, {
              duration: M,
              easeLinearity: f,
              noMoveStart: !0,
...
var en, ni = 13, nn = 40, Jo = 38, wa = [ni, 27, nn, Jo, 37, 39], xa = /* @__PURE__ */ function() {
  ...
  function a(o) {
    ...
    this.handleClick = void 0, this.selected = -1, this.results = [], this.container = void 0, this.resultItem = void 0, this.notFoundMessage = void 0, this.onClick = function(p) {
...
class Qt {
  constructor({ apiKey: r, authReferrerPolicy: o, channel: h, client: l, id: d = "__googleMapsScriptId", language: u, libraries: m = [], mapIds: p, nonce: _, region: y, retries: w = 3, url: P = "https://maps.googleapis.com/maps/api/js", version: E }) {
    if (this.callbacks = [], this.done = !1, this.loading = !1, this.errors = [], this.apiKey = r, this.authReferrerPolicy = o, this.channel = h, this.client = l, this.id = d || "__googleMapsScriptId", this.language = u, this.libraries = m, this.mapIds = p, this.nonce = _, this.region = y, this.retries = w, this.url = P, this.version = E, Qt.instance) {
  ...
  setScript() {
    ...
    Object.keys(h).forEach((d) => !h[d] && delete h[d]), !((o = (r = window == null ? void 0 : window.google) === null || r === void 0 ? void 0 : r.maps) === null || o === void 0) && o.importLibrary || ((d) => {
      let u, m, p, _ = "The Google Maps JavaScript API", y = "google", w = "importLibrary", P = "__ib__", E = document, C = window;
      C = C[y] || (C[y] = {});
      const x = C.maps || (C.maps = {}), R = /* @__PURE__ */ new Set(), Z = new URLSearchParams(), S = () => u || (u = new Promise((B, G) => {
        return F = this, rt = function* () {
          var Y;
          for (p in yield m = E.createElement("script"), m.id = this.id, Z.set("libraries", [...R] + ""), d)
            Z.set(p.replace(/[A-Z]/g, (K) => "_" + K[0].toLowerCase()), d[p]);
          Z.set("callback", y + ".maps." + P), m.src = this.url + "?" + Z, x[P] = B, m.onerror = () => u = G(Error(_ + " could not load.")), m.nonce = this.nonce || ((Y = E.querySelector("script[nonce]")) === null || Y === void 0 ? void 0 : Y.nonce) || "", E.head.append(m);
...
var Ta = /* @__PURE__ */ function(a) {
  ...
  return o.endpoint = function(h) {
    ...
    return h.data.results.map(function(l) {
      var d = l.geometry.location.toJSON(), u = d.lat, m = d.lng, p = l.geometry.viewport.toJSON();
      return { x: m, y: u, label: l.formatted_address, bounds: [[p.south, p.west], [p.north, p.east]], raw: l };
    });
  }, o.search = function(h) {
    try {
      var l = function(m) {
        ...
        return Promise.resolve(m.geocode({ address: h.query }, function(p) {
          return { results: p };
        }).catch(function(p) {
          return p.code !== "ZERO_RESULTS" && console.error(p.code + ": " + p.message), { results: [] };
        })).then(function(p) {
          return d.parse({ data: p });
        });
      }, d = this, u = d.geocoder;
...
class hi extends yt {
  constructor(r) {
    ...
    const o = new te();
    o.classList.add("bg-semi-transp"), this.innerText = (l = (h = N.callbacks) == null ? void 0 : h.addressButton) == null ? void 0 : l.text, this.appendChild(o), (u = (d = N.callbacks) == null ? void 0 : d.addressButton) != null && u.action && (this.onclick = (m) => {
      var p, _;
      return (_ = (p = N.callbacks) == null ? void 0 : p.addressButton) == null ? void 0 : _.action(r, m);
    });
  }
}
...
class fn extends yt {
  constructor({ type: o, id: h, name: l, address: d, image_url: u, country: m, location: p, data: _ }) {
    super();
    k(this, "map");
    this.setStyles({
    ...
    new MutationObserver(function(C, x) {
      document.getElementById(
        ...
        P.map = ei.map(w).setView(
          ...
          typeof ((G = (B = N.callbacks) == null ? void 0 : B.addressButton) == null ? void 0 : G.action)
        ) || ((V = (F = N.callbacks) == null ? void 0 : F.addressButton) == null ? void 0 : V.action) instanceof Promise) && P.appendChild(
          new hi({
            id: h,
            name: l,
            address: d,
...
`, " ").replace(/\n/g, " "), o.fileType === "audio") {
      let p;
      typeof o.file == "string" ? p = o.file : p = URL.createObjectURL(o.file), this.wavesurfer = ai.create({
        barHeight: 12,
        height: 24,
        barWidth: 1,
      ...
      let _ = typeof o.file == "string" ? o.file : URL.createObjectURL(o.file);
      p.src = _, p.style.objectFit = "cover", p.style.minHeight = "100px", p.style.minWidth = "100px", p.style.maxHeight = "80%", p.style.maxWidth = "80%", this.querySelector(".onbotgo-message").appendChild(p);
    } else if (!o.fileType && o.type === "userMessage") {
      const p = this.querySelector(".onbotgo-message");
      this.appendChild(this.getAvatarMessage("userMessage")), p.innerText += o.message;
      ...
      const p = new fn(o);
      this.appendChild(p);
    } else if (!o.fileType && o.type === "address" && o.render_map === "backgroud") {
      const p = this.querySelector(".onbotgo-message");
      p.style.width = "65%", p.innerHTML += `<span>${o.name}
                                        <ul style="margin-bottom: 0">
                                          <li>Proyecto: ${o.data.proyecto}</li>
                                          <li>Precio: ${o.data.precio}</li>
                                          <li>Cuartos: ${o.data.cuartos}</li>
                                        </ul>
                                        </span>`, (["function"].includes(
        typeof ((d = (l = N.callbacks) == null ? void 0 : l.addressButton) == null ? void 0 : d.action)
      ) || ((m = (u = N.callbacks) == null ? void 0 : u.addressButton) == null ? void 0 : m.action) instanceof Promise) && p.appendChild(new hi(o)), this.insertBefore(this.getAvatarMessage("apiMessage"), p);
    } else
      !o.fileType && o.type === "address" && o.render_map;
    if (o.type === "LoadingMessage") {
      const p = this.querySelector(".onbotgo-message");
      this.insertBefore(this.getAvatarMessage("apiMessage"), p), this.setLoadingAnimation();
    }
  }
  handlePlayPause() {
...
const ka = (a) => ({
  ...
  const r = `${N.ssl ? "https" : "http"}://${N.botHost}`;
  return (await fetch(`${r}${N.projectPath}chat`, {
    headers: {
...
class gn extends HTMLElement {
  ...
  setScrollThumbHeight() {
    ...
    h.addEventListener("mousedown", (y) => {
      p = !0, _ = y.clientY, this.preventContentHighlight("remove");
    }), document.addEventListener("mouseup", () => {
      p = !1, this.preventContentHighlight("add");
...
const Za = async (a) => await fetch(`${N.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
    ...
    o.defaults = {
      ...
      buildToast: function() {
        ...
        if (this.options.ariaLive && u.setAttribute("aria-live", this.options.ariaLive), this.options.node && this.options.node.nodeType === Node.ELEMENT_NODE)
          ...
          p.src = this.options.avatar, p.className = "toastify-avatar", this.options.position == "left" || this.options.positionLeft === !0 ? u.appendChild(p) : u.insertAdjacentElement("afterbegin", p);
        }
      ...
      for (var u = {
        ...
        C <= 360 ? (_[w].style[y] = p[y] + "px", p[y] += P + E) : d(_[w], "toastify-left") === !0 ? (_[w].style[y] = u[y] + "px", u[y] += P + E) : (_[w].style[y] = m[y] + "px", m[y] += P + E);
      }
      return this;
    };
    function l(u, m) {
...
class vn extends yt {
  ...
  initMessagesWebsocket(o) {
    ...
    const l = `${`${N.ssl ? "wss" : "ws"}://${N.botHost}`}/messages/${o}/ws`;
...
${l.url}`,
        ...
        var u;
        this.querySelector("input").focus(), (u = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || u.forEach((m) => {
          m.parentNode.remove();
        }), d.disabled = !1;
      });
      return;
    ...
    l.url.length ? l.url.forEach((u) => {
      zo({
        ...
        var p, _, y;
        m != null && m.unique_id && (N.messageHistoryId = m.unique_id, this.initMessagesWebsocket(N.messageHistoryId)), (_ = (p = m == null ? void 0 : m.data) == null ? void 0 : p.process) != null && _.length && m.data.process.forEach((w) => {
          this.addMessages([
            {
              type: w.role,
              name: w.name,
        ...
        ]), m.thought && this.showBotThought(m.thought), m.redirect && (this.chattingWith = "human_agent"), (y = m == null ? void 0 : m.content) != null && y.cards && this.handleCardMessages(m.content.cards);
      }).catch((m) => console.log(m)).finally(() => {
        var m;
        (m = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || m.forEach((p) => p.parentNode.remove()), this.updateScrollbar(), d.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", d.focus();
      });
    }) : zo(l).then((u) => {
      var m, p, _;
      u != null && u.unique_id && (N.messageHistoryId = u.unique_id, this.initMessagesWebsocket(N.messageHistoryId)), (p = (m = u == null ? void 0 : u.data) == null ? void 0 : m.process) != null && p.length && u.data.process.forEach((y) => {
        this.addMessages([
          {
            type: y.role,
            name: y.name,
      ...
      ]), u.redirect && (this.chattingWith = "human_agent"), u.thought && this.showBotThought(u.thought), (_ = u == null ? void 0 : u.content) != null && _.cards && this.handleCardMessages(u.content.cards);
    }).catch((u) => console.log(u)).finally(() => {
      var u;
      (u = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || u.forEach((m) => m.parentNode.remove()), d.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", d.focus(), this.updateScrollbar();
    });
  }
  handleCardMessages(o) {
    ...
    o.forEach((m) => {
      var p;
      this.addMessages([m]), (p = N.callbacks) != null && p.address && m.type === "address" && h.push(m);
    }), console.log((l = N.callbacks) == null ? void 0 : l.address), (d = N.callbacks) != null && d.address && ((u = N.callbacks) == null || u.address(h));
  }
  toggle() {
...
class yn extends eh {
  ...
  renderMicStream(r) {
    ...
    let p;
    const _ = () => {
      l.getFloatTimeDomainData(u), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = !1, this.wavesurfer.load("", [u], m)), p = requestAnimationFrame(_);
    };
    return _(), () => {
      cancelAnimationFrame(p), h == null || h.disconnect(), o == null || o.close();
    };
  }
  startMic() {
...
class sh {
  constructor({
    ...
    if (N.chatflowID = r, h && (N.projectPath = h), l && (N.botHost = l), d && (N.ssl = d), m && (N.welcomeMessage = m), y && (N.callbacks = y), w && (N.googleApikey = w), [!1, !0].includes(_) && (N.showThoughts = _), N.chathubChannelId = o, !u)
      return;
    ...
    P && Object.keys(P).forEach(
      ...
      (x) => ot.colors[x] = E[x]
    ), C && (ot.customIcon = C), p != null && p.active && (St.active = !0, St.number = p.number, St.position = p.position.toLowerCase(), St.msg = p.msg);
  }
  init() {
