...
var Ms = (a, r, o) => r in a ? Ss(a, r, { enumerable: !0, configurable: !0, writable: !0, value: o }) : a[r] = o;
var k = (a, r, o) => (Ms(a, typeof r != "symbol" ? r + "" : r, o), o);
function Rs(a, r) {
...
const Bs = {}, Os = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Bs
}, Symbol.toStringTag, { value: "Module" })), Zo = /* @__PURE__ */ Is(Os);
var So = new Function("return this")().Promise, Wi = !1;
try {
  Wi = new Function("return (async function(){}).constructor")();
} catch (a) {
...
function Te(a, r, o) {
  for (var h in r)
    Fo(r, h) && (r[h] != null && typeof r[h] == "object" && (h === "storage" || h === "prefixes") && !o ? a[h] = Te(
      /*toObj[key] ||*/
      {},
      r[h]
    ) : a[h] = r[h]);
...
function Ke(a) {
  return Mo.test(a) ? a.replace(Mo, "\\$&") : a;
}
function Ns(a, r) {
...
`).replace(/^\s+|\s+$/gm, "")), Ge.lastIndex = 0, Xe.lastIndex = 0, Qe.lastIndex = 0;
  var o = r.prefixes, h = [
    ...
    return E && x ? E + "|" + Ke(x) : x ? Ke(x) : E;
  }, ""), l = new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?" + // comments, strings
  Ke(r.tags[1]) + ")", "g"), d = new RegExp("([^]*?)" + Ke(r.tags[0]) + "(-|_)?\\s*(" + h + ")?\\s*", "g"), u = 0, m = !1;
  function v(E, x) {
    var C = { f: [] }, S = 0, R = "c";
    x === "h" || x === "b" || x === "c" ? R = "n" : x === "r" && (C.raw = !0, x = "i");
    function F(J) {
      var te = a.slice(u, J), $ = te.trim();
      if (R === "f")
        $ === "safe" ? C.raw = !0 : r.async && Ft.test($) ? ($ = $.replace(Ft, ""), C.f.push([$, "", !0])) : C.f.push([$, ""]);
      else if (R === "fp")
        C.f[C.f.length - 1][1] += $;
      else if (R === "err") {
        if ($) {
          var jt = te.search(/\S/);
          Zt("invalid syntax", a, u + jt);
        }
      } else
        C[R] = $;
      u = J + 1;
    ...
    for (var B; (B = l.exec(a)) !== null; ) {
      var Q = B[1], U = B[2], Y = B[3], ot = B[4], q = B[5], K = B.index;
      if (Q)
        Q === "(" ? (S === 0 && (R === "n" ? (F(K), R = "p") : R === "f" && (F(K), R = "fp")), S++) : Q === ")" ? (S--, S === 0 && R !== "c" && (F(K), R = "err")) : S === 0 && Q === "|" ? (F(K), R = "f") : Q === "=>" && (F(K), u += 1, R = "res");
      else if (U) {
        if (U === "/*") {
          ...
          var X = Xe.exec(a);
          X ? l.lastIndex = Xe.lastIndex : Zt("unclosed string", a, B.index);
        } else if (U === '"') {
          ...
          var ht = Ge.exec(a);
          ht ? l.lastIndex = Ge.lastIndex : Zt("unclosed string", a, B.index);
        }
      } else if (Y)
        return F(K), u = K + B[0].length, d.lastIndex = u, m = q, ot && x === "h" && (x = "s"), C.t = x, C;
    }
    return Zt("unclosed tag", a, E), C;
  }
  function b(E, x) {
    E.b = [], E.d = [];
    var C = !1, S = [];
    function R(ht, J) {
      ht && (ht = zs(
        ...
        J
      ), ht && (ht = ht.replace(/\\|'/g, "\\$&").replace(/\r\n|\n|\r/g, "\\n"), S.push(ht)));
    }
    for (var F; (F = d.exec(a)) !== null; ) {
      var B = F[1], Q = F[2], U = F[3] || "", Y;
      for (var ot in o)
        if (o[ot] === U) {
          Y = ot;
          break;
        }
      R(B, Q), u = F.index + F[0].length, Y || Zt("unrecognized tag type: " + U, a, u);
      var q = v(F.index, Y), K = q.t;
      if (K === "h") {
        var vt = q.n || "";
        r.async && Ft.test(vt) && (q.a = !0, q.n = vt.replace(Ft, "")), q = b(q), S.push(q);
      } else if (K === "c") {
        if (E.n === q.n)
          return C ? (C.d = S, E.b.push(C)) : E.d = S, E;
        Zt("Helper start and end don't match", a, F.index + F[0].length);
      } else if (K === "b") {
        C ? (C.d = S, E.b.push(C)) : E.d = S;
        var X = q.n || "";
        r.async && Ft.test(X) && (q.a = !0, q.n = X.replace(Ft, "")), C = q, S = [];
      } else if (K === "s") {
        var it = q.n || "";
        r.async && Ft.test(it) && (q.a = !0, q.n = it.replace(Ft, "")), S.push(q);
      } else
        S.push(q);
    }
    if (x)
      R(a.slice(u, a.length), !1), E.d = S;
    else
...
function Ro(a, r) {
  var o = Ns(a, r), h = "var tR='';" + (r.useWith ? "with(" + r.varName + "||{}){" : "") + Xt(o, r) + "if(cb){cb(null,tR)} return tR" + (r.useWith ? "}" : "");
  if (r.plugins)
...
function jo(a, r, o, h, l, d) {
  var u = "{exec:" + (l ? "async " : "") + Uo(o, r, a) + ",params:[" + h + "]";
  return d && (u += ",name:'" + d + "'"), l && (u += ",async:true"), u += "}", u;
}
function Hs(a, r) {
  for (var o = "[", h = 0; h < a.length; h++) {
    var l = a[h];
    o += jo(r, l.res || "", l.d, l.p || "", l.a, l.n), h < a.length && (o += ",");
  }
  return o += "]", o;
}
function Uo(a, r, o) {
...
function Xt(a, r) {
  ...
  for (o; o < h; o++) {
    ...
    if (typeof d == "string") {
      ...
      var m = d.t, v = d.c || "", b = d.f, y = d.n || "", w = d.p || "", P = d.res || "", E = d.b, x = !!d.a;
      if (m === "i") {
        r.defaultFilter && (v = "c.l('F','" + r.defaultFilter + "')(" + v + ")");
        var C = ji(v, b);
        !d.raw && r.autoEscape && (C = "c.l('F','e')(" + C + ")"), l += "tR+=" + C + ";";
      } else if (m === "h")
        if (r.storage.nativeHelpers.get(y))
          l += r.storage.nativeHelpers.get(y)(d, r);
        else {
          var S = (x ? "await " : "") + "c.l('H','" + y + "')(" + jo(r, P, d.d, w, x);
          E ? S += "," + Hs(E, r) : S += ",[]", S += ",c)", l += "tR+=" + ji(S, b) + ";";
        }
      else
        m === "s" ? l += "tR+=" + ji((x ? "await " : "") + "c.l('H','" + y + "')({params:[" + w + "]},[],c)", b) + ";" : m === "e" && (l += v + `
`);
    }
  }
  return l;
...
function qo(a, r, o, h, l) {
  o(a[r], r).then(function(d) {
    h += d, r === a.length - 1 ? l(h) : qo(a, r + 1, o, h, l);
  });
}
function Vo(a, r, o, h, l, d) {
  h(r[o], a[r[o]]).then(function(u) {
    l += u, o === r.length - 1 ? d(l) : Vo(a, r, o + 1, h, l, d);
  });
}
var Zs = {
  "&": "&amp;",
...
function js(a) {
  var r = String(a);
  return /[&<>"']/.test(r) ? r.replace(/[&<>"']/g, Fs) : r;
}
var Us = new oi({}), an = new oi({
  each: function(a, r) {
    var o = "", h = a.params[0];
  ...
  foreach: function(a, r) {
    ...
    if (Kt("foreach", r, !1), a.async)
      return new Promise(function(d) {
        Vo(o, Object.keys(o), 0, a.exec, "", d);
      });
    var h = "";
    for (var l in o)
      Fo(o, l) && (h += a.exec(l, o[l]));
    return h;
  },
  ...
  block: function(a, r) {
    Kt("block", a.b, a.f, !0);
    var o = "if(!" + r.varName + "[" + a.p + "]){tR+=(" + Uo(a.d, "", r) + ")()}else{tR+=" + r.varName + "[" + a.p + "]}";
    return o;
  }
}), Vs = new oi({ e: js }), Gi = {
  varName: "it",
...
function ri(a, r) {
  var o = {};
  return Te(o, Gi), r && Te(o, r), a && Te(o, a), o.l.bind(o), o;
}
function hn(a, r) {
...
function Ws(a, r) {
  ...
  if (d && d.length)
    o = qi(a.replace(/^\/*/, ""), r.root || "/", !0);
  else if (r.filename && (h = qi(a, r.filename), Xi.existsSync(h) && (o = h)), o || Array.isArray(l) && l.some(function(u) {
    return h = qi(a, u, !0), Xi.existsSync(h);
  }) && (o = h), !o)
    throw dt('Could not find the include file "' + a + '"');
  return o;
}
function Yo(a) {
  return Xi.readFileSync(a).toString().replace(Ys, "");
}
function Gs(a, r) {
  var o = ri(r), h = Yo(a);
  try {
...
function Wo(a, r) {
  var o = ri({ filename: Ws(a, r) }, r);
  return Xs(o);
}
function Qs(a, r, o) {
  if (r && r.length > 0)
    throw dt("Helper 'includeFile' doesn't accept blocks");
  return Wo(a.params[0], o)(a.params[1], o);
}
function Ks(a, r, o) {
  var h = a.params[1] || {};
  h.content = a.exec();
  ...
  return Wo(a.params[0], o)(h, o);
}
function Vi(a, r) {
  var o;
  return r.cache && r.name && r.storage.templates.get(r.name) ? r.storage.templates.get(r.name) : (typeof a == "function" ? o = a : o = hn(a, r), r.cache && r.name && r.storage.templates.define(r.name, o), o);
}
function Js(a, r, o, h) {
  var l = ri(o || {});
  if (l.async) {
...
an.define("includeFile", Qs);
an.define("extendsFile", Ks);
...
const $s = '<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"  fill="currentColor">    <path  fill="currentColor" d="M 12.011719 2 C 6.5057187 2 2.0234844 6.478375 2.0214844 11.984375 C 2.0204844 13.744375 2.4814687 15.462563 3.3554688 16.976562 L 2 22 L 7.2324219 20.763672 C 8.6914219 21.559672 10.333859 21.977516 12.005859 21.978516 L 12.009766 21.978516 C 17.514766 21.978516 21.995047 17.499141 21.998047 11.994141 C 22.000047 9.3251406 20.962172 6.8157344 19.076172 4.9277344 C 17.190172 3.0407344 14.683719 2.001 12.011719 2 z M 12.009766 4 C 14.145766 4.001 16.153109 4.8337969 17.662109 6.3417969 C 19.171109 7.8517969 20.000047 9.8581875 19.998047 11.992188 C 19.996047 16.396187 16.413812 19.978516 12.007812 19.978516 C 10.674812 19.977516 9.3544062 19.642812 8.1914062 19.007812 L 7.5175781 18.640625 L 6.7734375 18.816406 L 4.8046875 19.28125 L 5.2851562 17.496094 L 5.5019531 16.695312 L 5.0878906 15.976562 C 4.3898906 14.768562 4.0204844 13.387375 4.0214844 11.984375 C 4.0234844 7.582375 7.6067656 4 12.009766 4 z M 8.4765625 7.375 C 8.3095625 7.375 8.0395469 7.4375 7.8105469 7.6875 C 7.5815469 7.9365 6.9355469 8.5395781 6.9355469 9.7675781 C 6.9355469 10.995578 7.8300781 12.182609 7.9550781 12.349609 C 8.0790781 12.515609 9.68175 15.115234 12.21875 16.115234 C 14.32675 16.946234 14.754891 16.782234 15.212891 16.740234 C 15.670891 16.699234 16.690438 16.137687 16.898438 15.554688 C 17.106437 14.971687 17.106922 14.470187 17.044922 14.367188 C 16.982922 14.263188 16.816406 14.201172 16.566406 14.076172 C 16.317406 13.951172 15.090328 13.348625 14.861328 13.265625 C 14.632328 13.182625 14.464828 13.140625 14.298828 13.390625 C 14.132828 13.640625 13.655766 14.201187 13.509766 14.367188 C 13.363766 14.534188 13.21875 14.556641 12.96875 14.431641 C 12.71875 14.305641 11.914938 14.041406 10.960938 13.191406 C 10.218937 12.530406 9.7182656 11.714844 9.5722656 11.464844 C 9.4272656 11.215844 9.5585938 11.079078 9.6835938 10.955078 C 9.7955938 10.843078 9.9316406 10.663578 10.056641 10.517578 C 10.180641 10.371578 10.223641 10.267562 10.306641 10.101562 C 10.389641 9.9355625 10.347156 9.7890625 10.285156 9.6640625 C 10.223156 9.5390625 9.737625 8.3065 9.515625 7.8125 C 9.328625 7.3975 9.131125 7.3878594 8.953125 7.3808594 C 8.808125 7.3748594 8.6425625 7.375 8.4765625 7.375 z"/></svg>';
class ta {
  constructor() {
    k(this, "active", !1);
    k(this, "number", "");
...
const St = new ta(), $e = "onbotgo-btn-whatsapp";
class Qi extends wt {
  constructor() {
  ...
  html() {
    return `<onbotgo-box>${$s}<onbotgo-box>`;
  }
}
Qi.tag = $e;
const ea = (a) => ({
...
class ue extends wt {
  constructor() {
    super(), this.setStyles({
      fontFamily: lt.typography.primary
    });
  }
}
ue.tag = ia;
...
class ln extends wt {
  constructor(r) {
    super(), this.innerHTML = r, this.innerHTML = this.isIconValid(r) ? r : lt.defaultIcon;
  }
  isIconValid(r) {
    var h, l, d, u;
    if (!r)
 ...
 allowed nodes: "svg", "i", "img"`), !1;
    for (let m = 0; m < o.childNodes.length; m++) {
      const v = (u = (d = o.childNodes[m]) == null ? void 0 : d.tagName) == null ? void 0 : u.toLowerCase();
      if (["script"].includes(v))
        return console.error(`Element "<${v}>" is not valid.`), !1;
    }
    return !0;
  }
}
...
}), oa = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
{{ /if}} {{/if}}\r
`;
var ra = globalThis && globalThis.__awaiter || function(a, r, o, h) {
  function l(d) {
  ...
  return new (o || (o = Promise))(function(d, u) {
    ...
    function b(y) {
      y.done ? d(y.value) : l(y.value).then(m, v);
    }
...
function ha(a, r) {
  return typeof a[0] == "number" && (a = [a]), aa(a), {
    duration: r,
    length: a[0].length,
...
var Io = globalThis && globalThis.__awaiter || function(a, r, o, h) {
  function l(d) {
    return d instanceof o ? d : new o(function(u) {
      u(d);
    });
...
function la(a, r, o) {
  ...
  return Io(this, void 0, void 0, function* () {
    ...
    {
      const u = (h = d.clone().body) === null || h === void 0 ? void 0 : h.getReader(), m = Number((l = d.headers) === null || l === void 0 ? void 0 : l.get("Content-Length"));
      let v = 0;
      const b = (y, w) => Io(this, void 0, void 0, function* () {
        if (y)
          return;
        v += (w == null ? void 0 : w.length) || 0;
        const P = Math.round(v / m * 100);
        return r(P), u == null ? void 0 : u.read().then(({ done: E, value: x }) => b(E, x));
      });
      u == null || u.read().then(({ done: y, value: w }) => b(y, w));
    }
    return d.blob();
  });
}
...
function da(a, r, o, h, l = 5) {
  ...
  const u = (m) => {
    ...
    let v = m.clientX, b = m.clientY, y = !1;
    const w = (x) => {
      x.preventDefault(), x.stopPropagation();
      const C = x.clientX, S = x.clientY;
      if (y || Math.abs(C - v) >= l || Math.abs(S - b) >= l) {
        const { left: R, top: F } = a.getBoundingClientRect();
        y || (y = !0, o == null || o(v - R, b - F)), r(C - v, S - b, C - R, S - F), v = C, b = S;
      }
    }, P = (x) => {
...
class si extends cn {
  ...
  renderBarWaveform(r, o, h, l) {
    const d = r[0], u = r[1] || r[0], m = d.length, { width: v, height: b } = h.canvas, y = b / 2, w = window.devicePixelRatio || 1, P = o.barWidth ? o.barWidth * w : 1, E = o.barGap ? o.barGap * w : o.barWidth ? P / 2 : 0, x = o.barRadius || 0, C = v / (P + E) / m, S = x && "roundRect" in h ? "roundRect" : "rect";
    h.beginPath();
    let R = 0, F = 0, B = 0;
    for (let Q = 0; Q <= m; Q++) {
      const U = Math.round(Q * C);
      if (U > R) {
        const q = Math.round(F * y * l), K = Math.round(B * y * l), vt = q + K || 1;
        let X = y - q;
        o.barAlign === "top" ? X = 0 : o.barAlign === "bottom" && (X = b - vt), h[S](R * (P + E), X, P, vt, x), R = U, F = 0, B = 0;
      }
      const Y = Math.abs(d[Q] || 0), ot = Math.abs(u[Q] || 0);
      Y > F && (F = Y), ot > B && (B = ot);
    }
    h.fill(), h.closePath();
  }
  renderLineWaveform(r, o, h, l) {
    const d = (u) => {
      const m = r[u] || r[0], v = m.length, { height: b } = h.canvas, y = b / 2, w = h.canvas.width / v;
      h.moveTo(0, y);
      let P = 0, E = 0;
      for (let x = 0; x <= v; x++) {
        const C = Math.round(x * w);
        if (C > P) {
          const R = Math.round(E * y * l) || 1, F = y + R * (u === 0 ? -1 : 1);
          h.lineTo(P, F), P = C, E = 0;
        }
        const S = Math.abs(m[x] || 0);
        S > E && (E = S);
      }
      h.lineTo(P, y);
    };
  ...
  renderWaveform(r, o, h) {
    ...
    let l = o.barHeight || 1;
    if (o.normalize) {
      const d = Array.from(r[0]).reduce((u, m) => Math.max(u, Math.abs(m)), 0);
      l = d ? 1 / d : 1;
    }
  ...
  renderSingleCanvas(r, o, h, l, d, u, m, v) {
    const b = window.devicePixelRatio || 1, y = document.createElement("canvas"), w = r[0].length;
    y.width = Math.round(h * (u - d) / w), y.height = l * b, y.style.width = `${Math.floor(y.width / b)}px`, y.style.height = `${l}px`, y.style.left = `${Math.floor(d * h / b / w)}px`, m.appendChild(y);
    const P = y.getContext("2d");
    this.renderWaveform(r.map((C) => C.slice(d, u)), o, P);
    const E = y.cloneNode();
    v.appendChild(E);
    const x = E.getContext("2d");
    y.width > 0 && y.height > 0 && x.drawImage(y, 0, 0), x.globalCompositeOperation = "source-in", x.fillStyle = this.convertColorValues(o.progressColor), x.fillRect(0, 0, y.width, y.height);
  }
  renderChannel(r, o, h) {
    ...
    const { scrollLeft: m, scrollWidth: v, clientWidth: b } = this.scrollContainer, y = r[0].length, w = y / v;
    let P = Math.min(si.MAX_CANVAS_WIDTH, b);
    if (o.barWidth || o.barGap) {
      const U = o.barWidth || 0.5, Y = o.barGap || U / 2, ot = U + Y;
      P % ot !== 0 && (P = Math.floor(P / ot) * ot);
    }
    const E = Math.floor(Math.abs(m) * w), x = Math.floor(E + P * w), C = x - E, S = (U, Y) => {
      this.renderSingleCanvas(r, o, h, d, Math.max(0, U), Math.min(Y, y), l, u);
    }, R = this.createDelay(), F = this.createDelay(), B = (U, Y) => {
      S(U, Y), U > 0 && R(() => {
        B(U - C, Y - C);
      });
    }, Q = (U, Y) => {
  ...
  render(r) {
    this.timeouts.forEach((m) => m.timeout && clearTimeout(m.timeout)), this.timeouts = [], this.canvasWrapper.innerHTML = "", this.progressWrapper.innerHTML = "", this.wrapper.style.width = "";
    ...
    if (this.wrapper.style.width = d ? "100%" : `${l}px`, this.scrollContainer.style.overflowX = this.isScrolling ? "auto" : "hidden", this.scrollContainer.classList.toggle("noScrollbar", !!this.options.hideScrollbar), this.cursor.style.backgroundColor = `${this.options.cursorColor || this.options.progressColor}`, this.cursor.style.width = `${this.options.cursorWidth}px`, this.options.splitChannels)
      for (let m = 0; m < r.numberOfChannels; m++) {
        const v = Object.assign(Object.assign({}, this.options), this.options.splitChannels[m]);
        this.renderChannel([r.getChannelData(m)], v, u);
      }
    else {
      const m = [r.getChannelData(0)];
      r.numberOfChannels > 1 && m.push(r.getChannelData(1)), this.renderChannel(m, this.options, u);
    }
  ...
  scrollIntoView(r, o = !1) {
    const { clientWidth: h, scrollLeft: l, scrollWidth: d } = this.scrollContainer, u = d * r, m = h / 2, v = o && this.options.autoCenter && !this.isDragging ? m : h;
    if (u > l + v || u < l)
      if (this.options.autoCenter && !this.isDragging) {
        const b = m / 20;
        u - (l + m) >= b && u < l + h ? this.scrollContainer.scrollLeft += b : this.scrollContainer.scrollLeft = u - m;
      } else
        this.isDragging ? this.scrollContainer.scrollLeft = u < l ? u - 10 : u - h + 10 : this.scrollContainer.scrollLeft = u;
    {
      const { scrollLeft: b } = this.scrollContainer, y = b / d, w = (b + h) / d;
...
class ai extends ua {
  ...
  constructor(r) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, pa, r), this.timer = new fa();
  ...
  loadAudio(r, o, h, l) {
    return Je(this, void 0, void 0, function* () {
      if (this.emit("load", r), this.isPlaying() && this.pause(), this.decodedData = null, !o && !h) {
        ...
        o = yield ca.fetchBlob(r, d, this.options.fetchParams);
      }
      if (this.setSrc(r, o), h)
        ...
        })) || (yield Promise.resolve(0)), this.decodedData = ko.createBuffer(h, l);
      else if (o) {
        const d = yield o.arrayBuffer();
        this.decodedData = yield ko.decode(d, this.options.sampleRate);
      }
  ...
  exportPeaks({ channels: r = 1, maxLength: o = 8e3, precision: h = 1e4 } = {}) {
    ...
    for (let u = 0; u < l; u++) {
      const m = this.decodedData.getChannelData(u), v = Math.min(m.length, o), b = m.length / v, y = [];
      for (let w = 0; w < v; w++) {
        const P = Math.round(w * b), E = m[P];
...
const Ki = `<svg fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" \r
...
(function(a, r) {
  (function(o, h) {
    ...
    var ot = 0;
    function q(t) {
      var e = +/* @__PURE__ */ new Date(), i = Math.max(0, 16 - (e - ot));
      return ot = e + i, window.setTimeout(t, i);
    }
    var K = window.requestAnimationFrame || Y("RequestAnimationFrame") || q, vt = window.cancelAnimationFrame || Y("CancelAnimationFrame") || Y("CancelRequestAnimationFrame") || function(t) {
    ...
    J.extend = function(t) {
      ...
      return t.statics && l(e, t.statics), t.includes && (te(t.includes), l.apply(null, [n].concat(t.includes))), l(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? d(i.options) : {}, l(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
    ...
    var $ = {
      ...
      _off: function(t, e, i) {
        ...
        if (this._events && (n = this._events[t], !!n)) {
          ...
          if (f !== !1) {
            var p = n[f];
            this._firingCount && (p.fn = w, this._events[t] = n = n.slice()), n.splice(f, 1);
          }
        }
      },
        ...
        if (this._events) {
          ...
          if (s) {
            ...
            for (var c = 0, f = s.length; c < f; c++) {
              var p = s[c], g = p.fn;
              p.once && this.off(t, g, p.ctx), g.call(p.ctx || this, n);
            }
            this._firingCount--;
          }
        }
    ...
    mt.prototype = {
      ...
      extend: function(t) {
        ...
        if (t instanceof W)
          ...
          return t ? this.extend(H(t) || rt(t)) : this;
      ...
      // Returns `true` if the rectangle contains the given point.
      contains: function(t) {
        typeof t[0] == "number" || t instanceof W || "lat" in t ? t = H(t) : t = rt(t);
        var e = this._southWest, i = this._northEast, n, s;
      ...
      equals: function(t, e) {
        return t ? (t = rt(t), this._southWest.equals(t.getSouthWest(), e) && this._northEast.equals(t.getNorthEast(), e)) : !1;
      },
      // @method isValid(): Boolean
      // Returns `true` if the bounds are properly initialized.
      isValid: function() {
    ...
    var Rt = {
      ...
      wrapLatLngBounds: function(t) {
        ...
        if (n === 0 && s === 0)
          return t;
        var c = t.getSouthWest(), f = t.getNorthEast(), p = new W(c.lat - n, c.lng - s), g = new W(f.lat - n, f.lng - s);
        return new mt(p, g);
      }
    }, Dt = l({}, Rt, {
      wrapLng: [-180, 180],
      ...
      distance: function(t, e) {
        var i = Math.PI / 180, n = t.lat * i, s = e.lat * i, c = Math.sin((e.lat - t.lat) * i / 2), f = Math.sin((e.lng - t.lng) * i / 2), p = c * c + Math.cos(n) * Math.cos(s) * f * f, g = 2 * Math.atan2(Math.sqrt(p), Math.sqrt(1 - p));
        return this.R * g;
      }
    }), yn = 6378137, hi = {
      R: yn,
    ...
    function bn(t, e) {
      ...
      for (n = 0, c = t.length; n < c; n++) {
        for (p = t[n], s = 0, f = p.length; s < f; s++)
          g = p[s], i += (s ? "L" : "M") + g.x + " " + g.y;
        i += e ? T.svg ? "z" : "x" : "";
      }
      return i || "M0 0";
    }
    var ui = document.documentElement.style, Se = "ActiveXObject" in window, sr = Se && !document.addEventListener, wn = "msLaunchUri" in navigator && !("documentMode" in document), di = Et("webkit"), xn = Et("android"), Cn = Et("android 2") || Et("android 3"), ar = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), hr = xn && Et("Google") && ar < 537 && !("AudioNode" in window), fi = !!window.opera, An = !wn && Et("chrome"), En = Et("gecko") && !di && !fi && !Se, lr = !An && Et("safari"), Pn = Et("phantom"), Ln = "OTransition" in ui, cr = navigator.platform.indexOf("Win") === 0, Tn = Se && "transition" in ui, pi = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !Cn, Sn = "MozPerspective" in ui, ur = !window.L_DISABLE_3D && (Tn || pi || Sn) && !Ln && !Pn, fe = typeof orientation < "u" || Et("mobile"), dr = fe && di, fr = fe && pi, Mn = !window.PointerEvent && window.MSPointerEvent, Rn = !!(window.PointerEvent || Mn), kn = "ontouchstart" in window || !!window.TouchEvent, pr = !window.L_NO_TOUCH && (kn || Rn), mr = fe && fi, gr = fe && En, vr = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, yr = function() {
      var t = !1;
      try {
    ...
    }(), mi = !!(document.createElementNS && _n("svg").createSVGRect), br = !!mi && function() {
    ...
    }(), xr = navigator.platform.indexOf("Mac") === 0, Cr = navigator.platform.indexOf("Linux") === 0;
    function Et(t) {
    ...
    var T = {
      ...
      mac: xr,
      linux: Cr
    }, In = T.msPointer ? "MSPointerDown" : "pointerdown", Bn = T.msPointer ? "MSPointerMove" : "pointermove", On = T.msPointer ? "MSPointerUp" : "pointerup", zn = T.msPointer ? "MSPointerCancel" : "pointercancel", gi = {
      touchstart: In,
      touchmove: Bn,
      touchend: On,
      touchcancel: zn
    ...
    function Ar(t, e, i) {
      return e === "touchstart" && Tr(), Dn[e] ? (i = Dn[e].bind(this, i), t.addEventListener(gi[e], i, !1), i) : (console.warn("wrong event specified:", e), w);
    }
    function Er(t, e, i) {
      if (!gi[e]) {
    ...
    function Tr() {
      Nn || (document.addEventListener(In, Pr, !0), document.addEventListener(Bn, Lr, !0), document.addEventListener(On, Hn, !0), document.addEventListener(zn, Hn, !0), Nn = !0);
    }
    function Me(t, e) {
    ...
    function kr(t, e) {
      ...
      function s(c) {
        ...
        if (!(c.pointerType === "mouse" || c.sourceCapabilities && !c.sourceCapabilities.firesTouchEvents)) {
          var f = qn(c);
          if (!(f.some(function(g) {
            return g instanceof HTMLLabelElement && g.attributes.for;
          }) && !f.some(function(g) {
            return g instanceof HTMLInputElement || g instanceof HTMLSelectElement;
          }))) {
            var p = Date.now();
            p - i <= Rr ? (n++, n === 2 && e(Mr(c))) : n = 1, i = p;
          }
        }
      }
    ...
    ), Zn = pe === "webkitTransition" || pe === "OTransition" ? pe + "End" : "transitionend";
    function Fn(t) {
    ...
    function D(t, e) {
      if (t.classList !== void 0)
        for (var i = x(e), n = 0, s = i.length; n < s; n++)
          t.classList.add(i[n]);
      else if (!yi(t, e)) {
        var c = ke(t);
        _i(t, (c ? c + " " : "") + e);
    ...
    function nt(t, e) {
      t.classList !== void 0 ? t.classList.remove(e) : _i(t, E((" " + ke(t) + " ").replace(" " + e + " ", " ")));
    }
    function _i(t, e) {
    ...
    function yt(t, e) {
      "opacity" in t.style ? t.style.opacity = e : "filter" in t.style && Br(t, e);
    }
    function Br(t, e) {
    ...
    function Ut(t, e, i) {
      var n = e || new O(0, 0);
      t.style[vi] = (T.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "");
    }
    function st(t, e) {
      t._leaflet_pos = e, T.any3d ? Ut(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
    }
    function qt(t) {
    ...
    if ("onselectstart" in document)
      ...
      ge = function() {
        ...
        ye && (document.documentElement.style[ye] = bi, bi = void 0);
      };
    }
    function wi() {
    ...
    function Ai(t) {
      for (; t.tabIndex === -1; )
        t = t.parentNode;
      t.style && (Oe(), Be = t, Ci = t.style.outlineStyle, t.style.outlineStyle = "none", z(window, "keydown", Oe));
    }
    function Oe() {
      Be && (Be.style.outlineStyle = Ci, Be = void 0, Ci = void 0, G(window, "keydown", Oe));
    }
    function jn(t) {
      do
        t = t.parentNode;
    ...
    function G(t, e, i, n) {
      if (arguments.length === 1)
        ...
        for (var s in e)
          Ti(t, s, e[s], i);
      else if (e = x(e), arguments.length === 2)
        Un(t, function(p) {
          return Q(e, p) !== -1;
        });
      else
    ...
    function Li(t, e, i, n) {
      ...
      !T.touchNative && T.pointer && e.indexOf("touch") === 0 ? c = Ar(t, e, c) : T.touch && e === "dblclick" ? c = kr(t, c) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Pi[e] || e, c, T.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (c = function(p) {
        p = p || window.event, Mi(t, p) && f(p);
      }, t.addEventListener(Pi[e], c, !1)) : t.addEventListener(e, f, !1) : t.attachEvent("on" + e, c), t[Pt] = t[Pt] || {}, t[Pt][s] = c;
    }
    function Ti(t, e, i, n, s) {
      ...
      if (!c)
        return this;
      !T.touchNative && T.pointer && e.indexOf("touch") === 0 ? Er(t, e, c) : T.touch && e === "dblclick" ? Ir(t, c) : "removeEventListener" in t ? t.removeEventListener(Pi[e] || e, c, !1) : t.detachEvent("on" + e, c), t[Pt][s] = null;
    }
    function Vt(t) {
      return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
    }
    function Si(t) {
      return Li(t, "wheel", Vt), this;
    }
    function _e(t) {
    ...
    var zr = T.linux && T.chrome ? window.devicePixelRatio : T.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
    function Yn(t) {
      return T.edge ? t.wheelDeltaY / 2 : (
        // Don't trust window-geometry-based delta
        t.deltaY && t.deltaMode === 0 ? -t.deltaY / zr : (
          // Pixels
    ...
    var Dr = {
      ...
      setZoomAround: function(t, e, i) {
        var n = this.getZoomScale(e), s = this.getSize().divideBy(2), c = t instanceof O ? t : this.latLngToContainerPoint(t), f = c.subtract(s).multiplyBy(1 - 1 / n), p = this.containerPointToLatLng(s.add(f));
        return this.setView(p, e, { zoom: i });
      },
      _getBoundsCenterZoom: function(t, e) {
        e = e || {}, t = t.getBounds ? t.getBounds() : rt(t);
        ...
        var c = n.subtract(i).divideBy(2), f = this.project(t.getSouthWest(), s), p = this.project(t.getNorthEast(), s), g = this.unproject(f.add(p).divideBy(2).add(c), s);
        return {
          center: g,
          zoom: s
        };
      ...
      flyTo: function(t, e, i) {
        ...
        var p = Math.max(c.x, c.y), g = p * this.getZoomScale(f, e), _ = s.distanceTo(n) || 1, A = 1.42, M = A * A;
        function N(at) {
          var We = at ? -1 : 1, Es = at ? g : p, Ps = g * g - p * p + We * M * M * _ * _, Ls = 2 * Es * M * _, Fi = Ps / Ls, To = Math.sqrt(Fi * Fi + 1) - Fi, Ts = To < 1e-9 ? -18 : Math.log(To);
          return Ts;
        }
        function ft(at) {
        ...
        var gt = N(0);
        function le(at) {
          return p * (ct(gt) / ct(gt + A * at));
        }
        function ws(at) {
          return p * (ct(gt) * bt(gt + A * at) - ft(gt)) / M;
        }
        function xs(at) {
          return 1 - Math.pow(1 - at, 1.5);
        }
        var Cs = Date.now(), Po = (N(1) - gt) / A, As = i.duration ? 1e3 * i.duration : 1e3 * Po * 0.8;
        function Lo() {
          var at = (Date.now() - Cs) / As, We = xs(at) * Po;
          at <= 1 ? (this._flyToFrame = X(Lo, this), this._move(
            this.unproject(n.add(s.subtract(n).multiplyBy(ws(We) / _)), f),
            this.getScaleZoom(p / le(We), f),
            { flyTo: !0 }
      ...
      setMaxBounds: function(t) {
        return t = rt(t), this.listens("moveend", this._panInsideMaxBounds) && this.off("moveend", this._panInsideMaxBounds), t.isValid() ? (this.options.maxBounds = t, this._loaded && this._panInsideMaxBounds(), this.on("moveend", this._panInsideMaxBounds)) : (this.options.maxBounds = null, this);
      },
      ...
      panInsideBounds: function(t, e) {
        ...
        var i = this.getCenter(), n = this._limitCenter(i, this._zoom, rt(t));
      ...
      panInside: function(t, e) {
        e = e || {};
        var i = I(e.paddingTopLeft || e.padding || [0, 0]), n = I(e.paddingBottomRight || e.padding || [0, 0]), s = this.project(this.getCenter()), c = this.project(t), f = this.getPixelBounds(), p = pt([f.min.add(i), f.max.subtract(n)]), g = p.getSize();
        if (!p.contains(c)) {
          this._enforcingBounds = !0;
          var _ = c.subtract(p.getCenter()), A = p.extend(c).getSize().subtract(g);
          s.x += _.x < 0 ? -A.x : A.x, s.y += _.y < 0 ? -A.y : A.y, this.panTo(this.unproject(s), e), this._enforcingBounds = !1;
        }
        return this;
      },
      ...
      _handleGeolocationResponse: function(t) {
        if (this._container._leaflet_id) {
          ...
          for (var g in t.coords)
            typeof t.coords[g] == "number" && (p[g] = t.coords[g]);
      ...
      getBoundsZoom: function(t, e, i) {
        t = rt(t), i = I(i || [0, 0]);
        var n = this.getZoom() || 0, s = this.getMinZoom(), c = this.getMaxZoom(), f = t.getNorthWest(), p = t.getSouthEast(), g = this.getSize().subtract(i), _ = pt(this.project(p, n), this.project(f, n)).getSize(), A = T.any3d ? this.options.zoomSnap : 1, M = g.x / _.x, N = g.y / _.y, ft = e ? Math.max(M, N) : Math.min(M, N);
      ...
      wrapLatLngBounds: function(t) {
        return this.options.crs.wrapLatLngBounds(rt(t));
      },
      // @method distance(latlng1: LatLng, latlng2: LatLng): Number
      ...
      _initContainer: function(t) {
        ...
        z(e, "scroll", this._onScroll, this), this._containerId = v(e);
      },
      ...
      _onResize: function() {
        it(this._resizeRequest), this._resizeRequest = X(
          function() {
      ...
      _findEventTargets: function(t, e) {
        for (var i = [], n, s = e === "mouseout" || e === "mouseover", c = t.target || t.srcElement, f = !1; c; ) {
          if (n = this._targets[v(c)], n && (e === "click" || e === "preclick") && this._draggableMoved(n)) {
            f = !0;
            break;
          }
          if (n && n.listens(e, !0) && (s && !Mi(c, t) || (i.push(n), s)) || c === this._container)
            break;
          c = c.parentNode;
        }
      ...
      _fireDOMEvent: function(t, e, i) {
        ...
        if (s.length) {
          ...
          if (t.type !== "keypress" && t.type !== "keydown" && t.type !== "keyup") {
            var _ = p.getLatLng && (!p._radius || p._radius <= 10);
            g.containerPoint = _ ? this.latLngToContainerPoint(p.getLatLng()) : this.mouseEventToContainerPoint(t), g.layerPoint = this.containerPointToLayerPoint(g.containerPoint), g.latlng = _ ? p.getLatLng() : this.layerPointToLatLng(g.layerPoint);
          }
          for (f = 0; f < s.length; f++)
            if (s[f].fire(e, g, !0), g.originalEvent._stopped || s[f].options.bubblingMouseEvents === !1 && Q(this._mouseEvents, e) !== -1)
              return;
        }
      },
      ...
      _getBoundsOffset: function(t, e, i) {
        ...
        ), s = n.min.subtract(t.min), c = n.max.subtract(t.max), f = this._rebound(s.x, -c.x), p = this._rebound(s.y, -c.y);
        return new O(f, p);
      },
      ...
      _tryAnimatedZoom: function(t, e, i) {
        ...
        return i.animate !== !0 && !this.getSize().contains(s) ? !1 : (X(function() {
    ...
    var Gn = xt.extend({
      ...
      _addItem: function(t) {
        ...
        t.overlay ? (n = document.createElement("input"), n.type = "checkbox", n.className = "leaflet-control-layers-selector", n.defaultChecked = i) : n = this._createRadioElement("leaflet-base-layers_" + v(this), i), this._layerControlInputs.push(n), n.layerId = v(t.layer), z(n, "click", this._onInputClick, this);
      ...
      _expandSafely: function() {
        ...
        var e = this;
        setTimeout(function() {
          G(t, "click", ut), e._preventClick = !1;
        });
      }
    }), Hr = function(t, e, i) {
      return new Gn(t, e, i);
    ...
    var Zr = function(t) {
      ...
      return new Xn(t);
    }, jr = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', ki = xt.extend({
      // @section
      ...
      options: {
        ...
        prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (T.inlineSvg ? jr + " " : "") + "Leaflet</a>"
      },
      initialize: function(t) {
        C(this, t), this._attributions = {};
      },
      onAdd: function(t) {
        t.attributionControl = this, this._container = j("div", "leaflet-control-attribution"), _e(this._container);
    ...
    xt.Layers = Gn, xt.Zoom = Ri, xt.Scale = Xn, xt.Attribution = ki, be.layers = Hr, be.zoom = Zr, be.scale = Fr, be.attribution = Ur;
    var Lt = J.extend({
      initialize: function(t) {
        this._map = t;
      },
    ...
    var qr = { Events: $ }, Qn = T.touch ? "touchstart mousedown" : "mousedown", Nt = jt.extend({
      options: {
        // @section
      ...
      enable: function() {
        this._enabled || (z(this._dragStartTarget, Qn, this._onDown, this), this._enabled = !0);
      },
      // @method disable()
      // Disables the dragging ability
      disable: function() {
        this._enabled && (Nt._dragging === this && this.finishDrag(!0), G(this._dragStartTarget, Qn, this._onDown, this), this._enabled = !1, this._moved = !1);
      },
      _onDown: function(t) {
        if (this._enabled && (this._moved = !1, !yi(this._element, "leaflet-zoom-anim"))) {
          ...
          if (!(Nt._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (Nt._dragging = this, this._preventOutline && Ai(this._element), wi(), ge(), !this._moving)) {
            this.fire("down");
            var e = t.touches ? t.touches[0] : t, i = jn(this._element);
            this._startPoint = new O(e.clientX, e.clientY), this._startPos = qt(this._element), this._parentScale = Ei(i);
      ...
      finishDrag: function(t) {
        nt(document.body, "leaflet-dragging"), this._lastTarget && (nt(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), G(document, "mousemove touchmove", this._onMove, this), G(document, "mouseup touchend touchcancel", this._onUp, this), xi(), ve();
    ...
    function Kn(t, e, i) {
      var n, s = [1, 4, 2, 8], c, f, p, g, _, A, M, N;
      for (c = 0, A = t.length; c < A; c++)
        t[c]._code = Wt(t[c], e);
      for (p = 0; p < 4; p++) {
        for (M = s[p], n = [], c = 0, A = t.length, f = A - 1; c < A; f = c++)
          g = t[c], _ = t[f], g._code & M ? _._code & M || (N = ze(_, g, M, e, i), N._code = Wt(N, e), n.push(N)) : (_._code & M && (N = ze(_, g, M, e, i), N._code = Wt(N, e), n.push(N)), n.push(g));
        t = n;
      }
      return t;
    }
    function Jn(t, e) {
      var i, n, s, c, f, p, g, _, A;
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      _t(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var M = H([0, 0]), N = rt(t), ft = N.getNorthWest().distanceTo(N.getSouthWest()) * N.getNorthEast().distanceTo(N.getNorthWest());
      ft < 1700 && (M = Ii(t));
      var ct = t.length, bt = [];
      for (i = 0; i < ct; i++) {
        var gt = H(t[i]);
        bt.push(e.project(H([gt.lat - M.lat, gt.lng - M.lng])));
      }
      for (p = g = _ = 0, i = 0, n = ct - 1; i < ct; n = i++)
        s = bt[i], c = bt[n], f = s.y * c.x - c.y * s.x, g += (s.x + c.x) * f, _ += (s.y + c.y) * f, p += f * 3;
      p === 0 ? A = bt[0] : A = [g / p, _ / p];
      var le = e.unproject(I(A));
      return H([le.lat + M.lat, le.lng + M.lng]);
    }
    function Ii(t) {
    ...
    function Bi(t, e, i, n, s) {
      var c = 0, f, p, g;
      for (p = n + 1; p <= s - 1; p++)
        g = we(t[p], t[n], t[s], !0), g > c && (f = p, c = g);
      c > i && (e[f] = 1, Bi(t, e, i, n, f), Bi(t, e, i, f, s));
    }
    function Gr(t, e) {
      for (var i = [t[0]], n = 1, s = 0, c = t.length; n < c; n++)
        Xr(t[n], t[s]) > e && (i.push(t[n]), s = n);
      return s < c - 1 && i.push(t[c - 1]), i;
    }
    var eo;
    function io(t, e, i, n, s) {
      var c = n ? eo : Wt(t, i), f = Wt(e, i), p, g, _;
      for (eo = f; ; ) {
        if (!(c | f))
          return [t, e];
        if (c & f)
          return !1;
        p = c || f, g = ze(t, e, p, i, s), _ = Wt(g, i), p === c ? (t = g, c = _) : (e = g, f = _);
      }
    }
    function ze(t, e, i, n, s) {
      var c = e.x - t.x, f = e.y - t.y, p = n.min, g = n.max, _, A;
      return i & 8 ? (_ = t.x + c * (g.y - t.y) / f, A = g.y) : i & 4 ? (_ = t.x + c * (p.y - t.y) / f, A = p.y) : i & 2 ? (_ = g.x, A = t.y + f * (g.x - t.x) / c) : i & 1 && (_ = p.x, A = t.y + f * (p.x - t.x) / c), new O(_, A, s);
    }
    function Wt(t, e) {
      var i = 0;
    ...
    function we(t, e, i, n) {
      var s = e.x, c = e.y, f = i.x - s, p = i.y - c, g = f * f + p * p, _;
      return g > 0 && (_ = ((t.x - s) * f + (t.y - c) * p) / g, _ > 1 ? (s = i.x, c = i.y) : _ > 0 && (s += f * _, c += p * _)), f = t.x - s, p = t.y - c, n ? f * f + p * p : new O(s, c);
    }
    function _t(t) {
      return !B(t[0]) || typeof t[0][0] != "object" && typeof t[0][0] < "u";
    }
    function no(t) {
      return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), _t(t);
    }
    function oo(t, e) {
      var i, n, s, c, f, p, g, _;
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      _t(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var A = H([0, 0]), M = rt(t), N = M.getNorthWest().distanceTo(M.getSouthWest()) * M.getNorthEast().distanceTo(M.getNorthWest());
      N < 1700 && (A = Ii(t));
      var ft = t.length, ct = [];
      for (i = 0; i < ft; i++) {
        var bt = H(t[i]);
        ct.push(e.project(H([bt.lat - A.lat, bt.lng - A.lng])));
      }
      ...
      if (n === 0)
        ...
        for (i = 0, c = 0; i < ft - 1; i++)
          if (f = ct[i], p = ct[i + 1], s = f.distanceTo(p), c += s, c > n) {
            g = (c - n) / s, _ = [
              p.x - g * (p.x - f.x),
              p.y - g * (p.y - f.y)
            ];
      ...
      var gt = e.unproject(I(_));
      return H([gt.lat + A.lat, gt.lng + A.lng]);
    }
    var Qr = {
      __proto__: null,
      simplify: $n,
      pointToSegmentDistance: to,
      closestPointOnSegment: Yr,
      clipSegment: io,
      ...
      project: function(t) {
        var e = Math.PI / 180, i = this.R, n = t.lat * e, s = this.R_MINOR / i, c = Math.sqrt(1 - s * s), f = c * Math.sin(n), p = Math.tan(Math.PI / 4 - n / 2) / Math.pow((1 - f) / (1 + f), c / 2);
        return n = -i * Math.log(Math.max(p, 1e-10)), new O(t.lng * e * i, n);
      },
      unproject: function(t) {
        for (var e = 180 / Math.PI, i = this.R, n = this.R_MINOR / i, s = Math.sqrt(1 - n * n), c = Math.exp(-t.y / i), f = Math.PI / 2 - 2 * Math.atan(c), p = 0, g = 0.1, _; p < 15 && Math.abs(g) > 1e-7; p++)
          _ = s * Math.sin(f), _ = Math.pow((1 - _) / (1 + _), s / 2), g = Math.PI / 2 - 2 * Math.atan(c * _) - f, f += g;
    ...
    Rt.Earth = Dt, Rt.EPSG3395 = Jr, Rt.EPSG3857 = ci, Rt.EPSG900913 = rr, Rt.EPSG4326 = ro, Rt.Simple = $r;
    var Ct = jt.extend({
    ...
    var xe = re.extend({
      ...
      _getIconUrl: function(t) {
        return typeof xe.imagePath != "string" && (xe.imagePath = this._detectIconPath()), (this.options.imagePath || xe.imagePath) + re.prototype._getIconUrl.call(this, t);
      },
      ...
      _detectIconPath: function() {
        var t = j("div", "leaflet-default-icon-path", document.body), e = me(t, "background-image") || me(t, "backgroundImage");
      ...
      _adjustPan: function(t) {
        var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, s = this._marker.options.autoPanPadding, c = qt(e._icon), f = i.getPixelBounds(), p = i.getPixelOrigin(), g = pt(
          f.min._subtract(p).add(s),
          f.max._subtract(p).subtract(s)
        );
        if (!g.contains(c)) {
          var _ = I(
            (Math.max(g.max.x, c.x) - g.max.x) / (f.max.x - g.max.x) - (Math.min(g.min.x, c.x) - g.min.x) / (f.min.x - g.min.x),
            (Math.max(g.max.y, c.y) - g.max.y) / (f.max.y - g.max.y) - (Math.min(g.min.y, c.y) - g.min.y) / (f.min.y - g.min.y)
          ).multiplyBy(n);
          i.panBy(_, { animate: !1 }), this._draggable._newPos._add(_), this._draggable._startPos._add(_), st(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = X(this._adjustPan.bind(this, t));
        }
      },
      ...
      _onPreDrag: function(t) {
        this._marker.options.autoPan && (it(this._panRequest), this._panRequest = X(this._adjustPan.bind(this, t)));
      },
      _onDrag: function(t) {
        var e = this._marker, i = e._shadow, n = qt(e._icon), s = e._map.layerPointToLatLng(n);
        i && st(i, n), e._latlng = s, t.latlng = s, t.oldLatLng = this._oldLatLng, e.fire("move", t).fire("drag", t);
      },
      ...
      _removeIcon: function() {
        this.options.riseOnHover && this.off({
          mouseover: this._bringToFront,
          mouseout: this._resetZIndex
        }), this.options.autoPanOnFocus && G(this._icon, "focus", this._panOnFocus, this), et(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null;
      },
      ...
      _initInteraction: function() {
        if (this.options.interactive && (D(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), so)) {
          var t = this.options.draggable;
          this.dragging && (t = this.dragging.enabled(), this.dragging.disable()), this.dragging = new so(this), t && this.dragging.enable();
        }
      },
      ...
      _updateOpacity: function() {
        ...
        this._icon && yt(this._icon, t), this._shadow && yt(this._shadow, t);
      },
    ...
    var Ht = Ct.extend({
      ...
      initialize: function(t, e) {
        C(this, e), this._latlng = H(t), this._radius = this.options.radius;
      },
      // @method setLatLng(latLng: LatLng): this
    ...
    var Di = Ne.extend({
      initialize: function(t, e, i) {
        if (typeof e == "number" && (e = l({}, i, { radius: e })), C(this, e), this._latlng = H(t), isNaN(this.options.radius))
      ...
      _project: function() {
        ...
        if (n.distance === Dt.distance) {
          var s = Math.PI / 180, c = this._mRadius / Dt.R / s, f = i.project([e + c, t]), p = i.project([e - c, t]), g = f.add(p).divideBy(2), _ = i.unproject(g).lat, A = Math.acos((Math.cos(c * s) - Math.sin(e * s) * Math.sin(_ * s)) / (Math.cos(e * s) * Math.cos(_ * s))) / s;
          (isNaN(A) || A === 0) && (A = c / Math.cos(Math.PI / 180 * e)), this._point = g.subtract(i.getPixelOrigin()), this._radius = isNaN(A) ? 0 : g.x - i.project([_, t - A]).x, this._radiusY = g.y - f.y;
        } else {
    ...
    var It = Ht.extend({
      ...
      closestLayerPoint: function(t) {
        for (var e = 1 / 0, i = null, n = we, s, c, f = 0, p = this._parts.length; f < p; f++)
          for (var g = this._parts[f], _ = 1, A = g.length; _ < A; _++) {
            s = g[_ - 1], c = g[_];
            var M = n(t, s, c, !0);
            M < e && (e = M, i = n(t, s, c));
          }
      ...
      getCenter: function() {
        ...
        return oo(this._defaultShape(), this._map.options.crs);
      },
      // @method getBounds(): LatLngBounds
      // Returns the `LatLngBounds` of the path.
      getBounds: function() {
      ...
      _convertLatLngs: function(t) {
        for (var e = [], i = _t(t), n = 0, s = t.length; n < s; n++)
      ...
      _clipPoints: function() {
        ...
        if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
          ...
          var e = this._parts, i, n, s, c, f, p, g;
          for (i = 0, s = 0, c = this._rings.length; i < c; i++)
            for (g = this._rings[i], n = 0, f = g.length; n < f - 1; n++)
              p = io(g[n], g[n + 1], t, n, !0), p && (e[s] = e[s] || [], e[s].push(p[0]), (p[1] !== g[n + 1] || n === f - 2) && (e[s].push(p[1]), s++));
        }
      },
      ...
      _containsPoint: function(t, e) {
        var i, n, s, c, f, p, g = this._clickTolerance();
        if (!this._pxBounds || !this._pxBounds.contains(t))
          return !1;
        for (i = 0, c = this._parts.length; i < c; i++)
          for (p = this._parts[i], n = 0, f = p.length, s = f - 1; n < f; s = n++)
            if (!(!e && n === 0) && to(t, p[s], p[n]) <= g)
              return !0;
        return !1;
      }
    });
    ...
    var se = It.extend({
      ...
      _setLatLngs: function(t) {
        It.prototype._setLatLngs.call(this, t), _t(this._latlngs) && (this._latlngs = [this._latlngs]);
      },
      _defaultShape: function() {
      ...
      _clipPoints: function() {
        ...
        if (t = new tt(t.min.subtract(i), t.max.add(i)), this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
          ...
          for (var n = 0, s = this._rings.length, c; n < s; n++)
            c = Kn(this._rings[n], t, !0), c.length && this._parts.push(c);
        }
      },
      _updatePath: function() {
      ...
      // Needed by the `Canvas` renderer for interactivity
      _containsPoint: function(t) {
        var e = !1, i, n, s, c, f, p, g, _;
        if (!this._pxBounds || !this._pxBounds.contains(t))
          return !1;
        for (c = 0, g = this._parts.length; c < g; c++)
          for (i = this._parts[c], f = 0, _ = i.length, p = _ - 1; f < _; p = f++)
            n = i[f], s = i[p], n.y > t.y != s.y > t.y && t.x < (s.x - n.x) * (t.y - n.y) / (s.y - n.y) + n.x && (e = !e);
    ...
    var Bt = kt.extend({
      ...
      addData: function(t) {
        ...
        if (c.filter && !c.filter(t))
          return this;
        var f = He(t, c);
        return f ? (f.feature = je(t), f.defaultOptions = f.options, this.resetStyle(f), c.onEachFeature && c.onEachFeature(t, f), this.addLayer(f)) : this;
      },
    ...
    function He(t, e) {
      var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, s = [], c = e && e.pointToLayer, f = e && e.coordsToLatLng || Ni, p, g, _, A;
      if (!n && !i)
        return null;
      switch (i.type) {
        case "Point":
          return p = f(n), ao(c, t, p, e);
        case "MultiPoint":
          for (_ = 0, A = n.length; _ < A; _++)
            p = f(n[_]), s.push(ao(c, t, p, e));
          return new kt(s);
        case "LineString":
        case "MultiLineString":
          return g = Ze(n, i.type === "LineString" ? 0 : 1, f), new It(g, e);
        case "Polygon":
        case "MultiPolygon":
          return g = Ze(n, i.type === "Polygon" ? 1 : 2, f), new se(g, e);
        case "GeometryCollection":
          for (_ = 0, A = i.geometries.length; _ < A; _++) {
            var M = He({
        ...
        case "FeatureCollection":
          for (_ = 0, A = i.features.length; _ < A; _++) {
            var N = He(i.features[_], e);
            N && s.push(N);
          }
          return new kt(s);
        default:
    ...
    function Ze(t, e, i) {
      for (var n = [], s = 0, c = t.length, f; s < c; s++)
        f = e ? Ze(t[s], e - 1, i) : (i || Ni)(t[s]), n.push(f);
      return n;
    }
    function Hi(t, e) {
      return t = H(t), t.alt !== void 0 ? [P(t.lng, e), P(t.lat, e), P(t.alt, e)] : [P(t.lng, e), P(t.lat, e)];
    }
    function Fe(t, e, i, n) {
      for (var s = [], c = 0, f = t.length; c < f; c++)
        s.push(e ? Fe(t[c], _t(t[c]) ? 0 : e - 1, i, n) : Hi(t[c], n));
      return !e && i && s.length > 0 && s.push(s[0].slice()), s;
    }
    function ae(t, e) {
      return t.feature ? l({}, t.feature, { geometry: e }) : je(e);
    }
    function je(t) {
    ...
    De.include(Zi), Di.include(Zi), Ne.include(Zi), It.include({
      toGeoJSON: function(t) {
        var e = !_t(this._latlngs), i = Fe(this._latlngs, e ? 1 : 0, !1, t);
        return ae(this, {
      ...
      toGeoJSON: function(t) {
        var e = !_t(this._latlngs), i = e && !_t(this._latlngs[0]), n = Fe(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
        return e || (n = [n]), ae(this, {
    ...
    var hs = ho, Ue = Ct.extend({
      ...
      initialize: function(t, e, i) {
        this._url = t, this._bounds = rt(e), C(this, i);
      },
      onAdd: function() {
      ...
      setBounds: function(t) {
        return this._bounds = rt(t), this._map && this._reset(), this;
      },
      getEvents: function() {
        var t = {
          zoom: this._reset,
    ...
    var Tt = Ct.extend({
      ...
      initialize: function(t, e) {
        t && (t instanceof W || B(t)) ? (this._latlng = H(t), C(this, e)) : (C(this, t), this._source = e), this.options.content && (this._content = this.options.content);
      },
      ...
      onAdd: function(t) {
        this._zoomAnimated = t._zoomAnimated, this._container || this._initLayout(), t._fadeAnimated && yt(this._container, 0), clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), this.update(), t._fadeAnimated && yt(this._container, 1), this.bringToFront(), this.options.interactive && (D(this._container, "leaflet-interactive"), this.addInteractiveTarget(this._container));
      },
      onRemove: function(t) {
        t._fadeAnimated ? (yt(this._container, 0), this._removeTimeout = setTimeout(u(et, void 0, this._container), 200)) : et(this._container), this.options.interactive && (nt(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
      },
    ...
    var qe = Tt.extend({
      ...
      _initLayout: function() {
        ...
        if (this._contentNode = j("div", t + "-content", i), _e(e), Si(this._contentNode), z(e, "contextmenu", Vt), this._tipContainer = j("div", t + "-tip-container", e), this._tip = j("div", t + "-tip", this._tipContainer), this.options.closeButton) {
      ...
      _adjustPan: function() {
        if (this.options.autoPan) {
          ...
          var c = t.layerPointToContainerPoint(s), f = I(this.options.autoPanPadding), p = I(this.options.autoPanPaddingTopLeft || f), g = I(this.options.autoPanPaddingBottomRight || f), _ = t.getSize(), A = 0, M = 0;
          c.x + n + g.x > _.x && (A = c.x + n - _.x + g.x), c.x - A - p.x < 0 && (A = c.x - p.x), c.y + i + g.y > _.y && (M = c.y + i - _.y + g.y), c.y - M - p.y < 0 && (M = c.y - p.y), (A || M) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([A, M]));
        }
      },
      _getAnchor: function() {
    ...
    var Ve = Tt.extend({
      ...
      _initLayout: function() {
        ...
        this._contentNode = this._container = j("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + v(this));
      },
      _updateLayout: function() {
      },
      _adjustPan: function() {
      ...
      _setPosition: function(t) {
        var e, i, n = this._map, s = this._container, c = n.latLngToContainerPoint(n.getCenter()), f = n.layerPointToContainerPoint(t), p = this.options.direction, g = s.offsetWidth, _ = s.offsetHeight, A = I(this.options.offset), M = this._getAnchor();
        p === "top" ? (e = g / 2, i = _) : p === "bottom" ? (e = g / 2, i = 0) : p === "center" ? (e = g / 2, i = _ / 2) : p === "right" ? (e = 0, i = _ / 2) : p === "left" ? (e = g, i = _ / 2) : f.x < c.x ? (p = "right", e = 0, i = _ / 2) : (p = "left", e = g + (A.x + M.x) * 2, i = _ / 2), t = t.subtract(I(e, i, !0)).add(A).add(M), nt(s, "leaflet-tooltip-right"), nt(s, "leaflet-tooltip-left"), nt(s, "leaflet-tooltip-top"), nt(s, "leaflet-tooltip-bottom"), D(s, "leaflet-tooltip-" + p), st(s, t);
      },
      _updatePosition: function() {
    ...
    var Ce = Ct.extend({
      ...
      bringToBack: function() {
        return this._map && (ne(this._container), this._setAutoZIndex(Math.min)), this;
      },
      // @method getContainer: HTMLElement
        ...
        if (this._map && !T.ielt9) {
          ...
          for (var n in this._tiles) {
            ...
            if (!(!s.current || !s.loaded)) {
              ...
              yt(s.el, c), c < 1 ? e = !0 : (s.active ? i = !0 : this._onOpaqueTile(s), s.active = !0);
            }
          }
          i && !this._noPrune && this._pruneTiles(), e && (it(this._fadeFrame), this._fadeFrame = X(this._updateOpacity, this));
        }
      },
      _onOpaqueTile: w,
      ...
      _updateLevels: function() {
        ...
        if (t !== void 0) {
          ...
          return n || (n = this._levels[t] = {}, n.el = j("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = s.project(s.unproject(s.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, s.getCenter(), s.getZoom()), w(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n, n;
        }
      },
      _onUpdateLevel: w,
      _onRemoveLevel: w,
      ...
      _retainParent: function(t, e, i, n) {
        var s = Math.floor(t / 2), c = Math.floor(e / 2), f = i - 1, p = new O(+s, +c);
        p.z = +f;
        var g = this._tileCoordsToKey(p), _ = this._tiles[g];
        return _ && _.active ? (_.retain = !0, !0) : (_ && _.loaded && (_.retain = !0), f > n ? this._retainParent(s, c, f, n) : !1);
      },
      _retainChildren: function(t, e, i, n) {
        for (var s = 2 * t; s < 2 * t + 2; s++)
          for (var c = 2 * e; c < 2 * e + 2; c++) {
            var f = new O(s, c);
            f.z = i + 1;
            var p = this._tileCoordsToKey(f), g = this._tiles[p];
            if (g && g.active) {
              g.retain = !0;
              continue;
            } else
      ...
      _update: function(t) {
        ...
        if (e) {
          ...
          if (t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0) {
            var n = this._getTiledPixelBounds(t), s = this._pxBoundsToTileRange(n), c = s.getCenter(), f = [], p = this.options.keepBuffer, g = new tt(
              s.getBottomLeft().subtract([p, -p]),
              s.getTopRight().add([p, -p])
            );
            if (!(isFinite(s.min.x) && isFinite(s.min.y) && isFinite(s.max.x) && isFinite(s.max.y)))
              throw new Error("Attempted to load an infinite number of tiles");
            for (var _ in this._tiles) {
              var A = this._tiles[_].coords;
              (A.z !== this._tileZoom || !g.contains(new O(A.x, A.y))) && (this._tiles[_].current = !1);
            }
            ...
            if (f.sort(function(gt, le) {
              return gt.distanceTo(c) - le.distanceTo(c);
            }), f.length !== 0) {
              this._loading || (this._loading = !0, this.fire("loading"));
              var bt = document.createDocumentFragment();
              for (N = 0; N < f.length; N++)
                this._addTile(f[N], bt);
      ...
      _isValidTile: function(t) {
        ...
        return rt(this.options.bounds).overlaps(n);
      },
      ...
      _initTile: function(t) {
        ...
        t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = w, t.onmousemove = w, T.ielt9 && this.options.opacity < 1 && yt(t, this.options.opacity);
      },
      _addTile: function(t, e) {
        var i = this._getTilePos(t), n = this._tileCoordsToKey(t), s = this.createTile(this._wrapCoords(t), u(this._tileReady, this, t));
        this._initTile(s), this.createTile.length < 2 && X(u(this._tileReady, this, t, null, s)), st(s, i), this._tiles[n] = {
          el: s,
          coords: t,
          current: !0
      ...
      _tileReady: function(t, e, i) {
        ...
        i = this._tiles[n], i && (i.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (yt(i.el, 0), it(this._fadeFrame), this._fadeFrame = X(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (D(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
          tile: i.el,
          coords: t
        })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), T.ielt9 || !this._map._fadeAnimated ? X(this._pruneTiles, this) : setTimeout(u(this._pruneTiles, this), 250)));
      },
    ...
    var he = Ce.extend({
      ...
      getTileUrl: function(t) {
        ...
        return F(this._url, l(e, this.options));
      },
      ...
      _removeTile: function(t) {
        var e = this._tiles[t];
        if (e)
          return e.el.setAttribute("src", U), Ce.prototype._removeTile.call(this, t);
      },
      _tileReady: function(t, e, i) {
        if (!(!this._map || i && i.getAttribute("src") === U))
    ...
    var po = he.extend({
      ...
      onAdd: function(t) {
        ...
        this.wmsParams[e] = this._crs.code, he.prototype.onAdd.call(this, t);
      },
      getTileUrl: function(t) {
        var e = this._tileCoordsToNwSe(t), i = this._crs, n = pt(i.project(e[0]), i.project(e[1])), s = n.min, c = n.max, f = (this._wmsVersion >= 1.3 && this._crs === ro ? [s.y, s.x, c.y, c.x] : [s.x, s.y, c.x, c.y]).join(","), p = he.prototype.getTileUrl.call(this, t);
        return p + S(this.wmsParams, p, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + f;
      },
    ...
    var Ot = Ct.extend({
      ...
      initialize: function(t) {
        C(this, t), v(this), this._layers = this._layers || {};
      },
      onAdd: function() {
      ...
      _updateTransform: function(t, e) {
        ...
        T.any3d ? Ut(this._container, c, i) : st(this._container, c);
      },
      _reset: function() {
      ...
      _destroyContainer: function() {
        it(this._redrawRequest), delete this._ctx, et(this._container), G(this._container), delete this._container;
      },
      _updatePaths: function() {
      ...
      _update: function() {
        if (!(this._map._animatingZoom && this._bounds)) {
          ...
          st(e, t.min), e.width = n * i.x, e.height = n * i.y, e.style.width = i.x + "px", e.style.height = i.y + "px", T.retina && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update");
        }
      },
      _reset: function() {
      ...
      _updatePoly: function(t, e) {
        if (this._drawing) {
          var i, n, s, c, f = t._parts, p = f.length, g = this._ctx;
          if (p) {
            for (g.beginPath(), i = 0; i < p; i++) {
              for (n = 0, s = f[i].length; n < s; n++)
                c = f[i][n], g[n ? "lineTo" : "moveTo"](c.x, c.y);
              e && g.closePath();
            }
    ...
    var Ae = function() {
      ...
      _initPath: function(t) {
        ...
        D(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = Ae("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[v(t)] = t;
      },
      _addPath: function(t) {
        var e = t._container;
      ...
      _removePath: function(t) {
        var e = t._container;
        et(e), t.removeInteractiveTarget(e), delete this._layers[v(t)];
      },
      _updateStyle: function(t) {
      ...
      _destroyContainer: function() {
        et(this._container), G(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
      },
      _update: function() {
        if (!(this._map._animatingZoom && this._bounds)) {
          Ot.prototype._update.call(this);
      ...
      _initPath: function(t) {
        ...
        t.options.className && D(e, t.options.className), t.options.interactive && D(e, "leaflet-interactive"), this._updateStyle(t), this._layers[v(t)] = t;
      },
      _addPath: function(t) {
        this._rootGroup || this._initContainer(), this._rootGroup.appendChild(t._path), t.addInteractiveTarget(t._path);
      },
      _removePath: function(t) {
        et(t._path), t.removeInteractiveTarget(t._path), delete this._layers[v(t)];
      },
      _updatePath: function(t) {
    ...
    Z.include({
      ...
      _createRenderer: function(t) {
        return this.options.preferCanvas && go(t) || vo(t);
      }
    });
    var yo = se.extend({
      initialize: function(t, e) {
        se.prototype.initialize.call(this, this._boundsToLatLngs(t), e);
      },
    ...
    Ee.create = Ye, Ee.pointsToPath = bn, Bt.geometryToLayer = He, Bt.coordsToLatLng = Ni, Bt.coordsToLatLngs = Ze, Bt.latLngToCoords = Hi, Bt.latLngsToCoords = Fe, Bt.getFeature = ae, Bt.asFeature = je, Z.mergeOptions({
    ...
    var _o = Lt.extend({
      ...
      _onMouseDown: function(t) {
        if (!t.shiftKey || t.which !== 1 && t.button !== 1)
          return !1;
        this._clearDeferredResetState(), this._resetState(), ge(), wi(), this._startPoint = this._map.mouseEventToContainerPoint(t), z(document, {
          contextmenu: Yt,
      ...
      _onMouseMove: function(t) {
        this._moved || (this._moved = !0, this._box = j("div", "leaflet-zoom-box", this._container), D(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
      ...
      _finish: function() {
        this._moved && (et(this._box), nt(this._container, "leaflet-crosshair")), ve(), xi(), G(document, {
          contextmenu: Yt,
          mousemove: this._onMouseMove,
          mouseup: this._onMouseUp,
          keydown: this._onKeyDown
    ...
    Z.addInitHook("addHandler", "boxZoom", _o), Z.mergeOptions({
    ...
    Z.addInitHook("addHandler", "doubleClickZoom", bo), Z.mergeOptions({
    ...
    var wo = Lt.extend({
      ...
      _onDragStart: function() {
        ...
        if (t._stop(), this._map.options.maxBounds && this._map.options.maxBoundsViscosity) {
          var e = rt(this._map.options.maxBounds);
      ...
      _onDragEnd: function(t) {
        ...
        if (e.fire("dragend", t), n)
          ...
          var s = this._lastPos.subtract(this._positions[0]), c = (this._lastTime - this._times[0]) / 1e3, f = i.easeLinearity, p = s.multiplyBy(f / c), g = p.distanceTo([0, 0]), _ = Math.min(i.inertiaMaxSpeed, g), A = p.multiplyBy(_ / g), M = _ / (i.inertiaDeceleration * f), N = A.multiplyBy(-M / 2).round();
          !N.x && !N.y ? e.fire("moveend") : (N = e._limitOffset(N, e.options.maxBounds), X(function() {
            e.panBy(N, {
              duration: M,
              easeLinearity: f,
              noMoveStart: !0,
    ...
    Z.addInitHook("addHandler", "keyboard", xo), Z.mergeOptions({
    ...
    Z.addInitHook("addHandler", "scrollWheelZoom", Co);
    var _s = 600;
    Z.mergeOptions({
    ...
    var Ao = Lt.extend({
      ...
      _onDown: function(t) {
        if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
          ...
          }, this), _s), z(document, "touchend touchcancel contextmenu", this._cancel, this), z(document, "touchmove", this._onMove, this);
        }
      },
      _cancelClickPrevent: function t() {
        G(document, "touchend", ut), G(document, "touchend touchcancel", t);
      },
      _cancel: function() {
    ...
    Z.addInitHook("addHandler", "tapHold", Ao), Z.mergeOptions({
      // @section Touch interaction options
    ...
    var Eo = Lt.extend({
      ...
      removeHooks: function() {
        nt(this._map._container, "leaflet-touch-zoom"), G(this._map._container, "touchstart", this._onTouchStart, this);
      },
      ...
      _onTouchMove: function(t) {
        if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
          ...
          this._animRequest = X(f, this, !0), ut(t);
        }
      },
      _onTouchEnd: function() {
        ...
        this._zooming = !1, it(this._animRequest), G(document, "touchmove", this._onTouchMove, this), G(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom));
      }
    });
    Z.addInitHook("addHandler", "touchZoom", Eo), Z.BoxZoom = _o, Z.DoubleClickZoom = bo, Z.Drag = wo, Z.Keyboard = xo, Z.ScrollWheelZoom = Co, Z.TapHold = Ao, Z.TouchZoom = Eo, o.Bounds = tt, o.Browser = T, o.CRS = Rt, o.Canvas = mo, o.Circle = Di, o.CircleMarker = Ne, o.Class = J, o.Control = xt, o.DivIcon = uo, o.DivOverlay = Tt, o.DomEvent = Dr, o.DomUtil = Or, o.Draggable = Nt, o.Evented = jt, o.FeatureGroup = kt, o.GeoJSON = Bt, o.GridLayer = Ce, o.Handler = Lt, o.Icon = re, o.ImageOverlay = Ue, o.LatLng = W, o.LatLngBounds = mt, o.Layer = Ct, o.LayerGroup = oe, o.LineUtil = Qr, o.Map = Z, o.Marker = De, o.Mixin = qr, o.Path = Ht, o.Point = O, o.PolyUtil = Vr, o.Polygon = se, o.Polyline = It, o.Popup = qe, o.PosAnimation = Wn, o.Projection = Kr, o.Rectangle = yo, o.Renderer = Ot, o.SVG = Ee, o.SVGOverlay = co, o.TileLayer = he, o.Tooltip = Ve, o.Transformation = li, o.Util = ht, o.VideoOverlay = lo, o.bind = u, o.bounds = pt, o.canvas = go, o.circle = rs, o.circleMarker = os, o.control = be, o.divIcon = ps, o.extend = l, o.featureGroup = es, o.geoJSON = ho, o.geoJson = hs, o.gridLayer = ms, o.icon = is, o.imageOverlay = ls, o.latLng = H, o.latLngBounds = rt, o.layerGroup = ts, o.map = Nr, o.marker = ns, o.point = I, o.polygon = as, o.polyline = ss, o.popup = ds, o.rectangle = ys, o.setOptions = C, o.stamp = v, o.svg = vo, o.svgOverlay = us, o.tileLayer = fo, o.tooltip = fs, o.transformation = de, o.version = h, o.videoOverlay = cs;
    var bs = window.L;
...
var At = Ji.exports;
const ei = /* @__PURE__ */ Ho(At), Xo = /* @__PURE__ */ Rs({
  __proto__: null,
  default: ei
}, [At]);
function Jt() {
...
function ya(a, r) {
  a.prototype = Object.create(r.prototype), a.prototype.constructor = a, $i(a, r);
}
function $i(a, r) {
  return $i = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(o, h) {
...
var tn, ni = 13, en = 40, Qo = 38, _a = [ni, 27, en, Qo, 37, 39], ba = /* @__PURE__ */ function() {
  function a(o) {
    var h = this, l = o.handleSubmit, d = o.searchLabel, u = o.classNames, m = u === void 0 ? {} : u;
    this.container = void 0, this.form = void 0, this.input = void 0, this.handleSubmit = void 0, this.hasError = !1, this.container = zt("div", ii("geosearch", m.container)), this.form = zt("form", ["", m.form].join(" "), this.container, { autocomplete: "none", onClick: Pe, onDblClick: Pe, touchStart: Pe, touchEnd: Pe }), this.input = zt("input", ["glass", m.input].join(" "), this.form, { type: "text", placeholder: d || "search", onInput: this.onInput, onKeyUp: function(v) {
      return h.onKeyUp(v);
    }, onKeyPress: function(v) {
      return h.onKeyPress(v);
  ...
  function a(o) {
    var h = this, l = o.handleClick, d = o.classNames, u = d === void 0 ? {} : d, m = o.notFoundMessage;
    this.handleClick = void 0, this.selected = -1, this.results = [], this.container = void 0, this.resultItem = void 0, this.notFoundMessage = void 0, this.onClick = function(v) {
      if (typeof h.handleClick == "function") {
        var b = v.target;
        if (b && h.container.contains(b) && b.hasAttribute("data-key")) {
          var y = Number(b.getAttribute("data-key"));
          h.handleClick({ result: h.results[y] });
        }
      }
    }, this.handleClick = l, this.notFoundMessage = m ? zt("div", ii(u.notfound), void 0, { html: m }) : void 0, this.container = zt("div", ii("results", u.resultlist)), this.container.addEventListener("click", this.onClick, !0), this.resultItem = zt("div", ii(u.item));
  }
  var r = a.prototype;
  return r.render = function(o, h) {
    var l = this;
    o === void 0 && (o = []), this.clear(), o.forEach(function(d, u) {
      var m = l.resultItem.cloneNode(!0);
      m.setAttribute("data-key", "" + u), m.innerHTML = h({ result: d }), l.container.appendChild(m);
...
}(), Yi = { position: "topleft", style: "button", showMarker: !0, showPopup: !1, popupFormat: function(a) {
  return "" + a.result.label;
}, resultFormat: function(a) {
  return "" + a.result.label;
}, marker: { icon: Xo && At.Icon ? new At.Icon.Default() : void 0, draggable: !1 }, maxMarkers: 1, maxSuggestions: 5, retainZoomLevel: !1, animateZoom: !0, searchLabel: "Enter address", clearSearchLabel: "Clear search", notFoundMessage: "", messageHideDelay: 3e3, zoomLevel: 18, classNames: { container: "leaflet-bar leaflet-control leaflet-control-geosearch", button: "leaflet-bar-part leaflet-bar-part-single", resetButton: "reset", msgbox: "leaflet-bar message", form: "", input: "", resultlist: "", item: "", notfound: "leaflet-bar-notfound" }, autoComplete: !0, autoCompleteDelay: 250, autoClose: !1, keepResult: !1, updateMap: !0 }, xa = "Leaflet must be loaded before instantiating the GeoSearch control";
Jt({}, Yi), Jt({}, Yi.classNames);
(function(a) {
...
var Ca = /* @__PURE__ */ function() {
  ...
  return r.getParamString = function(o) {
    ...
    try {
      var h = this, l = h.endpoint({ query: o.query, type: tn.SEARCH });
...
var ce, Ea = /* @__PURE__ */ Aa(function a(r, o) {
  if (r === o)
    return !0;
...
class Qt {
  constructor({ apiKey: r, authReferrerPolicy: o, channel: h, client: l, id: d = "__googleMapsScriptId", language: u, libraries: m = [], mapIds: v, nonce: b, region: y, retries: w = 3, url: P = "https://maps.googleapis.com/maps/api/js", version: E }) {
    if (this.callbacks = [], this.done = !1, this.loading = !1, this.errors = [], this.apiKey = r, this.authReferrerPolicy = o, this.channel = h, this.client = l, this.id = d || "__googleMapsScriptId", this.language = u, this.libraries = m, this.mapIds = v, this.nonce = b, this.region = y, this.retries = w, this.url = P, this.version = E, Qt.instance) {
      if (!Ea(this.options, Qt.instance.options))
  ...
  setScript() {
    ...
    Object.keys(h).forEach((d) => !h[d] && delete h[d]), !((o = (r = window == null ? void 0 : window.google) === null || r === void 0 ? void 0 : r.maps) === null || o === void 0) && o.importLibrary || ((d) => {
      let u, m, v, b = "The Google Maps JavaScript API", y = "google", w = "importLibrary", P = "__ib__", E = document, x = window;
      x = x[y] || (x[y] = {});
      const C = x.maps || (x.maps = {}), S = /* @__PURE__ */ new Set(), R = new URLSearchParams(), F = () => u || (u = new Promise((B, Q) => {
        return U = this, ot = function* () {
          var q;
          for (v in yield m = E.createElement("script"), m.id = this.id, R.set("libraries", [...S] + ""), d)
            R.set(v.replace(/[A-Z]/g, (K) => "_" + K[0].toLowerCase()), d[v]);
          R.set("callback", y + ".maps." + P), m.src = this.url + "?" + R, C[P] = B, m.onerror = () => u = Q(Error(b + " could not load.")), m.nonce = this.nonce || ((q = E.querySelector("script[nonce]")) === null || q === void 0 ? void 0 : q.nonce) || "", E.head.append(m);
        }, new ((Y = void 0) || (Y = Promise))(function(q, K) {
          function vt(ht) {
            try {
              it(ot.next(ht));
            } catch (J) {
          ...
          function it(ht) {
            var J;
            ht.done ? q(ht.value) : (J = ht.value, J instanceof Y ? J : new Y(function(te) {
              te(J);
            })).then(vt, X);
          }
          it((ot = ot.apply(U, [])).next());
        });
        var U, Y, ot;
      }));
      C[w] ? console.warn(b + " only loads once. Ignoring:", d) : C[w] = (B, ...Q) => S.add(B) && F().then(() => C[w](B, ...Q));
    })(h);
...
var Pa = /* @__PURE__ */ function(a) {
  ...
  return o.endpoint = function(h) {
    ...
    return h.data.results.map(function(l) {
      var d = l.geometry.location.toJSON(), u = d.lat, m = d.lng, v = l.geometry.viewport.toJSON();
      return { x: m, y: u, label: l.formatted_address, bounds: [[v.south, v.west], [v.north, v.east]], raw: l };
    });
  }, o.search = function(h) {
    try {
      var l = function(m) {
        ...
        return Promise.resolve(m.geocode({ address: h.query }, function(v) {
          return { results: v };
        }).catch(function(v) {
          return v.code !== "ZERO_RESULTS" && console.error(v.code + ": " + v.message), { results: [] };
        })).then(function(v) {
          return d.parse({ data: v });
        });
      }, d = this, u = d.geocoder;
...
class un extends wt {
  constructor({ type: o, id: h, name: l, address: d, image_url: u, country: m, location: v, data: b }) {
    super();
    k(this, "map");
    this.setStyles({
    ...
    w.id = y, w.style.width = "100%", w.style.height = "100%", w.id = `onbotgo-mapContainer-${y}`, this.appendChild(w), new MutationObserver(function(E, x) {
      const C = document.getElementById(
        `onbotgo-mapContainer-${y}`
      );
      if (console.log("before find div"), C) {
        const S = new Pa({
          apiKey: "AIzaSyBCjdZlTczQqOpJw-XVw88hqyVsBfTi7k8"
        });
        console.log("after find div"), S.search({ query: d }).then(([R]) => {
          console.log(R), this.map = ei.map(w).setView(
            [
              (R == null ? void 0 : R.y) || -12.046064944817124,
              (R == null ? void 0 : R.x) || -77.04547005862791
            ],
            17
          ), ei.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
            maxZoom: 19,
            attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
          }).addTo(this.map), ei.marker([
            (R == null ? void 0 : R.y) || -12.046064944817124,
            (R == null ? void 0 : R.x) || -77.04547005862791
          ]).addTo(this.map);
        }), x.disconnect();
...
class dn extends wt {
  constructor(o, h = !1) {
    ...
    if (this.message = o, this.setStyles({
      ...
      alignItems: "center"
    }), this.innerHTML = this.renderHTML(oa, {
      type: o.type,
      fileType: o.fileType,
      file: o.file,
      message: o.message,
...
`, " ").replace(/\n/g, " "), o.fileType === "audio") {
    ...
    } else if (!o.fileType && o.type === "mapApiMessage") {
  ...
  handlePlayPause() {
    this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
      ...
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = ma;
    }), this.wavesurfer.on("pause", () => {
      this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
        this.wavesurfer.play();
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = Ki;
    });
  }
  setLoadingAnimation() {
  ...
  getAvatarMessage(o = "api", h = !1) {
    const l = new ue();
    let d;
    return o === "apiMessage" && !h ? d = Go : o === "userMessage" ? d = va : h && (d = ga), l.innerHTML = `<img src=${d} width="25" height="25" />`, l.setStyles({
      padding: "5px",
      marginRight: "10px",
      backgroundColor: lt.colors.primary,
      borderRadius: "100px",
...
class Sa {
  constructor() {
    ...
    k(this, "chatflowID", "");
    k(this, "welcomeMessage", "¡Hola! ¿En qué puedo ayudarte hoy?");
...
const V = new Sa(), Bo = async (a) => {
  const r = `${V.ssl ? "https" : "http"}://${V.botHost}`;
  return (await fetch(`${r}${V.projectPath}chat`, {
    headers: {
...
class fn extends wt {
  constructor() {
    ...
    k(this, "input");
    this.innerHTML = this.renderHTML(Ra, { sendIcon: Jo }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(ue.tag), this.input.style.fontFamily = lt.typography.primary, this.input.style.backgroundColor = "white", this.input.style.color = "black", this.setStyles(this.defaultStyles);
  }
  onSubmit(o) {
...
class pn extends HTMLElement {
  ...
  setScrollThumbHeight() {
    const o = this.shadowRoot.querySelector(
      ...
      ".custom-scrollbar__thumb"
    ), l = o.offsetHeight, d = this.targetEl.offsetHeight, u = this.targetEl.scrollHeight, m = d / u * l;
    h.style.height = `${m}px`;
    let v = !1, b;
    h.addEventListener("mousedown", (y) => {
      v = !0, b = y.clientY, this.preventContentHighlight("remove");
    }), document.addEventListener("mouseup", () => {
      v = !1, this.preventContentHighlight("add");
    }), document.addEventListener("mousemove", (y) => {
      if (!v)
        return;
      const w = y.clientY - b;
      b = y.clientY, this.targetEl.scrollTop += w * (u / l);
    });
  }
...
pn.tag = "onbotgo-customscrollbar";
const Ia = `<onbotgo-box\r
  style="\r
    padding: 20px;\r
...
`, za = ` <svg\r
  ...
  >\r
    ...
    >\r
      ...
      ></path>\r
    </svg>`, on = `<svg viewBox="-3 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    \r
    <defs>\r
\r
</defs>\r
...
</svg>`, zo = '<svg  style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M28,14H18V4c0-1.104-0.896-2-2-2s-2,0.896-2,2v10H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h10v10c0,1.104,0.896,2,2,2  s2-0.896,2-2V18h10c1.104,0,2-0.896,2-2S29.104,14,28,14z"/></svg>';
class rn {
}
k(rn, "messageHistoryId", {
...
const Da = async (a) => await fetch(`${V.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  ...
  (function(r, o) {
    ...
    o.defaults = {
      ...
      buildToast: function() {
        ...
        for (var m in this.options.style)
          u.style[m] = this.options.style[m];
        if (this.options.ariaLive && u.setAttribute("aria-live", this.options.ariaLive), this.options.node && this.options.node.nodeType === Node.ELEMENT_NODE)
          ...
          v.src = this.options.avatar, v.className = "toastify-avatar", this.options.position == "left" || this.options.positionLeft === !0 ? u.appendChild(v) : u.insertAdjacentElement("afterbegin", v);
        }
        if (this.options.close === !0) {
          ...
          b.type = "button", b.setAttribute("aria-label", "Close"), b.className = "toast-close", b.innerHTML = "&#10006;", b.addEventListener(
            "click",
            (function(S) {
              S.stopPropagation(), this.removeElement(this.toastElement), window.clearTimeout(this.toastElement.timeOutValue);
            }).bind(this)
          );
          var y = window.innerWidth > 0 ? window.innerWidth : screen.width;
          (this.options.position == "left" || this.options.positionLeft === !0) && y > 360 ? u.insertAdjacentElement("afterbegin", b) : u.appendChild(b);
        }
        ...
        if (typeof this.options.destination < "u" && u.addEventListener(
          "click",
          (function(S) {
            S.stopPropagation(), this.options.newWindow === !0 ? window.open(this.options.destination, "_blank") : window.location = this.options.destination;
          }).bind(this)
        ), typeof this.options.onClick == "function" && typeof this.options.destination > "u" && u.addEventListener(
          "click",
          (function(S) {
            S.stopPropagation(), this.options.onClick();
          }).bind(this)
        ), typeof this.options.offset == "object") {
          var P = l("x", this.options), E = l("y", this.options), x = this.options.position == "left" ? P : "-" + P, C = this.options.gravity == "toastify-top" ? E : "-" + E;
          u.style.transform = "translate(" + x + "," + C + ")";
        }
        return u;
      },
      ...
      showToast: function() {
        ...
        var m = o.defaults.oldestFirst ? u.firstChild : u.lastChild;
        return u.insertBefore(this.toastElement, m), o.reposition(), this.options.duration > 0 && (this.toastElement.timeOutValue = window.setTimeout(
          (function() {
      ...
      for (var u = {
        ...
        top: 15,
        bottom: 15
      }, b = document.getElementsByClassName("toastify"), y, w = 0; w < b.length; w++) {
        d(b[w], "toastify-top") === !0 ? y = "toastify-top" : y = "toastify-bottom";
        var P = b[w].offsetHeight;
        y = y.substr(9, y.length - 1);
        var E = 15, x = window.innerWidth > 0 ? window.innerWidth : screen.width;
        x <= 360 ? (b[w].style[y] = v[y] + "px", v[y] += P + E) : d(b[w], "toastify-left") === !0 ? (b[w].style[y] = u[y] + "px", u[y] += P + E) : (b[w].style[y] = m[y] + "px", m[y] += P + E);
      }
      return this;
    };
    function l(u, m) {
      return m.offset[u] ? isNaN(m.offset[u]) ? m.offset[u] : m.offset[u] + "px" : "0px";
    }
    function d(u, m) {
      return !u || typeof m != "string" ? !1 : !!(u.className && u.className.trim().split(/\s+/gi).indexOf(m) > -1);
    }
    return o.lib.init.prototype = o.lib, o;
  });
})($o);
var Na = $o.exports;
const Ha = /* @__PURE__ */ Ho(Na), Le = "onbotgo-chatcontainer";
class mn extends wt {
  constructor() {
    super();
  ...
  initMessagesWebsocket(o) {
    ...
    const l = `${`${V.ssl ? "wss" : "ws"}://${V.botHost}`}/messages/${o}/ws`;
    this.messagesWebsocket = new WebSocket(l), console.log(this.messagesWebsocket), this.messagesWebsocket.onmessage = (d) => {
      ...
      if (console.log("ON MESSAGE ", u), u.event === "incoming_message") {
        const m = u.data;
        this.addMessages(
          [{ message: m.content, type: "apiMessage" }],
          { updateScrollbar: !0 },
          !0
        );
      }
  ...
  onSubmit(o) {
    ...
    if (d.disabled = !0, this.getChild("#onbotgo-chatinput").style.backgroundColor = "rgba(239,239,239,.6)", this.chattingWith === "human_agent") {
      Ma({
        content: `${l.message}
${l.url}`,
        conversation_id: V.messageHistoryId,
        channel_id: V.chathubChannelId,
        sender: "user"
      }).finally(() => {
        var u;
        this.querySelector("input").focus(), (u = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || u.forEach((m) => m.remove()), d.disabled = !1;
      });
      return;
    }
    l.url.length ? l.url.forEach((u) => {
      Bo({
        ...
        var v, b;
        m != null && m.unique_id && (V.messageHistoryId = m.unique_id, this.initMessagesWebsocket(V.messageHistoryId)), (b = (v = m == null ? void 0 : m.data) == null ? void 0 : v.process) != null && b.length && m.data.process.forEach((y) => {
          this.addMessages([
            {
              type: y.role,
              name: y.name,
          ...
          { message: m.response, type: "apiMessage" }
        ]), m.thought && this.showBotThought(m.thought), m.redirect && (this.chattingWith = "human_agent"), m != null && m.cards && handleCardMessages(m.cards);
      }).catch((m) => console.log(m)).finally(() => {
        var m;
        (m = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || m.forEach((v) => v.remove()), this.updateScrollbar(), d.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", d.focus();
      });
    }) : Bo(l).then((u) => {
      var m, v;
      u != null && u.unique_id && (V.messageHistoryId = u.unique_id, this.initMessagesWebsocket(V.messageHistoryId)), (v = (m = u == null ? void 0 : u.data) == null ? void 0 : m.process) != null && v.length && u.data.process.forEach((b) => {
        this.addMessages([
          {
            type: b.role,
            name: b.name,
      ...
      ]), u.redirect && (this.chattingWith = "human_agent"), u.thought && this.showBotThought(u.thought), u != null && u.cards && handleCardMessages(u.cards);
    }).catch((u) => console.log(u)).finally(() => {
      var u;
      (u = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || u.forEach((m) => m.remove()), d.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", d.focus(), this.updateScrollbar();
    });
  }
  handleCardMessages(o) {
    o.forEach(() => {
      apiMessage.cards.type === "address" && apiMessage.cards.render_map === "background" && typeof V.callbacks.address == "function" && V.callbacks.address({
        ...apiMessage.cards,
        render_map: void 0
      }), apiMessage.cards.type === "address" && apiMessage.cards.render_map === "modal" && this.addMessages([{ ...apiMessage == null ? void 0 : apiMessage.cards, type: "mapApiMessage" }]);
    });
  }
  toggle() {
  ...
  showBotThought(o) {
    console.log(V.showThoughts), V.showThoughts && Ha({
      text: `<div style="display:flex;align-items:center;gap:10px"><img src="${Go}" width="30" height="30" /> ${o}</div>`,
      duration: 3e3,
      newWindow: !0,
      gravity: "bottom",
      escapeMarkup: !1,
  ...
  async attachFile(o) {
    ...
    try {
      ...
      .onbotgo-lds-ring div {
        ...
        width: 19px;
        height: 19px;
        border: 2px solid ${lt.colors.primary};
        border-radius: 50%;
        animation: onbotgo-lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;
        border-color: ${lt.colors.primary} transparent transparent transparent;
      }
  ...
  renderMessages(o, h = !1) {
    o.forEach(
      (l) => !["dataMessage"].includes(l.type) && this.messagesContainer.appendChild(new dn(l, h))
    );
  }
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(Ba, {
  ...
  render() {
    this.innerHTML = this.renderHTML(Ia, {
      logo: Oa,
      micIcon: za,
      paperclipIcon: Oo,
      attachedFiles: this.attachedFiles,
...
class sn extends wt {
  constructor() {
    ...
    const o = new ln(lt.customIcon), h = new mn();
...
function ja({ element: a, styles: r }) {
  const o = r.reduce(
    (d, u) => ({
      ...d,
      ...u
    ...
    {}
  ), h = document.createElement("style"), l = Va(o);
...
class er extends wt {
  constructor() {
    ...
    let h = "black";
    r === "primary" && (h = lt.colors.primary), r === "danger" && (h = "red"), o && (this.querySelector("svg").style.width = `calc(${o} - 16px)`, this.querySelector("svg").style.height = `calc(${o} - 16px)`, this.setStyles({ width: o, height: o })), this.setStyles({ color: h });
    const l = new ue();
    l.setStyles({
      backgroundColor: h,
      opacity: 0.2,
...
class nr extends wt {
  constructor() {
    ...
    const r = this.getAttribute("color"), o = this.getAttribute("size");
    let h = "black";
    r === "primary" && (h = lt.colors.primary), o && this.setStyles({ width: o, height: o }), this.setStyles({
...
nr.tag = Ga;
const Xa = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, Qa = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
function Do(a, r, o, h) {
  return new (o || (o = Promise))(function(l, d) {
    ...
    function v(b) {
      var y;
      b.done ? l(b.value) : (y = b.value, y instanceof o ? y : new o(function(w) {
        w(y);
      })).then(u, m);
    }
    v((h = h.apply(a, r || [])).next());
  });
}
class Ka {
  constructor() {
...
const $a = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class gn extends Ja {
  constructor(r) {
    var o;
  ...
  renderMicStream(r) {
    ...
    h.connect(l);
    const d = l.frequencyBinCount, u = new Float32Array(d), m = d / o.sampleRate;
    let v;
    const b = () => {
      l.getFloatTimeDomainData(u), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = !1, this.wavesurfer.load("", [u], m)), v = requestAnimationFrame(b);
    };
    return b(), () => {
      cancelAnimationFrame(v), h == null || h.disconnect(), o == null || o.close();
    };
  }
  startMic() {
  ...
  startRecording() {
    return Do(this, void 0, void 0, function* () {
      const r = this.stream || (yield this.startMic()), o = this.mediaRecorder || new MediaRecorder(r, { mimeType: this.options.mimeType || $a.find((l) => MediaRecorder.isTypeSupported(l)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
class or extends wt {
  ...
  render() {
    this.innerHTML = this.renderHTML(Xa, {
  ...
  initMic() {
    this.wavesurfer = ai.create({
      ...
      barHeight: 1,
      fillParent: !0
    }), this.recorder = this.wavesurfer.registerPlugin(gn.create());
  }
  startRecording() {
...
class nh {
  constructor({
    ...
    if (V.chatflowID = r, h && (V.projectPath = h), l && (V.botHost = l), d && (V.ssl = d), m && (V.welcomeMessage = m), y && (V.callbacks = y), [!1, !0].includes(b) && (V.showThoughts = b), V.chathubChannelId = o, !u)
      return;
    const { typography: w, colors: P, icon: E } = u;
    w && Object.keys(w).forEach(
      (x) => lt.typography[x] = w[x]
    ), P && Object.keys(P).forEach(
      (x) => lt.colors[x] = P[x]
    ), E && (lt.customIcon = E), v != null && v.active && (St.active = !0, St.number = v.number, St.position = v.position.toLowerCase(), St.msg = v.msg);
  }
  init() {
    ...
    const o = document.createElement("style");
    if (o.innerHTML = eh, r.prepend(o), document.body.appendChild(r), St.active) {
      const h = new Qi();
