...
var Gt = (r, t, e) => t in r ? Wt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var m = (r, t, e) => (Gt(r, typeof t != "symbol" ? t + "" : t, e), e);
class Zt {
  constructor() {
    m(this, "typography", {
...
const ee = {}, ne = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ee
}, Symbol.toStringTag, { value: "Module" })), kt = /* @__PURE__ */ te(ne);
var Et = new Function("return this")().Promise, it = !1;
try {
...
function Y(r, t, e) {
  for (var n in t)
    Ht(t, n) && (t[n] != null && typeof t[n] == "object" && (n === "storage" || n === "prefixes") && !e ? r[n] = Y(
      /*toObj[key] ||*/
      {},
      t[n]
    ) : r[n] = t[n]);
...
var F = /^async +/, X = /`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g, z = /'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g, J = /"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g, wt = /[.*+\-?^${}()|[\]\\]/g;
function K(r) {
  return wt.test(r) ? r.replace(wt, "\\$&") : r;
}
function ie(r, t) {
  t.rmWhitespace && (r = r.replace(/[\r\n]+/g, `
`).replace(/^\s+|\s+$/gm, "")), X.lastIndex = 0, z.lastIndex = 0, J.lastIndex = 0;
  var e = t.prefixes, n = [
    e.h,
    e.b,
    e.i,
  ...
  K(t.tags[1]) + ")", "g"), s = new RegExp("([^]*?)" + K(t.tags[0]) + "(-|_)?\\s*(" + n + ")?\\s*", "g"), i = 0, l = !1;
  function d(p, u) {
    var g = { f: [] }, f = 0, A = "c";
    u === "h" || u === "b" || u === "c" ? A = "n" : u === "r" && (g.raw = !0, u = "i");
    function y(Q) {
      var xt = r.slice(i, Q), k = xt.trim();
      if (A === "f")
        k === "safe" ? g.raw = !0 : t.async && F.test(k) ? (k = k.replace(F, ""), g.f.push([k, "", !0])) : g.f.push([k, ""]);
      else if (A === "fp")
        g.f[g.f.length - 1][1] += k;
      else if (A === "err") {
        if (k) {
          var Kt = xt.search(/\S/);
          D("invalid syntax", r, i + Kt);
        }
      } else
        g[A] = k;
      i = Q + 1;
    ...
    o.lastIndex = i;
    for (var C; (C = o.exec(r)) !== null; ) {
<<<<<<< HEAD
      var P = C[1], v = C[2], w = C[3], M = C[4], E = C[5], T = C.index;
=======
      var P = C[1], v = C[2], E = C[3], M = C[4], x = C[5], T = C.index;
>>>>>>> main
      if (P)
        P === "(" ? (f === 0 && (A === "n" ? (y(T), A = "p") : A === "f" && (y(T), A = "fp")), f++) : P === ")" ? (f--, f === 0 && A !== "c" && (y(T), A = "err")) : f === 0 && P === "|" ? (y(T), A = "f") : P === "=>" && (y(T), i += 1, A = "res");
      else if (v) {
        if (v === "/*") {
          var H = r.indexOf("*/", o.lastIndex);
          H === -1 && D("unclosed comment", r, C.index), o.lastIndex = H + 2;
        } else if (v === "'") {
          z.lastIndex = C.index;
          var I = z.exec(r);
          I ? o.lastIndex = z.lastIndex : D("unclosed string", r, C.index);
        } else if (v === '"') {
          J.lastIndex = C.index;
          var V = J.exec(r);
          V ? o.lastIndex = J.lastIndex : D("unclosed string", r, C.index);
        } else if (v === "`") {
          X.lastIndex = C.index;
          var B = X.exec(r);
          B ? o.lastIndex = X.lastIndex : D("unclosed string", r, C.index);
        }
<<<<<<< HEAD
      } else if (w)
        return y(T), i = T + C[0].length, s.lastIndex = i, l = E, M && u === "h" && (u = "s"), g.t = u, g;
=======
      } else if (E)
        return y(T), i = T + C[0].length, s.lastIndex = i, a = x, M && u === "h" && (u = "s"), g.t = u, g;
>>>>>>> main
    }
    return D("unclosed tag", r, p), g;
  }
  function c(p, u) {
    p.b = [], p.d = [];
    var g = !1, f = [];
    ...
    for (var y; (y = s.exec(r)) !== null; ) {
      var C = y[1], P = y[2], v = y[3] || "", E;
      for (var M in e)
        if (e[M] === v) {
          E = M;
          break;
...
<<<<<<< HEAD
      A(C, P), i = y.index + y[0].length, w || D("unrecognized tag type: " + v, r, i);
      var E = d(y.index, w), T = E.t;
=======
      A(C, P), i = y.index + y[0].length, E || D("unrecognized tag type: " + v, r, i);
      var x = d(y.index, E), T = x.t;
>>>>>>> main
      if (T === "h") {
        var H = E.n || "";
        t.async && F.test(H) && (E.a = !0, E.n = H.replace(F, "")), E = c(E), f.push(E);
      } else if (T === "c") {
        if (p.n === E.n)
          return g ? (g.d = f, p.b.push(g)) : p.d = f, p;
        D("Helper start and end don't match", r, y.index + y[0].length);
      } else if (T === "b") {
        g ? (g.d = f, p.b.push(g)) : p.d = f;
        var I = E.n || "";
        t.async && F.test(I) && (E.a = !0, E.n = I.replace(F, "")), g = E, f = [];
      } else if (T === "s") {
        var V = E.n || "";
        t.async && F.test(V) && (E.a = !0, E.n = V.replace(F, "")), f.push(E);
      } else
        f.push(E);
    }
    if (u)
      A(r.slice(i, r.length), !1), p.d = f;
    else
...
function Rt(r, t) {
  var e = ie(r, t), n = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + j(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function It(r, t, e, n, o, s) {
  var i = "{exec:" + (o ? "async " : "") + Dt(e, t, r) + ",params:[" + n + "]";
  return s && (i += ",name:'" + s + "'"), o && (i += ",async:true"), i += "}", i;
}
function se(r, t) {
  for (var e = "[", n = 0; n < r.length; n++) {
    var o = r[n];
    e += It(t, o.res || "", o.d, o.p || "", o.a, o.n), n < r.length && (e += ",");
  }
  return e += "]", e;
}
function Dt(r, t, e) {
...
function j(r, t) {
  ...
  for (e; e < n; e++) {
    ...
    if (typeof s == "string") {
      ...
      var l = s.t, d = s.c || "", c = s.f, a = s.n || "", h = s.p || "", b = s.res || "", p = s.b, u = !!s.a;
      if (l === "i") {
        t.defaultFilter && (d = "c.l('F','" + t.defaultFilter + "')(" + d + ")");
        var g = et(d, c);
        !s.raw && t.autoEscape && (g = "c.l('F','e')(" + g + ")"), o += "tR+=" + g + ";";
      } else if (l === "h")
        if (t.storage.nativeHelpers.get(a))
          o += t.storage.nativeHelpers.get(a)(s, t);
        else {
          var f = (u ? "await " : "") + "c.l('H','" + a + "')(" + It(t, b, s.d, h, u);
          p ? f += "," + se(p, t) : f += ",[]", f += ",c)", o += "tR+=" + et(f, c) + ";";
        }
      else
        l === "s" ? o += "tR+=" + et((u ? "await " : "") + "c.l('H','" + a + "')({params:[" + h + "]},[],c)", c) + ";" : l === "e" && (o += d + `
`);
    }
  }
  return o;
...
function Ft(r, t, e, n, o) {
  e(r[t], t).then(function(s) {
    n += s, t === r.length - 1 ? o(n) : Ft(r, t + 1, e, n, o);
  });
}
function Ot(r, t, e, n, o, s) {
  n(t[e], r[t[e]]).then(function(i) {
    o += i, e === t.length - 1 ? s(o) : Ot(r, t, e + 1, n, o, s);
  });
}
var ae = {
  "&": "&amp;",
...
function ce(r) {
  var t = String(r);
  return /[&<>"']/.test(t) ? t.replace(/[&<>"']/g, le) : t;
}
var de = new Z({}), pt = new Z({
  each: function(r, t) {
    var e = "", n = r.params[0];
    if (U("each", t, !1), r.async)
  ...
  foreach: function(r, t) {
    var e = r.params[0];
    if (U("foreach", t, !1), r.async)
      return new Promise(function(s) {
        Ot(e, Object.keys(e), 0, r.exec, "", s);
      });
    var n = "";
    for (var o in e)
      Ht(e, o) && (n += r.exec(o, e[o]));
    return n;
  },
  ...
  useScope: function(r, t) {
    return U("useScope", t, !1), r.exec(r.params[0]);
  }
}), he = new Z({
  if: function(r, t) {
    U("if", !1, r.f, !0);
  ...
  try: function(r, t) {
    if (U("try", !1, r.f, !0), !r.b || r.b.length !== 1 || r.b[0].n !== "catch")
  ...
  block: function(r, t) {
    U("block", r.b, r.f, !0);
    var e = "if(!" + t.varName + "[" + r.p + "]){tR+=(" + Dt(r.d, "", t) + ")()}else{tR+=" + t.varName + "[" + r.p + "]}";
    return e;
  }
}), ue = new Z({ e: ce }), st = {
  varName: "it",
...
function _(r, t) {
  var e = {};
  return Y(e, st), t && Y(e, t), r && Y(e, r), e.l.bind(e), e;
}
function gt(r, t) {
...
function ge(r, t) {
  ...
  else if (t.filename && (n = rt(r, t.filename), at.existsSync(n) && (e = n)), e || Array.isArray(o) && o.some(function(i) {
    return n = rt(r, i, !0), at.existsSync(n);
  }) && (e = n), !e)
    throw S('Could not find the include file "' + r + '"');
  return e;
}
function jt(r) {
  return at.readFileSync(r).toString().replace(pe, "");
}
function fe(r, t) {
  var e = _(t), n = jt(r);
  try {
...
function Ut(r, t) {
  var e = _({ filename: ge(r, t) }, t);
  return me(e);
}
function be(r, t, e) {
  if (t && t.length > 0)
    throw S("Helper 'includeFile' doesn't accept blocks");
  return Ut(r.params[0], e)(r.params[1], e);
}
function ye(r, t, e) {
  var n = r.params[1] || {};
  n.content = r.exec();
  ...
  return Ut(r.params[0], e)(n, e);
}
function ot(r, t) {
  var e;
  return t.cache && t.name && t.storage.templates.get(t.name) ? t.storage.templates.get(t.name) : (typeof r == "function" ? e = r : e = gt(r, t), t.cache && t.name && t.storage.templates.define(t.name, e), e);
}
function Ae(r, t, e, n) {
  var o = _(e || {});
  if (o.async) {
...
pt.define("includeFile", be);
pt.define("extendsFile", ye);
...
class ft extends L {
 ...
 allowed nodes: "svg", "i", "img"`), !1;
    for (let l = 0; l < e.childNodes.length; l++) {
      const d = (i = (s = e.childNodes[l]) == null ? void 0 : s.tagName) == null ? void 0 : i.toLowerCase();
...
}), xe = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
var Ee = globalThis && globalThis.__awaiter || function(r, t, e, n) {
  ...
  return new (e || (e = Promise))(function(s, i) {
    ...
    function c(a) {
      a.done ? s(a.value) : o(a.value).then(l, d);
    }
...
var Pt = globalThis && globalThis.__awaiter || function(r, t, e, n) {
  function o(s) {
    return s instanceof e ? s : new e(function(i) {
      i(s);
    });
...
function Pe(r, t, e) {
  ...
  return Pt(this, void 0, void 0, function* () {
    ...
    {
      const i = (n = s.clone().body) === null || n === void 0 ? void 0 : n.getReader(), l = Number((o = s.headers) === null || o === void 0 ? void 0 : o.get("Content-Length"));
      let d = 0;
      const c = (a, h) => Pt(this, void 0, void 0, function* () {
        if (a)
          return;
        d += (h == null ? void 0 : h.length) || 0;
        const b = Math.round(d / l * 100);
        return t(b), i == null ? void 0 : i.read().then(({ done: p, value: u }) => c(p, u));
      });
      i == null || i.read().then(({ done: a, value: h }) => c(a, h));
    }
    return s.blob();
  });
}
...
function Le(r, t, e, n, o = 5) {
  ...
  const i = (l) => {
    ...
    let d = l.clientX, c = l.clientY, a = !1;
    const h = (u) => {
      u.preventDefault(), u.stopPropagation();
      const g = u.clientX, f = u.clientY;
      if (a || Math.abs(g - d) >= o || Math.abs(f - c) >= o) {
        const { left: A, top: y } = r.getBoundingClientRect();
        a || (a = !0, e == null || e(d - A, c - y)), t(g - d, f - c, g - A, f - y), d = g, c = f;
      }
    }, b = (u) => {
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, n, o) {
    const s = t[0], i = t[1] || t[0], l = s.length, { width: d, height: c } = n.canvas, a = c / 2, h = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * h : 1, p = e.barGap ? e.barGap * h : e.barWidth ? b / 2 : 0, u = e.barRadius || 0, g = d / (b + p) / l, f = u && "roundRect" in n ? "roundRect" : "rect";
    n.beginPath();
    let A = 0, y = 0, C = 0;
    for (let P = 0; P <= l; P++) {
      const v = Math.round(P * g);
      if (v > A) {
        const E = Math.round(y * a * o), T = Math.round(C * a * o), H = E + T || 1;
        let I = a - E;
        e.barAlign === "top" ? I = 0 : e.barAlign === "bottom" && (I = c - H), n[f](A * (b + p), I, b, H, u), A = v, y = 0, C = 0;
      }
      const E = Math.abs(s[P] || 0), M = Math.abs(i[P] || 0);
      E > y && (y = E), M > C && (C = M);
    }
    n.fill(), n.closePath();
  }
  renderLineWaveform(t, e, n, o) {
    const s = (i) => {
      const l = t[i] || t[0], d = l.length, { height: c } = n.canvas, a = c / 2, h = n.canvas.width / d;
      n.moveTo(0, a);
      let b = 0, p = 0;
      for (let u = 0; u <= d; u++) {
        const g = Math.round(u * h);
        if (g > b) {
          const A = Math.round(p * a * o) || 1, y = a + A * (i === 0 ? -1 : 1);
          n.lineTo(b, y), b = g, p = 0;
        }
        const f = Math.abs(l[u] || 0);
        f > p && (p = f);
      }
      n.lineTo(b, a);
    };
  ...
  renderWaveform(t, e, n) {
    ...
    let o = e.barHeight || 1;
    if (e.normalize) {
      const s = Array.from(t[0]).reduce((i, l) => Math.max(i, Math.abs(l)), 0);
      o = s ? 1 / s : 1;
    }
  ...
  renderSingleCanvas(t, e, n, o, s, i, l, d) {
    const c = window.devicePixelRatio || 1, a = document.createElement("canvas"), h = t[0].length;
    a.width = Math.round(n * (i - s) / h), a.height = o * c, a.style.width = `${Math.floor(a.width / c)}px`, a.style.height = `${o}px`, a.style.left = `${Math.floor(s * n / c / h)}px`, l.appendChild(a);
    const b = a.getContext("2d");
    this.renderWaveform(t.map((g) => g.slice(s, i)), e, b);
    const p = a.cloneNode();
    d.appendChild(p);
    const u = p.getContext("2d");
    a.width > 0 && a.height > 0 && u.drawImage(a, 0, 0), u.globalCompositeOperation = "source-in", u.fillStyle = this.convertColorValues(e.progressColor), u.fillRect(0, 0, a.width, a.height);
  }
  renderChannel(t, e, n) {
    ...
    const { scrollLeft: l, scrollWidth: d, clientWidth: c } = this.scrollContainer, a = t[0].length, h = a / d;
    let b = Math.min($.MAX_CANVAS_WIDTH, c);
    if (e.barWidth || e.barGap) {
      const v = e.barWidth || 0.5, E = e.barGap || v / 2, M = v + E;
      b % M !== 0 && (b = Math.floor(b / M) * M);
    }
<<<<<<< HEAD
    const p = Math.floor(Math.abs(l) * h), u = Math.floor(p + b * h), g = u - p, f = (v, w) => {
      this.renderSingleCanvas(t, e, n, s, Math.max(0, v), Math.min(w, a), o, i);
    }, A = this.createDelay(), y = this.createDelay(), C = (v, w) => {
      f(v, w), v > 0 && A(() => {
        C(v - g, w - g);
      });
    }, P = (v, w) => {
      f(v, w), w < a && y(() => {
        P(v + g, w + g);
=======
    const p = Math.floor(Math.abs(a) * h), u = Math.floor(p + b * h), g = u - p, f = (v, E) => {
      this.renderSingleCanvas(t, e, n, s, Math.max(0, v), Math.min(E, l), o, i);
    }, A = this.createDelay(), y = this.createDelay(), C = (v, E) => {
      f(v, E), v > 0 && A(() => {
        C(v - g, E - g);
      });
    }, P = (v, E) => {
...
>>>>>>> main
  ...
  render(t) {
    ...
    if (this.wrapper.style.width = s ? "100%" : `${o}px`, this.scrollContainer.style.overflowX = this.isScrolling ? "auto" : "hidden", this.scrollContainer.classList.toggle("noScrollbar", !!this.options.hideScrollbar), this.cursor.style.backgroundColor = `${this.options.cursorColor || this.options.progressColor}`, this.cursor.style.width = `${this.options.cursorWidth}px`, this.options.splitChannels)
      for (let l = 0; l < t.numberOfChannels; l++) {
        const d = Object.assign(Object.assign({}, this.options), this.options.splitChannels[l]);
        this.renderChannel([t.getChannelData(l)], d, i);
      }
    else {
      const l = [t.getChannelData(0)];
      t.numberOfChannels > 1 && l.push(t.getChannelData(1)), this.renderChannel(l, this.options, i);
    }
  ...
  scrollIntoView(t, e = !1) {
    const { clientWidth: n, scrollLeft: o, scrollWidth: s } = this.scrollContainer, i = s * t, l = n / 2, d = e && this.options.autoCenter && !this.isDragging ? l : n;
    if (i > o + d || i < o)
      if (this.options.autoCenter && !this.isDragging) {
        const c = l / 20;
        i - (o + l) >= c && i < o + n ? this.scrollContainer.scrollLeft += c : this.scrollContainer.scrollLeft = i - l;
      } else
        this.isDragging ? this.scrollContainer.scrollLeft = i < o ? i - 10 : i - n + 10 : this.scrollContainer.scrollLeft = i;
    {
      const { scrollLeft: c } = this.scrollContainer, a = c / s, h = (c + n) / s;
...
class tt extends Me {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, ke, t), this.timer = new Be();
  ...
  loadAudio(t, e, n, o) {
    return W(this, void 0, void 0, function* () {
      if (this.emit("load", t), this.isPlaying() && this.pause(), this.decodedData = null, !e && !n) {
        ...
        e = yield Te.fetchBlob(t, s, this.options.fetchParams);
      }
      if (this.setSrc(t, e), n)
        ...
        })) || (yield Promise.resolve(0)), this.decodedData = St.createBuffer(n, o);
      else if (e) {
        const s = yield e.arrayBuffer();
        this.decodedData = yield St.decode(s, this.options.sampleRate);
      }
  ...
  exportPeaks({ channels: t = 1, maxLength: e = 8e3, precision: n = 1e4 } = {}) {
    ...
    for (let i = 0; i < o; i++) {
      const l = this.decodedData.getChannelData(i), d = Math.min(l.length, e), c = l.length / d, a = [];
      for (let h = 0; h < d; h++) {
        const b = Math.round(h * c), p = l[b];
        a.push(Math.round(p * n) / n);
      }
      s.push(a);
    }
    return s;
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
  ...
  handlePlayPause() {
    this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
      ...
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = He;
  ...
  getAvatarMessage(e = "api", n = !1) {
    const o = new N();
    let s;
    return e === "apiMessage" && !n ? s = Nt : e === "userMessage" ? s = De : n && (s = Ie), o.innerHTML = `<img src=${s} width="25" height="25" />`, o.setStyles({
      padding: "5px",
      marginRight: "10px",
...
class Oe {
  constructor() {
    m(this, "botHost", "endpoint-prod-chatgpt.mibot.cl:8080");
    m(this, "ssl", !0);
    ...
    m(this, "chathubChannelId", "");
    m(this, "projectPath", "/");
  }
}
<<<<<<< HEAD
const x = new Oe(), Tt = async (r) => {
  const t = `${x.ssl ? "https" : "http"}://${x.botHost}`;
  return (await fetch(`${t}${x.projectPath}chat`, {
    headers: {
...
=======
const w = new Oe(), Tt = async (r) => await fetch(`${w.gpt_url}${w.projectPath}chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), je = async (r) => await fetch(`${w.gpt_url}${w.projectPath}messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), Ue = `<input\r
>>>>>>> main
...
class yt extends L {
  constructor() {
    ...
    m(this, "input");
    this.innerHTML = this.renderHTML(Ue, { sendIcon: qt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(N.tag), this.input.style.fontFamily = R.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
class At extends HTMLElement {
  ...
  setScrollThumbHeight() {
    const e = this.shadowRoot.querySelector(
      ...
      ".custom-scrollbar__thumb"
    ), o = e.offsetHeight, s = this.targetEl.offsetHeight, i = this.targetEl.scrollHeight, l = s / i * o;
    n.style.height = `${l}px`;
    let d = !1, c;
    n.addEventListener("mousedown", (a) => {
      d = !0, c = a.clientY, this.preventContentHighlight("remove");
      ...
      if (!d)
        return;
      const h = a.clientY - c;
      c = a.clientY, this.targetEl.scrollTop += h * (i / o);
    });
  }
...
At.tag = "onbotgo-customscrollbar";
const qe = `<onbotgo-box\r
  style="\r
    padding: 20px;\r
...
<<<<<<< HEAD
const Xe = async (r) => await fetch(`${x.storage_url}/storage/upload`, {
=======
const Xe = async (r) => await fetch(`${w.storage_url}/storage/upload`, {
>>>>>>> main
  headers: {
    "Content-Type": "application/json"
  },
  ...
  (function(t, e) {
    ...
    e.defaults = {
      ...
      buildToast: function() {
        ...
        for (var l in this.options.style)
          i.style[l] = this.options.style[l];
        ...
        if (this.options.close === !0) {
          ...
          c.type = "button", c.setAttribute("aria-label", "Close"), c.className = "toast-close", c.innerHTML = "&#10006;", c.addEventListener(
            "click",
            (function(f) {
              f.stopPropagation(), this.removeElement(this.toastElement), window.clearTimeout(this.toastElement.timeOutValue);
            }).bind(this)
          );
          var a = window.innerWidth > 0 ? window.innerWidth : screen.width;
          (this.options.position == "left" || this.options.positionLeft === !0) && a > 360 ? i.insertAdjacentElement("afterbegin", c) : i.appendChild(c);
        }
        ...
        if (typeof this.options.destination < "u" && i.addEventListener(
          "click",
          (function(f) {
            f.stopPropagation(), this.options.newWindow === !0 ? window.open(this.options.destination, "_blank") : window.location = this.options.destination;
          }).bind(this)
        ), typeof this.options.onClick == "function" && typeof this.options.destination > "u" && i.addEventListener(
          "click",
          (function(f) {
            f.stopPropagation(), this.options.onClick();
          }).bind(this)
        ), typeof this.options.offset == "object") {
          var b = o("x", this.options), p = o("y", this.options), u = this.options.position == "left" ? b : "-" + b, g = this.options.gravity == "toastify-top" ? p : "-" + p;
          i.style.transform = "translate(" + u + "," + g + ")";
        }
        return i;
      },
      ...
      showToast: function() {
        ...
        var l = e.defaults.oldestFirst ? i.firstChild : i.lastChild;
        return i.insertBefore(this.toastElement, l), e.reposition(), this.options.duration > 0 && (this.toastElement.timeOutValue = window.setTimeout(
          (function() {
      ...
      for (var i = {
        ...
        top: 15,
        bottom: 15
      }, c = document.getElementsByClassName("toastify"), a, h = 0; h < c.length; h++) {
        s(c[h], "toastify-top") === !0 ? a = "toastify-top" : a = "toastify-bottom";
        var b = c[h].offsetHeight;
        a = a.substr(9, a.length - 1);
        var p = 15, u = window.innerWidth > 0 ? window.innerWidth : screen.width;
        u <= 360 ? (c[h].style[a] = d[a] + "px", d[a] += b + p) : s(c[h], "toastify-left") === !0 ? (c[h].style[a] = i[a] + "px", i[a] += b + p) : (c[h].style[a] = l[a] + "px", l[a] += b + p);
      }
      return this;
    };
    function o(i, l) {
      return l.offset[i] ? isNaN(l.offset[i]) ? l.offset[i] : l.offset[i] + "px" : "0px";
    }
    function s(i, l) {
      return !i || typeof l != "string" ? !1 : !!(i.className && i.className.trim().split(/\s+/gi).indexOf(l) > -1);
    }
    return e.lib.init.prototype = e.lib, e;
  });
})(Yt);
var ze = Yt.exports;
const Je = /* @__PURE__ */ $t(ze), q = "onbotgo-chatcontainer";
class Ct extends L {
  constructor() {
    super();
    m(this, "messagesHistory", [
      {
<<<<<<< HEAD
        message: x.welcomeMessage,
=======
        message: w.welcomeMessage,
>>>>>>> main
        type: "apiMessage"
      },
    ...
    m(this, "messagesWebsocket");
    m(this, "chattingWith", "virtual_assistant");
...
<<<<<<< HEAD
    const o = `${`${x.ssl ? "wss" : "ws"}://${x.botHost}`}/messages/${e}/ws`;
    this.messagesWebsocket = new WebSocket(o), console.log(this.messagesWebsocket), this.messagesWebsocket.onmessage = (s) => {
      ...
      if (console.log("ON MESSAGE ", i), i.event === "incoming_message") {
        const l = i.data;
=======
    const n = `wss://endpoint-prod-chatgpt.mibot.cl:8080${w.projectPath}messages/${e}/ws`;
    this.messagesWebsocket = new WebSocket(n), console.log(this.messagesWebsocket), this.messagesWebsocket.onmessage = (o) => {
      const s = JSON.parse(o.data);
      if (console.log("ON MESSAGE ", s), s.event === "incoming_message") {
        const i = s.data;
>>>>>>> main
        this.addMessages(
          [{ message: l.content, type: "apiMessage" }],
          { updateScrollbar: !0 },
          !0
        );
      }
...
${o.url}`,
<<<<<<< HEAD
        conversation_id: x.messageHistoryId,
        channel_id: x.chathubChannelId,
=======
        conversation_id: w.messageHistoryId,
        channel_id: w.chathubChannelId,
>>>>>>> main
        sender: "user"
      }).finally(() => {
        var i;
        this.querySelector("input").focus(), (i = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || i.forEach((l) => l.remove());
      });
      return;
    }
    o.url.length ? o.url.forEach((i) => {
      Tt({
        ...
        var d, c;
<<<<<<< HEAD
        l != null && l.unique_id && (x.messageHistoryId = l.unique_id, this.initMessagesWebsocket(x.messageHistoryId)), (c = (d = l == null ? void 0 : l.data) == null ? void 0 : d.process) != null && c.length && l.data.process.forEach((a) => {
=======
        a != null && a.unique_id && (w.messageHistoryId = a.unique_id, this.initMessagesWebsocket(w.messageHistoryId)), (c = (d = a == null ? void 0 : a.data) == null ? void 0 : d.process) != null && c.length && a.data.process.forEach((l) => {
>>>>>>> main
          this.addMessages([
            {
              type: a.role,
          ...
          { message: l.response, type: "apiMessage" }
        ]), l.thought && this.showBotThought(l.thought), l.redirect && (this.chattingWith = "human_agent");
      }).catch((l) => console.log(l)).finally(() => {
        var l;
        (l = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || l.forEach((d) => d.remove()), this.updateScrollbar(), s.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", s.focus();
      });
    }) : Tt(o).then((i) => {
<<<<<<< HEAD
      var l, d;
      i != null && i.unique_id && (x.messageHistoryId = i.unique_id, this.initMessagesWebsocket(x.messageHistoryId)), (d = (l = i == null ? void 0 : i.data) == null ? void 0 : l.process) != null && d.length && i.data.process.forEach((c) => {
=======
      var a, d;
      i != null && i.unique_id && (w.messageHistoryId = i.unique_id, this.initMessagesWebsocket(w.messageHistoryId)), (d = (a = i == null ? void 0 : i.data) == null ? void 0 : a.process) != null && d.length && i.data.process.forEach((c) => {
>>>>>>> main
        this.addMessages([
          {
            type: c.role,
      ...
      var i;
      (i = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || i.forEach((l) => l.remove()), s.disabled = !1, this.getChild("#onbotgo-chatinput").style.backgroundColor = "white", s.focus(), this.updateScrollbar();
    });
  }
  toggle() {
  ...
  showBotThought(e) {
    Je({
      text: `<div style="display:flex;align-items:center;gap:10px"><img src="${Nt}" width="30" height="30" /> ${e}</div>`,
      duration: 6500,
      newWindow: !0,
      gravity: "bottom",
      escapeMarkup: !1,
  ...
  renderMessages(e, n = !1) {
    e.forEach(
      (o) => !["dataMessage"].includes(o.type) && this.messagesContainer.appendChild(new bt(o, n))
    );
  }
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(Ye, {
...
class ut extends L {
  constructor() {
    ...
    const e = new ft(R.customIcon), n = new Ct();
...
function Ge({ element: r, styles: t }) {
  const e = t.reduce(
    (s, i) => ({
      ...s,
      ...i
    ...
    {}
  ), n = document.createElement("style"), o = $e(e);
...
zt.tag = nn;
const rn = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, on = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
function Bt(r, t, e, n) {
  return new (e || (e = Promise))(function(o, s) {
    ...
    function d(c) {
      var a;
      c.done ? o(c.value) : (a = c.value, a instanceof e ? a : new e(function(h) {
        h(a);
      })).then(i, l);
    }
...
const ln = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class vt extends an {
  constructor(t) {
    var e;
  ...
  renderMicStream(t) {
    ...
    n.connect(o);
    const s = o.frequencyBinCount, i = new Float32Array(s), l = s / e.sampleRate;
    let d;
    const c = () => {
      o.getFloatTimeDomainData(i), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = !1, this.wavesurfer.load("", [i], l)), d = requestAnimationFrame(c);
    };
    return c(), () => {
  ...
  startRecording() {
    return Bt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || ln.find((o) => MediaRecorder.isTypeSupported(o)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
class Jt extends L {
  ...
  render() {
    this.innerHTML = this.renderHTML(rn, {
  ...
  initMic() {
    this.wavesurfer = tt.create({
      ...
      barHeight: 1,
      fillParent: !0
    }), this.recorder = this.wavesurfer.registerPlugin(vt.create());
  }
  startRecording() {
...
<<<<<<< HEAD
    if (x.chatflowID = t, n && (x.projectPath = n), o && (x.botHost = o), s && (x.ssl = s), l && (x.welcomeMessage = l), x.chathubChannelId = e, !i)
=======
    if (w.chatflowID = t, n && (w.projectPath = n), w.chathubChannelId = e, s && (w.welcomeMessage = s), !o)
>>>>>>> main
      return;
    const { typography: d, colors: c, icon: a } = i;
    d && Object.keys(d).forEach(
      (h) => R.typography[h] = d[h]
  ...
  init() {
    ...
    const e = document.createElement("style");
    e.innerHTML = dn, t.prepend(e), document.body.appendChild(t);
  }
