...
`).replace(/^\s+|\s+$/gm, "")), Ge.lastIndex = 0, Xe.lastIndex = 0, Qe.lastIndex = 0;
  ...
  function v(E, C) {
    var x = { f: [] }, R = 0, H = "c";
    C === "h" || C === "b" || C === "c" ? H = "n" : C === "r" && (x.raw = !0, C = "i");
    function S(J) {
    ...
    for (var B; (B = l.exec(a)) !== null; ) {
      ...
      if (G)
        G === "(" ? (R === 0 && (H === "n" ? (S(K), H = "p") : H === "f" && (S(K), H = "fp")), R++) : G === ")" ? (R--, R === 0 && H !== "c" && (S(K), H = "err")) : R === 0 && G === "|" ? (S(K), H = "f") : G === "=>" && (S(K), u += 1, H = "res");
      else if (F) {
        if (F === "/*") {
        ...
        return S(K), u = K + B[0].length, d.lastIndex = u, m = Y, rt && C === "h" && (C = "s"), x.t = C, x;
    }
  ...
  function _(E, C) {
    ...
    for (var S; (S = d.exec(a)) !== null; ) {
      ...
      H(B, G), u = S.index + S[0].length, V || Zt("unrecognized tag type: " + F, a, u);
      var Y = v(S.index, V), K = Y.t;
      if (K === "h") {
        var vt = Y.n || "";
...
function Xt(a, r) {
  ...
  for (o; o < h; o++) {
    ...
    if (typeof d == "string") {
      ...
      var m = d.t, v = d.c || "", _ = d.f, y = d.n || "", w = d.p || "", P = d.res || "", E = d.b, C = !!d.a;
      if (m === "i") {
        ...
        m === "s" ? l += "tR+=" + ji((C ? "await " : "") + "c.l('H','" + y + "')({params:[" + w + "]},[],c)", _) + ";" : m === "e" && (l += v + `
`);
    }
  }
  return l;
...
function pa(a, r, o, h, l = 5) {
  ...
  const u = (m) => {
    ...
    let v = m.clientX, _ = m.clientY, y = !1;
    const w = (C) => {
      C.preventDefault(), C.stopPropagation();
      const x = C.clientX, R = C.clientY;
      if (y || Math.abs(x - v) >= l || Math.abs(R - _) >= l) {
        const { left: H, top: S } = a.getBoundingClientRect();
        y || (y = !0, o == null || o(v - H, _ - S)), r(x - v, R - _, x - H, R - S), v = x, _ = R;
      }
    }, P = (C) => {
...
class si extends dn {
  ...
  renderBarWaveform(r, o, h, l) {
    const d = r[0], u = r[1] || r[0], m = d.length, { width: v, height: _ } = h.canvas, y = _ / 2, w = window.devicePixelRatio || 1, P = o.barWidth ? o.barWidth * w : 1, E = o.barGap ? o.barGap * w : o.barWidth ? P / 2 : 0, C = o.barRadius || 0, x = v / (P + E) / m, R = C && "roundRect" in h ? "roundRect" : "rect";
    h.beginPath();
    let H = 0, S = 0, B = 0;
    for (let G = 0; G <= m; G++) {
      ...
      if (F > H) {
        ...
        let Q = y - Y;
        o.barAlign === "top" ? Q = 0 : o.barAlign === "bottom" && (Q = _ - vt), h[R](H * (P + E), Q, P, vt, C), H = F, S = 0, B = 0;
      }
  ...
  renderLineWaveform(r, o, h, l) {
    const d = (u) => {
      const m = r[u] || r[0], v = m.length, { height: _ } = h.canvas, y = _ / 2, w = h.canvas.width / v;
      h.moveTo(0, y);
      let P = 0, E = 0;
      for (let C = 0; C <= v; C++) {
        const x = Math.round(C * w);
        if (x > P) {
          const H = Math.round(E * y * l) || 1, S = y + H * (u === 0 ? -1 : 1);
          h.lineTo(P, S), P = x, E = 0;
        }
        const R = Math.abs(m[C] || 0);
        R > E && (E = R);
      }
      h.lineTo(P, y);
    };
  ...
  renderSingleCanvas(r, o, h, l, d, u, m, v) {
    ...
    y.width = Math.round(h * (u - d) / w), y.height = l * _, y.style.width = `${Math.floor(y.width / _)}px`, y.style.height = `${l}px`, y.style.left = `${Math.floor(d * h / _ / w)}px`, m.appendChild(y);
  ...
  renderChannel(r, o, h) {
    ...
    const { scrollLeft: m, scrollWidth: v, clientWidth: _ } = this.scrollContainer, y = r[0].length, w = y / v;
    ...
    const E = Math.floor(Math.abs(m) * w), C = Math.floor(E + P * w), x = C - E, R = (F, V) => {
      this.renderSingleCanvas(r, o, h, d, Math.max(0, F), Math.min(V, y), l, u);
    }, H = this.createDelay(), S = this.createDelay(), B = (F, V) => {
      R(F, V), F > 0 && H(() => {
        B(F - x, V - x);
      });
    }, G = (F, V) => {
  ...
  scrollIntoView(r, o = !1) {
    ...
    if (u > l + v || u < l)
      if (this.options.autoCenter && !this.isDragging) {
        const _ = m / 20;
        u - (l + m) >= _ && u < l + h ? this.scrollContainer.scrollLeft += _ : this.scrollContainer.scrollLeft = u - m;
      } else
...
class ai extends fa {
  ...
  exportPeaks({ channels: r = 1, maxLength: o = 8e3, precision: h = 1e4 } = {}) {
    ...
    for (let u = 0; u < l; u++) {
      const m = this.decodedData.getChannelData(u), v = Math.min(m.length, o), _ = m.length / v, y = [];
      for (let w = 0; w < v; w++) {
        const P = Math.round(w * _), E = m[P];
...
(function(a, r) {
  (function(o, h) {
    ...
    var H = /\{ *([\w_ -]+) *\}/g;
    function S(t, e) {
      return t.replace(H, function(i, n) {
        var s = e[n];
        if (s === void 0)
    ...
    function Ti(t, e, i, n) {
      ...
      !T.touchNative && T.pointer && e.indexOf("touch") === 0 ? c = Pr(t, e, c) : T.touch && e === "dblclick" ? c = Ir(t, c) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Li[e] || e, c, T.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (c = function(p) {
        p = p || window.event, Ri(t, p) && f(p);
    ...
    var Hr = {
      ...
      flyTo: function(t, e, i) {
        ...
        var p = Math.max(c.x, c.y), g = p * this.getZoomScale(f, e), b = s.distanceTo(n) || 1, A = 1.42, M = A * A;
        function N(ht) {
          var We = ht ? -1 : 1, Ls = ht ? g : p, Ts = g * g - p * p + We * M * M * b * b, Ss = 2 * Ls * M * b, Ui = Ts / Ss, Mo = Math.sqrt(Ui * Ui + 1) - Ui, Ms = Mo < 1e-9 ? -18 : Math.log(Mo);
          return Ms;
        }
        function ft(ht) {
        ...
        var gt = N(0);
        function ce(ht) {
          return p * (ct(gt) / ct(gt + A * ht));
        }
        function Cs(ht) {
          return p * (ct(gt) * wt(gt + A * ht) - ft(gt)) / M;
        }
        function As(ht) {
      ...
      panInside: function(t, e) {
        ...
        if (!p.contains(c)) {
          this._enforcingBounds = !0;
          var b = c.subtract(p.getCenter()), A = p.extend(c).getSize().subtract(g);
      ...
      getBoundsZoom: function(t, e, i) {
        t = st(t), i = I(i || [0, 0]);
        var n = this.getZoom() || 0, s = this.getMinZoom(), c = this.getMaxZoom(), f = t.getNorthWest(), p = t.getSouthEast(), g = this.getSize().subtract(i), b = pt(this.project(p, n), this.project(f, n)).getSize(), A = T.any3d ? this.options.zoomSnap : 1, M = g.x / b.x, N = g.y / b.y, ft = e ? Math.max(M, N) : Math.min(M, N);
      ...
      _fireDOMEvent: function(t, e, i) {
        ...
        if (s.length) {
          ...
          if (t.type !== "keypress" && t.type !== "keydown" && t.type !== "keyup") {
            var b = p.getLatLng && (!p._radius || p._radius <= 10);
            g.containerPoint = b ? this.latLngToContainerPoint(p.getLatLng()) : this.mouseEventToContainerPoint(t), g.layerPoint = this.containerPointToLayerPoint(g.containerPoint), g.latlng = b ? p.getLatLng() : this.layerPointToLatLng(g.layerPoint);
          }
          for (f = 0; f < s.length; f++)
            if (s[f].fire(e, g, !0), g.originalEvent._stopped || s[f].options.bubblingMouseEvents === !1 && G(this._mouseEvents, e) !== -1)
              return;
        }
      },
    ...
    function $n(t, e, i) {
      var n, s = [1, 4, 2, 8], c, f, p, g, b, A, M, N;
      for (c = 0, A = t.length; c < A; c++)
        t[c]._code = Wt(t[c], e);
      for (p = 0; p < 4; p++) {
        for (M = s[p], n = [], c = 0, A = t.length, f = A - 1; c < A; f = c++)
          g = t[c], b = t[f], g._code & M ? b._code & M || (N = ze(b, g, M, e, i), N._code = Wt(N, e), n.push(N)) : (b._code & M && (N = ze(b, g, M, e, i), N._code = Wt(N, e), n.push(N)), n.push(g));
        t = n;
      }
      return t;
    }
    function to(t, e) {
      var i, n, s, c, f, p, g, b, A;
      if (!t || t.length === 0)
      ...
      for (p = g = b = 0, i = 0, n = ct - 1; i < ct; n = i++)
        s = wt[i], c = wt[n], f = s.y * c.x - c.y * s.x, g += (s.x + c.x) * f, b += (s.y + c.y) * f, p += f * 3;
      p === 0 ? A = wt[0] : A = [g / p, b / p];
    ...
    function oo(t, e, i, n, s) {
      var c = n ? no : Wt(t, i), f = Wt(e, i), p, g, b;
      for (no = f; ; ) {
        if (!(c | f))
          return [t, e];
        if (c & f)
          return !1;
        p = c || f, g = ze(t, e, p, i, s), b = Wt(g, i), p === c ? (t = g, c = b) : (e = g, f = b);
      }
    }
    function ze(t, e, i, n, s) {
      var c = e.x - t.x, f = e.y - t.y, p = n.min, g = n.max, b, A;
      return i & 8 ? (b = t.x + c * (g.y - t.y) / f, A = g.y) : i & 4 ? (b = t.x + c * (p.y - t.y) / f, A = p.y) : i & 2 ? (b = g.x, A = t.y + f * (g.x - t.x) / c) : i & 1 && (b = p.x, A = t.y + f * (p.x - t.x) / c), new O(b, A, s);
    }
    function Wt(t, e) {
      var i = 0;
    ...
    function we(t, e, i, n) {
      var s = e.x, c = e.y, f = i.x - s, p = i.y - c, g = f * f + p * p, b;
      return g > 0 && (b = ((t.x - s) * f + (t.y - c) * p) / g, b > 1 ? (s = i.x, c = i.y) : b > 0 && (s += f * b, c += p * b)), f = t.x - s, p = t.y - c, n ? f * f + p * p : new O(s, c);
    }
    function bt(t) {
    ...
    var Jr = {
      ...
      unproject: function(t) {
        for (var e = 180 / Math.PI, i = this.R, n = this.R_MINOR / i, s = Math.sqrt(1 - n * n), c = Math.exp(-t.y / i), f = Math.PI / 2 - 2 * Math.atan(c), p = 0, g = 0.1, b; p < 15 && Math.abs(g) > 1e-7; p++)
          b = s * Math.sin(f), b = Math.pow((1 - b) / (1 + b), s / 2), g = Math.PI / 2 - 2 * Math.atan(c * b) - f, f += g;
    ...
    var Ni = Ne.extend({
      ...
      _project: function() {
        ...
        if (n.distance === Dt.distance) {
          var s = Math.PI / 180, c = this._mRadius / Dt.R / s, f = i.project([e + c, t]), p = i.project([e - c, t]), g = f.add(p).divideBy(2), b = i.unproject(g).lat, A = Math.acos((Math.cos(c * s) - Math.sin(e * s) * Math.sin(b * s)) / (Math.cos(e * s) * Math.cos(b * s))) / s;
          (isNaN(A) || A === 0) && (A = c / Math.cos(Math.PI / 180 * e)), this._point = g.subtract(i.getPixelOrigin()), this._radius = isNaN(A) ? 0 : g.x - i.project([b, t - A]).x, this._radiusY = g.y - f.y;
        } else {
    ...
    var Bt = Ht.extend({
      ...
      closestLayerPoint: function(t) {
        for (var e = 1 / 0, i = null, n = we, s, c, f = 0, p = this._parts.length; f < p; f++)
          for (var g = this._parts[f], b = 1, A = g.length; b < A; b++) {
            s = g[b - 1], c = g[b];
            var M = n(t, s, c, !0);
            M < e && (e = M, i = n(t, s, c));
          }
        ...
        if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
          ...
          for (i = 0, s = 0, c = this._rings.length; i < c; i++)
            for (g = this._rings[i], n = 0, f = g.length; n < f - 1; n++)
              p = oo(g[n], g[n + 1], t, n, !0), p && (e[s] = e[s] || [], e[s].push(p[0]), (p[1] !== g[n + 1] || n === f - 2) && (e[s].push(p[1]), s++));
        }
      },
    ...
    var ae = Bt.extend({
      ...
      // Needed by the `Canvas` renderer for interactivity
      _containsPoint: function(t) {
        var e = !1, i, n, s, c, f, p, g, b;
        if (!this._pxBounds || !this._pxBounds.contains(t))
          return !1;
        for (c = 0, g = this._parts.length; c < g; c++)
          for (i = this._parts[c], f = 0, b = i.length, p = b - 1; f < b; p = f++)
    ...
    function He(t, e) {
      var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, s = [], c = e && e.pointToLayer, f = e && e.coordsToLatLng || Hi, p, g, b, A;
      if (!n && !i)
        return null;
      switch (i.type) {
        case "Point":
          return p = f(n), lo(c, t, p, e);
        case "MultiPoint":
          for (b = 0, A = n.length; b < A; b++)
            p = f(n[b]), s.push(lo(c, t, p, e));
          return new kt(s);
        case "LineString":
        case "MultiLineString":
          return g = Ze(n, i.type === "LineString" ? 0 : 1, f), new Bt(g, e);
        case "Polygon":
        case "MultiPolygon":
          return g = Ze(n, i.type === "Polygon" ? 1 : 2, f), new ae(g, e);
    ...
    var qe = Tt.extend({
      ...
      _adjustPan: function() {
        if (this.options.autoPan) {
          ...
          var c = t.layerPointToContainerPoint(s), f = I(this.options.autoPanPadding), p = I(this.options.autoPanPaddingTopLeft || f), g = I(this.options.autoPanPaddingBottomRight || f), b = t.getSize(), A = 0, M = 0;
          c.x + n + g.x > b.x && (A = c.x + n - b.x + g.x), c.x - A - p.x < 0 && (A = c.x - p.x), c.y + i + g.y > b.y && (M = c.y + i - b.y + g.y), c.y - M - p.y < 0 && (M = c.y - p.y), (A || M) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([A, M]));
        }
      },
      _getAnchor: function() {
    ...
    var Ve = Tt.extend({
      ...
      _initLayout: function() {
        ...
        this._contentNode = this._container = q("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + v(this));
      },
      _updateLayout: function() {
      },
      _adjustPan: function() {
      ...
      _setPosition: function(t) {
        var e, i, n = this._map, s = this._container, c = n.latLngToContainerPoint(n.getCenter()), f = n.layerPointToContainerPoint(t), p = this.options.direction, g = s.offsetWidth, b = s.offsetHeight, A = I(this.options.offset), M = this._getAnchor();
        p === "top" ? (e = g / 2, i = b) : p === "bottom" ? (e = g / 2, i = 0) : p === "center" ? (e = g / 2, i = b / 2) : p === "right" ? (e = 0, i = b / 2) : p === "left" ? (e = g, i = b / 2) : f.x < c.x ? (p = "right", e = 0, i = b / 2) : (p = "left", e = g + (A.x + M.x) * 2, i = b / 2), t = t.subtract(I(e, i, !0)).add(A).add(M), nt(s, "leaflet-tooltip-right"), nt(s, "leaflet-tooltip-left"), nt(s, "leaflet-tooltip-top"), nt(s, "leaflet-tooltip-bottom"), D(s, "leaflet-tooltip-" + p), at(s, t);
      },
      _updatePosition: function() {
    ...
    var Ce = Ct.extend({
      ...
      _retainParent: function(t, e, i, n) {
        ...
        p.z = +f;
        var g = this._tileCoordsToKey(p), b = this._tiles[g];
        ...
        if (e) {
          ...
          if (t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0) {
            ...
            for (var b in this._tiles) {
              ...
              (A.z !== this._tileZoom || !g.contains(new O(A.x, A.y))) && (this._tiles[b].current = !1);
            }
    ...
    var go = le.extend({
      ...
      getTileUrl: function(t) {
        var e = this._tileCoordsToNwSe(t), i = this._crs, n = pt(i.project(e[0]), i.project(e[1])), s = n.min, c = n.max, f = (this._wmsVersion >= 1.3 && this._crs === ao ? [s.y, s.x, c.y, c.x] : [s.x, s.y, c.x, c.y]).join(","), p = le.prototype.getTileUrl.call(this, t);
        return p + R(this.wmsParams, p, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + f;
      },
    ...
    var Co = Lt.extend({
      ...
      _onDragEnd: function(t) {
        ...
        if (e.fire("dragend", t), n)
          ...
          var s = this._lastPos.subtract(this._positions[0]), c = (this._lastTime - this._times[0]) / 1e3, f = i.easeLinearity, p = s.multiplyBy(f / c), g = p.distanceTo([0, 0]), b = Math.min(i.inertiaMaxSpeed, g), A = p.multiplyBy(b / g), M = b / (i.inertiaDeceleration * f), N = A.multiplyBy(-M / 2).round();
...
class Qt {
  constructor({ apiKey: r, authReferrerPolicy: o, channel: h, client: l, id: d = "__googleMapsScriptId", language: u, libraries: m = [], mapIds: v, nonce: _, region: y, retries: w = 3, url: P = "https://maps.googleapis.com/maps/api/js", version: E }) {
    if (this.callbacks = [], this.done = !1, this.loading = !1, this.errors = [], this.apiKey = r, this.authReferrerPolicy = o, this.channel = h, this.client = l, this.id = d || "__googleMapsScriptId", this.language = u, this.libraries = m, this.mapIds = v, this.nonce = _, this.region = y, this.retries = w, this.url = P, this.version = E, Qt.instance) {
  ...
  setScript() {
    ...
    Object.keys(h).forEach((d) => !h[d] && delete h[d]), !((o = (r = window == null ? void 0 : window.google) === null || r === void 0 ? void 0 : r.maps) === null || o === void 0) && o.importLibrary || ((d) => {
      let u, m, v, _ = "The Google Maps JavaScript API", y = "google", w = "importLibrary", P = "__ib__", E = document, C = window;
      C = C[y] || (C[y] = {});
      const x = C.maps || (C.maps = {}), R = /* @__PURE__ */ new Set(), H = new URLSearchParams(), S = () => u || (u = new Promise((B, G) => {
        return F = this, rt = function* () {
          var Y;
          for (v in yield m = E.createElement("script"), m.id = this.id, H.set("libraries", [...R] + ""), d)
            H.set(v.replace(/[A-Z]/g, (K) => "_" + K[0].toLowerCase()), d[v]);
          H.set("callback", y + ".maps." + P), m.src = this.url + "?" + H, x[P] = B, m.onerror = () => u = G(Error(_ + " could not load.")), m.nonce = this.nonce || ((Y = E.querySelector("script[nonce]")) === null || Y === void 0 ? void 0 : Y.nonce) || "", E.head.append(m);
...
class hi extends yt {
  constructor(r) {
    ...
    const o = new te();
    o.classList.add("bg-semi-transp"), this.innerText = Z.callbacks.addressButton.text, this.appendChild(o), (l = (h = Z.callbacks) == null ? void 0 : h.addressButton) != null && l.action && (this.onclick = (d) => Z.callbacks.addressButton.action(r, d));
  }
}
...
class fn extends yt {
  constructor({ type: o, id: h, name: l, address: d, image_url: u, country: m, location: v, data: _ }) {
    super();
    k(this, "map");
    this.setStyles({
    ...
    new MutationObserver(function(C, x) {
      document.getElementById(
        ...
        P.map = ei.map(w).setView(
          ...
          typeof ((G = (B = Z.callbacks) == null ? void 0 : B.addressButton) == null ? void 0 : G.action)
        ) || ((V = (F = Z.callbacks) == null ? void 0 : F.addressButton) == null ? void 0 : V.action) instanceof Promise) && P.appendChild(
          new hi({
            id: h,
            name: l,
            address: d,
...
const ka = (a) => ({
  ...
  const r = `${Z.ssl ? "https" : "http"}://${Z.botHost}`;
  return (await fetch(`${r}${Z.projectPath}chat`, {
    headers: {
...
class mn extends yt {
  constructor() {
    ...
    k(this, "input");
    this.innerHTML = this.renderHTML(Ia, { sendIcon: tr }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(te.tag), this.input.style.fontFamily = ot.typography.primary, this.input.style.backgroundColor = "white", this.input.style.color = "black", this.setStyles(this.defaultStyles);
  }
  onSubmit(o) {
...
class gn extends HTMLElement {
  ...
  setScrollThumbHeight() {
    ...
    h.addEventListener("mousedown", (y) => {
      v = !0, _ = y.clientY, this.preventContentHighlight("remove");
...
const Za = async (a) => await fetch(`${Z.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  ...
  (function(r, o) {
    ...
    o.defaults = {
      ...
      for (var u = {
        ...
        C <= 360 ? (_[w].style[y] = v[y] + "px", v[y] += P + E) : d(_[w], "toastify-left") === !0 ? (_[w].style[y] = u[y] + "px", u[y] += P + E) : (_[w].style[y] = m[y] + "px", m[y] += P + E);
      }
      return this;
    };
    function l(u, m) {
...
class vn extends yt {
  ...
  initMessagesWebsocket(o) {
    ...
    const l = `${`${Z.ssl ? "wss" : "ws"}://${Z.botHost}`}/messages/${o}/ws`;
  ...
  onSubmit(o) {
    ...
    if (d.disabled = !0, this.getChild("#onbotgo-chatinput").style.backgroundColor = "rgba(239,239,239,.6)", this.chattingWith === "human_agent") {
      Ba({
        content: `${l.message}
${l.url}`,
        conversation_id: Z.messageHistoryId,
        channel_id: Z.chathubChannelId,
        sender: "user"
      }).finally(() => {
        var u;
    ...
    l.url.length ? l.url.forEach((u) => {
      zo({
        ...
        var v, _;
        m != null && m.unique_id && (Z.messageHistoryId = m.unique_id, this.initMessagesWebsocket(Z.messageHistoryId)), (_ = (v = m == null ? void 0 : m.data) == null ? void 0 : v.process) != null && _.length && m.data.process.forEach((y) => {
          this.addMessages([
            {
              type: y.role,
              name: y.name,
        ...
        ]), m.thought && this.showBotThought(m.thought), m.redirect && (this.chattingWith = "human_agent"), m != null && m.cards && this.handleCardMessages(m.cards);
      ...
      var m, v;
      u != null && u.unique_id && (Z.messageHistoryId = u.unique_id, this.initMessagesWebsocket(Z.messageHistoryId)), (v = (m = u == null ? void 0 : u.data) == null ? void 0 : m.process) != null && v.length && u.data.process.forEach((_) => {
        this.addMessages([
          {
            type: _.role,
            name: _.name,
  ...
  handleCardMessages(o) {
    o.forEach((h) => {
      var l, d;
      this.addMessages([h]), (l = Z.callbacks) != null && l.address && h.type === "address" && ((d = Z.callbacks) == null || d.address(messageData));
    });
  }
  toggle() {
...
class yn extends eh {
  ...
  renderMicStream(r) {
    ...
    let v;
    const _ = () => {
      l.getFloatTimeDomainData(u), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = !1, this.wavesurfer.load("", [u], m)), v = requestAnimationFrame(_);
    };
    return _(), () => {
...
class sh {
  constructor({
    ...
    if (Z.chatflowID = r, h && (Z.projectPath = h), l && (Z.botHost = l), d && (Z.ssl = d), m && (Z.welcomeMessage = m), y && (Z.callbacks = y), w && (Z.googleApikey = w), [!1, !0].includes(_) && (Z.showThoughts = _), Z.chathubChannelId = o, !u)
      return;
    ...
    P && Object.keys(P).forEach(
      ...
      (x) => ot.colors[x] = E[x]
    ), C && (ot.customIcon = C), v != null && v.active && (St.active = !0, St.number = v.number, St.position = v.position.toLowerCase(), St.msg = v.msg);
  }
  init() {
