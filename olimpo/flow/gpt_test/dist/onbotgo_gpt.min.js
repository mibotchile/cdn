...
var $t = (r, t, e) => t in r ? Zt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var g = (r, t, e) => ($t(r, typeof t != "symbol" ? t + "" : t, e), e);
class _t {
  constructor() {
    g(this, "typography", {
...
function V(r, t, e) {
  for (var n in t)
    Dt(t, n) && (t[n] != null && typeof t[n] == "object" && (n === "storage" || n === "prefixes") && !e ? r[n] = V(
      /*toObj[key] ||*/
      {},
      t[n]
    ) : r[n] = t[n]);
...
function K(r) {
  return Tt.test(r) ? r.replace(Tt, "\\$&") : r;
}
function ne(r, t) {
...
`).replace(/^\s+|\s+$/gm, "")), z.lastIndex = 0, J.lastIndex = 0, W.lastIndex = 0;
  ...
  function d(u, p) {
    ...
    for (var v; (v = o.exec(r)) !== null; ) {
      var T = v[1], x = v[2], w = v[3], L = v[4], E = v[5], P = v.index;
      if (T)
        T === "(" ? (m === 0 && (A === "n" ? (y(P), A = "p") : A === "f" && (y(P), A = "fp")), m++) : T === ")" ? (m--, m === 0 && A !== "c" && (y(P), A = "err")) : m === 0 && T === "|" ? (y(P), A = "f") : T === "=>" && (y(P), i += 1, A = "res");
      else if (x) {
        if (x === "/*") {
        ...
        return y(P), i = P + v[0].length, s.lastIndex = i, l = E, L && p === "h" && (p = "s"), f.t = p, f;
    }
    return F("unclosed tag", r, u), f;
  }
  function c(u, p) {
    u.b = [], u.d = [];
    var f = !1, m = [];
    ...
    for (var y; (y = s.exec(r)) !== null; ) {
      var v = y[1], T = y[2], x = y[3] || "", w;
      for (var L in e)
        if (e[L] === x) {
          w = L;
          break;
        }
      A(v, T), i = y.index + y[0].length, w || F("unrecognized tag type: " + x, r, i);
      var E = d(y.index, w), P = E.t;
      if (P === "h") {
        var I = E.n || "";
        t.async && O.test(I) && (E.a = !0, E.n = I.replace(O, "")), E = c(E), m.push(E);
      } else if (P === "c") {
        if (u.n === E.n)
          return f ? (f.d = m, u.b.push(f)) : u.d = m, u;
        F("Helper start and end don't match", r, y.index + y[0].length);
      } else if (P === "b") {
        f ? (f.d = m, u.b.push(f)) : u.d = m;
        var D = E.n || "";
    ...
    if (p)
      A(r.slice(i, r.length), !1), u.d = m;
    else
      throw S('unclosed helper "' + u.n + '"');
    return u;
  }
  var a = c({ f: [] }, !0);
  if (t.plugins)
...
function Pt(r, t) {
  var e = ne(r, t), n = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + U(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function Ft(r, t, e, n, o, s) {
  var i = "{exec:" + (o ? "async " : "") + Ot(e, t, r) + ",params:[" + n + "]";
  return s && (i += ",name:'" + s + "'"), o && (i += ",async:true"), i += "}", i;
}
function re(r, t) {
  for (var e = "[", n = 0; n < r.length; n++) {
    var o = r[n];
    e += Ft(t, o.res || "", o.d, o.p || "", o.a, o.n), n < r.length && (e += ",");
  }
  return e += "]", e;
}
function Ot(r, t, e) {
...
function U(r, t) {
  ...
  for (e; e < n; e++) {
    ...
    if (typeof s == "string") {
      ...
      var l = s.t, d = s.c || "", c = s.f, a = s.n || "", h = s.p || "", b = s.res || "", u = s.b, p = !!s.a;
      if (l === "i") {
        ...
        if (t.storage.nativeHelpers.get(a))
          ...
          var m = (p ? "await " : "") + "c.l('H','" + a + "')(" + Ft(t, b, s.d, h, p);
          u ? m += "," + re(u, t) : m += ",[]", m += ",c)", o += "tR+=" + rt(m, c) + ";";
        }
      else
        l === "s" ? o += "tR+=" + rt((p ? "await " : "") + "c.l('H','" + a + "')({params:[" + h + "]},[],c)", c) + ";" : l === "e" && (o += d + `
`);
    }
  }
  return o;
...
function jt(r, t, e, n, o) {
  e(r[t], t).then(function(s) {
    n += s, t === r.length - 1 ? o(n) : jt(r, t + 1, e, n, o);
  });
}
function Ut(r, t, e, n, o, s) {
  n(t[e], r[t[e]]).then(function(i) {
    o += i, e === t.length - 1 ? s(o) : Ut(r, t, e + 1, n, o, s);
  });
}
var oe = {
  "&": "&amp;",
...
function se(r) {
  var t = String(r);
  return /[&<>"']/.test(t) ? t.replace(/[&<>"']/g, ie) : t;
}
var ae = new _({}), mt = new _({
  each: function(r, t) {
    var e = "", n = r.params[0];
  ...
  block: function(r, t) {
    N("block", r.b, r.f, !0);
    var e = "if(!" + t.varName + "[" + r.p + "]){tR+=(" + Ot(r.d, "", t) + ")()}else{tR+=" + t.varName + "[" + r.p + "]}";
    return e;
  }
}), ce = new _({ e: se }), lt = {
  varName: "it",
...
var ct = require("fs"), ot = require("path"), de = /^\uFEFF/;
function it(r, t, e) {
  var n = ot.resolve(
    e ? t : ot.dirname(t),
...
function Nt(r) {
  return ct.readFileSync(r).toString().replace(de, "");
}
function ue(r, t) {
  var e = tt(t), n = Nt(r);
  try {
...
function qt(r, t) {
  var e = tt({ filename: he(r, t) }, t);
  return pe(e);
}
function ge(r, t, e) {
  if (t && t.length > 0)
    throw S("Helper 'includeFile' doesn't accept blocks");
  return qt(r.params[0], e)(r.params[1], e);
}
function fe(r, t, e) {
  var n = r.params[1] || {};
  n.content = r.exec();
...
mt.define("includeFile", ge);
mt.define("extendsFile", fe);
...
const be = '<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"  fill="currentColor">    <path  fill="currentColor" d="M 12.011719 2 C 6.5057187 2 2.0234844 6.478375 2.0214844 11.984375 C 2.0204844 13.744375 2.4814687 15.462563 3.3554688 16.976562 L 2 22 L 7.2324219 20.763672 C 8.6914219 21.559672 10.333859 21.977516 12.005859 21.978516 L 12.009766 21.978516 C 17.514766 21.978516 21.995047 17.499141 21.998047 11.994141 C 22.000047 9.3251406 20.962172 6.8157344 19.076172 4.9277344 C 17.190172 3.0407344 14.683719 2.001 12.011719 2 z M 12.009766 4 C 14.145766 4.001 16.153109 4.8337969 17.662109 6.3417969 C 19.171109 7.8517969 20.000047 9.8581875 19.998047 11.992188 C 19.996047 16.396187 16.413812 19.978516 12.007812 19.978516 C 10.674812 19.977516 9.3544062 19.642812 8.1914062 19.007812 L 7.5175781 18.640625 L 6.7734375 18.816406 L 4.8046875 19.28125 L 5.2851562 17.496094 L 5.5019531 16.695312 L 5.0878906 15.976562 C 4.3898906 14.768562 4.0204844 13.387375 4.0214844 11.984375 C 4.0234844 7.582375 7.6067656 4 12.009766 4 z M 8.4765625 7.375 C 8.3095625 7.375 8.0395469 7.4375 7.8105469 7.6875 C 7.5815469 7.9365 6.9355469 8.5395781 6.9355469 9.7675781 C 6.9355469 10.995578 7.8300781 12.182609 7.9550781 12.349609 C 8.0790781 12.515609 9.68175 15.115234 12.21875 16.115234 C 14.32675 16.946234 14.754891 16.782234 15.212891 16.740234 C 15.670891 16.699234 16.690438 16.137687 16.898438 15.554688 C 17.106437 14.971687 17.106922 14.470187 17.044922 14.367188 C 16.982922 14.263188 16.816406 14.201172 16.566406 14.076172 C 16.317406 13.951172 15.090328 13.348625 14.861328 13.265625 C 14.632328 13.182625 14.464828 13.140625 14.298828 13.390625 C 14.132828 13.640625 13.655766 14.201187 13.509766 14.367188 C 13.363766 14.534188 13.21875 14.556641 12.96875 14.431641 C 12.71875 14.305641 11.914938 14.041406 10.960938 13.191406 C 10.218937 12.530406 9.7182656 11.714844 9.5722656 11.464844 C 9.4272656 11.215844 9.5585938 11.079078 9.6835938 10.955078 C 9.7955938 10.843078 9.9316406 10.663578 10.056641 10.517578 C 10.180641 10.371578 10.223641 10.267562 10.306641 10.101562 C 10.389641 9.9355625 10.347156 9.7890625 10.285156 9.6640625 C 10.223156 9.5390625 9.737625 8.3065 9.515625 7.8125 C 9.328625 7.3975 9.131125 7.3878594 8.953125 7.3808594 C 8.808125 7.3748594 8.6425625 7.375 8.4765625 7.375 z"/></svg>';
class ye {
  constructor() {
    g(this, "active", !1);
    g(this, "number", "");
...
const B = new ye(), Z = "onbotgo-btn-whatsapp";
class dt extends M {
  constructor() {
  ...
  html() {
    return `<onbotgo-box>${be}<onbotgo-box>`;
  }
}
dt.tag = Z;
const Ae = (r) => ({
...
var Mt = globalThis && globalThis.__awaiter || function(r, t, e, n) {
  function o(s) {
    return s instanceof e ? s : new e(function(i) {
      i(s);
    });
...
function Te(r, t, e) {
  ...
  return Mt(this, void 0, void 0, function* () {
    const s = yield fetch(r, e);
    {
      ...
      let d = 0;
      const c = (a, h) => Mt(this, void 0, void 0, function* () {
        if (a)
          return;
        d += (h == null ? void 0 : h.length) || 0;
        const b = Math.round(d / l * 100);
        return t(b), i == null ? void 0 : i.read().then(({ done: u, value: p }) => c(u, p));
      });
...
function Me(r, t, e, n, o = 5) {
  ...
  const i = (l) => {
    ...
    const h = (p) => {
      ...
      const f = p.clientX, m = p.clientY;
      if (a || Math.abs(f - d) >= o || Math.abs(m - c) >= o) {
        const { left: A, top: y } = r.getBoundingClientRect();
        a || (a = !0, e == null || e(d - A, c - y)), t(f - d, m - c, f - A, m - y), d = f, c = m;
      }
    }, b = (p) => {
    ...
    document.addEventListener("pointermove", h), document.addEventListener("pointerup", u), document.addEventListener("pointerleave", u), document.addEventListener("click", b, !0), s = () => {
...
class et extends At {
  ...
  renderBarWaveform(t, e, n, o) {
    const s = t[0], i = t[1] || t[0], l = s.length, { width: d, height: c } = n.canvas, a = c / 2, h = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * h : 1, u = e.barGap ? e.barGap * h : e.barWidth ? b / 2 : 0, p = e.barRadius || 0, f = d / (b + u) / l, m = p && "roundRect" in n ? "roundRect" : "rect";
    n.beginPath();
    let A = 0, y = 0, v = 0;
    for (let T = 0; T <= l; T++) {
      const x = Math.round(T * f);
      if (x > A) {
        const E = Math.round(y * a * o), P = Math.round(v * a * o), I = E + P || 1;
        let D = a - E;
        e.barAlign === "top" ? D = 0 : e.barAlign === "bottom" && (D = c - I), n[m](A * (b + u), D, b, I, p), A = x, y = 0, v = 0;
      }
      const w = Math.abs(s[T] || 0), L = Math.abs(i[T] || 0);
      w > y && (y = w), L > v && (v = L);
    }
    n.fill(), n.closePath();
  }
  renderLineWaveform(t, e, n, o) {
    const s = (i) => {
      ...
      let b = 0, u = 0;
      for (let p = 0; p <= d; p++) {
        const f = Math.round(p * h);
        if (f > b) {
          const A = Math.round(u * a * o) || 1, y = a + A * (i === 0 ? -1 : 1);
          n.lineTo(b, y), b = f, u = 0;
        }
        const m = Math.abs(l[p] || 0);
        m > u && (u = m);
      }
      n.lineTo(b, a);
    };
  ...
  renderChannel(t, e, n) {
    ...
    if (e.barWidth || e.barGap) {
      const x = e.barWidth || 0.5, w = e.barGap || x / 2, L = x + w;
      b % L !== 0 && (b = Math.floor(b / L) * L);
    }
    const u = Math.floor(Math.abs(l) * h), p = Math.floor(u + b * h), f = p - u, m = (x, w) => {
      this.renderSingleCanvas(t, e, n, s, Math.max(0, x), Math.min(w, a), o, i);
    }, A = this.createDelay(), y = this.createDelay(), v = (x, w) => {
      m(x, w), x > 0 && A(() => {
        v(x - f, w - f);
      });
    }, T = (x, w) => {
  ...
  loadAudio(t, e, n, o) {
    return G(this, void 0, void 0, function* () {
      if (this.emit("load", t), this.isPlaying() && this.pause(), this.decodedData = null, !e && !n) {
        ...
        e = yield Pe.fetchBlob(t, s, this.options.fetchParams);
      }
      if (this.setSrc(t, e), n)
        ...
        })) || (yield Promise.resolve(0)), this.decodedData = Lt.createBuffer(n, o);
      else if (e) {
        const s = yield e.arrayBuffer();
        this.decodedData = yield Lt.decode(s, this.options.sampleRate);
      }
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
  ...
  getAvatarMessage(e = "api", n = !1) {
    const o = new q();
    let s;
    return e === "apiMessage" && !n ? s = Yt : e === "userMessage" ? s = De : n && (s = Ie), o.innerHTML = `<img src=${s} width="25" height="25" />`, o.setStyles({
      padding: "5px",
      marginRight: "10px",
...
const C = new Oe(), Bt = async (r) => {
  const t = `${C.ssl ? "https" : "http"}://${C.botHost}`;
  return (await fetch(`${t}${C.projectPath}chat`, {
    headers: {
...
class vt extends M {
  constructor() {
    ...
    g(this, "input");
    this.innerHTML = this.renderHTML(Ue, { sendIcon: Vt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(q.tag), this.input.style.fontFamily = R.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
const Xe = async (r) => await fetch(`${C.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
    ...
    e.defaults = {
      ...
      buildToast: function() {
        ...
        if (typeof this.options.destination < "u" && i.addEventListener(
          ...
          var b = o("x", this.options), u = o("y", this.options), p = this.options.position == "left" ? b : "-" + b, f = this.options.gravity == "toastify-top" ? u : "-" + u;
      ...
      for (var i = {
        ...
        var u = 15, p = window.innerWidth > 0 ? window.innerWidth : screen.width;
        p <= 360 ? (c[h].style[a] = d[a] + "px", d[a] += b + u) : s(c[h], "toastify-left") === !0 ? (c[h].style[a] = i[a] + "px", i[a] += b + u) : (c[h].style[a] = l[a] + "px", l[a] += b + u);
      }
      return this;
    };
    function o(i, l) {
...
var We = Qt.exports;
const Ke = /* @__PURE__ */ Je(We), Y = "onbotgo-chatcontainer";
class Et extends M {
  constructor() {
    super();
  ...
  initMessagesWebsocket(e) {
    ...
    const o = `${`${C.ssl ? "wss" : "ws"}://${C.botHost}`}/messages/${e}/ws`;
  ...
  onSubmit(e) {
    ...
    if (s.disabled = !0, this.getChild("#onbotgo-chatinput").style.backgroundColor = "rgba(239,239,239,.6)", this.chattingWith === "human_agent") {
      je({
        content: `${o.message}
${o.url}`,
        conversation_id: C.messageHistoryId,
        channel_id: C.chathubChannelId,
        sender: "user"
      }).finally(() => {
        var i;
        this.querySelector("input").focus(), (i = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || i.forEach((l) => l.remove()), s.disabled = !1;
      });
      return;
    }
    o.url.length ? o.url.forEach((i) => {
      Bt({
        ...
        var d, c;
        l != null && l.unique_id && (C.messageHistoryId = l.unique_id, this.initMessagesWebsocket(C.messageHistoryId)), (c = (d = l == null ? void 0 : l.data) == null ? void 0 : d.process) != null && c.length && l.data.process.forEach((a) => {
          this.addMessages([
            {
              type: a.role,
              name: a.name,
      ...
      var l, d;
      i != null && i.unique_id && (C.messageHistoryId = i.unique_id, this.initMessagesWebsocket(C.messageHistoryId)), (d = (l = i == null ? void 0 : i.data) == null ? void 0 : l.process) != null && d.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
  ...
  showBotThought(e) {
    console.log(C.showThoughts), C.showThoughts && Ke({
      text: `<div style="display:flex;align-items:center;gap:10px"><img src="${Yt}" width="30" height="30" /> ${e}</div>`,
      duration: 3e3,
      newWindow: !0,
      gravity: "bottom",
      escapeMarkup: !1,
...
function $e({ element: r, styles: t }) {
  const e = t.reduce(
    ...
    {}
  ), n = document.createElement("style"), o = en(e);
...
Wt.tag = on;
const sn = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, an = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
const dn = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class wt extends cn {
  constructor(t) {
    var e;
  ...
  startRecording() {
    return It(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || dn.find((o) => MediaRecorder.isTypeSupported(o)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
class Kt extends M {
  ...
  render() {
    this.innerHTML = this.renderHTML(sn, {
...
class gn {
  constructor({
    ...
    if (C.chatflowID = t, n && (C.projectPath = n), o && (C.botHost = o), s && (C.ssl = s), l && (C.welcomeMessage = l), [!1, !0].includes(c) && (C.showThoughts = c), C.chathubChannelId = e, !i)
      return;
    const { typography: a, colors: h, icon: b } = i;
    a && Object.keys(a).forEach(
      (u) => R.typography[u] = a[u]
    ), h && Object.keys(h).forEach(
      (u) => R.colors[u] = h[u]
    ), b && (R.customIcon = b), d != null && d.active && (B.active = !0, B.number = d.number, B.position = d.position.toLowerCase(), B.msg = d.msg);
  }
  init() {
    ...
    const e = document.createElement("style");
    if (e.innerHTML = un, t.prepend(e), document.body.appendChild(t), B.active) {
      const n = new dt();
  ...
  registerComponents(...t) {
    t.forEach((e) => {
      customElements.get(e) || customElements.define(e.tag, e);
    });
  }
}
export {
