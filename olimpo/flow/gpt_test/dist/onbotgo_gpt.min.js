...
var Wt = (r, t, e) => t in r ? Kt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var m = (r, t, e) => (Wt(r, typeof t != "symbol" ? t + "" : t, e), e);
class Gt {
  constructor() {
    m(this, "typography", {
...
const te = {}, ee = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: te
}, Symbol.toStringTag, { value: "Module" })), Bt = /* @__PURE__ */ $t(ee);
...
function q(r, t, e) {
  for (var n in t)
    kt(t, n) && (t[n] != null && typeof t[n] == "object" && (n === "storage" || n === "prefixes") && !e ? r[n] = q(
      /*toObj[key] ||*/
      {},
      t[n]
    ) : r[n] = t[n]);
...
`).replace(/^\s+|\s+$/gm, "")), X.lastIndex = 0, z.lastIndex = 0, J.lastIndex = 0;
  ...
  function d(p, u) {
    ...
    for (var C; (C = o.exec(r)) !== null; ) {
      var P = C[1], v = C[2], w = C[3], T = C[4], x = C[5], M = C.index;
      if (P)
        P === "(" ? (f === 0 && (A === "n" ? (y(M), A = "p") : A === "f" && (y(M), A = "fp")), f++) : P === ")" ? (f--, f === 0 && A !== "c" && (y(M), A = "err")) : f === 0 && P === "|" ? (y(M), A = "f") : P === "=>" && (y(M), i += 1, A = "res");
      else if (v) {
        if (v === "/*") {
        ...
        return y(M), i = M + C[0].length, s.lastIndex = i, l = x, T && u === "h" && (u = "s"), g.t = u, g;
    }
...
function Rt(r, t) {
  var e = oe(r, t), n = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + j(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function Ht(r, t, e, n, o, s) {
  var i = "{exec:" + (o ? "async " : "") + It(e, t, r) + ",params:[" + n + "]";
    ...
    if (typeof s == "string") {
      ...
      if (l === "i") {
        ...
        if (t.storage.nativeHelpers.get(a))
          ...
          var f = (u ? "await " : "") + "c.l('H','" + a + "')(" + Ht(t, b, s.d, h, u);
          p ? f += "," + ie(p, t) : f += ",[]", f += ",c)", o += "tR+=" + et(f, c) + ";";
        }
      else
...
function Dt(r, t, e, n, o) {
  e(r[t], t).then(function(s) {
    n += s, t === r.length - 1 ? o(n) : Dt(r, t + 1, e, n, o);
  });
}
function Ft(r, t, e, n, o, s) {
  n(t[e], r[t[e]]).then(function(i) {
    o += i, e === t.length - 1 ? s(o) : Ft(r, t, e + 1, n, o, s);
  });
}
var se = {
  "&": "&amp;",
...
function le(r) {
  var t = String(r);
  return /[&<>"']/.test(t) ? t.replace(/[&<>"']/g, ae) : t;
}
var ce = new Z({}), pt = new Z({
  each: function(r, t) {
    var e = "", n = r.params[0];
  ...
  foreach: function(r, t) {
    ...
    if (U("foreach", t, !1), r.async)
      return new Promise(function(s) {
        Ft(e, Object.keys(e), 0, r.exec, "", s);
      });
    var n = "";
    for (var o in e)
      kt(e, o) && (n += r.exec(o, e[o]));
    return n;
  },
  ...
  block: function(r, t) {
    U("block", r.b, r.f, !0);
    var e = "if(!" + t.varName + "[" + r.p + "]){tR+=(" + It(r.d, "", t) + ")()}else{tR+=" + t.varName + "[" + r.p + "]}";
    return e;
  }
}), he = new Z({ e: le }), st = {
  varName: "it",
...
function Ot(r) {
  return at.readFileSync(r).toString().replace(ue, "");
}
function ge(r, t) {
  var e = _(t), n = Ot(r);
  try {
...
function jt(r, t) {
  var e = _({ filename: pe(r, t) }, t);
  return fe(e);
}
function me(r, t, e) {
  if (t && t.length > 0)
    throw S("Helper 'includeFile' doesn't accept blocks");
  return jt(r.params[0], e)(r.params[1], e);
}
function be(r, t, e) {
  var n = r.params[1] || {};
  n.content = r.exec();
...
pt.define("includeFile", me);
pt.define("extendsFile", be);
...
}), ve = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
function Re(r, t) {
  return typeof r[0] == "number" && (r = [r]), we(r), {
    duration: t,
    length: r[0].length,
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, n, o) {
    ...
    for (let P = 0; P <= l; P++) {
      ...
      if (v > A) {
        const x = Math.round(y * a * o), M = Math.round(C * a * o), H = x + M || 1;
        let I = a - x;
        e.barAlign === "top" ? I = 0 : e.barAlign === "bottom" && (I = c - H), n[f](A * (b + p), I, b, H, u), A = v, y = 0, C = 0;
      }
      const w = Math.abs(s[P] || 0), T = Math.abs(i[P] || 0);
      w > y && (y = w), T > C && (C = T);
    }
    n.fill(), n.closePath();
  }
  ...
  renderChannel(t, e, n) {
    ...
    if (e.barWidth || e.barGap) {
      const v = e.barWidth || 0.5, w = e.barGap || v / 2, T = v + w;
      b % T !== 0 && (b = Math.floor(b / T) * T);
    }
...
class tt extends Me {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, Be, t), this.timer = new Le();
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
  ...
  getAvatarMessage(e = "api", n = !1) {
    const o = new N();
    let s;
    return e === "apiMessage" && !n ? s = Ut : e === "userMessage" ? s = Ie : n && (s = He), o.innerHTML = `<img src=${s} width="25" height="25" />`, o.setStyles({
      padding: "5px",
      marginRight: "10px",
...
const E = new Fe(), Oe = async (r) => {
  const t = `${E.ssl ? "https" : "http"}://${E.botHost}`;
  return (await fetch(`${t}${E.projectPath}chat`, {
    headers: {
...
class yt extends L {
  constructor() {
    ...
    m(this, "input");
    this.innerHTML = this.renderHTML(Ue, { sendIcon: Nt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(N.tag), this.input.style.fontFamily = R.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
</svg>`, Tt = '<svg  style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M28,14H18V4c0-1.104-0.896-2-2-2s-2,0.896-2,2v10H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h10v10c0,1.104,0.896,2,2,2  s2-0.896,2-2V18h10c1.104,0,2-0.896,2-2S29.104,14,28,14z"/></svg>';
class ht {
}
...
var ze = Yt.exports;
const Je = /* @__PURE__ */ _t(ze), Y = "onbotgo-chatcontainer";
class Ct extends L {
  constructor() {
    super();
  ...
  initMessagesWebsocket(e) {
    ...
    const o = `${`${E.ssl ? "wss" : "ws"}://${E.botHost}`}/messages/${e}/ws`;
  ...
  onSubmit(e) {
    ...
    const o = {
      ...
      urls: (this.attachedFiles || []).map(({ url: i }) => i),
...
${o.urls}`,
    ...
    Oe(o).then((i) => {
      var l, d;
      i != null && i.unique_id && (E.messageHistoryId = i.unique_id, this.initMessagesWebsocket(E.messageHistoryId)), (d = (l = i == null ? void 0 : i.data) == null ? void 0 : l.process) != null && d.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
  ...
  showBotThought(e) {
    Je({
      text: `<div style="display:flex;align-items:center;gap:10px"><img src="${Ut}" width="30" height="30" /> ${e}</div>`,
      duration: 3e3,
      newWindow: !0,
      gravity: "bottom",
      escapeMarkup: !1,
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(qe, {
...
class un {
  constructor({
    ...
    if (E.chatflowID = t, n && (E.projectPath = n), o && (E.botHost = o), (s !== void 0 || s !== null) && (E.ssl = s), l && (E.welcomeMessage = l), E.chathubChannelId = e, !i)
      return;
