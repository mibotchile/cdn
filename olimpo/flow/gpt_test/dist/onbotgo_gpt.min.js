...
`).replace(/^\s+|\s+$/gm, "")), Y.lastIndex = 0, Q.lastIndex = 0, V.lastIndex = 0;
  ...
  function h(p, g) {
    ...
    for (var v; (v = o.exec(n)) !== null; ) {
      var S = v[1], I = v[2], x = v[3], k = v[4], A = v[5], E = v.index;
      if (S)
        S === "(" ? (f === 0 && (C === "n" ? (y(E), C = "p") : C === "f" && (y(E), C = "fp")), f++) : S === ")" ? (f--, f === 0 && C !== "c" && (y(E), C = "err")) : f === 0 && S === "|" ? (y(E), C = "f") : S === "=>" && (y(E), s += 1, C = "res");
      else if (I) {
        if (I === "/*") {
          var T = n.indexOf("*/", o.lastIndex);
          T === -1 && z("unclosed comment", n, v.index), o.lastIndex = T + 2;
        } else if (I === "'") {
          Q.lastIndex = v.index;
          var P = Q.exec(n);
          P ? o.lastIndex = Q.lastIndex : z("unclosed string", n, v.index);
        } else if (I === '"') {
          V.lastIndex = v.index;
          var j = V.exec(n);
          j ? o.lastIndex = V.lastIndex : z("unclosed string", n, v.index);
        } else if (I === "`") {
          Y.lastIndex = v.index;
          var M = Y.exec(n);
          M ? o.lastIndex = Y.lastIndex : z("unclosed string", n, v.index);
        }
      } else if (x)
        return y(E), s = E + v[0].length, i.lastIndex = s, l = A, k && g === "h" && (g = "s"), u.t = g, u;
    }
...
function ee(n, t) {
  for (var e = "[", r = 0; r < n.length; r++) {
    var o = n[r];
    e += zt(t, o.res || "", o.d, o.p || "", o.a, o.n), r < n.length && (e += ",");
  }
  return e += "]", e;
}
function Ht(n, t, e) {
    ...
    if (typeof i == "string") {
      ...
      if (l === "i") {
        ...
        if (t.storage.nativeHelpers.get(a))
          ...
          var f = (g ? "await " : "") + "c.l('H','" + a + "')(" + zt(t, b, i.d, d, g);
          p ? f += "," + ee(p, t) : f += ",[]", f += ",c)", o += "tR+=" + et(f, c) + ";";
        }
      else
...
function Dt(n, t, e, r, o) {
  e(n[t], t).then(function(i) {
    r += i, t === n.length - 1 ? o(r) : Dt(n, t + 1, e, r, o);
  });
}
...
function ut(n, t) {
  ...
  try {
    ...
    throw o instanceof SyntaxError ? w(`Bad template syntax
...
function Se(n, t, e, r, o = 5) {
  ...
  const s = (l) => {
    ...
    const d = (g) => {
      ...
      if (a || Math.abs(u - h) >= o || Math.abs(f - c) >= o) {
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, r, o) {
    const i = t[0], s = t[1] || t[0], l = i.length, { width: h, height: c } = r.canvas, a = c / 2, d = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * d : 1, p = e.barGap ? e.barGap * d : e.barWidth ? b / 2 : 0, g = e.barRadius || 0, u = h / (b + p) / l, f = g && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let C = 0, y = 0, v = 0;
    for (let S = 0; S <= l; S++) {
      const I = Math.round(S * u);
      if (I > C) {
        const A = Math.round(y * a * o), E = Math.round(v * a * o), T = A + E || 1;
        let P = a - A;
        e.barAlign === "top" ? P = 0 : e.barAlign === "bottom" && (P = c - T), r[f](C * (b + p), P, b, T, g), C = I, y = 0, v = 0;
      }
      const x = Math.abs(i[S] || 0), k = Math.abs(s[S] || 0);
      x > y && (y = x), k > v && (v = k);
    }
    r.fill(), r.closePath();
  }
  ...
  loadAudio(t, e, r, o) {
    return J(this, void 0, void 0, function* () {
      ...
      if (this.setSrc(t, e), r)
        ...
        })) || (yield Promise.resolve(0)), this.decodedData = Rt.createBuffer(r, o);
      else if (e) {
        const i = yield e.arrayBuffer();
        this.decodedData = yield Rt.decode(i, this.options.sampleRate);
      }
...
class yt extends L {
  constructor() {
    ...
    m(this, "input");
    this.innerHTML = this.renderHTML(Fe, { sendIcon: qt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(U.tag), this.input.style.fontFamily = R.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
class vt extends L {
  ...
  onSubmit(e) {
    ...
    this.attachedFiles.length && (this.addMessages(
    ...
    ]), e && this.addMessages([{ message: e, type: "userMessage" }]), this.renderMessages([{ type: "LoadingMessage" }]), this.updateScrollbar(), this.isRecordSelected = !1, this.attachedRecord = null, this.chatInput.getChild("input").value = "", this.getChild("#onbotgo-chatinput").style.display = "grid", this.getChild("#onbotgo-attachFileTemplateContainer").style.display = "grid", this.getChild("#onbotgo-micrecord").style.display = "none", this.updateScrollbar(), o.url.length ? o.url.forEach((i) => {
      kt({
        ...o,
      ...
      var s, l;
      i != null && i.unique_id && (D.messageHistoryId = i.unique_id), (l = (s = i == null ? void 0 : i.data) == null ? void 0 : s.process) != null && l.length && i.data.process.forEach((h) => {
        this.addMessages([
          {
            type: h.role,
            name: h.name,
  ...
  render() {
    ...
    o.src = We, o.style.objectFit = "cover", this.getChild("#onbotgo-btnrecordSend").style.display = "none", this.querySelector("#onbotgo-btnrecord").onclick = () => {
...
class gt extends L {
  constructor() {
    ...
    const e = new ft(R.customIcon), r = new vt();
...
function qe({ element: n, styles: t }) {
  const e = t.reduce(
    ...
    {}
  ), r = document.createElement("style"), o = je(e);
...
class Ot extends L {
  constructor() {
    ...
    let r = "black";
    t === "primary" && (r = R.colors.primary), t === "danger" && (r = "red"), e && (this.querySelector("svg").style.width = `calc(${e} - 16px)`, this.querySelector("svg").style.height = `calc(${e} - 16px)`, this.setStyles({ width: e, height: e })), this.setStyles({ color: r });
    const o = new U();
    o.setStyles({
      backgroundColor: r,
      opacity: 0.2,
...
class jt extends L {
  constructor() {
    ...
    const t = this.getAttribute("color"), e = this.getAttribute("size");
    let r = "black";
    t === "primary" && (r = R.colors.primary), e && this.setStyles({ width: e, height: e }), this.setStyles({
...
class It extends Ze {
  ...
  startRecording() {
    return Ft(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || Ke.find((o) => MediaRecorder.isTypeSupported(o)), audioBitsPerSecond: this.options.audioBitsPerSecond });
