...
`).replace(/^\s+|\s+$/gm, "")), X.lastIndex = 0, z.lastIndex = 0, J.lastIndex = 0;
  ...
  function d(p, u) {
    ...
    for (var C; (C = o.exec(r)) !== null; ) {
      var P = C[1], v = C[2], w = C[3], M = C[4], x = C[5], T = C.index;
      if (P)
...
class $ extends mt {
  ...
  renderChannel(t, e, n) {
    ...
    const p = Math.floor(Math.abs(a) * h), u = Math.floor(p + b * h), g = u - p, f = (v, w) => {
      this.renderSingleCanvas(t, e, n, s, Math.max(0, v), Math.min(w, l), o, i);
...
const E = new Oe();
console.log(E);
const Tt = async (r) => await fetch(`${E.gpt_url}${E.projectPath}chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), je = async (r) => await fetch(`${E.gpt_url}${E.projectPath}messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
...
const Xe = async (r) => await fetch(`${E.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
...
class Ct extends L {
  ...
  initMessagesWebsocket(e) {
    ...
    const n = `wss://endpoint-prod-chatgpt.mibot.cl:8080${E.projectPath}messages/${e}/ws`;
  ...
  onSubmit(e) {
    ...
    if (s.disabled = !0, this.getChild("#onbotgo-chatinput").style.backgroundColor = "rgba(239,239,239,.6)", this.chattingWith === "human_agent") {
      je({
        content: `${o.message}
${o.url}`,
        conversation_id: E.messageHistoryId,
        channel_id: E.chathubChannelId,
        sender: "user"
      }).finally(() => {
        var i;
    ...
    o.url.length ? o.url.forEach((i) => {
      Tt({
        ...
        var d, c;
        a != null && a.unique_id && (E.messageHistoryId = a.unique_id, this.initMessagesWebsocket(E.messageHistoryId)), (c = (d = a == null ? void 0 : a.data) == null ? void 0 : d.process) != null && c.length && a.data.process.forEach((l) => {
          this.addMessages([
            {
              type: l.role,
              name: l.name,
      ...
      var a, d;
      i != null && i.unique_id && (E.messageHistoryId = i.unique_id, this.initMessagesWebsocket(E.messageHistoryId)), (d = (a = i == null ? void 0 : i.data) == null ? void 0 : a.process) != null && d.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
...
class un {
  constructor({
    ...
    if (E.chatflowID = t, n && (E.projectPath = n), E.chathubChannelId = e, s && (E.welcomeMessage = s), !o)
      return;
