...
`).replace(/^\s+|\s+$/gm, "")), Y.lastIndex = 0, Q.lastIndex = 0, V.lastIndex = 0;
  ...
  function h(p, g) {
    ...
    for (var v; (v = o.exec(n)) !== null; ) {
      ...
      if (S)
        S === "(" ? (f === 0 && (C === "n" ? (b(E), C = "p") : C === "f" && (b(E), C = "fp")), f++) : S === ")" ? (f--, f === 0 && C !== "c" && (b(E), C = "err")) : f === 0 && S === "|" ? (b(E), C = "f") : S === "=>" && (b(E), s += 1, C = "res");
      else if (I) {
        if (I === "/*") {
        ...
        return b(E), s = E + v[0].length, i.lastIndex = s, l = A, k && g === "h" && (g = "s"), u.t = g, u;
    }
...
function B(n, t) {
  ...
  for (e; e < r; e++) {
    ...
    if (typeof i == "string") {
      ...
      var l = i.t, h = i.c || "", c = i.f, a = i.n || "", d = i.p || "", y = i.res || "", p = i.b, g = !!i.a;
      if (l === "i") {
        ...
        if (t.storage.nativeHelpers.get(a))
          ...
          var f = (g ? "await " : "") + "c.l('H','" + a + "')(" + zt(t, y, i.d, d, g);
...
function Se(n, t, e, r, o = 5) {
  ...
  const s = (l) => {
    ...
    document.addEventListener("pointermove", d), document.addEventListener("pointerup", p), document.addEventListener("pointerleave", p), document.addEventListener("click", y, !0), i = () => {
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, r, o) {
    const i = t[0], s = t[1] || t[0], l = i.length, { width: h, height: c } = r.canvas, a = c / 2, d = window.devicePixelRatio || 1, y = e.barWidth ? e.barWidth * d : 1, p = e.barGap ? e.barGap * d : e.barWidth ? y / 2 : 0, g = e.barRadius || 0, u = h / (y + p) / l, f = g && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let C = 0, b = 0, v = 0;
    for (let S = 0; S <= l; S++) {
      const I = Math.round(S * u);
      if (I > C) {
        const A = Math.round(b * a * o), E = Math.round(v * a * o), T = A + E || 1;
        let P = a - A;
  ...
  renderLineWaveform(t, e, r, o) {
    const i = (s) => {
      ...
      for (let g = 0; g <= h; g++) {
        ...
        if (u > y) {
          const C = Math.round(p * a * o) || 1, b = a + C * (s === 0 ? -1 : 1);
  ...
  renderSingleCanvas(t, e, r, o, i, s, l, h) {
    ...
    this.renderWaveform(t.map((u) => u.slice(i, s)), e, y);
    const p = a.cloneNode();
    h.appendChild(p);
...
class vt extends L {
  ...
  async attachFile(e) {
    ...
    Be(r).then((o) => {
      console.log(r, this.attachedFiles), this.attachedFiles.find(({ name: i }) => i === r[0].name).url = o.data[0].url;
    }).catch((o) => alert("Error al subir archivo") || console.log(o)), this.attachedFiles.push(e.target.files[0]), this.renderAttachTemplate();
  }
  renderMessages(e) {
    e.forEach(
