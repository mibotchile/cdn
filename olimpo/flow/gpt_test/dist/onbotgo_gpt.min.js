...
var Jt = (r, t, e) => t in r ? Gt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var A = (r, t, e) => (Jt(r, typeof t != "symbol" ? t + "" : t, e), e);
class Wt {
  constructor() {
    A(this, "typography", {
...
const Zt = {}, _t = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Zt
}, Symbol.toStringTag, { value: "Module" })), Lt = /* @__PURE__ */ Kt(_t);
var vt = new Function("return this")().Promise, it = !1;
try {
  it = new Function("return (async function(){}).constructor")();
} catch (r) {
...
function q(r, t, e) {
  for (var n in t)
    Dt(t, n) && (t[n] != null && typeof t[n] == "object" && (n === "storage" || n === "prefixes") && !e ? r[n] = q(
      /*toObj[key] ||*/
      {},
      t[n]
    ) : r[n] = t[n]);
...
function $t(r, t, e, n) {
  var o, i;
  return typeof t.autoTrim == "string" ? o = i = t.autoTrim : Array.isArray(t.autoTrim) && (o = t.autoTrim[1], i = t.autoTrim[0]), (e || e === !1) && (o = e), (n || n === !1) && (i = n), o === "slurp" && i === "slurp" ? r.trim() : (o === "_" || o === "slurp" ? String.prototype.trimLeft ? r = r.trimLeft() : r = r.replace(/^[\s\uFEFF\xA0]+/, "") : (o === "-" || o === "nl") && (r = r.replace(/^(?:\n|\r|\r\n)/, "")), i === "_" || i === "slurp" ? String.prototype.trimRight ? r = r.trimRight() : r = r.replace(/[\s\uFEFF\xA0]+$/, "") : (i === "-" || i === "nl") && (r = r.replace(/(?:\n|\r|\r\n)$/, "")), r);
}
var Z = (
  /** @class */
  function() {
    ...
    return r.prototype.define = function(t, e) {
      this.cache[t] = e;
...
function I(r) {
  var t = new Error(r);
  return te(t, I.prototype), t;
}
I.prototype = Object.create(Error.prototype, {
  name: { value: "Squirrelly Error", enumerable: !1 }
});
function F(r, t, e) {
  var n = t.slice(0, e).split(/\n/), o = n.length, i = n[o - 1].length + 1;
  throw r += " at line " + o + " col " + i + `:

  ` + t.split(/\n/)[o - 1] + `
  ` + Array(i).join(" ") + "^", I(r);
}
var k = /^async +/, X = /`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g, z = /'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g, G = /"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g, xt = /[.*+\-?^${}()|[\]\\]/g;
function J(r) {
  return xt.test(r) ? r.replace(xt, "\\$&") : r;
}
function ee(r, t) {
  t.rmWhitespace && (r = r.replace(/[\r\n]+/g, `
`).replace(/^\s+|\s+$/gm, "")), X.lastIndex = 0, z.lastIndex = 0, G.lastIndex = 0;
  var e = t.prefixes, n = [
    e.h,
    e.b,
    e.i,
    ...
    return u && g ? u + "|" + J(g) : g ? J(g) : u;
  }, ""), o = new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?" + // comments, strings
  J(t.tags[1]) + ")", "g"), i = new RegExp("([^]*?)" + J(t.tags[0]) + "(-|_)?\\s*(" + n + ")?\\s*", "g"), s = 0, l = !1;
  function c(u, g) {
    var p = { f: [] }, f = 0, b = "c";
    g === "h" || g === "b" || g === "c" ? b = "n" : g === "r" && (p.raw = !0, g = "i");
    function E(V) {
      var Ct = r.slice(s, V), L = Ct.trim();
      if (b === "f")
        L === "safe" ? p.raw = !0 : t.async && k.test(L) ? (L = L.replace(k, ""), p.f.push([L, "", !0])) : p.f.push([L, ""]);
      else if (b === "fp")
        p.f[p.f.length - 1][1] += L;
      else if (b === "err") {
        if (L) {
          var zt = Ct.search(/\S/);
          F("invalid syntax", r, s + zt);
        }
      } else
        p[b] = L;
      s = V + 1;
    ...
    o.lastIndex = s;
    for (var y; (y = o.exec(r)) !== null; ) {
      var w = y[1], R = y[2], v = y[3], B = y[4], C = y[5], P = y.index;
      if (w)
        w === "(" ? (f === 0 && (b === "n" ? (E(P), b = "p") : b === "f" && (E(P), b = "fp")), f++) : w === ")" ? (f--, f === 0 && b !== "c" && (E(P), b = "err")) : f === 0 && w === "|" ? (E(P), b = "f") : w === "=>" && (E(P), s += 1, b = "res");
      else if (R) {
        if (R === "/*") {
          var D = r.indexOf("*/", o.lastIndex);
          D === -1 && F("unclosed comment", r, y.index), o.lastIndex = D + 2;
        } else if (R === "'") {
          z.lastIndex = y.index;
          var H = z.exec(r);
          H ? o.lastIndex = z.lastIndex : F("unclosed string", r, y.index);
        } else if (R === '"') {
          G.lastIndex = y.index;
          var Q = G.exec(r);
          Q ? o.lastIndex = G.lastIndex : F("unclosed string", r, y.index);
        } else if (R === "`") {
          X.lastIndex = y.index;
          var T = X.exec(r);
          T ? o.lastIndex = X.lastIndex : F("unclosed string", r, y.index);
        }
      } else if (v)
        return E(P), s = P + y[0].length, i.lastIndex = s, l = C, B && g === "h" && (g = "s"), p.t = g, p;
    }
    return F("unclosed tag", r, u), p;
  }
  function d(u, g) {
    u.b = [], u.d = [];
    var p = !1, f = [];
    ...
    for (var E; (E = i.exec(r)) !== null; ) {
      var y = E[1], w = E[2], R = E[3] || "", v;
      for (var B in e)
        if (e[B] === R) {
          v = B;
          break;
        }
      b(y, w), s = E.index + E[0].length, v || F("unrecognized tag type: " + R, r, s);
      var C = c(E.index, v), P = C.t;
      if (P === "h") {
        var D = C.n || "";
        t.async && k.test(D) && (C.a = !0, C.n = D.replace(k, "")), C = d(C), f.push(C);
      } else if (P === "c") {
        if (u.n === C.n)
          return p ? (p.d = f, u.b.push(p)) : u.d = f, u;
        F("Helper start and end don't match", r, E.index + E[0].length);
      } else if (P === "b") {
        p ? (p.d = f, u.b.push(p)) : u.d = f;
        var H = C.n || "";
        t.async && k.test(H) && (C.a = !0, C.n = H.replace(k, "")), p = C, f = [];
      } else if (P === "s") {
        var Q = C.n || "";
        t.async && k.test(Q) && (C.a = !0, C.n = Q.replace(k, "")), f.push(C);
      } else
        f.push(C);
    }
    if (g)
      b(r.slice(s, r.length), !1), u.d = f;
    else
      throw I('unclosed helper "' + u.n + '"');
    return u;
  }
  var a = d({ f: [] }, !0);
  if (t.plugins)
    for (var h = 0; h < t.plugins.length; h++) {
      var m = t.plugins[h];
      m.processAST && (a.d = m.processAST(a.d, t));
    }
  return a.d;
}
function It(r, t) {
  var e = ee(r, t), n = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + j(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function et(r, t) {
  for (var e = 0; e < t.length; e++) {
    var n = t[e][0], o = t[e][1], i = t[e][2];
    r = (i ? "await " : "") + "c.l('F','" + n + "')(" + r, o && (r += "," + o), r += ")";
  }
  return r;
}
function Ht(r, t, e, n, o, i) {
  var s = "{exec:" + (o ? "async " : "") + Ft(e, t, r) + ",params:[" + n + "]";
  return i && (s += ",name:'" + i + "'"), o && (s += ",async:true"), s += "}", s;
}
function ne(r, t) {
  for (var e = "[", n = 0; n < r.length; n++) {
    var o = r[n];
    e += Ht(t, o.res || "", o.d, o.p || "", o.a, o.n), n < r.length && (e += ",");
  }
  return e += "]", e;
}
function Ft(r, t, e) {
  return "function(" + t + "){var tR='';" + j(r, e) + "return tR}";
}
function j(r, t) {
  var e = 0, n = r.length, o = "";
  for (e; e < n; e++) {
    var i = r[e];
    if (typeof i == "string") {
      var s = i;
      ...
      var l = i.t, c = i.c || "", d = i.f, a = i.n || "", h = i.p || "", m = i.res || "", u = i.b, g = !!i.a;
      if (l === "i") {
        t.defaultFilter && (c = "c.l('F','" + t.defaultFilter + "')(" + c + ")");
        var p = et(c, d);
        !i.raw && t.autoEscape && (p = "c.l('F','e')(" + p + ")"), o += "tR+=" + p + ";";
      } else if (l === "h")
        if (t.storage.nativeHelpers.get(a))
          o += t.storage.nativeHelpers.get(a)(i, t);
        else {
          var f = (g ? "await " : "") + "c.l('H','" + a + "')(" + Ht(t, m, i.d, h, g);
          u ? f += "," + ne(u, t) : f += ",[]", f += ",c)", o += "tR+=" + et(f, d) + ";";
        }
      else
        l === "s" ? o += "tR+=" + et((g ? "await " : "") + "c.l('H','" + a + "')({params:[" + h + "]},[],c)", d) + ";" : l === "e" && (o += c + `
`);
    }
  }
  return o;
...
function N(r, t, e, n) {
  if (t && t.length > 0)
    throw I((n ? "Native" : "") + "Helper '" + r + "' doesn't accept blocks");
  if (e && e.length > 0)
    throw I((n ? "Native" : "") + "Helper '" + r + "' doesn't accept filters");
}
function kt(r, t, e, n, o) {
  e(r[t], t).then(function(i) {
    n += i, t === r.length - 1 ? o(n) : kt(r, t + 1, e, n, o);
  });
}
function Ut(r, t, e, n, o, i) {
  n(t[e], r[t[e]]).then(function(s) {
    o += s, e === t.length - 1 ? i(o) : Ut(r, t, e + 1, n, o, i);
  });
}
var re = {
  "&": "&amp;",
...
function ie(r) {
  var t = String(r);
  return /[&<>"']/.test(t) ? t.replace(/[&<>"']/g, oe) : t;
}
var se = new Z({}), ut = new Z({
  each: function(r, t) {
    var e = "", n = r.params[0];
    if (N("each", t, !1), r.async)
  ...
  foreach: function(r, t) {
    var e = r.params[0];
    if (N("foreach", t, !1), r.async)
      return new Promise(function(i) {
        Ut(e, Object.keys(e), 0, r.exec, "", i);
      });
    var n = "";
    for (var o in e)
      Dt(e, o) && (n += r.exec(o, e[o]));
    return n;
  },
  include: function(r, t, e) {
    N("include", t, !1);
    var n = e.storage.templates.get(r.params[0]);
    if (!n)
      throw I('Could not fetch template "' + r.params[0] + '"');
    return n(r.params[1], e);
  },
  extends: function(r, t, e) {
    var n = r.params[1] || {};
    n.content = r.exec();
    ...
    var s = e.storage.templates.get(r.params[0]);
    if (!s)
      throw I('Could not fetch template "' + r.params[0] + '"');
    return s(n, e);
  },
  useScope: function(r, t) {
    return N("useScope", t, !1), r.exec(r.params[0]);
  }
}), ae = new Z({
  if: function(r, t) {
    N("if", !1, r.f, !0);
    var e = "if(" + r.p + "){" + j(r.d, t) + "}";
    if (r.b)
      for (var n = 0; n < r.b.length; n++) {
        var o = r.b[n];
        o.n === "else" ? e += "else{" + j(o.d, t) + "}" : o.n === "elif" && (e += "else if(" + o.p + "){" + j(o.d, t) + "}");
      }
    return e;
  },
  try: function(r, t) {
    if (N("try", !1, r.f, !0), !r.b || r.b.length !== 1 || r.b[0].n !== "catch")
      throw I("native helper 'try' only accepts 1 block, 'catch'");
    var e = "try{" + j(r.d, t) + "}", n = r.b[0];
    return e += "catch" + (n.res ? "(" + n.res + ")" : "") + "{" + j(n.d, t) + "}", e;
  },
  block: function(r, t) {
    N("block", r.b, r.f, !0);
    var e = "if(!" + t.varName + "[" + r.p + "]){tR+=(" + Ft(r.d, "", t) + ")()}else{tR+=" + t.varName + "[" + r.p + "]}";
    return e;
  }
}), le = new Z({ e: ie }), st = {
  varName: "it",
  ...
  l: function(r, t) {
    if (r === "H") {
      ...
      if (e)
        return e;
      throw I("Can't find helper '" + t + "'");
    } else if (r === "F") {
      var n = this.storage.filters.get(t);
      if (n)
        return n;
      throw I("Can't find filter '" + t + "'");
    }
  },
  async: !1,
  storage: {
...
function _(r, t) {
  var e = {};
  return q(e, st), t && q(e, t), r && q(e, r), e.l.bind(e), e;
}
function pt(r, t) {
  var e = _(t || {}), n = Function;
  if (e.async)
    if (it)
      n = it;
    else
      throw I("This environment doesn't support async/await");
  try {
    return new n(
      e.varName,
      "c",
    ...
    throw o instanceof SyntaxError ? I(`Bad template syntax
...
function de(r, t) {
  var e, n, o = t.views, i = /^[A-Za-z]+:\\|^\//.exec(r);
  if (i && i.length)
    e = rt(r.replace(/^\/*/, ""), t.root || "/", !0);
  else if (t.filename && (n = rt(r, t.filename), at.existsSync(n) && (e = n)), e || Array.isArray(o) && o.some(function(s) {
    return n = rt(r, s, !0), at.existsSync(n);
  }) && (e = n), !e)
    throw I('Could not find the include file "' + r + '"');
  return e;
}
function jt(r) {
  return at.readFileSync(r).toString().replace(ce, "");
}
function he(r, t) {
  var e = _(t), n = jt(r);
  try {
    ...
    throw I("Loading file: " + r + " failed");
  }
}
function ge(r) {
  var t = r.filename;
  if (r.cache) {
    var e = r.storage.templates.get(t);
    return e || he(t, r);
  }
  return pt(jt(t), r);
}
function Nt(r, t) {
  var e = _({ filename: de(r, t) }, t);
  return ge(e);
}
function ue(r, t, e) {
  if (t && t.length > 0)
    throw I("Helper 'includeFile' doesn't accept blocks");
  return Nt(r.params[0], e)(r.params[1], e);
}
function pe(r, t, e) {
  var n = r.params[1] || {};
  n.content = r.exec();
  ...
  return Nt(r.params[0], e)(n, e);
}
function ot(r, t) {
  var e;
  return t.cache && t.name && t.storage.templates.get(t.name) ? t.storage.templates.get(t.name) : (typeof r == "function" ? e = r : e = pt(r, t), t.cache && t.name && t.storage.templates.define(t.name, e), e);
}
function Ae(r, t, e, n) {
  var o = _(e || {});
  if (o.async) {
    ...
    if (n)
      ...
      throw I("Please provide a callback function, this env doesn't support Promises");
    }
  } else
    return ot(r, o)(t, o);
}
ut.define("includeFile", ue);
...
const fe = "onbotgo-box";
class Y extends M {
  constructor() {
    super(), this.setStyles({
      fontFamily: x.typography.primary
    });
  }
}
Y.tag = fe;
const K = "onbotgo-bubble";
class At extends M {
  constructor(t) {
    super(), this.innerHTML = t, this.innerHTML = this.isIconValid(t) ? t : x.defaultIcon;
  }
  isIconValid(t) {
    var n, o, i, s;
    if (!t)
      return !1;
    const e = new Y();
    if (e.innerHTML = t, !["svg", "i", "img"].includes((o = (n = e.children[0]) == null ? void 0 : n.tagName) == null ? void 0 : o.toLowerCase()))
      return console.error(`node is not valid.
 allowed nodes: "svg", "i", "img"`), !1;
    for (let l = 0; l < e.childNodes.length; l++) {
      const c = (s = (i = e.childNodes[l]) == null ? void 0 : i.tagName) == null ? void 0 : s.toLowerCase();
      if (["script"].includes(c))
        return console.error(`Element "<${c}>" is not valid.`), !1;
    }
    return !0;
  }
}
...
}), Ee = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
{{ /if}} {{/if}}\r
`;
var be = globalThis && globalThis.__awaiter || function(r, t, e, n) {
  function o(i) {
  ...
  return new (e || (e = Promise))(function(i, s) {
    ...
    function d(a) {
      a.done ? i(a.value) : o(a.value).then(l, c);
    }
...
function Ce(r, t) {
  return typeof r[0] == "number" && (r = [r]), Re(r), {
    duration: t,
    length: r[0].length,
    sampleRate: r[0].length / t,
    numberOfChannels: r.length,
    getChannelData: (e) => r == null ? void 0 : r[e],
...
var St = globalThis && globalThis.__awaiter || function(r, t, e, n) {
  function o(i) {
    return i instanceof e ? i : new e(function(s) {
      s(i);
    });
...
function ve(r, t, e) {
  ...
  return St(this, void 0, void 0, function* () {
    ...
    {
      const s = (n = i.clone().body) === null || n === void 0 ? void 0 : n.getReader(), l = Number((o = i.headers) === null || o === void 0 ? void 0 : o.get("Content-Length"));
      let c = 0;
      const d = (a, h) => St(this, void 0, void 0, function* () {
        if (a)
          return;
        c += (h == null ? void 0 : h.length) || 0;
        const m = Math.round(c / l * 100);
        return t(m), s == null ? void 0 : s.read().then(({ done: u, value: g }) => d(u, g));
      });
      s == null || s.read().then(({ done: a, value: h }) => d(a, h));
    }
    return i.blob();
  });
}
...
class ft {
  ...
  once(t, e) {
    const n = this.on(t, e), o = this.on(t, () => {
      n(), o();
    });
    return n;
  }
...
class Ie extends ft {
  ...
  onMediaEvent(t, e, n) {
    return this.media.addEventListener(t, e, n), () => this.media.removeEventListener(t, e);
  }
  onceMediaEvent(t, e) {
...
function we(r, t, e, n, o = 5) {
  ...
  const s = (l) => {
    ...
    let c = l.clientX, d = l.clientY, a = !1;
    const h = (g) => {
      g.preventDefault(), g.stopPropagation();
      const p = g.clientX, f = g.clientY;
      if (a || Math.abs(p - c) >= o || Math.abs(f - d) >= o) {
        const { left: b, top: E } = r.getBoundingClientRect();
        a || (a = !0, e == null || e(c - b, d - E)), t(p - c, f - d, p - b, f - E), c = p, d = f;
      }
    }, m = (g) => {
    ...
    document.addEventListener("pointermove", h), document.addEventListener("pointerup", u), document.addEventListener("pointerleave", u), document.addEventListener("click", m, !0), i = () => {
      document.removeEventListener("pointermove", h), document.removeEventListener("pointerup", u), document.removeEventListener("pointerleave", u), setTimeout(() => {
        document.removeEventListener("click", m, !0);
      }, 10);
    };
  };
  return r.addEventListener("pointerdown", s), () => {
    i(), r.removeEventListener("pointerdown", s);
  };
}
class $ extends ft {
  constructor(t, e) {
    ...
    let n;
    if (typeof t.container == "string" ? n = document.querySelector(t.container) : t.container instanceof HTMLElement && (n = t.container), !n)
      throw new Error("Container not found");
    this.parent = n;
    const [o, i] = this.initHtml();
    n.appendChild(o), this.container = o, this.scrollContainer = i.querySelector(".scroll"), this.wrapper = i.querySelector(".wrapper"), this.canvasWrapper = i.querySelector(".canvases"), this.progressWrapper = i.querySelector(".progress"), this.cursor = i.querySelector(".cursor"), e && i.appendChild(e), this.initEvents();
  }
  initEvents() {
    this.wrapper.addEventListener("click", (e) => {
      const n = this.wrapper.getBoundingClientRect(), i = (e.clientX - n.left) / n.width;
      this.emit("click", i);
    }), this.options.dragToSeek && this.initDrag(), this.scrollContainer.addEventListener("scroll", () => {
      const { scrollLeft: e, scrollWidth: n, clientWidth: o } = this.scrollContainer, i = e / n, s = (e + o) / n;
  ...
  createDelay(t = 10) {
    const e = {};
    return this.timeouts.push(e), (n) => {
      e.timeout && clearTimeout(e.timeout), e.timeout = setTimeout(n, t);
    };
  }
  ...
  renderBarWaveform(t, e, n, o) {
    const i = t[0], s = t[1] || t[0], l = i.length, { width: c, height: d } = n.canvas, a = d / 2, h = window.devicePixelRatio || 1, m = e.barWidth ? e.barWidth * h : 1, u = e.barGap ? e.barGap * h : e.barWidth ? m / 2 : 0, g = e.barRadius || 0, p = c / (m + u) / l, f = g && "roundRect" in n ? "roundRect" : "rect";
    n.beginPath();
    let b = 0, E = 0, y = 0;
    for (let w = 0; w <= l; w++) {
      const R = Math.round(w * p);
      if (R > b) {
        const C = Math.round(E * a * o), P = Math.round(y * a * o), D = C + P || 1;
        let H = a - C;
        e.barAlign === "top" ? H = 0 : e.barAlign === "bottom" && (H = d - D), n[f](b * (m + u), H, m, D, g), b = R, E = 0, y = 0;
      }
      const v = Math.abs(i[w] || 0), B = Math.abs(s[w] || 0);
      v > E && (E = v), B > y && (y = B);
    }
    n.fill(), n.closePath();
  }
  renderLineWaveform(t, e, n, o) {
    const i = (s) => {
      const l = t[s] || t[0], c = l.length, { height: d } = n.canvas, a = d / 2, h = n.canvas.width / c;
      n.moveTo(0, a);
      let m = 0, u = 0;
      for (let g = 0; g <= c; g++) {
        const p = Math.round(g * h);
        if (p > m) {
          const b = Math.round(u * a * o) || 1, E = a + b * (s === 0 ? -1 : 1);
          n.lineTo(m, E), m = p, u = 0;
        }
  ...
  renderWaveform(t, e, n) {
    if (n.fillStyle = this.convertColorValues(e.waveColor), e.renderFunction) {
      e.renderFunction(t, n);
      return;
    }
    let o = e.barHeight || 1;
    if (e.normalize) {
    ...
    if (e.barWidth || e.barGap || e.barAlign) {
      this.renderBarWaveform(t, e, n, o);
      return;
    }
    this.renderLineWaveform(t, e, n, o);
  }
  renderSingleCanvas(t, e, n, o, i, s, l, c) {
    const d = window.devicePixelRatio || 1, a = document.createElement("canvas"), h = t[0].length;
    a.width = Math.round(n * (s - i) / h), a.height = o * d, a.style.width = `${Math.floor(a.width / d)}px`, a.style.height = `${o}px`, a.style.left = `${Math.floor(i * n / d / h)}px`, l.appendChild(a);
    const m = a.getContext("2d");
    this.renderWaveform(t.map((p) => p.slice(i, s)), e, m);
    const u = a.cloneNode();
    c.appendChild(u);
    const g = u.getContext("2d");
    a.width > 0 && a.height > 0 && g.drawImage(a, 0, 0), g.globalCompositeOperation = "source-in", g.fillStyle = this.convertColorValues(e.progressColor), g.fillRect(0, 0, a.width, a.height);
  }
  renderChannel(t, e, n) {
    ...
    const { scrollLeft: l, scrollWidth: c, clientWidth: d } = this.scrollContainer, a = t[0].length, h = a / c;
    let m = Math.min($.MAX_CANVAS_WIDTH, d);
    if (e.barWidth || e.barGap) {
      const R = e.barWidth || 0.5, v = e.barGap || R / 2, B = R + v;
      m % B !== 0 && (m = Math.floor(m / B) * B);
    }
    const u = Math.floor(Math.abs(l) * h), g = Math.floor(u + m * h), p = g - u, f = (R, v) => {
      this.renderSingleCanvas(t, e, n, i, Math.max(0, R), Math.min(v, a), o, s);
    }, b = this.createDelay(), E = this.createDelay(), y = (R, v) => {
      f(R, v), R > 0 && b(() => {
        y(R - p, v - p);
      });
    }, w = (R, v) => {
  ...
  render(t) {
    ...
    const e = window.devicePixelRatio || 1, n = this.scrollContainer.clientWidth, o = Math.ceil(t.duration * (this.options.minPxPerSec || 0));
    this.isScrolling = o > n;
    const i = this.options.fillParent && !this.isScrolling, s = (i ? n : o) * e;
    if (this.wrapper.style.width = i ? "100%" : `${o}px`, this.scrollContainer.style.overflowX = this.isScrolling ? "auto" : "hidden", this.scrollContainer.classList.toggle("noScrollbar", !!this.options.hideScrollbar), this.cursor.style.backgroundColor = `${this.options.cursorColor || this.options.progressColor}`, this.cursor.style.width = `${this.options.cursorWidth}px`, this.options.splitChannels)
      for (let l = 0; l < t.numberOfChannels; l++) {
        const c = Object.assign(Object.assign({}, this.options), this.options.splitChannels[l]);
        this.renderChannel([t.getChannelData(l)], c, s);
      }
    else {
  ...
  scrollIntoView(t, e = !1) {
    const { clientWidth: n, scrollLeft: o, scrollWidth: i } = this.scrollContainer, s = i * t, l = n / 2, c = e && this.options.autoCenter && !this.isDragging ? l : n;
    if (s > o + c || s < o)
      if (this.options.autoCenter && !this.isDragging) {
        const d = l / 20;
        s - (o + l) >= d && s < o + n ? this.scrollContainer.scrollLeft += d : this.scrollContainer.scrollLeft = s - l;
      } else
        this.isDragging ? this.scrollContainer.scrollLeft = s < o ? s - 10 : s - n + 10 : this.scrollContainer.scrollLeft = s;
    {
      const { scrollLeft: d } = this.scrollContainer, a = d / i, h = (d + n) / i;
      this.emit("scroll", a, h);
    }
  }
  renderProgress(t, e) {
...
var W = globalThis && globalThis.__awaiter || function(r, t, e, n) {
  function o(i) {
    return i instanceof e ? i : new e(function(s) {
      s(i);
    });
...
class tt extends Ie {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, Pe, t), this.timer = new Se();
    const o = t.media ? void 0 : this.getMediaElement();
    this.renderer = new $(this.options, o), this.initPlayerEvents(), this.initRendererEvents(), this.initTimerEvents(), this.initPlugins();
    const i = this.options.url || ((e = this.options.media) === null || e === void 0 ? void 0 : e.currentSrc) || ((n = this.options.media) === null || n === void 0 ? void 0 : n.src);
  ...
  loadAudio(t, e, n, o) {
    return W(this, void 0, void 0, function* () {
      if (this.emit("load", t), this.isPlaying() && this.pause(), this.decodedData = null, !e && !n) {
        const i = (s) => this.emit("loading", s);
        e = yield xe.fetchBlob(t, i, this.options.fetchParams);
      }
      if (this.setSrc(t, e), n)
        o = (yield Promise.resolve(o || this.getDuration())) || (yield new Promise((i) => {
          this.onceMediaEvent("loadedmetadata", () => i(this.getDuration()));
        })) || (yield Promise.resolve(0)), this.decodedData = wt.createBuffer(n, o);
      else if (e) {
        const i = yield e.arrayBuffer();
        this.decodedData = yield wt.decode(i, this.options.sampleRate);
      }
  ...
  load(t, e, n) {
    return W(this, void 0, void 0, function* () {
      yield this.loadAudio(t, void 0, e, n);
    });
  }
  /** Load an audio blob */
  loadBlob(t, e, n) {
    return W(this, void 0, void 0, function* () {
      yield this.loadAudio("blob", t, e, n);
    });
  }
  ...
  /** Get decoded peaks */
  exportPeaks({ channels: t = 1, maxLength: e = 8e3, precision: n = 1e4 } = {}) {
    if (!this.decodedData)
      throw new Error("The audio has not been decoded yet");
    const o = Math.min(t, this.decodedData.numberOfChannels), i = [];
    for (let s = 0; s < o; s++) {
      const l = this.decodedData.getChannelData(s), c = Math.min(l.length, e), d = l.length / c, a = [];
      for (let h = 0; h < c; h++) {
        const m = Math.round(h * d), u = l[m];
        a.push(Math.round(u * n) / n);
      }
      i.push(a);
    }
    return i;
...
const lt = `<svg fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" \r
...
class mt extends M {
  constructor(e, n = !1) {
    ...
    if (this.message = e, this.setStyles({
      ...
      alignItems: "center"
    }), this.innerHTML = this.renderHTML(Ee, {
      type: e.type,
      fileType: e.fileType,
      file: e.file,
      message: e.message,
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
      let o;
      typeof e.file == "string" ? o = e.file : o = URL.createObjectURL(e.file), this.wavesurfer = tt.create({
        barHeight: 12,
        height: 24,
        barWidth: 1,
      ...
      let i = typeof e.file == "string" ? e.file : URL.createObjectURL(e.file);
      o.src = i, o.style.objectFit = "cover", o.style.minHeight = "100px", o.style.minWidth = "100px", o.style.maxHeight = "80%", o.style.maxWidth = "80%", this.querySelector(".onbotgo-message").appendChild(o);
    } else if (!e.fileType && e.type === "userMessage") {
      const o = this.querySelector(".onbotgo-message");
      this.appendChild(this.getAvatarMessage("userMessage")), o.innerText += e.message;
    } else if (!e.fileType && e.type === "apiMessage") {
      const o = this.querySelector(".onbotgo-message");
      this.insertBefore(
        this.getAvatarMessage("apiMessage", n),
        o
  ...
  handlePlayPause() {
    this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
      ...
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = Be;
    }), this.wavesurfer.on("pause", () => {
      this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
        this.wavesurfer.play();
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = lt;
    });
  }
  setLoadingAnimation() {
    this.querySelectorAll(".dot").forEach(
      (e, n) => e.animate([{ transform: "translateY(-5px)", opacity: 0.2 }], {
        direction: "alternate",
        delay: n * 200,
        duration: 500,
        iterations: 1 / 0
  ...
  getAvatarMessage(e = "api", n = !1) {
    const o = new Y();
    let i;
    return e === "apiMessage" && !n ? i = Me : e === "userMessage" ? i = Le : n && (i = Te), o.innerHTML = `<img src=${i} width="25" height="25" />`, o.setStyles({
      padding: "5px",
      marginRight: "10px",
      backgroundColor: x.colors.primary,
      borderRadius: "100px",
...
class He {
  constructor() {
    A(this, "gpt_url", "https://endpoint-prod-chatgpt.mibot.cl:8080");
    A(this, "storage_url", "https://helpers.mibot.cl:444");
    A(this, "messageHistoryId", "");
    A(this, "chatflowID", "");
    A(this, "socketUid", "");
    A(this, "welcomeMessage", "¡Hola! ¿En qué puedo ayudarte hoy?");
  }
}
const S = new He(), Pt = async (r) => await fetch(`${S.gpt_url}/chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), Fe = async (r) => await fetch(`${S.gpt_url}/messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), ke = `<input\r
...
class Et extends M {
  constructor() {
    ...
    A(this, "input");
    this.innerHTML = this.renderHTML(ke, { sendIcon: Yt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(Y.tag), this.input.style.fontFamily = x.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
    this.sendIcon.onclick = () => e(this.input.value), this.input.onkeydown = (n) => {
      ["13", "Enter"].includes(n.key) && (e(this.input.value), this.input.value = "");
    };
  }
}
Et.tag = ct;
...
class bt extends HTMLElement {
  ...
  moveScrollThumb() {
    const e = this.shadowRoot.querySelector(
      ...
      ".custom-scrollbar__track"
    ).offsetHeight, o = this.targetEl.scrollTop / this.targetEl.scrollHeight * n;
    e.style.top = `${o}px`;
  }
  setTargetElCSS() {
  ...
  setScrollThumbHeight() {
    ...
    n.addEventListener("mousedown", (a) => {
      c = !0, d = a.clientY, this.preventContentHighlight("remove");
    }), document.addEventListener("mouseup", () => {
      c = !1, this.preventContentHighlight("add");
    }), document.addEventListener("mousemove", (a) => {
      if (!c)
        return;
      const h = a.clientY - d;
      d = a.clientY, this.targetEl.scrollTop += h * (s / o);
    });
  }
...
bt.tag = "onbotgo-customscrollbar";
const je = `<onbotgo-box\r
  style="\r
    padding: 20px;\r
...
</svg>`, Mt = '<svg  style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M28,14H18V4c0-1.104-0.896-2-2-2s-2,0.896-2,2v10H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h10v10c0,1.104,0.896,2,2,2  s2-0.896,2-2V18h10c1.104,0,2-0.896,2-2S29.104,14,28,14z"/></svg>';
class ht {
}
A(ht, "messageHistoryId", {
...
const qe = "data:image/png;base64,", Qe = async (r) => await fetch(`${S.storage_url}/storage/upload`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), O = "onbotgo-chatcontainer";
class yt extends M {
  constructor() {
    super();
    A(this, "messagesHistory", [
      ...
      ...ht.messagesHistory.get() ?? []
    ]);
    A(this, "attachedFiles", []);
    A(this, "attachedRecord");
    A(this, "header");
    A(this, "messagesContainer");
    A(this, "scrollBar");
    A(this, "chatInput");
    A(this, "attachFileInput");
    A(this, "btnOnbotgoAttachInput");
    A(this, "btnattachNewFile");
    A(this, "isRecordSelected", !1);
    A(this, "messagesWebsocket");
    A(this, "chattingWith", "virtual_assistant");
  ...
  initMessagesWebsocket(e) {
    this.messagesWebsocket && this.messagesWebsocket.OPEN && console.log("WS MESSAGES IS CONNECTED ", this.messagesWebsocket);
    const n = `wss://endpoint-prod-chatgpt.mibot.cl:8080/messages/${e}/ws`;
    this.messagesWebsocket = new WebSocket(n), this.messagesWebsocket.onmessage = (o) => {
      const i = JSON.parse(o.data);
      if (console.log("ON MESSAGE ", i), i.event === "incoming_message") {
        const s = i.data;
        this.addMessages(
          [{ message: s.content, type: "apiMessage" }],
          { updateScrollbar: !0 },
          !0
        );
      }
    }, this.messagesWebsocket.onopen = (o) => {
      console.log("SOCKET CONNECTED ", o), this.messagesWebsocket.send(
        JSON.stringify({ event: "connected", data: null })
      );
    }, this.messagesWebsocket.onerror = (o) => {
      console.log("SOCKET ERRROR ", o);
    }, this.messagesWebsocket.onclose = (o) => {
      console.log("SOCKET Disconnected", o);
    };
  }
  ...
  onSubmit(e) {
    ...
    const o = {
      channel_id: S.chathubChannelId,
      message: this.attachedFiles.length && !e && !this.attachedRecord ? "Adjunto comprobante de pago" : e,
      url: (this.attachedFiles || []).map(({ url: i }) => i),
      unique_id: S.messageHistoryId
    };
    if (this.attachedFiles.length && (this.addMessages(
    ...
    ]), e && this.addMessages([{ message: e, type: "userMessage" }]), this.renderMessages([{ type: "LoadingMessage" }]), this.updateScrollbar(), this.isRecordSelected = !1, this.attachedRecord = null, this.chatInput.getChild("input").value = "", this.getChild("#onbotgo-chatinput").style.display = "grid", this.getChild("#onbotgo-attachFileTemplateContainer").style.display = "grid", this.getChild("#onbotgo-micrecord").style.display = "none", this.updateScrollbar(), this.chattingWith === "human_agent") {
      Fe({
        content: `${o.message}
${o.url}`,
        conversation_id: S.messageHistoryId,
        channel_id: S.chathubChannelId,
        sender: "user"
      }).finally(() => {
        var i;
        (i = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || i.forEach((s) => s.remove());
      });
      return;
    }
    o.url.length ? o.url.forEach((i) => {
      Pt({
        ...o,
        message: `envio comprobante de pago, esta es la url "${i}"`,
        url: void 0
      }).then((s) => {
        var l, c;
        s != null && s.unique_id && (S.messageHistoryId = s.unique_id, this.initMessagesWebsocket(S.messageHistoryId)), (c = (l = s == null ? void 0 : s.data) == null ? void 0 : l.process) != null && c.length && s.data.process.forEach((d) => {
          this.addMessages([
            {
              type: d.role,
              name: d.name,
          ...
          { message: s.response, type: "apiMessage" }
        ]), s.redirect && (this.chattingWith = "human_agent");
      }).catch((s) => console.log(s)).finally(() => {
        var s;
        (s = this.messagesContainer.querySelectorAll(".loading-api-message")) == null || s.forEach((l) => l.remove()), this.updateScrollbar();
      });
    }) : Pt(o).then((i) => {
      var s, l;
      i != null && i.unique_id && (S.messageHistoryId = i.unique_id, this.initMessagesWebsocket(S.messageHistoryId)), (l = (s = i == null ? void 0 : i.data) == null ? void 0 : s.process) != null && l.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
      ...
      ]), i.redirect && (this.chattingWith = "human_agent");
  ...
  async attachFile(e) {
    ...
    try {
      o.querySelector("svg").style.display = "none", o.innerHTML += `<style>.onbotgo-lds-ring {
        display: grid;
        position: relative;
        place-items: center;
        width: 19px;
      ...
      .onbotgo-lds-ring div {
        ...
        width: 19px;
        height: 19px;
        border: 2px solid ${x.colors.primary};
        border-radius: 50%;
        animation: onbotgo-lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;
        border-color: ${x.colors.primary} transparent transparent transparent;
      }
      ...
      const i = await Qe(n);
      this.attachedFiles.push(e.target.files[0]), this.attachedFiles.find(({ name: s }) => s === n[0].name).url = i.data[0].url;
    } catch (i) {
      console.log(i);
    }
    o.querySelector("style").remove(), o.querySelector(".onbotgo-lds-ring").remove(), this.renderAttachTemplate();
  }
  renderMessages(e, n = !1) {
    e.forEach(
      (o) => !["dataMessage"].includes(o.type) && this.messagesContainer.appendChild(new mt(o, n))
    );
  }
  addMessages(e, { updateScrollbar: n } = { updateScrollbar: !1 }, o = !1) {
    this.messagesHistory = this.messagesHistory.concat(e), this.renderMessages(e, o), n && this.updateScrollbar();
  }
  updateScrollbar() {
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(Ne, {
    ...
    }, this.btnattachNewFile.onclick = () => this.attachFileInput.click(), this.attachFileInput.onchange = (e) => this.attachFile(e), this.querySelectorAll(".onbotgo-attachedFile").forEach((e, n) => {
      e.querySelector("i").onclick = (o) => {
        this.attachedFiles.splice(n, 1), this.renderAttachTemplate(), this.attachedFiles.length && (this.querySelector(".onbotgo-dropdown-content").style.display = "flex"), o.stopPropagation();
      };
    });
  }
  render() {
    this.innerHTML = this.renderHTML(je, {
      logo: Ye,
      micIcon: Oe,
      paperclipIcon: Bt,
      attachedFiles: this.attachedFiles,
    ...
    const e = this.querySelector("onbotgo-micrecord"), n = this.querySelector("onbotgo-dropdown");
    this.messagesContainer = this.querySelector("#onbotgo-messageContainer"), this.chatInput = this.querySelector(Et.tag), this.scrollBar = this.querySelector(bt.tag), this.header = this.querySelector("#onbotgo-chatheader"), this.header.style.display = "flex", this.header.style.width = "100%", this.header.style.justifyContent = "center", this.header.style.backgroundColor = x.colors.primary;
    const o = this.header.getChild("img");
    o.src = qe, o.style.objectFit = "cover", this.getChild("#onbotgo-btnrecordSend").style.display = "none", this.querySelector("#onbotgo-btnrecord").onclick = () => {
    ...
    }, this.chatInput.onSubmit(this.onSubmit.bind(this)), this.renderMessages(this.messagesHistory), this.isRecordSelected ? (n.style.display = "none", this.chatInput.style.display = "none", e.style.display = "flex") : (n.style.display = "grid", this.btnattachNewFile.style.display = "grid", this.chatInput.style.display = "grid", e.style.display = "none");
  }
}
const Ve = (r) => ({
  [`${O}.hidden`]: {
  ...
  [`${O} .onbotgo-messageContainer`]: {
    display: "flex !important"
  },
  [`${O} .onbotgo-chat-footer`]: {
    "font-family": r.typography.primary,
    display: "flex !important",
    "align-items": "center",
    "justify-content": "flex-end",
    gap: "5px"
  },
  [`${O} .onbotgo-icon-paperclip path`]: {
    stroke: r.colors.primary
  }
});
yt.tag = O;
const Ot = "onbotgo-chatbot";
class gt extends M {
  constructor() {
    super();
    ...
    const e = new At(x.customIcon), n = new yt();
    e.onclick = () => n.toggle(), this.appendChild(e), this.appendChild(n), this.setStyles(this.componentStyles);
  }
  connectedCallback() {
  }
}
...
function ze({ element: r, styles: t }) {
  const e = t.reduce(
    (i, s) => ({
      ...i,
      ...s
    ...
    {}
  ), n = document.createElement("style"), o = We(e);
  n.innerHTML = o, r.prepend(n);
}
function Ge(r, t = {}) {
  const e = Object.keys(t), n = Object.values(t);
  let o = `${r}{`;
  return e.forEach((i, s) => o += `${i}:${n[s]};`), o + "}";
}
function Je(r, t = {}) {
  const e = Object.keys(t), n = Object.values(t);
  let o = `${r}{`;
...
class qt extends M {
  constructor() {
    ...
    let n = "black";
    t === "primary" && (n = x.colors.primary), t === "danger" && (n = "red"), e && (this.querySelector("svg").style.width = `calc(${e} - 16px)`, this.querySelector("svg").style.height = `calc(${e} - 16px)`, this.setStyles({ width: e, height: e })), this.setStyles({ color: n });
    const o = new Y();
    o.setStyles({
      backgroundColor: n,
      opacity: 0.2,
...
class Qt extends M {
  constructor() {
    ...
    t.style.display = "none", t.style.position = "absolute", t.style.backgroundColor = "white", t.style.minWidth = "170px", t.style.width = "fit-content", t.style.borderRadius = "8px", t.style.bottom = "100%", t.style.left = "50%", t.style.transform = "translateX(-50%)", t.style.boxShadow = "0px 8px 16px 0px rgba(0, 0, 0, 0.2)", t.style.padding = "12px 16px", t.style.zIndex = "1", t.style.gap = "10px", t.style.justifyContent = "space-between", t.style.flexDirection = "column", e.forEach((n) => {
      n.style.maxWidth = "180px", n.style.textOverflow = "ellipsis", n.style.overflow = "hidden", n.style.whiteSpace = "nowrap", n.style.minWidth = "170px";
    }), document.body.onclick = (n) => {
      if (this.contains(n.target))
        return t.contains(n.target) ? void 0 : this.toggle();
...
class Vt extends M {
  constructor() {
    ...
    const t = this.getAttribute("color"), e = this.getAttribute("size");
    let n = "black";
    t === "primary" && (n = x.colors.primary), e && this.setStyles({ width: e, height: e }), this.setStyles({
      backgroundColor: t ? n : "transparent",
      fill: "white"
    });
  }
}
Vt.tag = _e;
const $e = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, tn = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
function Tt(r, t, e, n) {
  return new (e || (e = Promise))(function(o, i) {
    ...
    function c(d) {
      var a;
      d.done ? o(d.value) : (a = d.value, a instanceof e ? a : new e(function(h) {
        h(a);
      })).then(s, l);
    }
...
const rn = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class Rt extends nn {
  constructor(t) {
    var e;
  ...
  renderMicStream(t) {
    const e = new AudioContext(), n = e.createMediaStreamSource(t), o = e.createAnalyser();
    n.connect(o);
    const i = o.frequencyBinCount, s = new Float32Array(i), l = i / e.sampleRate;
    let c;
    const d = () => {
      o.getFloatTimeDomainData(s), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = !1, this.wavesurfer.load("", [s], l)), c = requestAnimationFrame(d);
    };
    return d(), () => {
      cancelAnimationFrame(c), n == null || n.disconnect(), e == null || e.close();
    };
  }
  startMic() {
  ...
  startRecording() {
    return Tt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || rn.find((o) => MediaRecorder.isTypeSupported(o)), audioBitsPerSecond: this.options.audioBitsPerSecond });
      this.mediaRecorder = e, this.stopRecording();
      const n = [];
      e.ondataavailable = (o) => {
        o.data.size > 0 && n.push(o.data);
      }, e.onstop = () => {
        var o;
...
class Xt extends M {
  constructor() {
    ...
    this.render(), this.hideMic(), this.initMic(), this.getChild("#onbootgo-delete-record").onclick = () => {
      let n = new Event("onbotgo-delete-record");
      document.querySelector("onbotgo-chatcontainer").dispatchEvent(n);
    }, (e = this.recorder) == null || e.on("record-end", (n) => {
      let o = new CustomEvent("onbotgo-stop-record", { detail: n });
      document.querySelector("onbotgo-chatcontainer").dispatchEvent(o);
    });
  }
  render() {
    this.innerHTML = this.renderHTML($e, {
  ...
  initMic() {
    this.wavesurfer = tt.create({
      container: this.getChild("#onbotgo-mic-record"),
      waveColor: "lightgray",
      barWidth: 1,
      barHeight: 1,
      fillParent: !0
    }), this.recorder = this.wavesurfer.registerPlugin(Rt.create());
  }
  startRecording() {
  ...
  displayMic() {
    ...
    const n = this.getChild("#onbotgo-empty-waveform");
    [this.getChild("#onbotgo-btn-play"), n].forEach((i) => {
      i.style.display = "none";
    });
  }
  hideMic() {
    const e = this.getChild("#onbotgo-mic-record"), n = this.getChild("#onbotgo-btn-stop");
    [e, n].forEach((i) => {
      i.style.display = "none";
    });
...
class an {
  constructor({
    ...
    if (S.chatflowID = t, S.chathubChannelId = e, o && (S.welcomeMessage = o), !n)
      return;
    const { typography: i, colors: s, icon: l } = n;
    i && Object.keys(i).forEach(
      (c) => x.typography[c] = i[c]
