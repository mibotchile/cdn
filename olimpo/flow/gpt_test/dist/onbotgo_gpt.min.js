...
var f = (n, t, e) => (Vt(n, typeof t != "symbol" ? t + "" : t, e), e);
class Xt {
  constructor() {
    f(this, "typography", {
      primary: "'Trebuchet MS', sans-serif"
    });
    f(this, "colors", { primary: "rgb(59, 129, 246)" });
    f(this, "defaultIcon", `
...
const Kt = {}, Zt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Kt
}, Symbol.toStringTag, { value: "Module" })), Ft = /* @__PURE__ */ Jt(Zt);
var xt = new Function("return this")().Promise, it = !1;
try {
...
var z = /^async +/, Y = /`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g, Q = /'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g, V = /"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g, St = /[.*+\-?^${}()|[\]\\]/g;
function X(n) {
  return St.test(n) ? n.replace(St, "\\$&") : n;
}
function te(n, t) {
...
`).replace(/^\s+|\s+$/gm, "")), Y.lastIndex = 0, Q.lastIndex = 0, V.lastIndex = 0;
  ...
  X(t.tags[1]) + ")", "g"), i = new RegExp("([^]*?)" + X(t.tags[0]) + "(-|_)?\\s*(" + r + ")?\\s*", "g"), s = 0, l = !1;
  function c(p, g) {
    var u = { f: [] }, m = 0, C = "c";
    ...
    function y(G) {
      ...
      if (C === "f")
        F === "safe" ? u.raw = !0 : t.async && z.test(F) ? (F = F.replace(z, ""), u.f.push([F, "", !0])) : u.f.push([F, ""]);
      else if (C === "fp")
        u.f[u.f.length - 1][1] += F;
      else if (C === "err") {
        if (F) {
          var Yt = At.search(/\S/);
          H("invalid syntax", n, s + Yt);
        }
      } else
        u[C] = F;
      s = G + 1;
    ...
    for (var v; (v = o.exec(n)) !== null; ) {
      var w = v[1], I = v[2], x = v[3], M = v[4], A = v[5], k = v.index;
      if (w)
        w === "(" ? (m === 0 && (C === "n" ? (y(k), C = "p") : C === "f" && (y(k), C = "fp")), m++) : w === ")" ? (m--, m === 0 && C !== "c" && (y(k), C = "err")) : m === 0 && w === "|" ? (y(k), C = "f") : w === "=>" && (y(k), s += 1, C = "res");
      else if (I) {
        if (I === "/*") {
          var P = n.indexOf("*/", o.lastIndex);
          P === -1 && H("unclosed comment", n, v.index), o.lastIndex = P + 2;
        } else if (I === "'") {
          Q.lastIndex = v.index;
          var W = Q.exec(n);
          W ? o.lastIndex = Q.lastIndex : H("unclosed string", n, v.index);
        } else if (I === '"') {
          V.lastIndex = v.index;
          var U = V.exec(n);
          U ? o.lastIndex = V.lastIndex : H("unclosed string", n, v.index);
        } else if (I === "`") {
          Y.lastIndex = v.index;
          var T = Y.exec(n);
          T ? o.lastIndex = Y.lastIndex : H("unclosed string", n, v.index);
        }
      } else if (x)
        return y(k), s = k + v[0].length, i.lastIndex = s, l = A, M && g === "h" && (g = "s"), u.t = g, u;
    }
    return H("unclosed tag", n, p), u;
  }
  function h(p, g) {
    p.b = [], p.d = [];
    var u = !1, m = [];
    ...
    for (var y; (y = i.exec(n)) !== null; ) {
      var v = y[1], w = y[2], I = y[3] || "", x;
      for (var M in e)
        if (e[M] === I) {
          x = M;
          break;
        }
      C(v, w), s = y.index + y[0].length, x || H("unrecognized tag type: " + I, n, s);
      var A = c(y.index, x), k = A.t;
      if (k === "h") {
        var P = A.n || "";
        t.async && z.test(P) && (A.a = !0, A.n = P.replace(z, "")), A = h(A), m.push(A);
      } else if (k === "c") {
        if (p.n === A.n)
          return u ? (u.d = m, p.b.push(u)) : p.d = m, p;
        H("Helper start and end don't match", n, y.index + y[0].length);
      } else if (k === "b") {
        u ? (u.d = m, p.b.push(u)) : p.d = m;
        var W = A.n || "";
        t.async && z.test(W) && (A.a = !0, A.n = W.replace(z, "")), u = A, m = [];
      } else if (k === "s") {
        var U = A.n || "";
        t.async && z.test(U) && (A.a = !0, A.n = U.replace(z, "")), m.push(A);
      } else
        m.push(A);
    }
    if (g)
      C(n.slice(s, n.length), !1), p.d = m;
    else
      throw S('unclosed helper "' + p.n + '"');
    return p;
  }
  var a = h({ f: [] }, !0);
  if (t.plugins)
    for (var d = 0; d < t.plugins.length; d++) {
      var b = t.plugins[d];
      b.processAST && (a.d = b.processAST(a.d, t));
    }
  return a.d;
}
function wt(n, t) {
...
function Wt(n, t, e, r, o, i) {
  var s = "{exec:" + (o ? "async " : "") + Ht(e, t, n) + ",params:[" + r + "]";
  return i && (s += ",name:'" + i + "'"), o && (s += ",async:true"), s += "}", s;
}
function ee(n, t) {
  for (var e = "[", r = 0; r < n.length; r++) {
    var o = n[r];
    e += Wt(t, o.res || "", o.d, o.p || "", o.a, o.n), r < n.length && (e += ",");
  }
  return e += "]", e;
}
function Ht(n, t, e) {
...
function B(n, t) {
  ...
  for (e; e < r; e++) {
    ...
    if (typeof i == "string") {
      ...
      var l = i.t, c = i.c || "", h = i.f, a = i.n || "", d = i.p || "", b = i.res || "", p = i.b, g = !!i.a;
      if (l === "i") {
        t.defaultFilter && (c = "c.l('F','" + t.defaultFilter + "')(" + c + ")");
        var u = et(c, h);
        !i.raw && t.autoEscape && (u = "c.l('F','e')(" + u + ")"), o += "tR+=" + u + ";";
      } else if (l === "h")
        if (t.storage.nativeHelpers.get(a))
          o += t.storage.nativeHelpers.get(a)(i, t);
        else {
          var m = (g ? "await " : "") + "c.l('H','" + a + "')(" + Wt(t, b, i.d, d, g);
          p ? m += "," + ee(p, t) : m += ",[]", m += ",c)", o += "tR+=" + et(m, h) + ";";
        }
      else
        l === "s" ? o += "tR+=" + et((g ? "await " : "") + "c.l('H','" + a + "')({params:[" + d + "]},[],c)", h) + ";" : l === "e" && (o += c + `
`);
    }
  }
  return o;
...
function N(n, t, e, r) {
  if (t && t.length > 0)
    throw S((r ? "Native" : "") + "Helper '" + n + "' doesn't accept blocks");
  if (e && e.length > 0)
    throw S((r ? "Native" : "") + "Helper '" + n + "' doesn't accept filters");
}
function zt(n, t, e, r, o) {
  e(n[t], t).then(function(i) {
    r += i, t === n.length - 1 ? o(r) : zt(n, t + 1, e, r, o);
  });
}
function Dt(n, t, e, r, o, i) {
  r(t[e], n[t[e]]).then(function(s) {
    o += s, e === t.length - 1 ? i(o) : Dt(n, t, e + 1, r, o, i);
  });
}
var re = {
  "&": "&amp;",
...
var ie = new Z({}), pt = new Z({
  ...
  foreach: function(n, t) {
    ...
    if (N("foreach", t, !1), n.async)
      return new Promise(function(i) {
        Dt(e, Object.keys(e), 0, n.exec, "", i);
      });
    var r = "";
    for (var o in e)
      Pt(e, o) && (r += n.exec(o, e[o]));
    return r;
  },
  include: function(n, t, e) {
    ...
    if (!r)
      throw S('Could not fetch template "' + n.params[0] + '"');
  ...
  if: function(n, t) {
    ...
    if (n.b)
      for (var r = 0; r < n.b.length; r++) {
        var o = n.b[r];
        o.n === "else" ? e += "else{" + B(o.d, t) + "}" : o.n === "elif" && (e += "else if(" + o.p + "){" + B(o.d, t) + "}");
      }
    return e;
  },
  try: function(n, t) {
    if (N("try", !1, n.f, !0), !n.b || n.b.length !== 1 || n.b[0].n !== "catch")
      throw S("native helper 'try' only accepts 1 block, 'catch'");
  ...
  l: function(n, t) {
    if (n === "H") {
      ...
      if (e)
        return e;
      throw S("Can't find helper '" + t + "'");
    } else if (n === "F") {
      var r = this.storage.filters.get(t);
      if (r)
        return r;
      throw S("Can't find filter '" + t + "'");
    }
  },
  async: !1,
  storage: {
...
function ut(n, t) {
  ...
  if (e.async)
    if (it)
      ...
      throw S("This environment doesn't support async/await");
  try {
    return new r(
      e.varName,
      "c",
    ...
    throw o instanceof SyntaxError ? S(`Bad template syntax
...
function ce(n, t) {
  ...
  else if (t.filename && (r = nt(n, t.filename), at.existsSync(r) && (e = r)), e || Array.isArray(o) && o.some(function(s) {
    return r = nt(n, s, !0), at.existsSync(r);
  }) && (e = r), !e)
    throw S('Could not find the include file "' + n + '"');
  return e;
}
function Bt(n) {
...
function ge(n, t, e) {
  if (t && t.length > 0)
    throw S("Helper 'includeFile' doesn't accept blocks");
...
function ue(n, t, e, r) {
  ...
  if (o.async) {
    ...
    if (r)
      ...
      throw S("Please provide a callback function, this env doesn't support Promises");
    }
  } else
    return ot(n, o)(t, o);
}
...
}), be = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
var Rt = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function o(i) {
    return i instanceof e ? i : new e(function(s) {
      s(i);
    });
...
function Ae(n, t, e) {
  ...
  return Rt(this, void 0, void 0, function* () {
    const i = yield fetch(n, e);
    {
      ...
      let c = 0;
      const h = (a, d) => Rt(this, void 0, void 0, function* () {
        if (a)
          return;
        c += (d == null ? void 0 : d.length) || 0;
        const b = Math.round(c / l * 100);
        return t(b), s == null ? void 0 : s.read().then(({ done: p, value: g }) => h(p, g));
      });
      s == null || s.read().then(({ done: a, value: d }) => h(a, d));
    }
    return i.blob();
  });
}
...
function we(n, t, e, r, o = 5) {
  ...
  const s = (l) => {
    ...
    let c = l.clientX, h = l.clientY, a = !1;
    const d = (g) => {
      g.preventDefault(), g.stopPropagation();
      const u = g.clientX, m = g.clientY;
      if (a || Math.abs(u - c) >= o || Math.abs(m - h) >= o) {
        const { left: C, top: y } = n.getBoundingClientRect();
        a || (a = !0, e == null || e(c - C, h - y)), t(u - c, m - h, u - C, m - y), c = u, h = m;
      }
    }, b = (g) => {
    ...
    document.addEventListener("pointermove", d), document.addEventListener("pointerup", p), document.addEventListener("pointerleave", p), document.addEventListener("click", b, !0), i = () => {
...
class $ extends mt {
  ...
  renderBarWaveform(t, e, r, o) {
    const i = t[0], s = t[1] || t[0], l = i.length, { width: c, height: h } = r.canvas, a = h / 2, d = window.devicePixelRatio || 1, b = e.barWidth ? e.barWidth * d : 1, p = e.barGap ? e.barGap * d : e.barWidth ? b / 2 : 0, g = e.barRadius || 0, u = c / (b + p) / l, m = g && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let C = 0, y = 0, v = 0;
    for (let w = 0; w <= l; w++) {
      const I = Math.round(w * u);
      if (I > C) {
        const A = Math.round(y * a * o), k = Math.round(v * a * o), P = A + k || 1;
        let W = a - A;
        e.barAlign === "top" ? W = 0 : e.barAlign === "bottom" && (W = h - P), r[m](C * (b + p), W, b, P, g), C = I, y = 0, v = 0;
      }
      const x = Math.abs(i[w] || 0), M = Math.abs(s[w] || 0);
      x > y && (y = x), M > v && (v = M);
    }
    r.fill(), r.closePath();
  }
  renderLineWaveform(t, e, r, o) {
    const i = (s) => {
      const l = t[s] || t[0], c = l.length, { height: h } = r.canvas, a = h / 2, d = r.canvas.width / c;
      r.moveTo(0, a);
      let b = 0, p = 0;
      for (let g = 0; g <= c; g++) {
        const u = Math.round(g * d);
        if (u > b) {
          const C = Math.round(p * a * o) || 1, y = a + C * (s === 0 ? -1 : 1);
          r.lineTo(b, y), b = u, p = 0;
        }
        const m = Math.abs(l[g] || 0);
        m > p && (p = m);
      }
      r.lineTo(b, a);
    };
  ...
  renderSingleCanvas(t, e, r, o, i, s, l, c) {
    const h = window.devicePixelRatio || 1, a = document.createElement("canvas"), d = t[0].length;
    a.width = Math.round(r * (s - i) / d), a.height = o * h, a.style.width = `${Math.floor(a.width / h)}px`, a.style.height = `${o}px`, a.style.left = `${Math.floor(i * r / h / d)}px`, l.appendChild(a);
    const b = a.getContext("2d");
    this.renderWaveform(t.map((u) => u.slice(i, s)), e, b);
    const p = a.cloneNode();
    c.appendChild(p);
  ...
  renderChannel(t, e, r) {
    ...
    const { scrollLeft: l, scrollWidth: c, clientWidth: h } = this.scrollContainer, a = t[0].length, d = a / c;
    let b = Math.min($.MAX_CANVAS_WIDTH, h);
    if (e.barWidth || e.barGap) {
      const I = e.barWidth || 0.5, x = e.barGap || I / 2, M = I + x;
      b % M !== 0 && (b = Math.floor(b / M) * M);
    }
    const p = Math.floor(Math.abs(l) * d), g = Math.floor(p + b * d), u = g - p, m = (I, x) => {
      this.renderSingleCanvas(t, e, r, i, Math.max(0, I), Math.min(x, a), o, s);
    }, C = this.createDelay(), y = this.createDelay(), v = (I, x) => {
      m(I, x), I > 0 && C(() => {
        v(I - u, x - u);
      });
    }, w = (I, x) => {
  ...
  scrollIntoView(t, e = !1) {
    const { clientWidth: r, scrollLeft: o, scrollWidth: i } = this.scrollContainer, s = i * t, l = r / 2, c = e && this.options.autoCenter && !this.isDragging ? l : r;
    if (s > o + c || s < o)
      if (this.options.autoCenter && !this.isDragging) {
        const h = l / 20;
        s - (o + l) >= h && s < o + r ? this.scrollContainer.scrollLeft += h : this.scrollContainer.scrollLeft = s - l;
      } else
        this.isDragging ? this.scrollContainer.scrollLeft = s < o ? s - 10 : s - r + 10 : this.scrollContainer.scrollLeft = s;
    {
      const { scrollLeft: h } = this.scrollContainer, a = h / i, d = (h + r) / i;
...
class tt extends Se {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, Re, t), this.timer = new Ee();
  ...
  exportPeaks({ channels: t = 1, maxLength: e = 8e3, precision: r = 1e4 } = {}) {
    ...
    for (let s = 0; s < o; s++) {
      const l = this.decodedData.getChannelData(s), c = Math.min(l.length, e), h = l.length / c, a = [];
      for (let d = 0; d < c; d++) {
        const b = Math.round(d * h), p = l[b];
...
</svg>`, ke = '<?xml version="1.0" ?><svg fill="currentColor" style="color:currentColor;enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M224,435.8V76.1c0-6.7-5.4-12.1-12.2-12.1h-71.6c-6.8,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6   C218.6,448,224,442.6,224,435.8z"/><path d="M371.8,64h-71.6c-6.7,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6c6.7,0,12.2-5.4,12.2-12.2V76.1   C384,69.4,378.6,64,371.8,64z"/></g></svg>', D = "onbotgo-chatmessage";
class bt extends L {
  constructor(e) {
    super();
    f(this, "wavesurfer");
    ...
    }), this.innerHTML = this.renderHTML(be, {
      type: e.type,
      fileType: e.fileType,
      file: e.file,
      message: e.message,
...
class Le {
  constructor() {
    f(this, "gpt_url", "https://endpoint-prod-chatgpt.mibot.cl:8080");
    f(this, "storage_url", "https://helpers.mibot.cl:444");
    f(this, "messageHistoryId", "");
    f(this, "chatflowID", "");
    f(this, "socketUid", "");
    f(this, "welcomeMessage", "¡Hola! ¿En qué puedo ayudarte hoy?");
  }
}
const R = new Le(), kt = async (n) => await fetch(`${R.gpt_url}/chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(n)
}).then((t) => t.json()), Te = async (n) => await fetch(`${R.gpt_url}/messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
...
class yt extends L {
  constructor() {
    ...
    f(this, "input");
    this.innerHTML = this.renderHTML(Fe, { sendIcon: qt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(j.tag), this.input.style.fontFamily = E.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
class Ct extends HTMLElement {
  ...
  setScrollThumbHeight() {
    ...
    r.addEventListener("mousedown", (a) => {
      c = !0, h = a.clientY, this.preventContentHighlight("remove");
      ...
      if (!c)
        return;
      const d = a.clientY - h;
      h = a.clientY, this.targetEl.scrollTop += d * (s / o);
    });
  }
...
</svg>`, Lt = '<svg  style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M28,14H18V4c0-1.104-0.896-2-2-2s-2,0.896-2,2v10H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h10v10c0,1.104,0.896,2,2,2  s2-0.896,2-2V18h10c1.104,0,2-0.896,2-2S29.104,14,28,14z"/></svg>';
class dt {
}
f(dt, "messageHistoryId", {
...
class vt extends L {
  constructor() {
    super();
    f(this, "messagesHistory", [
      {
        message: R.welcomeMessage,
        type: "apiMessage"
      },
      ...dt.messagesHistory.get() ?? []
    ]);
    f(this, "attachedFiles", []);
    f(this, "attachedRecord");
    f(this, "header");
    f(this, "messagesContainer");
    f(this, "scrollBar");
    f(this, "chatInput");
    f(this, "attachFileInput");
    f(this, "btnOnbotgoAttachInput");
    f(this, "btnattachNewFile");
    f(this, "isRecordSelected", !1);
    f(this, "messagesWebsocket");
    f(this, "chattingWith", "virtual_assistant");
  ...
  initMessagesWebsocket(e) {
    ...
    const r = `wss://endpoint-prod-chatgpt.mibot.cl:8080/messages/${e}/ws`;
    this.messagesWebsocket = new WebSocket(r), console.log(this.messagesWebsocket), this.messagesWebsocket.onmessage = (o) => {
      const i = JSON.parse(o.data);
      if (console.log("ON MESSAGE ", i), i.event === "incoming_message") {
        const s = i.data;
        this.addMessages([{ message: s.content, type: "apiMessage" }]), this.updateScrollbar();
      }
  ...
  onSubmit(e) {
    ...
    if (this.attachedFiles.length && (this.addMessages(
      ...
      Te({
        content: `${o.message}
${o.url}`,
        conversation_id: R.messageHistoryId,
        channel_id: R.chathubChannelId,
        sender: "user"
      }).finally(() => {
        var i;
    ...
    o.url.length ? o.url.forEach((i) => {
      kt({
        ...
        var l, c;
        s != null && s.unique_id && (R.messageHistoryId = s.unique_id, this.initMessagesWebsocket(R.messageHistoryId)), (c = (l = s == null ? void 0 : s.data) == null ? void 0 : l.process) != null && c.length && s.data.process.forEach((h) => {
          this.addMessages([
            {
              type: h.role,
              name: h.name,
      ...
      var s, l;
      i != null && i.unique_id && (R.messageHistoryId = i.unique_id, this.initMessagesWebsocket(R.messageHistoryId)), (l = (s = i == null ? void 0 : i.data) == null ? void 0 : s.process) != null && l.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
  ...
  async attachFile(e) {
    ...
    try {
      ...
      .onbotgo-lds-ring div {
        ...
        border-color: ${E.colors.primary} transparent transparent transparent;
      }
      ...
      const i = await Ne(r);
      this.attachedFiles.push(e.target.files[0]), this.attachedFiles.find(({ name: s }) => s === r[0].name).url = i.data[0].url;
    } catch (i) {
      console.log(i);
    }
  ...
  renderMessages(e) {
    e.forEach(
      (r) => !["dataMessage"].includes(r.type) && this.messagesContainer.appendChild(new bt(r))
    );
  }
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(He, {
    ...
    }, this.btnattachNewFile.onclick = () => this.attachFileInput.click(), this.attachFileInput.onchange = (e) => this.attachFile(e), this.querySelectorAll(".onbotgo-attachedFile").forEach((e, r) => {
      e.querySelector("i").onclick = (o) => {
        this.attachedFiles.splice(r, 1), this.renderAttachTemplate(), this.attachedFiles.length && (this.querySelector(".onbotgo-dropdown-content").style.display = "flex"), o.stopPropagation();
      };
    });
  }
  render() {
    this.innerHTML = this.renderHTML(We, {
      logo: ze,
      micIcon: De,
      paperclipIcon: Mt,
      attachedFiles: this.attachedFiles,
...
function Oe({ element: n, styles: t }) {
  const e = t.reduce(
    (i, s) => ({
      ...i,
      ...s
    ...
    {}
  ), r = document.createElement("style"), o = Ge(e);
...
Ut.tag = Ve;
const Xe = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, Je = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
function Tt(n, t, e, r) {
  return new (e || (e = Promise))(function(o, i) {
    ...
    function c(h) {
      var a;
      h.done ? o(h.value) : (a = h.value, a instanceof e ? a : new e(function(d) {
        d(a);
      })).then(s, l);
    }
...
const _e = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class It extends Ze {
  constructor(t) {
    var e;
  ...
  renderMicStream(t) {
    ...
    let c;
    const h = () => {
      o.getFloatTimeDomainData(s), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = !1, this.wavesurfer.load("", [s], l)), c = requestAnimationFrame(h);
    };
    return h(), () => {
      cancelAnimationFrame(c), r == null || r.disconnect(), e == null || e.close();
    };
  }
  startMic() {
  ...
  startRecording() {
    return Tt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || _e.find((o) => MediaRecorder.isTypeSupported(o)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
class Gt extends L {
  ...
  render() {
    this.innerHTML = this.renderHTML(Xe, {
...
Gt.tag = $e;
class er {
  constructor({ chatflow: t, chathubChannelId: e, theme: r, welcomeMessage: o }) {
    if (R.chatflowID = t, R.chathubChannelId = e, o && (R.welcomeMessage = o), !r)
      return;
    const { typography: i, colors: s, icon: l } = r;
    i && Object.keys(i).forEach(
      (c) => E.typography[c] = i[c]
