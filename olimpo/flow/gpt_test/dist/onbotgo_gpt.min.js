...
var Gt = (r, t, e) => t in r ? zt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var A = (r, t, e) => (Gt(r, typeof t != "symbol" ? t + "" : t, e), e);
class Jt {
  constructor() {
    A(this, "typography", {
...
const Kt = {}, Zt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Kt
}, Symbol.toStringTag, { value: "Module" })), Lt = /* @__PURE__ */ Wt(Zt);
...
function It(r, t) {
  var e = te(r, t), n = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + j(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function jt(r) {
  return at.readFileSync(r).toString().replace(le, "");
}
function de(r, t) {
  var e = _(t), n = jt(r);
  try {
...
ut.define("includeFile", ge);
ut.define("extendsFile", ue);
...
{{ /if}} {{/if}}\r
`;
var Ee = globalThis && globalThis.__awaiter || function(r, t, e, n) {
  function o(i) {
...
function Re(r, t) {
  return typeof r[0] == "number" && (r = [r]), ye(r), {
    duration: t,
    length: r[0].length,
...
class tt extends xe {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, Se, t), this.timer = new we();
  ...
  loadAudio(t, e, n, o) {
    return W(this, void 0, void 0, function* () {
      if (this.emit("load", t), this.isPlaying() && this.pause(), this.decodedData = null, !e && !n) {
        ...
        e = yield ve.fetchBlob(t, i, this.options.fetchParams);
      }
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
  ...
  handlePlayPause() {
    this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
      ...
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = Pe;
  ...
  getAvatarMessage(e = "api", n = !1) {
    const o = new Y();
    let i;
    return e === "apiMessage" && !n ? i = Be : e === "userMessage" ? i = Te : n && (i = Me), o.innerHTML = `<img src=${i} width="25" height="25" />`, o.setStyles({
      padding: "5px",
      marginRight: "10px",
...
const S = new De(), Pt = async (r) => await fetch(`${S.gpt_url}/chat`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), He = async (r) => await fetch(`${S.gpt_url}/messages/send`, {
  headers: {
    "Content-Type": "application/json"
  },
  method: "POST",
  body: JSON.stringify(r)
}).then((t) => t.json()), Fe = `<input\r
...
class Et extends M {
  constructor() {
    ...
    A(this, "input");
    this.innerHTML = this.renderHTML(Fe, { sendIcon: Yt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(Y.tag), this.input.style.fontFamily = x.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
${o.url}`,
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(je, {
  ...
  render() {
    this.innerHTML = this.renderHTML(Ue, {
      logo: Ne,
      micIcon: Ye,
      paperclipIcon: Bt,
      attachedFiles: this.attachedFiles,
    ...
    o.src = Oe, o.style.objectFit = "cover", this.getChild("#onbotgo-btnrecordSend").style.display = "none", this.querySelector("#onbotgo-btnrecord").onclick = () => {
...
gt.tag = "onbotgo-chatbot";
function Ve({ element: r, styles: t }) {
  const e = t.reduce(
    (i, s) => ({
      ...i,
      ...s
    ...
    {}
  ), n = document.createElement("style"), o = Ge(e);
...
Qt.tag = Ke;
const Ze = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, _e = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
const en = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class Rt extends tn {
  constructor(t) {
    var e;
  ...
  startRecording() {
    return Tt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || en.find((o) => MediaRecorder.isTypeSupported(o)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
class Vt extends M {
  ...
  render() {
    this.innerHTML = this.renderHTML(Ze, {
...
Vt.tag = nn;
class on {
  constructor({ chatflow: t, chathubChannelId: e, theme: n, welcomeMessage: o }) {
