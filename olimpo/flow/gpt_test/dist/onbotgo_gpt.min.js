    ...
    for (var C; (C = o.exec(r)) !== null; ) {
      ...
      if (P)
        ...
        if (v === "/*") {
          ...
          z.lastIndex = C.index;
          var k = z.exec(r);
          k ? o.lastIndex = z.lastIndex : F("unclosed string", r, C.index);
        }
      } else if (w)
...
class yn {
  constructor({
    ...
    c && Object.keys(c).forEach(
      ...
      (m) => R.colors[m] = a[m]
    ), h && (R.customIcon = h), d.active && (B.active = !0, B.number = d.number, B.position = d.position.toLowerCase(), B.msg = d.msg);
  }
  init() {
