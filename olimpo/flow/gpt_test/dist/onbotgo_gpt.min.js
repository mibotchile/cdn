...
${o.url}`,
    ...
    o.url.length ? o.url.forEach((i) => {
      ...
      var s, l;
      i != null && i.unique_id && (P.messageHistoryId = i.unique_id, this.initMessagesWebsocket(P.messageHistoryId)), (l = (s = i == null ? void 0 : i.data) == null ? void 0 : s.process) != null && l.length && i.data.process.forEach((c) => {
        this.addMessages([
          {
            type: c.role,
            name: c.name,
