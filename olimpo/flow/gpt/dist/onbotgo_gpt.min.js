...
var Vt = (n, t, e) => t in n ? Nt(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e;
var y = (n, t, e) => (Vt(n, typeof t != "symbol" ? t + "" : t, e), e);
class jt {
  constructor() {
    y(this, "typography", {
      primary: "'Trebuchet MS', sans-serif"
    });
    y(this, "colors", { primary: "rgb(59, 129, 246)" });
    y(this, "defaultIcon", `
...
const E = new jt();
var wt = new Function("return this")().Promise, it = !1;
try {
...
function D(n, t, e) {
  for (var r in t)
    Ft(t, r) && (t[r] != null && typeof t[r] == "object" && (r === "storage" || r === "prefixes") && !e ? n[r] = D(
      /*toObj[key] ||*/
      {},
      t[r]
    ) : n[r] = t[r]);
...
var W = /^async +/, V = /`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g, j = /'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g, Y = /"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g, St = /[.*+\-?^${}()|[\]\\]/g;
function G(n) {
  return St.test(n) ? n.replace(St, "\\$&") : n;
}
function Ut(n, t) {
  t.rmWhitespace && (n = n.replace(/[\r\n]+/g, `
`).replace(/^\s+|\s+$/gm, "")), V.lastIndex = 0, j.lastIndex = 0, Y.lastIndex = 0;
  var e = t.prefixes, r = [
    e.h,
    e.b,
    e.i,
    ...
    return u && p ? u + "|" + G(p) : p ? G(p) : u;
  }, ""), i = new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?" + // comments, strings
  G(t.tags[1]) + ")", "g"), o = new RegExp("([^]*?)" + G(t.tags[0]) + "(-|_)?\\s*(" + r + ")?\\s*", "g"), s = 0, l = !1;
  function h(u, p) {
    var g = { f: [] }, f = 0, C = "c";
    p === "h" || p === "b" || p === "c" ? C = "n" : p === "r" && (g.raw = !0, p = "i");
    function b(N) {
      var xt = n.slice(s, N), I = xt.trim();
      if (C === "f")
    ...
    for (var v; (v = i.exec(n)) !== null; ) {
      var k = v[1], x = v[2], S = v[3], T = v[4], w = v[5], L = v.index;
      if (k)
        k === "(" ? (f === 0 && (C === "n" ? (b(L), C = "p") : C === "f" && (b(L), C = "fp")), f++) : k === ")" ? (f--, f === 0 && C !== "c" && (b(L), C = "err")) : f === 0 && k === "|" ? (b(L), C = "f") : k === "=>" && (b(L), s += 1, C = "res");
      else if (x) {
        if (x === "/*") {
          var P = n.indexOf("*/", i.lastIndex);
          P === -1 && A("unclosed comment", n, v.index), i.lastIndex = P + 2;
        } else if (x === "'") {
          j.lastIndex = v.index;
          var H = j.exec(n);
          H ? i.lastIndex = j.lastIndex : A("unclosed string", n, v.index);
        } else if (x === '"') {
          Y.lastIndex = v.index;
          var O = Y.exec(n);
          O ? i.lastIndex = Y.lastIndex : A("unclosed string", n, v.index);
        } else if (x === "`") {
          V.lastIndex = v.index;
          var F = V.exec(n);
          F ? i.lastIndex = V.lastIndex : A("unclosed string", n, v.index);
        }
      } else if (S)
        return b(L), s = L + v[0].length, o.lastIndex = s, l = w, T && p === "h" && (p = "s"), g.t = p, g;
    }
    return A("unclosed tag", n, u), g;
  }
  function c(u, p) {
    u.b = [], u.d = [];
    var g = !1, f = [];
    ...
    for (var b; (b = o.exec(n)) !== null; ) {
      ...
      C(v, k), s = b.index + b[0].length, S || A("unrecognized tag type: " + x, n, s);
      var w = h(b.index, S), L = w.t;
      if (L === "h") {
        var P = w.n || "";
        ...
        A("Helper start and end don't match", n, b.index + b[0].length);
      } else if (L === "b") {
        g ? (g.d = f, u.b.push(g)) : u.d = f;
        var H = w.n || "";
        t.async && W.test(H) && (w.a = !0, w.n = H.replace(W, "")), g = w, f = [];
      } else if (L === "s") {
        var O = w.n || "";
        t.async && W.test(O) && (w.a = !0, w.n = O.replace(W, "")), f.push(w);
      } else
        f.push(w);
    }
    if (p)
...
function Mt(n, t) {
  var e = Ut(n, t), r = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + _(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function It(n, t, e, r, i, o) {
  var s = "{exec:" + (i ? "async " : "") + Pt(e, t, n) + ",params:[" + r + "]";
  return o && (s += ",name:'" + o + "'"), i && (s += ",async:true"), s += "}", s;
}
function Xt(n, t) {
  for (var e = "[", r = 0; r < n.length; r++) {
    var i = n[r];
    e += It(t, i.res || "", i.d, i.p || "", i.a, i.n), r < n.length && (e += ",");
  }
  return e += "]", e;
}
function Pt(n, t, e) {
  return "function(" + t + "){var tR='';" + _(n, e) + "return tR}";
}
function _(n, t) {
  ...
  for (e; e < r; e++) {
    ...
    if (typeof o == "string") {
      ...
      var l = o.t, h = o.c || "", c = o.f, a = o.n || "", d = o.p || "", m = o.res || "", u = o.b, p = !!o.a;
      if (l === "i") {
        t.defaultFilter && (h = "c.l('F','" + t.defaultFilter + "')(" + h + ")");
        var g = tt(h, c);
        !o.raw && t.autoEscape && (g = "c.l('F','e')(" + g + ")"), i += "tR+=" + g + ";";
      } else if (l === "h")
        if (t.storage.nativeHelpers.get(a))
          i += t.storage.nativeHelpers.get(a)(o, t);
        else {
          var f = (p ? "await " : "") + "c.l('H','" + a + "')(" + It(t, m, o.d, d, p);
          u ? f += "," + Xt(u, t) : f += ",[]", f += ",c)", i += "tR+=" + tt(f, c) + ";";
        }
      else
        l === "s" ? i += "tR+=" + tt((p ? "await " : "") + "c.l('H','" + a + "')({params:[" + d + "]},[],c)", c) + ";" : l === "e" && (i += h + `
`);
    }
  }
  return i;
...
function Ht(n, t, e, r, i) {
  e(n[t], t).then(function(o) {
    r += o, t === n.length - 1 ? i(r) : Ht(n, t + 1, e, r, i);
  });
}
function At(n, t, e, r, i, o) {
  r(t[e], n[t[e]]).then(function(s) {
    i += s, e === t.length - 1 ? o(i) : At(n, t, e + 1, r, i, o);
  });
}
var Zt = {
  "&": "&amp;",
...
function Jt(n) {
  var t = String(n);
  return /[&<>"']/.test(t) ? t.replace(/[&<>"']/g, Qt) : t;
}
var Kt = new Z({}), pt = new Z({
  each: function(n, t) {
    var e = "", r = n.params[0];
    if (z("each", t, !1), n.async)
  ...
  foreach: function(n, t) {
    var e = n.params[0];
    if (z("foreach", t, !1), n.async)
      return new Promise(function(o) {
        At(e, Object.keys(e), 0, n.exec, "", o);
      });
    var r = "";
    for (var i in e)
      Ft(e, i) && (r += n.exec(i, e[i]));
    return r;
  },
  ...
  useScope: function(n, t) {
    return z("useScope", t, !1), n.exec(n.params[0]);
  }
}), te = new Z({
  if: function(n, t) {
    z("if", !1, n.f, !0);
    var e = "if(" + n.p + "){" + _(n.d, t) + "}";
    if (n.b)
      for (var r = 0; r < n.b.length; r++) {
        var i = n.b[r];
        i.n === "else" ? e += "else{" + _(i.d, t) + "}" : i.n === "elif" && (e += "else if(" + i.p + "){" + _(i.d, t) + "}");
      }
    return e;
  },
  try: function(n, t) {
    if (z("try", !1, n.f, !0), !n.b || n.b.length !== 1 || n.b[0].n !== "catch")
      throw M("native helper 'try' only accepts 1 block, 'catch'");
    var e = "try{" + _(n.d, t) + "}", r = n.b[0];
    return e += "catch" + (r.res ? "(" + r.res + ")" : "") + "{" + _(r.d, t) + "}", e;
  },
  block: function(n, t) {
    z("block", n.b, n.f, !0);
    var e = "if(!" + t.varName + "[" + n.p + "]){tR+=(" + Pt(n.d, "", t) + ")()}else{tR+=" + t.varName + "[" + n.p + "]}";
    return e;
  }
}), ee = new Z({ e: Jt }), ot = {
  varName: "it",
...
function Q(n, t) {
  var e = {};
  return D(e, ot), t && D(e, t), n && D(e, n), e.l.bind(e), e;
}
function ut(n, t) {
  var e = Q(t || {}), r = Function;
  if (e.async)
    if (it)
      r = it;
    else
  ...
  try {
    ...
    throw i instanceof SyntaxError ? M(`Bad template syntax
...
var st = require("fs"), et = require("path"), re = /^\uFEFF/;
function rt(n, t, e) {
  var r = et.resolve(
    e ? t : et.dirname(t),
...
function ne(n, t) {
  ...
  if (o && o.length)
    e = rt(n.replace(/^\/*/, ""), t.root || "/", !0);
  else if (t.filename && (r = rt(n, t.filename), st.existsSync(r) && (e = r)), e || Array.isArray(i) && i.some(function(s) {
    return r = rt(n, s, !0), st.existsSync(r);
  }) && (e = r), !e)
    throw M('Could not find the include file "' + n + '"');
  return e;
}
function Wt(n) {
  return st.readFileSync(n).toString().replace(re, "");
}
function ie(n, t) {
  var e = Q(t), r = Wt(n);
  try {
...
function $t(n, t) {
  var e = Q({ filename: ne(n, t) }, t);
  return oe(e);
}
function se(n, t, e) {
  if (t && t.length > 0)
    throw M("Helper 'includeFile' doesn't accept blocks");
  return $t(n.params[0], e)(n.params[1], e);
}
function ae(n, t, e) {
  var r = n.params[1] || {};
  r.content = n.exec();
...
pt.define("includeFile", se);
pt.define("extendsFile", ae);
...
}), de = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
{{/if}} {{#else }}\r
<onbotgo-box class="from-user onbotgo-message"> {{it.message}}</onbotgo-box>\r
...
{{/if}} {{#else}}\r
<onbotgo-box class="from-chatbot onbotgo-message">\r
  {{it.message}} <onbotgo-box class="bg-semi-transp"></onbotgo-box>\r
</onbotgo-box>\r
{{ /if}} {{/if}}\r
`;
var pe = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function i(o) {
...
function fe(n, t) {
  return typeof n[0] == "number" && (n = [n]), ge(n), {
    duration: t,
    length: n[0].length,
  ...
  return Lt(this, void 0, void 0, function* () {
    const o = yield fetch(n, e);
    {
      ...
      const c = (a, d) => Lt(this, void 0, void 0, function* () {
        ...
        const m = Math.round(h / l * 100);
        return t(m), s == null ? void 0 : s.read().then(({ done: u, value: p }) => c(u, p));
      });
...
function Ce(n, t, e, r, i = 5) {
  ...
  const s = (l) => {
    ...
    const d = (p) => {
      ...
      if (a || Math.abs(g - h) >= i || Math.abs(f - c) >= i) {
    ...
    document.addEventListener("pointermove", d), document.addEventListener("pointerup", u), document.addEventListener("pointerleave", u), document.addEventListener("click", m, !0), o = () => {
...
class J extends ft {
  ...
  renderBarWaveform(t, e, r, i) {
    const o = t[0], s = t[1] || t[0], l = o.length, { width: h, height: c } = r.canvas, a = c / 2, d = window.devicePixelRatio || 1, m = e.barWidth ? e.barWidth * d : 1, u = e.barGap ? e.barGap * d : e.barWidth ? m / 2 : 0, p = e.barRadius || 0, g = h / (m + u) / l, f = p && "roundRect" in r ? "roundRect" : "rect";
    r.beginPath();
    let C = 0, b = 0, v = 0;
    for (let k = 0; k <= l; k++) {
      const x = Math.round(k * g);
      if (x > C) {
        const w = Math.round(b * a * i), L = Math.round(v * a * i), P = w + L || 1;
        let H = a - w;
        e.barAlign === "top" ? H = 0 : e.barAlign === "bottom" && (H = c - P), r[f](C * (m + u), H, m, P, p), C = x, b = 0, v = 0;
      }
      const S = Math.abs(o[k] || 0), T = Math.abs(s[k] || 0);
      S > b && (b = S), T > v && (v = T);
    }
    r.fill(), r.closePath();
  }
  renderLineWaveform(t, e, r, i) {
    const o = (s) => {
      ...
      for (let p = 0; p <= h; p++) {
        ...
        if (g > m) {
          const C = Math.round(u * a * i) || 1, b = a + C * (s === 0 ? -1 : 1);
          r.lineTo(m, b), m = g, u = 0;
        }
  ...
  renderSingleCanvas(t, e, r, i, o, s, l, h) {
    ...
    this.renderWaveform(t.map((g) => g.slice(o, s)), e, m);
    const u = a.cloneNode();
    h.appendChild(u);
  ...
  renderChannel(t, e, r) {
    ...
    let m = Math.min(J.MAX_CANVAS_WIDTH, c);
    if (e.barWidth || e.barGap) {
      const x = e.barWidth || 0.5, S = e.barGap || x / 2, T = x + S;
      m % T !== 0 && (m = Math.floor(m / T) * T);
    }
    const u = Math.floor(Math.abs(l) * d), p = Math.floor(u + m * d), g = p - u, f = (x, S) => {
      this.renderSingleCanvas(t, e, r, o, Math.max(0, x), Math.min(S, a), i, s);
...
var U = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function i(o) {
    return o instanceof e ? o : new e(function(s) {
      s(o);
    });
...
class K extends ye {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, xe, t), this.timer = new ve();
    const i = t.media ? void 0 : this.getMediaElement();
    this.renderer = new J(this.options, i), this.initPlayerEvents(), this.initRendererEvents(), this.initTimerEvents(), this.initPlugins();
  ...
  loadAudio(t, e, r, i) {
    return U(this, void 0, void 0, function* () {
      if (this.emit("load", t), this.isPlaying() && this.pause(), this.decodedData = null, !e && !r) {
        ...
        e = yield be.fetchBlob(t, o, this.options.fetchParams);
      }
      if (this.setSrc(t, e), r)
        ...
        })) || (yield Promise.resolve(0)), this.decodedData = kt.createBuffer(r, i);
      else if (e) {
        const o = yield e.arrayBuffer();
        this.decodedData = yield kt.decode(o, this.options.sampleRate);
      }
...
const at = `<svg fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" \r
...
</svg>`, we = '<?xml version="1.0" ?><svg fill="currentColor" style="color:currentColor;enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M224,435.8V76.1c0-6.7-5.4-12.1-12.2-12.1h-71.6c-6.8,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6   C218.6,448,224,442.6,224,435.8z"/><path d="M371.8,64h-71.6c-6.7,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6c6.7,0,12.2-5.4,12.2-12.2V76.1   C384,69.4,378.6,64,371.8,64z"/></g></svg>', $ = "onbotgo-chatmessage";
class mt extends R {
  constructor(e) {
    super();
    y(this, "wavesurfer");
    ...
    }), this.innerHTML = this.renderHTML(de, {
      type: e.type,
      fileType: e.fileType,
      file: e.file,
      message: e.message,
...
`, " ").replace(/\n/g, " "), e.fileType === "audio") {
      let r;
      typeof e.file == "string" ? r = e.file : r = URL.createObjectURL(e.file), this.wavesurfer = K.create({
        barHeight: 12,
        height: 24,
        barWidth: 1,
    ...
    e.type === "LoadingMessage" && this.setLoadingAnimation(), console.log(e, this.innerHTML, this);
  }
  handlePlayPause() {
    this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
      ...
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = we;
    }), this.wavesurfer.on("pause", () => {
      this.querySelector("#onbotgo-playAudioMessage").onclick = () => {
        this.wavesurfer.play();
      }, this.querySelector("#onbotgo-playAudioMessage").innerHTML = at;
    });
  }
  setLoadingAnimation() {
...
class Me {
  constructor() {
    y(this, "gpt_url", "https://api-whatsapp-dev.mibot.cl:7070");
    y(this, "chatflowID", "");
  }
}
const lt = new Me(), ke = async (n) => await fetch(
  `${lt.gpt_url}/v1/internal-prediction/${lt.chatflowID}`,
  {
    headers: {
...
class bt extends R {
  constructor() {
    ...
    y(this, "input");
    this.innerHTML = this.renderHTML(Le, { sendIcon: _t }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(B.tag), this.input.style.fontFamily = E.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
</svg>`, Tt = '<svg  style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M28,14H18V4c0-1.104-0.896-2-2-2s-2,0.896-2,2v10H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h10v10c0,1.104,0.896,2,2,2  s2-0.896,2-2V18h10c1.104,0,2-0.896,2-2S29.104,14,28,14z"/></svg>', q = "onbotgo-chatcontainer";
class Ct extends R {
  constructor() {
    super();
    y(this, "messagesHistory", [
      {
        message: "¡Hola! ¿En qué puedo ayudarte hoy?",
        type: "apiMessage"
      }
    ]);
    y(this, "attachedFiles", []);
    y(this, "attachedRecord");
    y(this, "messagesContainer");
    y(this, "scrollBar");
    y(this, "chatInput");
    y(this, "attachFileInput");
    y(this, "btnOnbotgoAttachInput");
    y(this, "btnattachNewFile");
    y(this, "isRecordSelected", !1);
    y(this, "defaultStyles", {
      bottom: "60px",
      right: "10px",
      position: "absolute",
  ...
  onSubmit(e) {
    if (e = (e == null ? void 0 : e.trim()) ?? "", !e && !this.attachedFiles.length && !this.attachedRecord)
      return;
    const r = structuredClone(this.messagesHistory);
    r.splice(0, 1);
    const i = {
      history: r,
      question: e
    ...
    ]), e && this.addMessages([{ message: e, type: "userMessage" }]), this.renderMessages([{ type: "LoadingMessage" }]), this.updateScrollbar(), this.isRecordSelected = !1, this.attachedRecord = null, this.chatInput.getChild("input").value = "", this.getChild("#onbotgo-chatinput").style.display = "grid", this.getChild("#onbotgo-attachFileTemplateContainer").style.display = "grid", this.getChild("#onbotgo-micrecord").style.display = "none", this.updateScrollbar(), ke(i).then((o) => {
      if (!o.success)
        throw new Error(o.msg);
      o.data.process.length && o.data.process.forEach((s) => {
        this.addMessages([
          {
            type: s.role,
            name: s.name,
  ...
  renderMessages(e) {
    e.forEach(
      (r) => !["dataMessage"].includes(r.type) && this.messagesContainer.appendChild(new mt(r))
    );
  }
  ...
  renderAttachTemplate() {
    this.getChild("#onbotgo-attachFileTemplateContainer").innerHTML = this.renderHTML(Re, {
  ...
  render() {
    ...
    this.messagesContainer = this.querySelector("#onbotgo-messageContainer"), this.chatInput = this.querySelector(bt.tag), this.scrollBar = this.querySelector(yt.tag), this.getChild("#onbotgo-btnrecordSend").style.display = "none", this.querySelector("#onbotgo-btnrecord").onclick = () => {
    ...
    }, this.chatInput.onSubmit(this.onSubmit.bind(this)), this.renderMessages(this.messagesHistory), this.isRecordSelected ? (r.style.display = "none", this.chatInput.style.display = "none", e.style.display = "flex") : (r.style.display = "grid", this.btnattachNewFile.style.display = "grid", this.chatInput.style.display = "grid", e.style.display = "none"), this.querySelectorAll(".onbotgo-attachedFile").forEach((i, o) => {
      i.querySelector("i").onclick = (s) => {
        this.attachedFiles.splice(o, 1), this.renderAttachTemplate(), this.attachedFiles.length && (this.querySelector(".onbotgo-dropdown-content").style.display = "flex"), s.stopPropagation();
      };
    });
  }
}
...
class dt extends R {
  constructor() {
    super();
    y(this, "componentStyles", {
      display: "inline-block",
      position: "absolute",
      bottom: "20px",
      right: "20px"
    });
    const e = new gt(E.customIcon), r = new Ct();
    e.onclick = () => r.toggle(), this.appendChild(e), this.appendChild(r), this.setStyles(this.componentStyles);
  }
  connectedCallback() {
  }
}
dt.tag = "onbotgo-chatbot";
function He({ element: n, styles: t }) {
  const e = t.reduce(
    (o, s) => ({
      ...o,
      ...s
    ...
    {}
  ), r = document.createElement("style"), i = $e(e);
...
Dt.tag = qe;
const De = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
<!-- END STOP-->\r
`, Be = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">\r
    <defs>\r
</defs>\r
...
const Ve = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class vt extends Ne {
  constructor(t) {
    var e;
  ...
  startRecording() {
    return Rt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || Ve.find((i) => MediaRecorder.isTypeSupported(i)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
Bt.tag = je;
class Ge {
  constructor({ chatflow: t, theme: e }) {
    if (lt.chatflowID = t, !e)
      return;
    const { typography: r, colors: i, icon: o } = e;
    r && Object.keys(r).forEach(
      (s) => E.typography[s] = r[s]
