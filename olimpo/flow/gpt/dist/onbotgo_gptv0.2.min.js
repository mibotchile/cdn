...
const Ut = {}, Xt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ut
}, Symbol.toStringTag, { value: "Module" })), Ft = /* @__PURE__ */ Gt(Xt);
...
function D(n, t, e) {
  for (var r in t)
    Pt(t, r) && (t[r] != null && typeof t[r] == "object" && (r === "storage" || r === "prefixes") && !e ? n[r] = D(
      /*toObj[key] ||*/
      {},
      t[r]
    ) : n[r] = t[r]);
...
var _ = /^async +/, j = /`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g, V = /'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g, Y = /"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g, St = /[.*+\-?^${}()|[\]\\]/g;
function G(n) {
  return St.test(n) ? n.replace(St, "\\$&") : n;
}
function Jt(n, t) {
  t.rmWhitespace && (n = n.replace(/[\r\n]+/g, `
`).replace(/^\s+|\s+$/gm, "")), j.lastIndex = 0, V.lastIndex = 0, Y.lastIndex = 0;
  var e = t.prefixes, r = [
    e.h,
    e.b,
    e.i,
  ...
  function h(u, p) {
    ...
    function b(N) {
      var xt = n.slice(s, N), P = xt.trim();
      if (C === "f")
        P === "safe" ? g.raw = !0 : t.async && _.test(P) ? (P = P.replace(_, ""), g.f.push([P, "", !0])) : g.f.push([P, ""]);
      else if (C === "fp")
        g.f[g.f.length - 1][1] += P;
      else if (C === "err") {
        if (P) {
          var Nt = xt.search(/\S/);
          H("invalid syntax", n, s + Nt);
        }
      } else
        g[C] = P;
      s = N + 1;
    ...
    for (var v; (v = i.exec(n)) !== null; ) {
      ...
      if (k)
        ...
        if (x === "/*") {
          var I = n.indexOf("*/", i.lastIndex);
          I === -1 && H("unclosed comment", n, v.index), i.lastIndex = I + 2;
        } else if (x === "'") {
          V.lastIndex = v.index;
          var A = V.exec(n);
          A ? i.lastIndex = V.lastIndex : H("unclosed string", n, v.index);
        } else if (x === '"') {
          Y.lastIndex = v.index;
          var O = Y.exec(n);
          O ? i.lastIndex = Y.lastIndex : H("unclosed string", n, v.index);
        } else if (x === "`") {
          j.lastIndex = v.index;
          var F = j.exec(n);
          F ? i.lastIndex = j.lastIndex : H("unclosed string", n, v.index);
        }
      } else if (S)
        return b(E), s = E + v[0].length, o.lastIndex = s, l = w, T && p === "h" && (p = "s"), g.t = p, g;
    }
    return H("unclosed tag", n, u), g;
  }
  function c(u, p) {
    u.b = [], u.d = [];
    var g = !1, f = [];
    ...
    for (var b; (b = o.exec(n)) !== null; ) {
      ...
      C(v, k), s = b.index + b[0].length, S || H("unrecognized tag type: " + x, n, s);
      var w = h(b.index, S), E = w.t;
      if (E === "h") {
        var I = w.n || "";
        t.async && _.test(I) && (w.a = !0, w.n = I.replace(_, "")), w = c(w), f.push(w);
      } else if (E === "c") {
        if (u.n === w.n)
          return g ? (g.d = f, u.b.push(g)) : u.d = f, u;
        H("Helper start and end don't match", n, b.index + b[0].length);
      } else if (E === "b") {
        g ? (g.d = f, u.b.push(g)) : u.d = f;
        var A = w.n || "";
        t.async && _.test(A) && (w.a = !0, w.n = A.replace(_, "")), g = w, f = [];
      } else if (E === "s") {
        var O = w.n || "";
        t.async && _.test(O) && (w.a = !0, w.n = O.replace(_, "")), f.push(w);
      } else
        f.push(w);
    }
    if (p)
...
function Mt(n, t) {
  var e = Jt(n, t), r = "var tR='';" + (t.useWith ? "with(" + t.varName + "||{}){" : "") + $(e, t) + "if(cb){cb(null,tR)} return tR" + (t.useWith ? "}" : "");
  if (t.plugins)
...
function It(n, t, e, r, i, o) {
  var s = "{exec:" + (i ? "async " : "") + At(e, t, n) + ",params:[" + r + "]";
...
function At(n, t, e) {
  return "function(" + t + "){var tR='';" + $(n, e) + "return tR}";
}
function $(n, t) {
...
function _t(n, t, e, r, i, o) {
  r(t[e], n[t[e]]).then(function(s) {
    i += s, e === t.length - 1 ? o(i) : _t(n, t, e + 1, r, i, o);
  });
}
var te = {
  "&": "&amp;",
...
function re(n) {
  var t = String(n);
  return /[&<>"']/.test(t) ? t.replace(/[&<>"']/g, ee) : t;
}
var ne = new Z({}), pt = new Z({
  each: function(n, t) {
    var e = "", r = n.params[0];
  ...
  if: function(n, t) {
    ...
    if (n.b)
      for (var r = 0; r < n.b.length; r++) {
        var i = n.b[r];
        i.n === "else" ? e += "else{" + $(i.d, t) + "}" : i.n === "elif" && (e += "else if(" + i.p + "){" + $(i.d, t) + "}");
      }
    return e;
  },
  try: function(n, t) {
    ...
    var e = "try{" + $(n.d, t) + "}", r = n.b[0];
    return e += "catch" + (r.res ? "(" + r.res + ")" : "") + "{" + $(r.d, t) + "}", e;
  },
  block: function(n, t) {
    z("block", n.b, n.f, !0);
...
function Wt(n) {
  return st.readFileSync(n).toString().replace(se, "");
}
function le(n, t) {
  var e = Q(t), r = Wt(n);
  try {
...
pt.define("includeFile", he);
pt.define("extendsFile", de);
...
}), fe = `{{ @if (it.type === "userMessage") }} {{@if(it.file)}} {{@if(it.fileType\r
==='audio')}}\r
<onbotgo-box\r
...
{{ /if}} {{/if}}\r
`;
var me = globalThis && globalThis.__awaiter || function(n, t, e, r) {
  function i(o) {
...
function Ce(n, t) {
  return typeof n[0] == "number" && (n = [n]), ye(n), {
    duration: t,
    length: n[0].length,
...
class J extends ft {
  ...
  renderBarWaveform(t, e, r, i) {
    ...
    for (let k = 0; k <= l; k++) {
      ...
      if (x > C) {
        const w = Math.round(b * a * i), E = Math.round(v * a * i), I = w + E || 1;
        let A = a - w;
        e.barAlign === "top" ? A = 0 : e.barAlign === "bottom" && (A = c - I), r[f](C * (m + u), A, m, I, p), C = x, b = 0, v = 0;
      }
...
class K extends we {
  ...
  constructor(t) {
    ...
    }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.options = Object.assign({}, ke, t), this.timer = new Me();
...
class mt extends R {
  constructor(e) {
    ...
    }), this.innerHTML = this.renderHTML(fe, {
      type: e.type,
      fileType: e.fileType,
      file: e.file,
      message: e.message,
...
const lt = new Te(), Re = async (n) => await fetch(
...
class bt extends R {
  constructor() {
    ...
    y(this, "input");
    this.innerHTML = this.renderHTML(Fe, { sendIcon: zt }), this.input = this.querySelector("input"), this.sendIcon = this.querySelector(B.tag), this.input.style.fontFamily = L.typography.primary, this.setStyles(this.defaultStyles);
  }
  onSubmit(e) {
...
class Ct extends R {
  ...
  onSubmit(e) {
    ...
    ]), e && this.addMessages([{ message: e, type: "userMessage" }]), this.renderMessages([{ type: "LoadingMessage" }]), this.updateScrollbar(), this.isRecordSelected = !1, this.attachedRecord = null, this.chatInput.getChild("input").value = "", this.getChild("#onbotgo-chatinput").style.display = "grid", this.getChild("#onbotgo-attachFileTemplateContainer").style.display = "grid", this.getChild("#onbotgo-micrecord").style.display = "none", this.updateScrollbar(), Re(i).then((o) => {
      if (!o.success)
  ...
  render() {
    this.innerHTML = this.renderHTML(Ie, {
      logo: He,
      micIcon: _e,
      paperclipIcon: Lt,
      attachedFiles: this.attachedFiles,
...
class dt extends R {
  constructor() {
    ...
    const e = new gt(L.customIcon), r = new Ct();
...
function $e({ element: n, styles: t }) {
  const e = t.reduce(
    ...
    {}
  ), r = document.createElement("style"), i = De(e);
...
Bt.tag = Ne;
const je = `<onbotgo-iconbutton color="danger" size="36px" id="onbootgo-delete-record">\r
...
const Ue = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class vt extends Ge {
  constructor(t) {
    var e;
  ...
  startRecording() {
    return Rt(this, void 0, void 0, function* () {
      const t = this.stream || (yield this.startMic()), e = this.mediaRecorder || new MediaRecorder(t, { mimeType: this.options.mimeType || Ue.find((i) => MediaRecorder.isTypeSupported(i)), audioBitsPerSecond: this.options.audioBitsPerSecond });
